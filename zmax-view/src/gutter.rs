...
//
// Both are `:set` options whose store lives in zmax-term; the values are
...
fn fold_marker(folds: &zmax_core::fold::Folds, line: usize) -> char {
...
pub fn marks<'doc>(
    ...
    use std::collections::HashMap;
    use zmax_core::textobject::{self, TextObject};
...
mod tests {
    ...
    fn foldcolumn_marks_closed_open_and_inner_lines() {
        ...
        let mut folds = zmax_core::fold::Folds::default();
