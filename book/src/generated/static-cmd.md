...
| --- | --- | --- |
| `no_op` | Do nothing |  |
| `move_char_left` | Move left | **spacemacs** — normal: `` h ``, insert: `` <C-b> ``, `` <left> ``<br>**hybrid** — normal: `` h ``, insert: `` <C-b> ``<br>**vim** — normal: `` h ``, `` <C-h> ``, insert: `` <left> ``<br>**helix, kakoune** — normal: `` h ``, `` <left> ``, insert: `` <left> ``<br>**emacs, cua, nano** — normal: `` <C-b> ``, insert: `` <C-b> `` |
| `move_char_right` | Move right | **spacemacs** — normal: `` l ``, insert: `` <C-f> ``, `` <right> ``<br>**hybrid** — normal: `` l ``, insert: `` <C-f> ``<br>**vim** — normal: `` l ``, `` <space> ``, insert: `` <right> ``<br>**helix, kakoune** — normal: `` l ``, `` <right> ``, insert: `` <right> ``<br>**emacs, cua, nano** — normal: `` <C-f> ``, insert: `` <C-f> `` |
| `move_line_up` | Move up | **spacemacs, vim** — normal: `` k ``, `` <C-p> ``, insert: `` <up> ``<br>**hybrid** — normal: `` k ``, `` <C-p> ``<br>**helix, kakoune** — normal: `` gk `` |
| `move_line_down` | Move down | **spacemacs, vim** — normal: `` j ``, `` <C-j> ``, `` <C-n> ``, insert: `` <down> ``<br>**hybrid** — normal: `` j ``, `` <C-j> ``, `` <C-n> ``<br>**helix, kakoune** — normal: `` gj `` |
| `shift_line_up` | Move the line/selection up (JetBrains Move Statement Up) | **spacemacs, hybrid, vim** — normal: `` <A-up> `` |
| `shift_line_down` | Move the line/selection down (JetBrains Move Statement Down) | **spacemacs, hybrid, vim** — normal: `` <A-down> `` |
| `drag_line_down` | Drag the current line down (SPC x . j) | **spacemacs, hybrid** — normal: `` <space>x.J ``, `` <space>x.j ``, `` <space>x.<down> ``, select: `` <space>x.J ``, `` <space>x.j ``, `` <space>x.<down> `` |
| `drag_line_up` | Drag the current line up (SPC x . k) | **spacemacs, hybrid** — normal: `` <space>x.K ``, `` <space>x.k ``, `` <space>x.<up> ``, select: `` <space>x.K ``, `` <space>x.k ``, `` <space>x.<up> `` |
| `toggle_test_file` | Toggle between implementation and test file (SPC p a) | **spacemacs, hybrid** — normal: `` <space>pa ``, select: `` <space>pa `` |
| `buffer_move_right` | Move this buffer one place right in the buffer line (AstroNvim >b) | **spacemacs, hybrid** — normal: `` <space>b<gt> ``, select: `` <space>b<gt> `` |
| `buffer_move_left` | Move this buffer one place left in the buffer line (AstroNvim <b) | **spacemacs, hybrid** — normal: `` <space>b<lt> ``, select: `` <space>b<lt> `` |
| `buffer_sort_by_extension` | Sort the buffer line by file extension (AstroNvim SPC b s e) | **spacemacs, hybrid** — normal: `` <space>boe ``, select: `` <space>boe `` |
| `buffer_sort_by_full_path` | Sort the buffer line by full path (AstroNvim SPC b s p) | **spacemacs, hybrid** — normal: `` <space>bop ``, select: `` <space>bop `` |
...
| `extend_char_left` | Extend left | **helix, kakoune** — select: `` h ``, `` <left> ``<br>**emacs, micro, nano** — select: `` <C-b> ``, `` <left> ``<br>**cua** — select: `` <C-b> ``, `` <left> ``, `` <S-left> `` |
| `extend_char_right` | Extend right | **vim** — select: `` <space> ``<br>**helix, kakoune** — select: `` l ``, `` <right> ``<br>**emacs, micro, nano** — select: `` <C-f> ``, `` <right> ``<br>**cua** — select: `` <C-f> ``, `` <right> ``, `` <S-right> `` |
| `extend_line_up` | Extend up | **helix, kakoune** — select: `` gk `` |
| `extend_line_down` | Extend down | **helix, kakoune** — select: `` gj `` |
| `extend_visual_line_up` | Extend up | **helix, kakoune** — select: `` k ``, `` <up> ``<br>**emacs, micro, nano** — select: `` <up> ``, `` <C-p> ``<br>**cua** — select: `` <up> ``, `` <C-p> ``, `` <S-up> `` |
| `extend_visual_line_down` | Extend down | **helix, kakoune** — select: `` j ``, `` <down> ``<br>**emacs, micro, nano** — select: `` <C-n> ``, `` <down> ``<br>**cua** — select: `` <C-n> ``, `` <down> ``, `` <S-down> `` |
...
| `visual_block_mode` | Enter/leave vim visual-block selection (CTRL-V) | **spacemacs, hybrid, vim** — normal: `` <C-v> ``, `` g<C-h> ``, select: `` <C-v> `` |
| `block_reproject` | Rebuild the visual-block rectangle from its anchor (internal motion helper) |  |
| `visual_line_mode` | Enter/leave vim visual-line selection (V) | **spacemacs, hybrid, vim** — normal: `` V ``, select: `` V `` |
| `line_reproject` | Rebuild the visual-line whole-line span from its anchor (internal motion helper) |  |
| `block_dollar` | Visual-block: extend each row to its own line end (CTRL-V $) | **spacemacs, hybrid, vim** — select: `` $ `` |
| `block_swap_corners` | Visual-block: move cursor to the opposite corner (o) | **spacemacs, hybrid, vim** — select: `` o `` |
| `block_swap_columns` | Visual-block: move cursor to the other column edge (O) | **spacemacs, hybrid, vim** — select: `` O `` |
| `block_insert` | Visual-block: insert at the left column on every row (I) | **spacemacs, hybrid, vim** — select: `` I `` |
| `block_append` | Visual-block: append at the right column, padding short rows (A) | **spacemacs, hybrid, vim** — select: `` A `` |
| `move_next_word_start` | Move to start of next word | **spacemacs** — normal: `` <A-f> ``, `` <A-right> ``, insert: `` <A-f> ``<br>**hybrid** — normal: `` <A-f> ``, `` <A-right> ``<br>**helix, kakoune** — normal: `` w ``<br>**micro** — normal: `` <A-f> ``, insert: `` <A-f> `` |
| `move_prev_word_start` | Move to start of previous word | **spacemacs** — normal: `` <A-b> ``, `` <A-left> ``, `` <C-left> ``, insert: `` <A-b> ``, `` <C-left> ``, `` <S-left> ``<br>**hybrid** — normal: `` <A-b> ``, `` <A-left> ``, `` <C-left> ``<br>**vim** — normal: `` <C-left> ``, insert: `` <C-left> ``, `` <S-left> ``<br>**helix, kakoune** — normal: `` b ``<br>**micro** — normal: `` <A-b> ``, insert: `` <A-b> `` |
| `forward_word` | Move forward over a word, emacs-style (emacs forward-word, M-f) | **hybrid** — insert: `` <A-f> ``<br>**emacs, cua, nano** — normal: `` <A-f> ``, insert: `` <A-f> `` |
| `backward_word` | Move back to the start of a word, emacs-style (emacs backward-word, M-b) | **hybrid** — insert: `` <A-b> ``<br>**emacs, cua, nano** — normal: `` <A-b> ``, insert: `` <A-b> `` |
| `right_word` | Move a word rightward (emacs right-word) |  |
| `left_word` | Move a word leftward (emacs left-word) |  |
| `extend_forward_word` | Extend the selection forward over a word (emacs forward-word with the mark active) | **emacs, cua, micro, nano** — select: `` <A-f> `` |
| `extend_backward_word` | Extend the selection back over a word (emacs backward-word with the mark active) | **emacs, cua, micro, nano** — select: `` <A-b> `` |
| `move_next_word_end` | Move to end of next word | **helix, kakoune** — normal: `` e `` |
| `move_prev_word_end` | Move to end of previous word |  |
| `move_next_long_word_start` | Move to start of next long word | **helix, kakoune** — normal: `` W `` |
| `move_prev_long_word_start` | Move to start of previous long word | **helix, kakoune** — normal: `` B `` |
| `move_next_long_word_end` | Move to end of next long word | **helix, kakoune** — normal: `` E `` |
...
| `vim_move_prev_word_end` | Move to end of previous word (vim caret) | **spacemacs, hybrid, vim** — normal: `` ge `` |
| `vim_move_next_long_word_start` | Move to start of next long word (vim caret) | **spacemacs, hybrid, vim** — normal: `` W `` |
| `vim_move_prev_long_word_start` | Move to start of previous long word (vim caret) | **spacemacs, hybrid, vim** — normal: `` B `` |
| `vim_move_next_long_word_end` | Move to end of next long word (vim caret) | **spacemacs, hybrid, vim** — normal: `` E `` |
| `vim_move_prev_long_word_end` | Move to end of previous long word (vim caret) | **spacemacs, hybrid, vim** — normal: `` gE `` |
| `move_parent_node_end` | Move to end of the parent node | **spacemacs, hybrid** — normal: `` <space>k$ ``, select: `` <space>k$ ``<br>**helix, kakoune** — normal: `` <A-e> `` |
| `move_parent_node_start` | Move to beginning of the parent node | **spacemacs, hybrid** — normal: `` <space>k0 ``, select: `` <space>k0 ``<br>**helix, kakoune** — normal: `` <A-b> `` |
| `extend_next_word_start` | Extend to start of next word | **helix, kakoune** — select: `` w `` |
| `extend_prev_word_start` | Extend to start of previous word | **helix, kakoune** — select: `` b `` |
| `extend_next_word_end` | Extend to end of next word | **helix, kakoune** — select: `` e `` |
...
| `extend_next_long_word_end` | Extend to end of next long word | **helix, kakoune** — select: `` E `` |
...
| `extend_parent_node_end` | Extend to end of the parent node | **helix, kakoune** — select: `` <A-e> `` |
| `extend_parent_node_start` | Extend to beginning of the parent node | **helix, kakoune** — select: `` <A-b> `` |
| `find_till_char` | Move till next occurrence of char | **helix, kakoune** — normal: `` t `` |
| `find_next_char` | Move to next occurrence of char | **helix, kakoune** — normal: `` f `` |
| `extend_till_char` | Extend till next occurrence of char | **helix, kakoune** — select: `` t `` |
| `extend_next_char` | Extend to next occurrence of char | **helix, kakoune** — select: `` f `` |
| `till_prev_char` | Move till previous occurrence of char | **helix, kakoune** — normal: `` T `` |
| `find_prev_char` | Move to previous occurrence of char | **helix, kakoune** — normal: `` F `` |
| `vim_find_next_char` | Move to next occurrence of char on this line (vim f) | **spacemacs, hybrid, vim** — normal: `` f `` |
| `vim_find_prev_char` | Move to previous occurrence of char on this line (vim F) | **spacemacs, hybrid, vim** — normal: `` F `` |
| `vim_find_till_char` | Move till next occurrence of char on this line (vim t) | **spacemacs, hybrid, vim** — normal: `` t `` |
| `vim_till_prev_char` | Move till previous occurrence of char on this line (vim T) | **spacemacs, hybrid, vim** — normal: `` T `` |
...
| `sneak_or_substitute_char` | Sneak forward, or substitute char when vim-sneak is off | **spacemacs, hybrid, vim** — normal: `` s `` |
| `sneak_or_substitute_line` | Sneak backward, or substitute line when vim-sneak is off | **spacemacs, hybrid, vim** — normal: `` S `` |
| `vim_change_line` | Change count lines, keeping the first line's indent (vim cc) | **spacemacs, hybrid, vim** — normal: `` cc `` |
| `extend_till_prev_char` | Extend till previous occurrence of char | **helix, kakoune** — select: `` T `` |
| `extend_prev_char` | Extend to previous occurrence of char | **helix, kakoune** — select: `` F `` |
| `repeat_last_motion` | Repeat last motion | **helix, kakoune** — normal: `` <A-.> ``, select: `` <A-.> `` |
| `repeat_last_command` | Run the last command again (emacs repeat, C-x z) | **spacemacs** — normal: `` <C-x>z ``, select: `` <C-x>z ``, insert: `` <C-x>z ``<br>**hybrid** — normal: `` <C-x>z ``, select: `` <C-x>z `` |
| `command_log_mode` | Toggle the live *command-log* buffer (spacemacs command-log layer) | **spacemacs, hybrid** — normal: `` <space>t<C-l> ``, select: `` <space>t<C-l> `` |
| `repeat_find_char` | Repeat last find in same direction (;) | **spacemacs, hybrid, vim** — normal: `` ; ``, select: `` ; `` |
| `repeat_find_char_reverse` | Repeat last find in opposite direction (,) | **spacemacs, hybrid, vim** — normal: `` , ``, select: `` , `` |
| `replace` | Replace with new char | **spacemacs, hybrid, vim** — select: `` r ``<br>**helix, kakoune** — normal: `` r ``, select: `` r `` |
| `switch_case` | Switch (toggle) case | **spacemacs, hybrid, vim** — select: `` ~ ``<br>**helix, kakoune** — normal: `` ~ ``, select: `` ~ `` |
| `switch_case_forward` | Toggle case and advance cursor (vim ~) | **spacemacs, hybrid, vim** — normal: `` ~ `` |
| `switch_to_uppercase` | Switch to uppercase | **spacemacs, hybrid** — normal: `` <space>xU ``, `` <C-x><C-u> ``, select: `` <space>xU ``, `` <C-x><C-u> ``, insert: `` <C-x><C-u> ``<br>**helix, kakoune** — normal: `` <A-`> ``, select: `` <A-`> ``<br>**emacs** — insert: `` <C-x><C-u> ``<br>**cua** — select: `` <C-X><C-u> ``, insert: `` <C-x><C-u> `` |
| `switch_to_lowercase` | Switch to lowercase | **spacemacs, hybrid** — normal: `` <space>xu ``, `` <C-x><C-l> ``, select: `` <space>xu ``, `` <C-x><C-l> ``, insert: `` <C-x><C-l> ``<br>**helix, kakoune** — normal: `` ` ``, select: `` ` ``<br>**emacs** — insert: `` <C-x><C-l> ``<br>**cua** — select: `` <C-X><C-l> ``, insert: `` <C-x><C-l> `` |
| `upcase_word` | Upper-case the word after point (emacs upcase-word, M-u) | **spacemacs** — normal: `` <A-u> ``<br>**hybrid, emacs, cua, micro** — normal: `` <A-u> ``, insert: `` <A-u> `` |
| `downcase_word` | Lower-case the word after point (emacs downcase-word, M-l) | **spacemacs** — normal: `` <A-l> ``<br>**hybrid, emacs, cua, micro, nano** — normal: `` <A-l> ``, insert: `` <A-l> `` |
| `capitalize_word` | Capitalize the word after point (emacs capitalize-word, M-c) | **spacemacs** — normal: `` <A-c> ``<br>**hybrid, emacs, cua, nano** — normal: `` <A-c> ``, insert: `` <A-c> `` |
...
| `page_up` | Move page up | **spacemacs** — normal: `` <A-v> ``, `` <C-b> ``, `` <S-minus> ``, insert: `` <A-v> ``, `` <S-up> ``, `` <pageup> ``<br>**hybrid** — normal: `` <A-v> ``, `` <C-b> ``, `` <S-minus> ``, insert: `` <A-v> ``, `` <pageup> ``<br>**vim** — normal: `` <C-b> ``, `` <S-minus> ``, insert: `` <S-up> ``, `` <pageup> ``<br>**helix** — normal: `` <C-b> ``, `` Z<C-b> ``, `` z<C-b> ``, `` <pageup> ``, `` Z<pageup> ``, `` z<pageup> ``, select: `` <C-b> ``, `` Z<C-b> ``, `` z<C-b> ``, `` <pageup> ``, `` Z<pageup> ``, `` z<pageup> ``, insert: `` <pageup> ``<br>**kakoune** — normal: `` <C-b> ``, `` V<C-b> ``, `` v<C-b> ``, `` <pageup> ``, `` V<pageup> ``, `` v<pageup> ``, select: `` <C-b> ``, `` <pageup> ``, insert: `` <pageup> ``<br>**emacs, cua, micro** — normal: `` <A-v> ``, `` <pageup> ``, insert: `` <A-v> ``, `` <pageup> ``<br>**nano** — normal: `` <A-v> ``, `` <C-y> ``, `` <pageup> ``, insert: `` <A-v> ``, `` <C-y> ``, `` <pageup> `` |
| `page_down` | Move page down | **spacemacs, vim** — normal: `` <C-f> ``, `` <S-+> ``, `` <S-ret> ``, insert: `` <S-down> ``, `` <pagedown> ``<br>**hybrid** — normal: `` <C-f> ``, `` <S-+> ``, `` <S-ret> ``, insert: `` <C-v> ``, `` <pagedown> ``<br>**helix** — normal: `` <C-f> ``, `` Z<C-f> ``, `` z<C-f> ``, `` <pagedown> ``, `` Z<pagedown> ``, `` z<pagedown> ``, select: `` <C-f> ``, `` Z<C-f> ``, `` z<C-f> ``, `` <pagedown> ``, `` Z<pagedown> ``, `` z<pagedown> ``, insert: `` <pagedown> ``<br>**kakoune** — normal: `` <C-f> ``, `` V<C-f> ``, `` v<C-f> ``, `` <pagedown> ``, `` V<pagedown> ``, `` v<pagedown> ``, select: `` <C-f> ``, `` <pagedown> ``, insert: `` <pagedown> ``<br>**emacs, nano** — normal: `` <C-v> ``, `` <pagedown> ``, insert: `` <C-v> ``, `` <pagedown> ``<br>**cua, micro** — normal: `` <pagedown> ``, insert: `` <pagedown> `` |
| `half_page_up` | Move half page up |  |
| `half_page_down` | Move half page down |  |
| `page_cursor_up` | Move page and cursor up |  |
| `page_cursor_down` | Move page and cursor down |  |
| `page_cursor_half_up` | Move page and cursor half up | **spacemacs, hybrid, vim** — normal: `` <C-u> ``<br>**helix** — normal: `` <C-u> ``, `` Z<C-u> ``, `` z<C-u> ``, `` Z<backspace> ``, `` z<backspace> ``, select: `` <C-u> ``, `` Z<C-u> ``, `` z<C-u> ``, `` Z<backspace> ``, `` z<backspace> ``<br>**kakoune** — normal: `` <C-u> ``, `` V<C-u> ``, `` v<C-u> ``, `` V<backspace> ``, `` v<backspace> ``, select: `` <C-u> `` |
| `page_cursor_half_down` | Move page and cursor half down | **spacemacs, hybrid, vim** — normal: `` <C-d> ``<br>**helix** — normal: `` <C-d> ``, `` Z<C-d> ``, `` z<C-d> ``, `` Z<space> ``, `` z<space> ``, select: `` <C-d> ``, `` Z<C-d> ``, `` z<C-d> ``, `` Z<space> ``, `` z<space> ``<br>**kakoune** — normal: `` <C-d> ``, `` V<C-d> ``, `` v<C-d> ``, `` V<space> ``, `` v<space> ``, select: `` <C-d> `` |
...
| `select_all` | Select whole document | **spacemacs, hybrid** — normal: `` <C-x>h ``, select: `` <C-x>h ``, insert: `` <C-x>h ``<br>**helix, kakoune** — normal: `` % ``, select: `` % ``<br>**emacs** — normal: `` <C-x>h ``, insert: `` <C-x>h ``<br>**cua** — normal: `` <C-x>h ``, select: `` <C-X>h ``, insert: `` <C-x>h ``<br>**micro** — normal: `` <C-a> ``, insert: `` <C-a> `` |
...
| `selection_union` | Union with the saved selections (vis |) | **spacemacs, hybrid, vim** — select: `` \| `` |
| `selection_intersection` | Intersection with the saved selections (vis &) | **spacemacs, hybrid, vim** — select: `` & `` |
| `selection_minus` | Subtract the saved selections (vis \) | **spacemacs, hybrid, vim** — select: `` \ `` |
| `selection_complement` | Select what the selections do not cover (vis ~) | **spacemacs, hybrid, vim** — select: `` <A-~> `` |
| `search` | Search for regex pattern | **spacemacs** — normal: `` / ``, `` <C-s> ``, `` <A-C-s> ``, select: `` / ``<br>**hybrid** — normal: `` / ``, `` <C-s> ``, `` <A-C-s> ``, select: `` / ``, insert: `` <C-s> ``, `` <A-C-s> ``<br>**vim, kakoune** — normal: `` / ``, select: `` / ``<br>**helix** — normal: `` / ``, `` Z/ ``, `` z/ ``, select: `` / ``, `` Z/ ``, `` z/ ``<br>**emacs, cua** — normal: `` <C-s> ``, `` <A-C-s> ``, insert: `` <C-s> ``, `` <A-C-s> ``<br>**micro** — normal: `` <F3> ``, `` <F7> ``, `` <C-f> ``, `` <A-C-s> ``, insert: `` <F3> ``, `` <F7> ``, `` <C-f> ``, `` <A-C-s> ``<br>**nano** — normal: `` <C-s> ``, `` <C-w> ``, `` <A-C-s> ``, insert: `` <C-s> ``, `` <C-w> ``, `` <A-C-s> `` |
| `rsearch` | Reverse search for regex pattern | **spacemacs** — normal: `` ? ``, `` <A-C-r> ``, select: `` ? ``<br>**hybrid** — normal: `` ? ``, `` <A-C-r> ``, select: `` ? ``, insert: `` <C-r> ``, `` <A-C-r> ``<br>**vim, kakoune** — normal: `` ? ``, select: `` ? ``<br>**helix** — normal: `` ? ``, `` Z? ``, `` z? ``, select: `` ? ``, `` Z? ``, `` z? ``<br>**emacs, cua, micro** — normal: `` <C-r> ``, `` <A-C-r> ``, insert: `` <C-r> ``, `` <A-C-r> ``<br>**nano** — normal: `` <C-q> ``, `` <A-C-r> ``, insert: `` <C-q> ``, `` <A-C-r> `` |
| `delete_to_search_forward` | Delete up to the next match (vim d/pat) | **spacemacs, hybrid, vim** — normal: `` d/ `` |
| `delete_to_search_backward` | Delete back to the previous match (vim d?pat) | **spacemacs, hybrid, vim** — normal: `` d? `` |
| `change_to_search_forward` | Change up to the next match (vim c/pat) | **spacemacs, hybrid, vim** — normal: `` c/ `` |
| `change_to_search_backward` | Change back to the previous match (vim c?pat) | **spacemacs, hybrid, vim** — normal: `` c? `` |
| `yank_to_search_forward` | Yank up to the next match (vim y/pat) | **spacemacs, hybrid, vim** — normal: `` y/ `` |
| `yank_to_search_backward` | Yank back to the previous match (vim y?pat) | **spacemacs, hybrid, vim** — normal: `` y? `` |
| `search_next` | Select next search match | **spacemacs, hybrid** — normal: `` <space>sH ``, select: `` <space>sH ``<br>**helix** — normal: `` n ``, `` Zn ``, `` zn ``, select: `` Zn ``, `` zn ``<br>**kakoune** — normal: `` n ``<br>**micro** — normal: `` <C-n> ``, insert: `` <C-n> ``<br>**nano** — normal: `` <A-w> ``, insert: `` <A-w> `` |
...
| `search_next_vim` | vim n: repeat last search in its direction | **spacemacs, hybrid, vim** — normal: `` n `` |
| `search_prev_vim` | vim N: repeat last search in the opposite direction | **spacemacs, hybrid, vim** — normal: `` N `` |
| `extend_search_next_vim` | vim n (visual): extend to the repeated match | **spacemacs, hybrid, vim** — select: `` n `` |
...
| `ediff_windows` | Diff the two front windows side by side (SPC D w w) | **spacemacs, hybrid** — normal: `` <space>Dwl ``, `` <space>Dww ``, select: `` <space>Dwl ``, `` <space>Dww `` |
| `ediff_buffer` | Diff the current buffer against a picked buffer (SPC D b b) | **spacemacs, hybrid** — normal: `` <space>Dbb ``, select: `` <space>Dbb `` |
| `ediff_dotfile_and_template` | Diff the config file against the shipped template (SPC f e D) | **spacemacs, hybrid** — normal: `` <space>Df. ``, `` <space>feD ``, select: `` <space>Df. ``, `` <space>feD `` |
| `compare_with_clipboard` | Diff the current buffer against the clipboard (JetBrains Compare with Clipboard) | **spacemacs, hybrid** — normal: `` <space>Dc ``, select: `` <space>Dc `` |
| `transpose_paragraph` | Swap the current paragraph with the previous one (SPC x t p) | **spacemacs, hybrid** — normal: `` <space>xtp ``, select: `` <space>xtp `` |
...
| `transpose_line` | Swap the current line with the previous one (emacs transpose-lines, C-x C-t) | **spacemacs, hybrid** — normal: `` <C-x><C-t> ``, select: `` <C-x><C-t> ``, insert: `` <C-x><C-t> ``<br>**emacs** — insert: `` <C-x><C-t> ``<br>**cua** — select: `` <C-X><C-t> ``, insert: `` <C-x><C-t> `` |
| `move_element_right` | Swap the syntax node under the cursor with its next sibling (JetBrains Move Element Right) | **spacemacs, hybrid** — normal: `` <space>x<gt> ``, select: `` <space>x<gt> `` |
| `move_element_left` | Swap the syntax node under the cursor with its previous sibling (JetBrains Move Element Left) | **spacemacs, hybrid** — normal: `` <space>x<lt> ``, select: `` <space>x<lt> `` |
| `convert_indent_to_spaces` | Convert leading indentation to spaces (JetBrains Convert Indents to Spaces) | **kakoune** — normal: `` @ `` |
| `convert_indent_to_tabs` | Convert leading indentation to tabs (JetBrains Convert Indents to Tabs) | **kakoune** — normal: `` <A-@> `` |
| `transpose_sexp` | Swap the current s-expression with the previous one (SPC x t e) | **spacemacs, hybrid** — normal: `` <A-C-t> ``, `` <space>xte ``, select: `` <space>xte `` |
| `transpose_sentence` | Swap the current sentence with the previous one (SPC x t s) | **spacemacs, hybrid** — normal: `` <space>xts ``, select: `` <space>xts `` |
| `make_3_windows` | Lay out three vertical windows (SPC w 3) | **spacemacs, hybrid** — normal: `` <C-w>3 ``, `` <space>w3 ``, `` <space>u<space>w3 ``, select: `` <space>w3 ``, `` <space>u<space>w3 ``<br>**vim** — normal: `` <C-w>3 `` |
| `make_4_windows` | Lay out a 2x2 window grid (SPC w 4) | **spacemacs, hybrid** — normal: `` <C-w>4 ``, `` <space>w4 ``, `` <space>u<space>w4 ``, select: `` <space>w4 ``, `` <space>u<space>w4 ``<br>**vim** — normal: `` <C-w>4 `` |
| `narrow_to_function` | Narrow the buffer to the enclosing function (SPC n f) | **spacemacs** — normal: `` <C-x>nd ``, `` <space>nf ``, select: `` <C-x>nd ``, `` <space>nf ``, insert: `` <C-x>nd ``<br>**hybrid** — normal: `` <C-x>nd ``, `` <space>nf ``, select: `` <C-x>nd ``, `` <space>nf `` |
| `align_at_equals` | Align region at = (SPC x a =) | **spacemacs, hybrid** — normal: `` <space>xa= ``, select: `` <space>xa= `` |
| `align_at_comma` | Align region at , (SPC x a ,) | **spacemacs, hybrid** — normal: `` <space>xa, ``, select: `` <space>xa, `` |
| `align_at_colon` | Align region at : (SPC x a :) | **spacemacs, hybrid** — normal: `` <space>xa: ``, select: `` <space>xa: `` |
| `align_at_semicolon` | Align region at ; (SPC x a ;) | **spacemacs, hybrid** — normal: `` <space>xa; ``, select: `` <space>xa; `` |
| `align_at_ampersand` | Align region at & (SPC x a &) | **spacemacs, hybrid** — normal: `` <space>xa& ``, select: `` <space>xa& `` |
| `align_at_lparen` | Align region at ( (SPC x a () | **spacemacs, hybrid** — normal: `` <space>xa( ``, select: `` <space>xa( `` |
| `align_at_rparen` | Align region at ) (SPC x a )) | **spacemacs, hybrid** — normal: `` <space>xa) ``, select: `` <space>xa) `` |
| `align_at_lbracket` | Align region at [ (SPC x a [) | **spacemacs, hybrid** — normal: `` <space>xa[ ``, select: `` <space>xa[ `` |
| `align_at_rbracket` | Align region at ] (SPC x a ]) | **spacemacs, hybrid** — normal: `` <space>xa] ``, select: `` <space>xa] `` |
| `align_at_lbrace` | Align region at { (SPC x a {) | **spacemacs, hybrid** — normal: `` <space>xa{ ``, select: `` <space>xa{ `` |
| `align_at_rbrace` | Align region at } (SPC x a }) | **spacemacs, hybrid** — normal: `` <space>xa} ``, select: `` <space>xa} `` |
| `align_at_dot` | Align region at . (SPC x a .) | **spacemacs, hybrid** — normal: `` <space>xa. ``, select: `` <space>xa. `` |
| `align_at_arithmetic` | Align region at arithmetic operators (SPC x a m) | **spacemacs, hybrid** — normal: `` <space>xam ``, select: `` <space>xam `` |
| `align_at_regex` | Align region at a user-specified regexp (SPC x a r) | **spacemacs, hybrid** — normal: `` <space>xar ``, select: `` <space>xar `` |
...
| `align_at_bar` | Align every | into columns (SPC x a |) | **spacemacs, hybrid** — normal: `` <space>xa\| ``, select: `` <space>xa\| `` |
| `align_at_bar_after` | Align every | into columns, padding after the bar (SPC u SPC x a |) | **spacemacs, hybrid** — normal: `` <space>u<space>xa\| ``, select: `` <space>u<space>xa\| `` |
| `align_left_at_char` | Left-align region at a typed delimiter (SPC x a l) | **spacemacs, hybrid** — normal: `` <space>xal ``, select: `` <space>xal `` |
| `align_right_at_char` | Right-align region at a typed delimiter (SPC x a L) | **spacemacs, hybrid** — normal: `` <space>xaL ``, select: `` <space>xaL `` |
| `buffer_to_window_1` | Move current buffer to window 1 (SPC b . 1) | **spacemacs, hybrid** — normal: `` <space>b.1 ``, select: `` <space>b.1 `` |
| `buffer_to_window_2` | Move current buffer to window 2 (SPC b . 2) | **spacemacs, hybrid** — normal: `` <space>b.2 ``, select: `` <space>b.2 `` |
| `buffer_to_window_3` | Move current buffer to window 3 (SPC b . 3) | **spacemacs, hybrid** — normal: `` <space>b.3 ``, select: `` <space>b.3 `` |
| `buffer_to_window_4` | Move current buffer to window 4 (SPC b . 4) | **spacemacs, hybrid** — normal: `` <space>b.4 ``, select: `` <space>b.4 `` |
| `buffer_to_window_5` | Move current buffer to window 5 (SPC b . 5) | **spacemacs, hybrid** — normal: `` <space>b.5 ``, select: `` <space>b.5 `` |
| `buffer_to_window_6` | Move current buffer to window 6 (SPC b . 6) | **spacemacs, hybrid** — normal: `` <space>b.6 ``, select: `` <space>b.6 `` |
| `buffer_to_window_7` | Move current buffer to window 7 (SPC b . 7) | **spacemacs, hybrid** — normal: `` <space>b.7 ``, select: `` <space>b.7 `` |
| `buffer_to_window_8` | Move current buffer to window 8 (SPC b . 8) | **spacemacs, hybrid** — normal: `` <space>b.8 ``, select: `` <space>b.8 `` |
| `buffer_to_window_9` | Move current buffer to window 9 (SPC b . 9) | **spacemacs, hybrid** — normal: `` <space>b.9 ``, select: `` <space>b.9 `` |
| `goto_window_1` | Go to window 1 (SPC 1) | **spacemacs, hybrid** — normal: `` <C-w>.1 ``, `` <C-w>[1 ``, `` <C-w>{1 ``, `` <space>1 ``, `` <space>w.1 ``, `` <space>w[1 ``, `` <space>w{1 ``, `` <space>b.<C-1> ``, select: `` <space>1 ``, `` <space>w.1 ``, `` <space>w[1 ``, `` <space>w{1 ``, `` <space>b.<C-1> ``<br>**vim** — normal: `` <C-w>.1 ``, `` <C-w>[1 ``, `` <C-w>{1 `` |
| `goto_window_2` | Go to window 2 (SPC 2) | **spacemacs, hybrid** — normal: `` <C-w>.2 ``, `` <C-w>[2 ``, `` <C-w>{2 ``, `` <space>2 ``, `` <space>w.2 ``, `` <space>w[2 ``, `` <space>w{2 ``, `` <space>b.<C-2> ``, select: `` <space>2 ``, `` <space>w.2 ``, `` <space>w[2 ``, `` <space>w{2 ``, `` <space>b.<C-2> ``<br>**vim** — normal: `` <C-w>.2 ``, `` <C-w>[2 ``, `` <C-w>{2 `` |
| `goto_window_3` | Go to window 3 (SPC 3) | **spacemacs, hybrid** — normal: `` <C-w>.3 ``, `` <C-w>[3 ``, `` <C-w>{3 ``, `` <space>3 ``, `` <space>w.3 ``, `` <space>w[3 ``, `` <space>w{3 ``, `` <space>b.<C-3> ``, select: `` <space>3 ``, `` <space>w.3 ``, `` <space>w[3 ``, `` <space>w{3 ``, `` <space>b.<C-3> ``<br>**vim** — normal: `` <C-w>.3 ``, `` <C-w>[3 ``, `` <C-w>{3 `` |
| `goto_window_4` | Go to window 4 (SPC 4) | **spacemacs, hybrid** — normal: `` <C-w>.4 ``, `` <C-w>[4 ``, `` <C-w>{4 ``, `` <space>4 ``, `` <space>w.4 ``, `` <space>w[4 ``, `` <space>w{4 ``, `` <space>b.<C-4> ``, select: `` <space>4 ``, `` <space>w.4 ``, `` <space>w[4 ``, `` <space>w{4 ``, `` <space>b.<C-4> ``<br>**vim** — normal: `` <C-w>.4 ``, `` <C-w>[4 ``, `` <C-w>{4 `` |
| `goto_window_5` | Go to window 5 (SPC 5) | **spacemacs, hybrid** — normal: `` <C-w>.5 ``, `` <C-w>[5 ``, `` <C-w>{5 ``, `` <space>5 ``, `` <space>w.5 ``, `` <space>w[5 ``, `` <space>w{5 ``, `` <space>b.<C-5> ``, select: `` <space>5 ``, `` <space>w.5 ``, `` <space>w[5 ``, `` <space>w{5 ``, `` <space>b.<C-5> ``<br>**vim** — normal: `` <C-w>.5 ``, `` <C-w>[5 ``, `` <C-w>{5 `` |
| `goto_window_6` | Go to window 6 (SPC 6) | **spacemacs, hybrid** — normal: `` <C-w>.6 ``, `` <C-w>[6 ``, `` <C-w>{6 ``, `` <space>6 ``, `` <space>w.6 ``, `` <space>w[6 ``, `` <space>w{6 ``, `` <space>b.<C-6> ``, select: `` <space>6 ``, `` <space>w.6 ``, `` <space>w[6 ``, `` <space>w{6 ``, `` <space>b.<C-6> ``<br>**vim** — normal: `` <C-w>.6 ``, `` <C-w>[6 ``, `` <C-w>{6 `` |
| `goto_window_7` | Go to window 7 (SPC 7) | **spacemacs, hybrid** — normal: `` <C-w>.7 ``, `` <C-w>[7 ``, `` <C-w>{7 ``, `` <space>7 ``, `` <space>w.7 ``, `` <space>w[7 ``, `` <space>w{7 ``, `` <space>b.<C-7> ``, select: `` <space>7 ``, `` <space>w.7 ``, `` <space>w[7 ``, `` <space>w{7 ``, `` <space>b.<C-7> ``<br>**vim** — normal: `` <C-w>.7 ``, `` <C-w>[7 ``, `` <C-w>{7 `` |
| `goto_window_8` | Go to window 8 (SPC 8) | **spacemacs, hybrid** — normal: `` <C-w>.8 ``, `` <C-w>[8 ``, `` <C-w>{8 ``, `` <space>8 ``, `` <space>w.8 ``, `` <space>w[8 ``, `` <space>w{8 ``, `` <space>b.<C-8> ``, select: `` <space>8 ``, `` <space>w.8 ``, `` <space>w[8 ``, `` <space>w{8 ``, `` <space>b.<C-8> ``<br>**vim** — normal: `` <C-w>.8 ``, `` <C-w>[8 ``, `` <C-w>{8 `` |
| `goto_window_9` | Go to window 9 (SPC 9) | **spacemacs, hybrid** — normal: `` <C-w>.9 ``, `` <C-w>[9 ``, `` <C-w>{9 ``, `` <space>9 ``, `` <space>w.9 ``, `` <space>w[9 ``, `` <space>w{9 ``, `` <space>b.<C-9> ``, select: `` <space>9 ``, `` <space>w.9 ``, `` <space>w[9 ``, `` <space>w{9 ``, `` <space>b.<C-9> ``<br>**vim** — normal: `` <C-w>.9 ``, `` <C-w>[9 ``, `` <C-w>{9 `` |
| `delete_window_and_buffer` | Close window and kill its buffer (SPC w . x) | **spacemacs, hybrid** — normal: `` <C-w>.x ``, `` <C-w>[x ``, `` <C-w>{x ``, `` <C-x>40 ``, `` <space>w.x ``, `` <space>w[x ``, `` <space>w{x ``, `` <space>u<space>bD ``, `` <space>u<space>wD ``, select: `` <C-x>40 ``, `` <space>w.x ``, `` <space>w[x ``, `` <space>w{x ``, `` <space>u<space>bD ``, `` <space>u<space>wD ``, insert: `` <C-x>40 ``<br>**vim** — normal: `` <C-w>.x ``, `` <C-w>[x ``, `` <C-w>{x ``<br>**emacs** — insert: `` <C-x>40 ``<br>**cua** — select: `` <C-X>40 ``, insert: `` <C-x>40 `` |
| `eval_elisp_region` | Evaluate the selection as elisp (SPC m e r) | **spacemacs, hybrid** — normal: `` <space>mer ``, select: `` <space>mer `` |
| `eval_elisp_buffer` | Evaluate the buffer as elisp (SPC m e b) | **spacemacs, hybrid** — normal: `` <space>meb ``, select: `` <space>meb `` |
| `eval_elisp_line` | Evaluate the current line as elisp (SPC m e e) | **spacemacs, hybrid** — normal: `` <space>me$ ``, `` <space>mee ``, `` <space>mel ``, select: `` <space>me$ ``, `` <space>mee ``, `` <space>mel `` |
| `eval_elisp_defun` | Evaluate the enclosing form as elisp (SPC m e f) | **spacemacs, hybrid** — normal: `` <space>mec ``, `` <space>mef ``, select: `` <space>mec ``, `` <space>mef `` |
| `eval_print_last_sexp` | Evaluate the sexp before point and insert its value (emacs eval-print-last-sexp) |  |
| `eval_last_sexp` | Evaluate the sexp before point and echo its value (emacs eval-last-sexp, C-x C-e) | **spacemacs** — normal: `` <C-x><C-e> ``, select: `` <C-x><C-e> ``, insert: `` <C-x><C-e> ``<br>**hybrid** — normal: `` <C-x><C-e> ``, select: `` <C-x><C-e> `` |
| `compare_windows` | Compare this window with the next, moving both points to the first difference (emacs compare-windows) |  |
| `layout_create` | Create a new window-layout from the current windows (SPC l l) | **spacemacs, hybrid** — normal: `` <space>ll ``, `` <space>lww ``, select: `` <space>ll ``, `` <space>lww `` |
| `layout_next` | Switch to the next layout (SPC l n) | **spacemacs, hybrid** — normal: `` <space>ln ``, `` <space>lwl ``, `` <space>lwn ``, `` <space>l<C-l> ``, select: `` <space>ln ``, `` <space>lwl ``, `` <space>lwn ``, `` <space>l<C-l> `` |
| `layout_prev` | Switch to the previous layout (SPC l p) | **spacemacs, hybrid** — normal: `` <space>lN ``, `` <space>lp ``, `` <space>lwN ``, `` <space>lwh ``, `` <space>lwp ``, `` <space>l<C-h> ``, select: `` <space>lN ``, `` <space>lp ``, `` <space>lwN ``, `` <space>lwh ``, `` <space>lwp ``, `` <space>l<C-h> `` |
| `layout_last` | Switch to the last-used layout (SPC l TAB) | **spacemacs, hybrid** — normal: `` <space>l<tab> ``, `` <space>lw<tab> ``, select: `` <space>l<tab> ``, `` <space>lw<tab> `` |
| `layout_default` | Switch to the default (first) layout (SPC l h) | **spacemacs, hybrid** — normal: `` <space>lh ``, select: `` <space>lh `` |
| `layout_delete` | Delete the current layout, keeping its buffers (SPC l d) | **spacemacs, hybrid** — normal: `` <space>lD ``, `` <space>lX ``, `` <space>ld ``, `` <space>lx ``, `` <space>lwd ``, select: `` <space>lD ``, `` <space>lX ``, `` <space>ld ``, `` <space>lx ``, `` <space>lwd `` |
| `layout_save` | Save layouts to disk (SPC l s) | **spacemacs, hybrid** — normal: `` <space>lS ``, select: `` <space>lS `` |
| `layout_rename` | Rename the current layout (SPC l R) | **spacemacs, hybrid** — normal: `` <space>lR ``, `` <space>lwR ``, select: `` <space>lR ``, `` <space>lwR `` |
| `layout_load` | Load layouts from disk (SPC l L) | **spacemacs, hybrid** — normal: `` <space>lL ``, `` <space>lo ``, select: `` <space>lL ``, `` <space>lo `` |
| `layout_goto_1` | Switch to layout 1 (SPC l 1) | **spacemacs, hybrid** — normal: `` <space>l1 ``, `` <space>lw1 ``, `` <space>l<C-1> ``, `` <space>lw<C-1> ``, select: `` <space>l1 ``, `` <space>lw1 ``, `` <space>l<C-1> ``, `` <space>lw<C-1> `` |
| `layout_goto_2` | Switch to layout 2 (SPC l 2) | **spacemacs, hybrid** — normal: `` <space>l2 ``, `` <space>lw2 ``, `` <space>l<C-2> ``, `` <space>lw<C-2> ``, select: `` <space>l2 ``, `` <space>lw2 ``, `` <space>l<C-2> ``, `` <space>lw<C-2> `` |
| `layout_goto_3` | Switch to layout 3 (SPC l 3) | **spacemacs, hybrid** — normal: `` <space>l3 ``, `` <space>lw3 ``, `` <space>l<C-3> ``, `` <space>lw<C-3> ``, select: `` <space>l3 ``, `` <space>lw3 ``, `` <space>l<C-3> ``, `` <space>lw<C-3> `` |
| `layout_goto_4` | Switch to layout 4 (SPC l 4) | **spacemacs, hybrid** — normal: `` <space>l4 ``, `` <space>lw4 ``, `` <space>l<C-4> ``, `` <space>lw<C-4> ``, select: `` <space>l4 ``, `` <space>lw4 ``, `` <space>l<C-4> ``, `` <space>lw<C-4> `` |
| `layout_goto_5` | Switch to layout 5 (SPC l 5) | **spacemacs, hybrid** — normal: `` <space>l5 ``, `` <space>lw5 ``, `` <space>l<C-5> ``, `` <space>lw<C-5> ``, select: `` <space>l5 ``, `` <space>lw5 ``, `` <space>l<C-5> ``, `` <space>lw<C-5> `` |
| `layout_goto_6` | Switch to layout 6 (SPC l 6) | **spacemacs, hybrid** — normal: `` <space>l6 ``, `` <space>lw6 ``, `` <space>l<C-6> ``, `` <space>lw<C-6> ``, select: `` <space>l6 ``, `` <space>lw6 ``, `` <space>l<C-6> ``, `` <space>lw<C-6> `` |
| `layout_goto_7` | Switch to layout 7 (SPC l 7) | **spacemacs, hybrid** — normal: `` <space>l7 ``, `` <space>lw7 ``, `` <space>l<C-7> ``, `` <space>lw<C-7> ``, select: `` <space>l7 ``, `` <space>lw7 ``, `` <space>l<C-7> ``, `` <space>lw<C-7> `` |
| `layout_goto_8` | Switch to layout 8 (SPC l 8) | **spacemacs, hybrid** — normal: `` <space>l8 ``, `` <space>lw8 ``, `` <space>l<C-8> ``, `` <space>lw<C-8> ``, select: `` <space>l8 ``, `` <space>lw8 ``, `` <space>l<C-8> ``, `` <space>lw<C-8> `` |
| `layout_goto_9` | Switch to layout 9 (SPC l 9) | **spacemacs, hybrid** — normal: `` <space>l9 ``, `` <space>lw9 ``, `` <space>l<C-9> ``, `` <space>lw<C-9> ``, select: `` <space>l9 ``, `` <space>lw9 ``, `` <space>l<C-9> ``, `` <space>lw<C-9> `` |
| `toggle_modeline_position` | Toggle cursor position in the mode line (SPC t m p) | **spacemacs, hybrid** — normal: `` <space>tmp ``, select: `` <space>tmp `` |
| `toggle_modeline_vcs` | Toggle version-control info in the mode line (SPC t m v) | **spacemacs, hybrid** — normal: `` <space>tmv ``, select: `` <space>tmv `` |
| `toggle_modeline_major_mode` | Toggle the major mode (file type) in the mode line (SPC t m M) | **spacemacs, hybrid** — normal: `` <space>tmM ``, select: `` <space>tmM `` |
| `toggle_system_monitor` | Toggle the system monitor in the minibuffer (symon-mode, SPC t m s) | **spacemacs, hybrid** — normal: `` <space>tms ``, select: `` <space>tms `` |
| `toggle_centered_cursor` | Keep the cursor vertically centered (SPC t -) | **spacemacs, hybrid** — normal: `` <space>wcC ``, `` <space>wcc ``, `` <space>t<minus> ``, select: `` <space>wcC ``, `` <space>wcc ``, `` <space>t<minus> `` |
...
| `set_fill_prefix` | Set the fill-prefix from line start to point (emacs set-fill-prefix) | **spacemacs** — normal: `` <C-x>. ``, select: `` <C-x>. ``, insert: `` <C-x>. ``<br>**hybrid** — normal: `` <C-x>. ``, select: `` <C-x>. `` |
| `set_goal_column` | Make vertical motion stick to the current column (emacs set-goal-column) | **spacemacs** — normal: `` <C-x><C-n> ``, select: `` <C-x><C-n> ``, insert: `` <C-x><C-n> ``<br>**hybrid** — normal: `` <C-x><C-n> ``, select: `` <C-x><C-n> `` |
| `toggle_fill_column` | Toggle a fill-column ruler (SPC t f) | **spacemacs, hybrid** — normal: `` <space>tf ``, select: `` <space>tf `` |
| `toggle_long_line_marker` | Toggle an 80th-column ruler (SPC t 8) | **spacemacs, hybrid** — normal: `` <space>t8 ``, `` <space>t<C-8> ``, select: `` <space>t8 ``, `` <space>t<C-8> `` |
...
| `toggle_syntax_highlighting` | Toggle syntax highlighting for the current buffer (SPC t h s) | **spacemacs, hybrid** — normal: `` <space>ths ``, select: `` <space>ths `` |
| `toggle_diagnostics` | Toggle diagnostics display / flycheck (SPC t s) | **spacemacs, hybrid** — normal: `` <space>ts ``, select: `` <space>ts `` |
| `ediff_file` | Diff a prompted file against the current buffer (SPC D f f) | **spacemacs, hybrid** — normal: `` <space>Dff ``, select: `` <space>Dff `` |
| `ediff_backup` | Two-pane ediff of this file against its backup file (emacs ediff-backup, SPC D B) | **spacemacs, hybrid** — normal: `` <space>DB ``, select: `` <space>DB `` |
| `ediff_documentation` | Show the Ediff manual and the ediff sessions this build ships (ediff-documentation, SPC D h) | **spacemacs, hybrid** — normal: `` <space>Dh ``, select: `` <space>Dh `` |
| `ediff_3_files` | 3-way diff of three prompted files, read-only (SPC D f 3) | **spacemacs, hybrid** — normal: `` <space>Df3 ``, select: `` <space>Df3 `` |
| `ediff_directories` | Compare two directories: list same-name files that differ or are unique, open ediff on one (emacs ediff-directories, SPC D d d) | **spacemacs, hybrid** — normal: `` <space>Ddd ``, select: `` <space>Ddd `` |
| `ediff_directories3` | Compare three directories: list same-name files present in all three that differ, open a 3-way ediff (emacs ediff-directories3, SPC D d 3) | **spacemacs, hybrid** — normal: `` <space>Dd3 ``, select: `` <space>Dd3 `` |
| `ediff_merge_directories_with_ancestor` | Merge the same-name files of two directories against a third holding their ancestors (emacs ediff-merge-directories-with-ancestor, SPC D m d 3) | **spacemacs, hybrid** — normal: `` <space>Dmd3 ``, select: `` <space>Dmd3 `` |
| `ediff_directory_revisions` | Compare a directory's files against their revisions (emacs ediff-directory-revisions, SPC D d r) | **spacemacs, hybrid** — normal: `` <space>Ddr ``, select: `` <space>Ddr `` |
| `ediff_merge_revisions_with_ancestor` | Merge two revisions of this file against their common ancestor (emacs ediff-merge-revisions-with-ancestor, SPC D m r 3) | **spacemacs, hybrid** — normal: `` <space>Dmr3 ``, select: `` <space>Dmr3 `` |
| `ediff_merge_revisions` | Merge two revisions of this file, no ancestor (emacs ediff-merge-revisions, SPC D m r r) | **spacemacs, hybrid** — normal: `` <space>Dmrr ``, select: `` <space>Dmrr `` |
| `ediff_regions` | Ediff two regions linewise: mark A, then diff B (SPC D r l) | **spacemacs, hybrid** — normal: `` <space>Drl ``, select: `` <space>Drl `` |
| `ediff_regions_wordwise` | Ediff two regions wordwise: mark A, then diff B by word (SPC D r w) | **spacemacs, hybrid** — normal: `` <space>Drw ``, select: `` <space>Drw `` |
| `ediff_merge_file` | Merge a picked file into the current buffer (editable, SPC D m f f) | **spacemacs, hybrid** — normal: `` <space>Dmff ``, select: `` <space>Dmff `` |
| `ediff_3_buffers` | 3-way diff of three open buffers, read-only (SPC D b 3) | **spacemacs, hybrid** — normal: `` <space>Db3 ``, select: `` <space>Db3 `` |
| `kill_buffers_by_regex` | Kill all buffers whose name matches a regex (SPC b M) | **spacemacs, hybrid** — normal: `` <space>b<C-D> ``, select: `` <space>b<C-D> `` |
| `narrow_to_page` | Narrow the buffer to the current page (SPC n p) | **spacemacs** — normal: `` <C-x>np ``, `` <space>np ``, select: `` <C-x>np ``, `` <space>np ``, insert: `` <C-x>np ``<br>**hybrid** — normal: `` <C-x>np ``, `` <space>np ``, select: `` <C-x>np ``, `` <space>np `` |
| `copy_file` | Copy the current file to a prompted destination (SPC f c) | **spacemacs, hybrid** — normal: `` <space>fc ``, select: `` <space>fc `` |
| `find_file_replace_buffer` | Open a file and replace the current buffer with it (SPC f A) | **spacemacs, hybrid** — normal: `` <space>fA ``, `` <C-x><C-v> ``, select: `` <space>fA ``, `` <C-x><C-v> ``, insert: `` <C-x><C-v> ``<br>**emacs** — insert: `` <C-x><C-v> ``<br>**cua** — select: `` <C-X><C-v> ``, insert: `` <C-x><C-v> `` |
| `open_file_literally` | Open a file with no syntax/language (fundamental mode, SPC f l) | **spacemacs, hybrid** — normal: `` <space>fl ``, select: `` <space>fl `` |
| `locate_file` | Locate a file via system locate/mdfind and open it (SPC f L) | **spacemacs, hybrid** — normal: `` <space>fL ``, select: `` <space>fL `` |
| `edit_project_config` | Edit the project-local .zmax/config.toml (SPC p e) | **spacemacs, hybrid** — normal: `` <space>pe ``, select: `` <space>pe `` |
| `man_page_search` | Search man pages via apropos and view the selected page (SPC h m) | **spacemacs, hybrid** — normal: `` <space>hm ``, select: `` <space>hm `` |
| `info_search` | Search GNU info manuals (apropos) and view the selected node (emacs info-apropos) | **spacemacs, hybrid** — normal: `` <space>hi ``, select: `` <space>hi `` |
| `info` | Open the Info directory node; a prefix reads a file or node name (emacs info, C-h i) | **spacemacs** — normal: `` <C-h>i ``, select: `` <C-h>i ``, insert: `` <C-h>i ``<br>**hybrid** — normal: `` <C-h>i ``, select: `` <C-h>i ``, insert: `` <F1>i ``, `` <C-h>i ``<br>**emacs, cua, micro** — normal: `` <F1>i ``, `` <C-h>i ``, select: `` <F1>i ``, `` <C-h>i ``, insert: `` <F1>i ``, `` <C-h>i ``<br>**nano** — normal: `` <F1>i ``, select: `` <F1>i ``, `` <C-h>i ``, insert: `` <F1>i `` |
| `info_lookup_symbol` | Look a symbol up in the Info manual for this buffer's language (emacs info-lookup-symbol, C-h S) | **spacemacs** — normal: `` <C-h>S ``, select: `` <C-h>S ``, insert: `` <C-h>S ``<br>**hybrid** — normal: `` <C-h>S ``, select: `` <C-h>S ``, insert: `` <F1>S ``, `` <C-h>S ``<br>**emacs, cua, micro** — normal: `` <F1>S ``, `` <C-h>S ``, select: `` <F1>S ``, `` <C-h>S ``, insert: `` <F1>S ``, `` <C-h>S ``<br>**nano** — normal: `` <F1>S ``, select: `` <F1>S ``, `` <C-h>S ``, insert: `` <F1>S `` |
...
| `info_goto_emacs_key_command_node` | Go to the Emacs manual node for the command a key runs (emacs Info-goto-emacs-key-command-node, C-h K) | **spacemacs** — normal: `` <C-h>K ``, select: `` <C-h>K ``, insert: `` <C-h>K ``<br>**hybrid** — normal: `` <C-h>K ``, select: `` <C-h>K ``, insert: `` <F1>K ``, `` <C-h>K ``<br>**emacs, cua, micro** — normal: `` <F1>K ``, `` <C-h>K ``, select: `` <F1>K ``, `` <C-h>K ``, insert: `` <F1>K ``, `` <C-h>K ``<br>**nano** — normal: `` <F1>K ``, select: `` <F1>K ``, `` <C-h>K ``, insert: `` <F1>K `` |
...
| `diagnostics_verify_setup` | Report the buffer's diagnostics/LSP setup (SPC e v) | **spacemacs, hybrid** — normal: `` <space>ev ``, select: `` <space>ev `` |
| `clear_diagnostics` | Clear all diagnostics for the current buffer (SPC e c) | **spacemacs, hybrid** — normal: `` <space>ec ``, select: `` <space>ec `` |
| `ai_chat` | Ask the AI provider about the selection/buffer (SPC a i) | **spacemacs, hybrid** — normal: `` <space>ai ``, select: `` <space>ai `` |
| `ai_chat_panel` | Open the streaming AI chat drawer (SPC a p) | **spacemacs, hybrid** — normal: `` <space>ap ``, select: `` <space>ap `` |
| `ai_model_picker` | Pick the AI model at runtime (SPC a m) |  |
| `toggle_ai_privacy` | Toggle AI privacy mode (SPC a P) | **spacemacs, hybrid** — normal: `` <space>aP ``, select: `` <space>aP `` |
| `ai_apply_block` | Apply the last AI code block to the selection (SPC a y) | **spacemacs, hybrid** — normal: `` <space>ay ``, select: `` <space>ay `` |
| `ai_add_file_context` | Add a file as @context for the next AI chat (SPC a @) | **spacemacs, hybrid** — normal: `` <space>a@ ``, select: `` <space>a@ `` |
| `ai_codebase_context` | Add codebase-search results as @context (SPC a b) | **spacemacs, hybrid** — normal: `` <space>ab ``, select: `` <space>ab `` |
| `ai_symbol_context` | Add the symbol-under-cursor's definitions as @context (SPC a s) | **spacemacs, hybrid** — normal: `` <space>as ``, select: `` <space>as `` |
| `ai_terminal_command` | Generate a shell command from natural language (SPC a k) | **spacemacs, hybrid** — normal: `` <space>aK ``, select: `` <space>aK `` |
| `ai_inline_edit` | AI inline edit/generate on the selection (SPC a e) | **spacemacs, hybrid** — normal: `` <space>ae ``, select: `` <space>ae `` |
| `ai_inline_edit_preview` | AI inline edit with a diff preview (SPC a E) | **spacemacs, hybrid** — normal: `` <space>aE ``, select: `` <space>aE `` |
| `ai_accept_edit` | Accept the pending AI inline-edit preview (SPC a .) | **spacemacs, hybrid** — normal: `` <space>a. ``, select: `` <space>a. `` |
| `ai_explain` | Explain the selected code with AI (SPC a x) | **spacemacs, hybrid** — normal: `` <space>ax ``, select: `` <space>ax `` |
| `ai_generate_tests` | Generate tests for the selection with AI (SPC a u) | **spacemacs, hybrid** — normal: `` <space>au ``, select: `` <space>au `` |
| `ai_commit_message` | Generate a git commit message with AI (SPC a c) |  |
| `ai_agent` | Run the autonomous AI agent on a task (SPC a a) | **spacemacs, hybrid** — normal: `` <space>aa ``, select: `` <space>aa `` |
| `ai_agent_review` | Toggle agent review (dry-run) mode — propose changes without applying (SPC a R) | **spacemacs, hybrid** — normal: `` <space>aR ``, select: `` <space>aR `` |
| `ai_complete` | AI code completion at the cursor (SPC a TAB) | **spacemacs, hybrid** — normal: `` <space>a<tab> ``, select: `` <space>a<tab> `` |
| `ai_docs_context` | @docs keyword-search over the docs directory for AI context (SPC a D) | **spacemacs, hybrid** — normal: `` <space>aD ``, select: `` <space>aD `` |
| `ai_web_context` | @web live web-search results as AI context (SPC a w) | **spacemacs, hybrid** — normal: `` <space>aw ``, select: `` <space>aw `` |
| `toggle_ai_autocomplete` | Toggle real-time AI ghost-text autocomplete (SPC a g) | **spacemacs, hybrid** — normal: `` <space>ag ``, select: `` <space>ag `` |
...
| `ai_revert_agent` | Revert the workspace to the last agent checkpoint (SPC a z) | **spacemacs, hybrid** — normal: `` <space>az ``, select: `` <space>az `` |
| `ai_fix` | AI-fix the diagnostic(s) on the current line (SPC a F) | **spacemacs, hybrid** — normal: `` <space>aF ``, select: `` <space>aF `` |
| `describe_diagnostics_checker` | Describe the buffer's checkers/language servers (SPC e h) | **spacemacs, hybrid** — normal: `` <space>eh ``, select: `` <space>eh `` |
| `describe_text_properties` | Describe the tree-sitter node stack at the cursor (SPC h d t) | **spacemacs, hybrid** — normal: `` <space>hdt ``, select: `` <space>hdt `` |
| `copy_system_info` | Copy system info (version/OS/arch) to the clipboard (SPC h d s) | **spacemacs, hybrid** — normal: `` <space>hds ``, select: `` <space>hds `` |
| `copy_last_keys` | Copy the most recently pressed keys to the clipboard (SPC h d l) | **spacemacs, hybrid** — normal: `` <space>hdl ``, select: `` <space>hdl `` |
| `ace_window` | Jump to a window by its number, prompted (ace-window, SPC w . a) | **spacemacs, hybrid** — normal: `` <C-w>.a ``, `` <C-w>[a ``, `` <C-w>{a ``, `` <space>w.a ``, `` <space>w[a ``, `` <space>w{a ``, select: `` <space>w.a ``, `` <space>w[a ``, `` <space>w{a ``<br>**vim** — normal: `` <C-w>.a ``, `` <C-w>[a ``, `` <C-w>{a `` |
| `browse_news` | Browse zmax release notes / NEWS (SPC h n) | **spacemacs** — normal: `` <C-h>n ``, `` <space>hn ``, `` <C-h><C-n> ``, select: `` <C-h>n ``, `` <space>hn ``, `` <C-h><C-n> ``, insert: `` <C-h>n ``, `` <C-h><C-n> ``<br>**hybrid** — normal: `` <C-h>n ``, `` <space>hn ``, `` <C-h><C-n> ``, select: `` <C-h>n ``, `` <space>hn ``, `` <C-h><C-n> ``, insert: `` <F1>n ``, `` <C-h>n ``, `` <F1><C-n> ``, `` <C-h><C-n> ``<br>**emacs, cua, micro** — normal: `` <F1>n ``, `` <C-h>n ``, `` <F1><C-n> ``, `` <C-h><C-n> ``, select: `` <F1>n ``, `` <C-h>n ``, `` <F1><C-n> ``, `` <C-h><C-n> ``, insert: `` <F1>n ``, `` <C-h>n ``, `` <F1><C-n> ``, `` <C-h><C-n> ``<br>**nano** — normal: `` <F1>n ``, `` <F1><C-n> ``, select: `` <F1>n ``, `` <C-h>n ``, `` <F1><C-n> ``, `` <C-h><C-n> ``, insert: `` <F1>n ``, `` <F1><C-n> `` |
| `browse_faq` | Browse the zmax FAQ (SPC h f) | **spacemacs, hybrid** — normal: `` <space>hf ``, select: `` <space>hf `` |
| `layer_search` | Search zmax capability areas / layers (SPC h l) | **spacemacs, hybrid** — normal: `` <space>hl ``, select: `` <space>hl `` |
| `show_environment` | Show the editor's environment variables (SPC f e e) | **spacemacs, hybrid** — normal: `` <space>fee ``, select: `` <space>fee `` |
| `reimport_shell_env` | Re-import the shell environment into the editor (SPC f e C-e) | **spacemacs, hybrid** — normal: `` <space>feE ``, `` <space>fe<C-e> ``, select: `` <space>feE ``, `` <space>fe<C-e> `` |
...
| `goto_buffer_window` | Focus the window already showing a chosen buffer (SPC b w) | **spacemacs, hybrid** — normal: `` <space>bW ``, select: `` <space>bW `` |
| `git_file_dispatch` | Magit-style file operations dispatch for the current file (SPC g f m) | **spacemacs, hybrid** — normal: `` <space>gfm ``, select: `` <space>gfm `` |
| `describe_current_modes` | Describe the current editor/buffer modes (SPC h d m) | **spacemacs** — normal: `` <C-h>m ``, `` <space>hdm ``, select: `` <C-h>m ``, `` <space>hdm ``, insert: `` <C-h>m ``<br>**hybrid** — normal: `` <C-h>m ``, `` <space>hdm ``, select: `` <C-h>m ``, `` <space>hdm ``, insert: `` <F1>m ``, `` <C-h>m ``<br>**emacs, cua, micro** — normal: `` <F1>m ``, `` <C-h>m ``, select: `` <F1>m ``, `` <C-h>m ``, insert: `` <F1>m ``, `` <C-h>m ``<br>**nano** — normal: `` <F1>m ``, select: `` <F1>m ``, `` <C-h>m ``, insert: `` <F1>m `` |
| `describe_command` | Describe a command — its doc and key bindings (C-h f) | **spacemacs** — normal: `` <C-h>x ``, select: `` <C-h>x ``, insert: `` <C-h>x ``<br>**hybrid** — normal: `` <C-h>x ``, select: `` <C-h>x ``, insert: `` <F1>x ``, `` <C-h>x ``<br>**emacs, cua, micro** — normal: `` <F1>x ``, `` <C-h>x ``, select: `` <F1>x ``, `` <C-h>x ``, insert: `` <F1>x ``, `` <C-h>x ``<br>**nano** — normal: `` <F1>x ``, select: `` <F1>x ``, `` <C-h>x ``, insert: `` <F1>x `` |
| `where_is` | Show the keys a command is bound to (C-h w) | **spacemacs** — normal: `` <C-h>w ``, select: `` <C-h>w ``, insert: `` <C-h>w ``<br>**hybrid** — normal: `` <C-h>w ``, select: `` <C-h>w ``, insert: `` <F1>w ``, `` <C-h>w ``<br>**emacs, cua, micro** — normal: `` <F1>w ``, `` <C-h>w ``, select: `` <F1>w ``, `` <C-h>w ``, insert: `` <F1>w ``, `` <C-h>w ``<br>**nano** — normal: `` <F1>w ``, select: `` <F1>w ``, `` <C-h>w ``, insert: `` <F1>w `` |
| `describe_key` | Describe a key — pick a binding, show its command and doc (C-h k) | **spacemacs** — normal: `` <C-h>k ``, select: `` <C-h>k ``, insert: `` <C-h>k ``<br>**hybrid** — normal: `` <C-h>k ``, select: `` <C-h>k ``, insert: `` <F1>k ``, `` <C-h>k ``<br>**emacs, cua, micro** — normal: `` <F1>k ``, `` <C-h>k ``, select: `` <F1>k ``, `` <C-h>k ``, insert: `` <F1>k ``, `` <C-h>k ``<br>**nano** — normal: `` <F1>k ``, select: `` <F1>k ``, `` <C-h>k ``, insert: `` <F1>k `` |
| `describe_bindings` | List every key binding of the current mode (C-h b) | **spacemacs** — normal: `` <C-h>b ``, select: `` <C-h>b ``, insert: `` <C-h>b ``<br>**hybrid** — normal: `` <C-h>b ``, select: `` <C-h>b ``, insert: `` <F1>b ``, `` <C-h>b ``<br>**emacs, cua, micro** — normal: `` <F1>b ``, `` <C-h>b ``, select: `` <F1>b ``, `` <C-h>b ``, insert: `` <F1>b ``, `` <C-h>b ``<br>**nano** — normal: `` <F1>b ``, select: `` <F1>b ``, `` <C-h>b ``, insert: `` <F1>b `` |
| `describe_coding_system` | Describe the buffer's coding system / encoding (C-h C) | **spacemacs** — normal: `` <C-h>C ``, select: `` <C-h>C ``, insert: `` <C-h>C ``<br>**hybrid** — normal: `` <C-h>C ``, select: `` <C-h>C ``, insert: `` <F1>C ``, `` <C-h>C ``<br>**emacs, cua, micro** — normal: `` <F1>C ``, `` <C-h>C ``, select: `` <F1>C ``, `` <C-h>C ``, insert: `` <F1>C ``, `` <C-h>C ``<br>**nano** — normal: `` <F1>C ``, select: `` <F1>C ``, `` <C-h>C ``, insert: `` <F1>C `` |
| `describe_language_environment` | Describe the language environment / locale (C-h L) | **spacemacs** — normal: `` <C-h>L ``, select: `` <C-h>L ``, insert: `` <C-h>L ``<br>**hybrid** — normal: `` <C-h>L ``, select: `` <C-h>L ``, insert: `` <F1>L ``, `` <C-h>L ``<br>**emacs, cua, micro** — normal: `` <F1>L ``, `` <C-h>L ``, select: `` <F1>L ``, `` <C-h>L ``, insert: `` <F1>L ``, `` <C-h>L ``<br>**nano** — normal: `` <F1>L ``, select: `` <F1>L ``, `` <C-h>L ``, insert: `` <F1>L `` |
| `describe_syntax` | Describe the buffer's syntax / tree-sitter status (C-h s) | **spacemacs** — normal: `` <C-h>s ``, select: `` <C-h>s ``, insert: `` <C-h>s ``<br>**hybrid** — normal: `` <C-h>s ``, select: `` <C-h>s ``, insert: `` <F1>s ``, `` <C-h>s ``<br>**emacs, cua, micro** — normal: `` <F1>s ``, `` <C-h>s ``, select: `` <F1>s ``, `` <C-h>s ``, insert: `` <F1>s ``, `` <C-h>s ``<br>**nano** — normal: `` <F1>s ``, select: `` <F1>s ``, `` <C-h>s ``, insert: `` <F1>s `` |
| `describe_fontset` | Describe the fontset — a tty uses none, so this reports so (emacs describe-fontset) |  |
| `view_lossage` | Show the recently pressed keys (C-h l) | **spacemacs** — normal: `` <C-h>l ``, select: `` <C-h>l ``, insert: `` <C-h>l ``<br>**hybrid** — normal: `` <C-h>l ``, select: `` <C-h>l ``, insert: `` <F1>l ``, `` <C-h>l ``<br>**emacs, cua, micro** — normal: `` <F1>l ``, `` <C-h>l ``, select: `` <F1>l ``, `` <C-h>l ``, insert: `` <F1>l ``, `` <C-h>l ``<br>**nano** — normal: `` <F1>l ``, select: `` <F1>l ``, `` <C-h>l ``, insert: `` <F1>l `` |
| `describe_char` | Describe the character after point — code, Unicode block, category (emacs describe-char, C-u C-x =) |  |
| `emoji_describe` | Say what the emoji after point is called (emacs emoji-describe) | **spacemacs** — normal: `` <C-x>8ed ``, select: `` <C-x>8ed ``, insert: `` <C-x>8ed ``<br>**hybrid** — normal: `` <C-x>8ed ``, select: `` <C-x>8ed `` |
| `emoji_list` | Pick an emoji by name and insert it (emacs emoji-list) | **spacemacs** — normal: `` <C-x>8ee ``, `` <C-x>8ei ``, `` <C-x>8el ``, `` <C-x>8es ``, `` <space>ie ``, `` <space>afe ``, select: `` <C-x>8ee ``, `` <C-x>8ei ``, `` <C-x>8el ``, `` <C-x>8es ``, `` <space>ie ``, `` <space>afe ``, insert: `` <C-x>8ee ``, `` <C-x>8ei ``, `` <C-x>8el ``, `` <C-x>8es ``<br>**hybrid** — normal: `` <C-x>8ee ``, `` <C-x>8ei ``, `` <C-x>8el ``, `` <C-x>8es ``, `` <space>ie ``, `` <space>afe ``, select: `` <C-x>8ee ``, `` <C-x>8ei ``, `` <C-x>8el ``, `` <C-x>8es ``, `` <space>ie ``, `` <space>afe `` |
| `complete_emoji` | Complete the `:name` being typed into an emoji (spacemacs company-emoji) | **spacemacs, hybrid** — normal: `` <space>iE ``, select: `` <space>iE `` |
...
| `emoji_recent` | Insert one of the recently-used emoji (emacs emoji-recent, C-x 8 e r) | **spacemacs** — normal: `` <C-x>8er ``, select: `` <C-x>8er ``, insert: `` <C-x>8er ``<br>**hybrid** — normal: `` <C-x>8er ``, select: `` <C-x>8er `` |
| `view_hello_file` | Show a multi-script greeting sample (emacs view-hello-file, C-h h) | **spacemacs** — normal: `` <C-h>h ``, select: `` <C-h>h ``, insert: `` <C-h>h ``<br>**hybrid** — normal: `` <C-h>h ``, select: `` <C-h>h ``, insert: `` <F1>h ``, `` <C-h>h ``<br>**emacs, cua, micro** — normal: `` <F1>h ``, `` <C-h>h ``, select: `` <F1>h ``, `` <C-h>h ``, insert: `` <F1>h ``, `` <C-h>h ``<br>**nano** — normal: `` <F1>h ``, select: `` <F1>h ``, `` <C-h>h ``, insert: `` <F1>h `` |
| `view_echo_area_messages` | Show the last echo-area message (emacs view-echo-area-messages, C-h e) | **spacemacs** — normal: `` g<lt> ``, `` <C-h>e ``, `` <space>wpm ``, select: `` <C-h>e ``, `` <space>wpm ``, insert: `` <C-h>e ``<br>**hybrid** — normal: `` g<lt> ``, `` <C-h>e ``, `` <space>wpm ``, select: `` <C-h>e ``, `` <space>wpm ``, insert: `` <F1>e ``, `` <C-h>e ``<br>**vim** — normal: `` g<lt> ``<br>**emacs, cua, micro** — normal: `` <F1>e ``, `` <C-h>e ``, select: `` <F1>e ``, `` <C-h>e ``, insert: `` <F1>e ``, `` <C-h>e ``<br>**nano** — normal: `` <F1>e ``, select: `` <F1>e ``, `` <C-h>e ``, insert: `` <F1>e `` |
| `describe_copying` | Show zmax's copying license, the GPL (emacs describe-copying, C-h C-c) | **spacemacs** — normal: `` <C-h><C-c> ``, select: `` <C-h><C-c> ``, insert: `` <C-h><C-c> ``<br>**hybrid** — normal: `` <C-h><C-c> ``, select: `` <C-h><C-c> ``, insert: `` <F1><C-c> ``, `` <C-h><C-c> ``<br>**emacs, cua, micro** — normal: `` <F1><C-c> ``, `` <C-h><C-c> ``, select: `` <F1><C-c> ``, `` <C-h><C-c> ``, insert: `` <F1><C-c> ``, `` <C-h><C-c> ``<br>**nano** — normal: `` <F1><C-c> ``, select: `` <F1><C-c> ``, `` <C-h><C-c> ``, insert: `` <F1><C-c> `` |
| `describe_distribution` | How to get zmax / GNU software (emacs describe-distribution, C-h C-d) | **spacemacs** — normal: `` <C-h><C-d> ``, `` <C-h><C-o> ``, select: `` <C-h><C-d> ``, `` <C-h><C-o> ``, insert: `` <C-h><C-d> ``, `` <C-h><C-o> ``<br>**hybrid** — normal: `` <C-h><C-d> ``, `` <C-h><C-o> ``, select: `` <C-h><C-d> ``, `` <C-h><C-o> ``, insert: `` <F1><C-d> ``, `` <F1><C-o> ``, `` <C-h><C-d> ``, `` <C-h><C-o> ``<br>**emacs, cua, micro** — normal: `` <F1><C-d> ``, `` <F1><C-o> ``, `` <C-h><C-d> ``, `` <C-h><C-o> ``, select: `` <F1><C-d> ``, `` <F1><C-o> ``, `` <C-h><C-d> ``, `` <C-h><C-o> ``, insert: `` <F1><C-d> ``, `` <F1><C-o> ``, `` <C-h><C-d> ``, `` <C-h><C-o> ``<br>**nano** — normal: `` <F1><C-d> ``, `` <F1><C-o> ``, select: `` <F1><C-d> ``, `` <F1><C-o> ``, `` <C-h><C-d> ``, `` <C-h><C-o> ``, insert: `` <F1><C-d> ``, `` <F1><C-o> `` |
| `describe_gnu_project` | Open the GNU project page (emacs describe-gnu-project, C-h g) | **spacemacs** — normal: `` <C-h>g ``, select: `` <C-h>g ``, insert: `` <C-h>g ``<br>**hybrid** — normal: `` <C-h>g ``, select: `` <C-h>g ``, insert: `` <F1>g ``, `` <C-h>g ``<br>**emacs, cua, micro** — normal: `` <F1>g ``, `` <C-h>g ``, select: `` <F1>g ``, `` <C-h>g ``, insert: `` <F1>g ``, `` <C-h>g ``<br>**nano** — normal: `` <F1>g ``, select: `` <F1>g ``, `` <C-h>g ``, insert: `` <F1>g `` |
| `describe_no_warranty` | Show the GPL no-warranty sections (emacs describe-no-warranty, C-h C-w) | **spacemacs** — normal: `` <C-h><C-w> ``, select: `` <C-h><C-w> ``, insert: `` <C-h><C-w> ``<br>**hybrid** — normal: `` <C-h><C-w> ``, select: `` <C-h><C-w> ``, insert: `` <F1><C-w> ``, `` <C-h><C-w> ``<br>**emacs, cua, micro** — normal: `` <F1><C-w> ``, `` <C-h><C-w> ``, select: `` <F1><C-w> ``, `` <C-h><C-w> ``, insert: `` <F1><C-w> ``, `` <C-h><C-w> ``<br>**nano** — normal: `` <F1><C-w> ``, select: `` <F1><C-w> ``, `` <C-h><C-w> ``, insert: `` <F1><C-w> `` |
| `view_emacs_faq` | Open the GNU Emacs FAQ (emacs view-emacs-FAQ, C-h C-f) | **spacemacs** — normal: `` <C-h><C-f> ``, select: `` <C-h><C-f> ``, insert: `` <C-h><C-f> ``<br>**hybrid** — normal: `` <C-h><C-f> ``, select: `` <C-h><C-f> ``, insert: `` <F1><C-f> ``, `` <C-h><C-f> ``<br>**emacs, cua, micro** — normal: `` <F1><C-f> ``, `` <C-h><C-f> ``, select: `` <F1><C-f> ``, `` <C-h><C-f> ``, insert: `` <F1><C-f> ``, `` <C-h><C-f> ``<br>**nano** — normal: `` <F1><C-f> ``, select: `` <F1><C-f> ``, `` <C-h><C-f> ``, insert: `` <F1><C-f> `` |
| `view_emacs_todo` | Open the Emacs TODO list (emacs view-emacs-todo) | **spacemacs** — normal: `` <C-h><C-t> ``, select: `` <C-h><C-t> ``, insert: `` <C-h><C-t> ``<br>**hybrid** — normal: `` <C-h><C-t> ``, select: `` <C-h><C-t> ``, insert: `` <F1><C-t> ``, `` <C-h><C-t> ``<br>**emacs, cua, micro** — normal: `` <F1><C-t> ``, `` <C-h><C-t> ``, select: `` <F1><C-t> ``, `` <C-h><C-t> ``, insert: `` <F1><C-t> ``, `` <C-h><C-t> ``<br>**nano** — normal: `` <F1><C-t> ``, select: `` <F1><C-t> ``, `` <C-h><C-t> ``, insert: `` <F1><C-t> `` |
| `view_emacs_problems` | Open the Emacs known-problems file (emacs view-emacs-problems) | **spacemacs** — normal: `` <C-h><C-p> ``, select: `` <C-h><C-p> ``, insert: `` <C-h><C-p> ``<br>**hybrid** — normal: `` <C-h><C-p> ``, select: `` <C-h><C-p> ``, insert: `` <F1><C-p> ``, `` <C-h><C-p> ``<br>**emacs, cua, micro** — normal: `` <F1><C-p> ``, `` <C-h><C-p> ``, select: `` <F1><C-p> ``, `` <C-h><C-p> ``, insert: `` <F1><C-p> ``, `` <C-h><C-p> ``<br>**nano** — normal: `` <F1><C-p> ``, select: `` <F1><C-p> ``, `` <C-h><C-p> ``, insert: `` <F1><C-p> `` |
| `view_emacs_debugging` | Open the Emacs debugging manual (emacs view-emacs-debugging) |  |
| `view_order_manuals` | Open where to get the GNU manuals (emacs view-order-manuals) | **spacemacs** — normal: `` <C-h><C-m> ``, select: `` <C-h><C-m> ``, insert: `` <C-h><C-m> ``<br>**hybrid** — normal: `` <C-h><C-m> ``, select: `` <C-h><C-m> ``, insert: `` <F1><C-m> ``, `` <C-h><C-m> ``<br>**emacs, cua, micro** — normal: `` <F1><C-m> ``, `` <C-h><C-m> ``, select: `` <F1><C-m> ``, `` <C-h><C-m> ``, insert: `` <F1><C-m> ``, `` <C-h><C-m> ``<br>**nano** — normal: `` <F1><C-m> ``, select: `` <F1><C-m> ``, `` <C-h><C-m> ``, insert: `` <F1><C-m> `` |
| `view_external_packages` | Open GNU ELPA / external packages (emacs view-external-packages) | **spacemacs** — normal: `` <C-h><C-e> ``, select: `` <C-h><C-e> ``, insert: `` <C-h><C-e> ``<br>**hybrid** — normal: `` <C-h><C-e> ``, select: `` <C-h><C-e> ``, insert: `` <F1><C-e> ``, `` <C-h><C-e> ``<br>**emacs, cua, micro** — normal: `` <F1><C-e> ``, `` <C-h><C-e> ``, select: `` <F1><C-e> ``, `` <C-h><C-e> ``, insert: `` <F1><C-e> ``, `` <C-h><C-e> ``<br>**nano** — normal: `` <F1><C-e> ``, select: `` <F1><C-e> ``, `` <C-h><C-e> ``, insert: `` <F1><C-e> `` |
| `describe_keymap` | List every binding of the current mode's keymap (emacs describe-keymap) | **spacemacs, hybrid** — normal: `` <space>hdK ``, select: `` <space>hdK `` |
| `which_key_top_level` | Pin the top-level keymap as a which-key popup (spacemacs SPC t k t) | **spacemacs, hybrid** — normal: `` <space>tkt ``, select: `` <space>tkt `` |
| `which_key_major_mode` | Pin the major mode's keymap as a which-key popup (spacemacs SPC t k m) | **spacemacs, hybrid** — normal: `` <space>tkm ``, select: `` <space>tkm `` |
| `which_key_major_mode_full` | Pin the full major-mode keymap as a which-key popup (spacemacs SPC t k M) | **spacemacs, hybrid** — normal: `` <space>tkM ``, select: `` <space>tkM `` |
| `which_key_hide` | Take the pinned which-key popup down (spacemacs SPC t k k) | **spacemacs, hybrid** — normal: `` <space>tkk ``, select: `` <space>tkk `` |
...
| `describe_language_package` | Describe the language-support config for the buffer (SPC h d p) | **spacemacs, hybrid** — normal: `` <space>hdp ``, select: `` <space>hdp `` |
| `package_search` | Search configured language packages and describe one (SPC h p) | **spacemacs, hybrid** — normal: `` <space>hp ``, select: `` <space>hp `` |
| `config_variable_search` | Search editor config variables, copy path on select (SPC h .) | **spacemacs, hybrid** — normal: `` <space>h. ``, select: `` <space>h. `` |
| `apropos_local_value` | Search buffer-local variables by value (emacs apropos-local-value, SPC h v) | **spacemacs, hybrid** — normal: `` <space>hv ``, select: `` <space>hv `` |
...
| `clone_indirect_buffer` | Clone the current buffer into a shared-document split (SPC b N i) | **spacemacs** — normal: `` <C-x>4c ``, `` <space>bNI ``, `` <space>bNi ``, select: `` <C-x>4c ``, `` <space>bNI ``, `` <space>bNi ``, insert: `` <C-x>4c ``<br>**hybrid** — normal: `` <C-x>4c ``, `` <space>bNI ``, `` <space>bNi ``, select: `` <C-x>4c ``, `` <space>bNI ``, `` <space>bNi `` |
| `clone_indirect_from_buffer` | Open an existing buffer in a shared-document split (SPC b N C-i) | **spacemacs, hybrid** — normal: `` <space>bN<C-i> ``, select: `` <space>bN<C-i> `` |
| `open_junk_file` | Open a fresh timestamped junk file (SPC f J) | **spacemacs, hybrid** — normal: `` <space>fJ ``, select: `` <space>fJ `` |
| `open_hex` | Open the current file in the hex editor (SPC f h, hexl) | **spacemacs, hybrid** — normal: `` <space>fh ``, select: `` <space>fh `` |
| `open_file_external` | Open the current file with the OS default program (SPC f o) | **spacemacs, hybrid** — normal: `` <space>fo ``, select: `` <space>fo `` |
| `git_init` | Initialize a new git repository (SPC g i) | **spacemacs, hybrid** — normal: `` <space>gi ``, select: `` <space>gi `` |
| `view_file_at_rev` | View the current file at a branch/commit (SPC g f f) | **spacemacs** — normal: `` <C-x>v~ ``, `` <space>gff ``, select: `` <C-x>v~ ``, `` <space>gff ``, insert: `` <C-x>v~ ``<br>**hybrid** — normal: `` <C-x>v~ ``, `` <space>gff ``, select: `` <C-x>v~ ``, `` <space>gff `` |
| `extend_line` | Select current line, if already selected, extend to another line based on the anchor | **spacemacs, hybrid** — normal: `` <space>kV ``, select: `` <space>kV `` |
| `extend_line_below` | Select current line, if already selected, extend to next line | **helix, kakoune** — normal: `` x ``, select: `` x `` |
...
| `extend_to_line_bounds` | Extend selection to line bounds | **helix, kakoune** — normal: `` X ``, select: `` X `` |
...
| `shrink_to_line_bounds` | Shrink selection to line bounds | **helix, kakoune** — normal: `` <A-x> ``, select: `` <A-x> `` |
| `delete_selection` | Delete selection | **helix, kakoune** — normal: `` d ``, select: `` d `` |
...
| `collapse_selection` | Collapse selection into single cursor | **hybrid** — insert: `` <C-g> ``, `` <C-pause> ``<br>**helix, kakoune** — normal: `` ; ``, select: `` ; ``<br>**emacs, cua** — normal: `` <C-g> ``, `` <C-pause> ``, insert: `` <C-g> ``, `` <C-pause> ``<br>**micro, nano** — normal: `` <C-pause> ``, insert: `` <C-pause> `` |
| `flip_selections` | Flip selection cursor and anchor | **helix, kakoune** — normal: `` <A-;> ``, select: `` <A-;> `` |
| `ensure_selections_forward` | Ensure all selections face forward | **helix, kakoune** — normal: `` <A-:> ``, select: `` <A-:> `` |
| `insert_mode` | Insert before selection | **spacemacs, hybrid** — normal: `` i ``, `` <ins> ``, `` <space>ki ``, select: `` <space>ki ``<br>**vim** — normal: `` i ``, `` <ins> ``<br>**helix, kakoune** — normal: `` i ``, select: `` i ``<br>**emacs, cua, micro, nano** — normal: `` a ``, `` i `` |
| `append_mode` | Append after selection | **spacemacs, hybrid, vim** — normal: `` a ``<br>**helix, kakoune** — normal: `` a ``, select: `` a `` |
| `replace_mode` | Enter Replace mode (overtype) | **spacemacs, hybrid, vim** — normal: `` R `` |
| `virtual_replace_mode` | Enter Virtual Replace mode, overtyping in screen space (vim gR) | **spacemacs, hybrid, vim** — normal: `` gR `` |
| `virtual_replace_char` | Replace {count} virtual characters in screen space with the next key (vim gr) |  |
| `command_mode` | Enter command mode | **spacemacs, hybrid** — normal: `` <space>: ``, `` <space>k: ``, select: `` : ``, `` <space>: ``, `` <space>k: ``<br>**vim** — select: `` : ``<br>**helix, kakoune** — normal: `` : ``, select: `` : ``<br>**micro** — normal: `` <C-e> ``, insert: `` <C-e> `` |
| `ex_mode` | Enter Ex mode: type : commands one after another until :visual (vim gQ) | **spacemacs, hybrid, vim** — normal: `` gQ `` |
| `file_picker` | Open file picker | **spacemacs, hybrid** — normal: `` <space>ff ``, `` <space>pf ``, `` <space>ph ``, `` <space>pp ``, `` <C-x><C-f> ``, select: `` <space>ff ``, `` <space>pf ``, `` <space>ph ``, `` <space>pp ``, `` <C-x><C-f> ``, insert: `` <C-x><C-f> ``<br>**helix** — normal: `` <space>f ``, select: `` <space>f ``<br>**emacs** — normal: `` <C-x><C-f> ``, insert: `` <C-x><C-f> ``<br>**cua** — normal: `` <C-x><C-f> ``, select: `` <C-X><C-f> ``, insert: `` <C-x><C-f> ``<br>**micro** — normal: `` <C-o> ``, insert: `` <C-o> `` |
| `bury_buffer` | Stop showing the current buffer without killing it (emacs bury-buffer) | **spacemacs, hybrid** — normal: `` <space>b.<C-d> ``, select: `` <space>b.<C-d> `` |
| `toggle_column_indexing` | Toggle 0/1-based column indexing in the statusline (Spacemacs SPC t z) | **spacemacs, hybrid** — normal: `` <space>tz ``, select: `` <space>tz `` |
...
| `file_picker_in_current_directory` | Open file picker at current working directory | **spacemacs** — normal: `` <C-x><C-d> ``, select: `` <C-x><C-d> ``, insert: `` <C-x><C-d> ``<br>**hybrid** — normal: `` <C-x><C-d> ``, select: `` <C-x><C-d> ``<br>**helix** — normal: `` <space>F ``, select: `` <space>F `` |
| `file_explorer` | Open file explorer in workspace root | **spacemacs, hybrid** — normal: `` <space>ad ``, `` <space>ft ``, `` <space>pd ``, `` <space>pt ``, `` <space>aff ``, `` <space>atrd ``, `` <space>atrr ``, select: `` <space>ad ``, `` <space>ft ``, `` <space>pd ``, `` <space>pt ``, `` <space>aff ``, `` <space>atrd ``, `` <space>atrr ``<br>**helix** — normal: `` <space>e ``, select: `` <space>e `` |
| `file_explorer_in_current_buffer_directory` | Open file explorer at current buffer's directory | **spacemacs, hybrid** — normal: `` <space>fd ``, `` <space>fj ``, `` <space>jD ``, `` <space>jd ``, select: `` <space>fd ``, `` <space>fj ``, `` <space>jD ``, `` <space>jd ``<br>**helix** — normal: `` <space>. ``, select: `` <space>. `` |
| `file_explorer_in_current_directory` | Open file explorer at current working directory |  |
| `buffer_menu` | Open the Buffer Menu (emacs buffer-menu / C-x C-b) | **spacemacs, hybrid** — normal: `` <space>bM ``, select: `` <space>bM `` |
| `list_buffers` | List open buffers in the Buffer Menu (emacs list-buffers) | **spacemacs, hybrid** — normal: `` <C-x><C-b> ``, select: `` <C-x><C-b> ``, insert: `` <C-x><C-b> ``<br>**emacs** — normal: `` <C-x><C-b> ``, insert: `` <C-x><C-b> ``<br>**cua** — normal: `` <C-x><C-b> ``, select: `` <C-X><C-b> ``, insert: `` <C-x><C-b> `` |
...
| `calc_dispatch` | Open the RPN Calc stack calculator (emacs calc / C-x *) | **spacemacs, hybrid** — normal: `` <space>ac ``, select: `` <space>ac `` |
| `occur` | List lines matching a regexp in an *Occur* overlay (emacs occur / M-s o) | **spacemacs, hybrid** — normal: `` <A-s>o `` |
| `isearch_forward_word` | Incremental whole-word search forward (emacs isearch-forward-word) | **spacemacs, hybrid** — normal: `` <A-s>w ``, `` <A-s><A-w> `` |
| `isearch_forward_symbol` | Incremental whole-symbol search forward (emacs isearch-forward-symbol) | **spacemacs, hybrid** — normal: `` <A-s>_ `` |
| `isearch_forward_thing_at_point` | Search for the symbol/word at point (emacs isearch-forward-thing-at-point) |  |
| `isearch_forward_symbol_at_point` | Search for the symbol at point (emacs isearch-forward-symbol-at-point) | **spacemacs, hybrid** — normal: `` <A-s>. ``, `` <A-s><A-.> `` |
...
| `query_replace` | Replace matches one by one, asking (emacs query-replace M-%) | **hybrid, emacs, cua, micro, nano** — insert: `` <A-%> `` |
| `query_replace_regexp` | Replace regexp matches one by one, asking (emacs query-replace-regexp C-M-%) | **hybrid, emacs, cua, micro, nano** — insert: `` <A-C-%> `` |
...
| `rmail` | Open the Rmail mail reader on ~/RMAIL (emacs rmail) | **spacemacs, hybrid** — normal: `` <space>ar ``, select: `` <space>ar `` |
...
| `gnus` | Open the Gnus newsreader on $NNTPSERVER or the ~/News spool (emacs gnus) | **spacemacs, hybrid** — normal: `` <space>aN ``, select: `` <space>aN `` |
...
| `dired` | Open the Dired directory editor (emacs C-x d) | **spacemacs, hybrid** — normal: `` <C-x>d ``, `` <space>pD ``, select: `` <C-x>d ``, `` <space>pD ``, insert: `` <C-x>d ``<br>**emacs** — insert: `` <C-x>d ``<br>**cua** — select: `` <C-X>d ``, insert: `` <C-x>d `` |
| `dired_jump` | Open Dired on the current buffer's directory (emacs C-x C-j) | **spacemacs, hybrid** — normal: `` <C-x><C-j> ``, select: `` <C-x><C-j> ``, insert: `` <C-x><C-j> ``<br>**emacs** — insert: `` <C-x><C-j> ``<br>**cua** — select: `` <C-X><C-j> ``, insert: `` <C-x><C-j> `` |
| `dired_other_window` | Open Dired (overlay; emacs dired-other-window C-x 4 d) | **spacemacs** — normal: `` <C-x>4d ``, select: `` <C-x>4d ``, insert: `` <C-x>4d ``<br>**hybrid** — normal: `` <C-x>4d ``, select: `` <C-x>4d `` |
| `dired_jump_other_window` | Open Dired on the buffer's dir (overlay; emacs dired-jump-other-window) | **spacemacs** — normal: `` <C-x>4<C-j> ``, select: `` <C-x>4<C-j> ``, insert: `` <C-x>4<C-j> ``<br>**hybrid** — normal: `` <C-x>4<C-j> ``, select: `` <C-x>4<C-j> `` |
...
| `code_action` | Perform code action | **spacemacs, hybrid** — normal: `` <space>la ``, select: `` <space>la ``<br>**helix** — normal: `` <space>a ``, select: `` <space>a `` |
...
| `organize_imports` | Organize/optimize imports via LSP source action (IntelliJ Ctrl-Alt-O) | **spacemacs, hybrid** — normal: `` <space>lO ``, select: `` <space>lO `` |
| `implement_methods` | Implement missing interface/trait members via LSP (IntelliJ Ctrl-I) | **spacemacs, hybrid** — normal: `` <space>li ``, select: `` <space>li `` |
| `override_methods` | Override inherited members via LSP (IntelliJ Ctrl-O) | **spacemacs, hybrid** — normal: `` <space>lv ``, select: `` <space>lv `` |
| `generate_code` | Generate code (getters/constructors/impls) via LSP (SPC l g) | **spacemacs, hybrid** — normal: `` <space>lg ``, select: `` <space>lg `` |
...
| `search_history_picker` | Fuzzy-pick and re-run a past search (:History/) | **spacemacs, hybrid** — normal: `` <space>r/ ``, select: `` <space>r/ `` |
...
| `changed_file_picker` | Open changed file picker | **spacemacs, hybrid** — normal: `` <space>bm ``, select: `` <space>bm ``<br>**helix** — normal: `` <space>g ``, select: `` <space>g `` |
| `frecent_file_picker` | Open recent files ranked by frecency (z algorithm) | **spacemacs, hybrid** — normal: `` <space>fr ``, select: `` <space>fr `` |
| `reopen_last_closed` | Reopen the most recently closed file | **spacemacs, hybrid** — normal: `` <space>bu ``, `` <space>fu ``, select: `` <space>bu ``, `` <space>fu `` |
| `harpoon_add` | Pin the current file to the harpoon list | **spacemacs, hybrid** — normal: `` <space>Ha ``, select: `` <space>Ha `` |
| `harpoon_jump` | Jump to the harpoon mark in slot [count] | **spacemacs, hybrid** — normal: `` <space>Hj ``, select: `` <space>Hj `` |
| `harpoon_1` | Jump to harpoon mark 1 | **spacemacs, hybrid** — normal: `` <space>H1 ``, select: `` <space>H1 `` |
| `harpoon_2` | Jump to harpoon mark 2 | **spacemacs, hybrid** — normal: `` <space>H2 ``, select: `` <space>H2 `` |
| `harpoon_3` | Jump to harpoon mark 3 | **spacemacs, hybrid** — normal: `` <space>H3 ``, select: `` <space>H3 `` |
...
| `workspace_diagnostics_picker` | Open workspace diagnostic picker | **spacemacs, hybrid** — normal: `` <space>eL ``, select: `` <space>eL ``<br>**helix** — normal: `` <space>D ``, select: `` <space>D `` |
| `last_picker` | Open last picker | **spacemacs, hybrid** — normal: `` <space>' ``, `` <space>rl ``, `` <space>rs ``, `` <space>sl ``, select: `` <space>' ``, `` <space>rl ``, `` <space>rs ``, `` <space>sl ``<br>**helix** — normal: `` <space>' ``, select: `` <space>' `` |
| `insert_at_line_start` | Insert at start of line | **spacemacs, hybrid, vim** — normal: `` I ``, `` gI ``<br>**helix, kakoune** — normal: `` I ``, select: `` I `` |
| `insert_at_line_end` | Insert at end of line | **spacemacs, hybrid, vim** — normal: `` A ``<br>**helix, kakoune** — normal: `` A ``, select: `` A `` |
| `open_below` | Open new line below selection | **spacemacs, hybrid, vim** — normal: `` o ``<br>**helix, kakoune** — normal: `` o ``, select: `` o `` |
| `open_above` | Open new line above selection | **spacemacs, hybrid, vim** — normal: `` O ``<br>**helix, kakoune** — normal: `` O ``, select: `` O `` |
| `complete_current_statement` | Complete the current statement (close brackets, add terminator, open next line) (JetBrains) | **spacemacs** — normal: `` <C-c>; ``, select: `` <C-c>; ``, insert: `` <C-c>; ``<br>**hybrid** — normal: `` <C-c>; ``, select: `` <C-c>; `` |
| `postfix_expand` | Postfix completion: expand `expr.kw` (if/for/while/match/let/return/not/…) (JetBrains) | **spacemacs** — normal: `` <C-c>. ``, select: `` <C-c>. ``, insert: `` <C-c>. ``<br>**hybrid** — normal: `` <C-c>. ``, select: `` <C-c>. `` |
| `normal_mode` | Enter normal mode | **spacemacs** — normal: `` <C-\><C-g> ``, `` <C-\><C-n> ``<br>**hybrid** — normal: `` <C-\><C-g> ``, `` <C-\><C-n> ``, insert: `` <esc> ``<br>**vim** — normal: `` <C-c> ``, `` <C-\><C-g> ``, `` <C-\><C-n> ``<br>**helix, kakoune** — normal: `` <esc> ``, select: `` v ``, insert: `` <esc> `` |
| `select_mode` | Enter selection extend mode | **spacemacs, hybrid** — normal: `` v ``, `` gh ``, `` <C-space> ``, `` <space>kv ``, `` <space>k<C-v> ``, select: `` <space>kv ``, `` <space>k<C-v> ``<br>**vim** — normal: `` v ``, `` gh ``<br>**helix** — normal: `` v ``<br>**emacs, cua, micro** — normal: `` <C-space> ``<br>**nano** — normal: `` <A-a> ``, `` <C-space> ``, insert: `` <A-a> `` |
| `exit_select_mode` | Exit selection mode | **helix, kakoune** — select: `` <esc> `` |
| `goto_definition` | Goto definition | **spacemacs** — normal: `` g] ``, `` gd ``, `` <A-.> ``, `` <C-w>] ``, `` g<C-]> ``, `` <C-c>,j ``, `` <C-w>g] ``, `` <space>gd ``, `` <space>jf ``, `` <space>jv ``, `` <space>w] ``, `` <C-w><C-]> ``, `` <space>mgg ``, `` <space>wg] ``, `` <C-w>g<C-]> ``, `` <space>w<C-]> ``, `` <space>wg<C-]> ``, select: `` <C-]> ``, `` <C-c>,j ``, `` <space>gd ``, `` <space>jf ``, `` <space>jv ``, `` <space>w] ``, `` <space>mgg ``, `` <space>wg] ``, `` <space>w<C-]> ``, `` <space>wg<C-]> ``, insert: `` <C-c>,j ``<br>**hybrid** — normal: `` g] ``, `` gd ``, `` <A-.> ``, `` <C-w>] ``, `` g<C-]> ``, `` <C-c>,j ``, `` <C-w>g] ``, `` <space>gd ``, `` <space>jf ``, `` <space>jv ``, `` <space>w] ``, `` <C-w><C-]> ``, `` <space>mgg ``, `` <space>wg] ``, `` <C-w>g<C-]> ``, `` <space>w<C-]> ``, `` <space>wg<C-]> ``, select: `` <C-]> ``, `` <C-c>,j ``, `` <space>gd ``, `` <space>jf ``, `` <space>jv ``, `` <space>w] ``, `` <space>mgg ``, `` <space>wg] ``, `` <space>w<C-]> ``, `` <space>wg<C-]> ``, insert: `` <A-.> ``<br>**vim** — normal: `` g] ``, `` gd ``, `` <C-w>] ``, `` g<C-]> ``, `` <C-w>g] ``, `` <C-w><C-]> ``, `` <C-w>g<C-]> ``, select: `` <C-]> ``<br>**helix, kakoune** — normal: `` gd ``, select: `` gd ``<br>**emacs, cua, nano** — normal: `` <A-.> ``, insert: `` <A-.> `` |
| `tag_jump` | Jump to the definition of the symbol under the cursor, recording where from on the tag stack (vim CTRL-]) | **spacemacs, hybrid, vim** — normal: `` <C-]> `` |
| `preview_tag` | Show the tag under the cursor in the preview window (vim CTRL-W }) | **spacemacs, hybrid** — normal: `` <C-w>} ``, `` <space>w} ``, select: `` <space>w} ``<br>**vim** — normal: `` <C-w>} `` |
...
| `goto_type_definition` | Goto type definition | **spacemacs, hybrid** — normal: `` gy ``, `` <space>gy ``, select: `` <space>gy ``<br>**vim** — normal: `` gy ``<br>**helix, kakoune** — normal: `` gy ``, select: `` gy `` |
| `goto_implementation` | Goto implementation | **helix, kakoune** — normal: `` gi ``, select: `` gi `` |
| `goto_file_start` | Goto line number `<n>` else file start | **spacemacs** — normal: `` gg ``, `` <A-lt> ``, `` <C-home> ``, insert: `` <A-lt> ``, `` <C-home> ``<br>**hybrid** — normal: `` gg ``, `` <A-lt> ``, `` <C-home> ``, insert: `` <A-lt> ``<br>**vim** — normal: `` gg ``, `` <C-home> ``, insert: `` <C-home> ``<br>**helix, kakoune** — normal: `` gg ``<br>**emacs, cua, micro** — normal: `` <A-lt> ``, select: `` <A-lt> ``, insert: `` <A-lt> ``<br>**nano** — normal: `` <A-\> ``, `` <A-lt> ``, select: `` <A-lt> ``, insert: `` <A-\> ``, `` <A-lt> `` |
...
| `goto_file` | Goto files/URLs in selections | **spacemacs, hybrid** — normal: `` [f ``, `` ]f ``, `` gf ``, `` gx ``, `` <C-w>gF ``, `` <C-w>gf ``, `` <space>fF ``, `` <space>jU ``, `` <space>ju ``, `` <space>pF ``, `` <space>wgF ``, `` <space>wgf ``, select: `` <space>fF ``, `` <space>jU ``, `` <space>ju ``, `` <space>pF ``, `` <space>wgF ``, `` <space>wgf ``<br>**vim** — normal: `` [f ``, `` ]f ``, `` gf ``, `` gx ``, `` <C-w>gF ``, `` <C-w>gf ``<br>**helix, kakoune** — normal: `` gf ``, select: `` gf `` |
| `goto_file_hsplit` | Goto files in selections (hsplit) | **spacemacs, hybrid** — normal: `` <C-w>F ``, `` <space>wF ``, `` <C-w><C-f> ``, `` <space>w<C-f> ``, select: `` <space>wF ``, `` <space>w<C-f> ``<br>**vim** — normal: `` <C-w>F ``, `` <C-w><C-f> ``<br>**helix** — normal: `` <C-w>f ``, `` <space>wf ``, select: `` <C-w>f ``, `` <space>wf ``<br>**kakoune** — normal: `` <C-w>f ``, select: `` <C-w>f `` |
| `goto_file_vsplit` | Goto files in selections (vsplit) | **helix** — normal: `` <C-w>F ``, `` <space>wF ``, select: `` <C-w>F ``, `` <space>wF ``<br>**kakoune** — normal: `` <C-w>F ``, select: `` <C-w>F `` |
...
| `smart_type_completion` | Complete with only what fits the expected type (JetBrains Smart Type Completion, Ctrl-Shift-Space) | **spacemacs, hybrid** — normal: `` <space>it ``, select: `` <space>it `` |
| `goto_window_top` | Goto window top | **spacemacs, hybrid, vim** — normal: `` H ``<br>**helix, kakoune** — normal: `` gt ``, select: `` gt `` |
...
| `count_lines_page` | Report lines on the current page, before + after point (emacs count-lines-page, C-x l) | **spacemacs** — normal: `` <C-x>l ``, select: `` <C-x>l ``, insert: `` <C-x>l ``<br>**hybrid** — normal: `` <C-x>l ``, select: `` <C-x>l `` |
| `what_cursor_position` | Report the character at point, its code, position, percentage and column (emacs what-cursor-position, C-x =) | **spacemacs** — normal: `` <C-x>= ``, select: `` <C-x>= ``, insert: `` <C-x>= ``<br>**hybrid** — normal: `` <C-x>= ``, select: `` <C-x>= ``<br>**nano** — normal: `` <C-c> ``, insert: `` <C-c> `` |
...
| `goto_last_modified_file` | Goto last modified file | **helix, kakoune** — normal: `` gm ``, select: `` gm `` |
| `goto_last_modification` | Goto last modification | **spacemacs, hybrid, vim** — normal: `` g. ``<br>**helix, kakoune** — normal: `` g. ``, select: `` g. `` |
| `goto_older_change` | vim g;: jump to an older change-list position | **spacemacs, hybrid, vim** — normal: `` g; `` |
| `goto_newer_change` | vim g,: jump to a newer change-list position | **spacemacs, hybrid, vim** — normal: `` g, `` |
| `goto_line` | Goto line | **spacemacs** — normal: `` <A-g>g ``, `` <A-g><A-g> ``<br>**hybrid, emacs, cua, micro** — normal: `` <A-g>g ``, `` <A-g><A-g> ``, insert: `` <A-g>g ``, `` <A-g><A-g> ``<br>**helix, kakoune** — normal: `` G ``, select: `` G ``<br>**nano** — normal: `` <A-g> ``, `` <C-_> ``, insert: `` <A-g> ``, `` <C-_> `` |
| `goto_last_line` | Goto last line | **spacemacs** — normal: `` G ``, `` <A-gt> ``, `` <C-end> ``<br>**hybrid** — normal: `` G ``, `` <A-gt> ``, `` <C-end> ``, insert: `` <A-gt> ``<br>**vim** — normal: `` G ``, `` <C-end> ``<br>**helix, kakoune** — normal: `` ge ``<br>**emacs, cua, micro** — normal: `` <A-gt> ``, select: `` <A-gt> ``, insert: `` <A-gt> ``<br>**nano** — normal: `` <A-/> ``, `` <A-gt> ``, select: `` <A-gt> ``, insert: `` <A-/> ``, `` <A-gt> `` |
| `extend_to_last_line` | Extend to last line | **helix, kakoune** — select: `` ge `` |
| `goto_first_diag` | Goto first diagnostic | **spacemacs, hybrid** — normal: `` <space>ef ``, `` <space>enf ``, `` <space>epf ``, select: `` <space>ef ``, `` <space>enf ``, `` <space>epf ``<br>**helix, kakoune** — normal: `` [D ``, select: `` [D `` |
| `copy_diagnostic` | Copy the diagnostic message(s) on the current line |  |
| `goto_last_diag` | Goto last diagnostic | **spacemacs, hybrid** — normal: `` <space>e. ``, select: `` <space>e. ``<br>**helix, kakoune** — normal: `` ]D ``, select: `` ]D `` |
| `goto_next_diag` | Goto next diagnostic | **spacemacs** — normal: `` ]d ``, `` <space>enj ``, `` <space>enn ``, `` <space>epj ``, `` <space>epn ``, select: `` <space>enj ``, `` <space>enn ``, `` <space>epj ``, `` <space>epn ``<br>**hybrid** — normal: `` ]d ``, `` <space>enj ``, `` <space>enn ``, `` <space>epj ``, `` <space>epn ``, select: `` <space>enj ``, `` <space>enn ``, `` <space>epj ``, `` <space>epn ``, insert: `` <A-g>n ``, `` <A-g><A-n> ``<br>**vim** — normal: `` ]d ``<br>**helix, kakoune** — normal: `` ]d ``, select: `` ]d ``<br>**emacs, cua, micro** — normal: `` <A-g>n ``, insert: `` <A-g>n ``, `` <A-g><A-n> `` |
| `goto_prev_diag` | Goto previous diagnostic | **spacemacs** — normal: `` [d ``, `` <space>enk ``, `` <space>enp ``, `` <space>epk ``, `` <space>epp ``, select: `` <space>enk ``, `` <space>enp ``, `` <space>epk ``, `` <space>epp ``<br>**hybrid** — normal: `` [d ``, `` <space>enk ``, `` <space>enp ``, `` <space>epk ``, `` <space>epp ``, select: `` <space>enk ``, `` <space>enp ``, `` <space>epk ``, `` <space>epp ``, insert: `` <A-g>p ``, `` <A-g><A-p> ``<br>**vim** — normal: `` [d ``<br>**helix, kakoune** — normal: `` [d ``, select: `` [d ``<br>**emacs, cua, micro** — normal: `` <A-g>p ``, insert: `` <A-g>p ``, `` <A-g><A-p> `` |
| `goto_next_diag_error` | Goto next error diagnostic (]e) | **spacemacs, hybrid, vim** — normal: `` ]e `` |
| `goto_prev_diag_error` | Goto previous error diagnostic ([e) | **spacemacs, hybrid, vim** — normal: `` [e `` |
| `goto_next_diag_warning` | Goto next warning diagnostic (]w) |  |
| `goto_prev_diag_warning` | Goto previous warning diagnostic ([w) |  |
| `goto_next_change` | Goto next change | **spacemacs, hybrid, vim** — normal: `` ]g ``<br>**helix, kakoune** — normal: `` ]g ``, select: `` ]g `` |
| `goto_prev_change` | Goto previous change | **spacemacs, hybrid, vim** — normal: `` [g ``<br>**helix, kakoune** — normal: `` [g ``, select: `` [g `` |
| `goto_next_conflict` | Goto next merge-conflict marker | **spacemacs, hybrid, vim** — normal: `` ]n `` |
| `goto_prev_conflict` | Goto previous merge-conflict marker | **spacemacs, hybrid, vim** — normal: `` [n `` |
| `conflict_take_all_ours` | Resolve ALL conflicts: keep our side | **spacemacs, hybrid** — normal: `` <space>gcO ``, select: `` <space>gcO `` |
| `conflict_take_all_theirs` | Resolve ALL conflicts: keep their side | **spacemacs, hybrid** — normal: `` <space>gcT ``, select: `` <space>gcT `` |
...
| `vc_print_branch_log` | VC log for a named branch (emacs vc-print-branch-log) | **spacemacs** — normal: `` <C-x>vbl ``, select: `` <C-x>vbl ``, insert: `` <C-x>vbl ``<br>**hybrid** — normal: `` <C-x>vbl ``, select: `` <C-x>vbl `` |
| `vc_root_diff` | Diff the whole working tree vs HEAD (emacs vc-root-diff) | **spacemacs** — normal: `` <C-x>vD ``, select: `` <C-x>vD ``, insert: `` <C-x>vD ``<br>**hybrid** — normal: `` <C-x>vD ``, select: `` <C-x>vD `` |
| `vc_region_history` | History of the selected line range (emacs vc-region-history) | **spacemacs** — normal: `` <C-x>vh ``, select: `` <C-x>vh ``, insert: `` <C-x>vh ``<br>**hybrid** — normal: `` <C-x>vh ``, select: `` <C-x>vh `` |
| `vc_log_incoming` | Commits incoming from upstream (emacs vc-log-incoming) | **spacemacs** — normal: `` <C-x>vI ``, select: `` <C-x>vI ``, insert: `` <C-x>vI ``<br>**hybrid** — normal: `` <C-x>vI ``, select: `` <C-x>vI `` |
| `vc_log_outgoing` | Commits outgoing to upstream (emacs vc-log-outgoing) | **spacemacs** — normal: `` <C-x>vO ``, select: `` <C-x>vO ``, insert: `` <C-x>vO ``<br>**hybrid** — normal: `` <C-x>vO ``, select: `` <C-x>vO `` |
| `vc_log_search` | Search the commit log by pattern (emacs vc-log-search) |  |
| `vc_create_branch` | Create and switch to a new branch (emacs vc-create-branch) | **spacemacs** — normal: `` <C-x>vbc ``, select: `` <C-x>vbc ``, insert: `` <C-x>vbc ``<br>**hybrid** — normal: `` <C-x>vbc ``, select: `` <C-x>vbc `` |
| `vc_switch_branch` | Switch to an existing branch (emacs vc-switch-branch) | **spacemacs** — normal: `` <C-x>vbs ``, select: `` <C-x>vbs ``, insert: `` <C-x>vbs ``<br>**hybrid** — normal: `` <C-x>vbs ``, select: `` <C-x>vbs `` |
| `vc_create_tag` | Create a git tag at HEAD (emacs vc-create-tag) | **spacemacs** — normal: `` <C-x>vs ``, select: `` <C-x>vs ``, insert: `` <C-x>vs ``<br>**hybrid** — normal: `` <C-x>vs ``, select: `` <C-x>vs `` |
| `vc_retrieve_tag` | Check out a tag or branch (emacs vc-retrieve-tag) | **spacemacs** — normal: `` <C-x>vr ``, select: `` <C-x>vr ``, insert: `` <C-x>vr ``<br>**hybrid** — normal: `` <C-x>vr ``, select: `` <C-x>vr `` |
...
| `vc_ignore` | Add the current file to .gitignore (emacs vc-ignore) | **spacemacs** — normal: `` <C-x>vG ``, select: `` <C-x>vG ``, insert: `` <C-x>vG ``<br>**hybrid** — normal: `` <C-x>vG ``, select: `` <C-x>vG `` |
| `vc_revert` | Revert the current file to HEAD (emacs vc-revert) | **spacemacs** — normal: `` <C-x>vu ``, select: `` <C-x>vu ``, insert: `` <C-x>vu ``<br>**hybrid** — normal: `` <C-x>vu ``, select: `` <C-x>vu `` |
...
| `vc_next_action` | Do the next logical VC step: stage + commit (emacs vc-next-action) | **spacemacs** — normal: `` <C-x>vv ``, select: `` <C-x>vv ``, insert: `` <C-x>vv ``<br>**hybrid** — normal: `` <C-x>vv ``, select: `` <C-x>vv `` |
...
| `menu_bar_open` | Open the menu bar (emacs menu-bar-open, F10) | **hybrid** — insert: `` <F10> ``<br>**emacs, cua, nano** — normal: `` <F10> ``, insert: `` <F10> `` |
| `menu_bar_mode` | Toggle the menu-bar row (emacs menu-bar-mode) | **spacemacs, hybrid** — normal: `` <space>Tm ``, select: `` <space>Tm `` |
| `tool_bar_mode` | Toggle the tool-bar row of command buttons (emacs tool-bar-mode) | **spacemacs, hybrid** — normal: `` <space>Tt ``, select: `` <space>Tt `` |
...
| `tmm_menubar` | Pick a menu-bar command from a text list (emacs tmm-menubar) | **hybrid** — insert: `` <A-`> ``<br>**emacs, cua, micro, nano** — normal: `` <A-`> ``, insert: `` <A-`> `` |
...
| `ediff_patch_file` | Apply a patch to a file and review the result in ediff (emacs ediff-patch-file, SPC D f p) | **spacemacs, hybrid** — normal: `` <space>Dfp ``, select: `` <space>Dfp `` |
...
| `project_shell_command` | Run a shell command in the project root (emacs project-shell-command) | **spacemacs, hybrid** — normal: `` <space>p! ``, select: `` <space>p! `` |
| `project_async_shell_command` | Run an async shell command in the project (emacs project-async-shell-command) | **spacemacs, hybrid** — normal: `` <space>p& ``, select: `` <space>p& `` |
| `project_eshell` | Open a shell buffer for the project (emacs project-eshell) |  |
| `xref_find_definitions_other_window` | Goto definition in another window (emacs xref-find-definitions-other-window) | **spacemacs, hybrid** — normal: `` <C-w>d ``, `` <C-x>4. ``, `` <space>mgG ``, select: `` <C-x>4. ``, `` <space>mgG ``, insert: `` <C-x>4. ``<br>**vim** — normal: `` <C-w>d ``<br>**emacs** — insert: `` <C-x>4. ``<br>**cua** — select: `` <C-X>4. ``, insert: `` <C-x>4. `` |
| `xref_find_definitions_other_frame` | Goto definition in another frame (emacs xref-find-definitions-other-frame, C-x 5 .) | **spacemacs, hybrid, emacs** — normal: `` <C-x>5. ``, select: `` <C-x>5. ``, insert: `` <C-x>5. ``<br>**cua** — normal: `` <C-x>5. ``, select: `` <C-X>5. ``, insert: `` <C-x>5. ``<br>**micro, nano** — select: `` <C-x>5. `` |
| `info_search_other_window` | Open the Info directory node in another window (emacs info-other-window) | **spacemacs** — normal: `` <C-h>4i ``, select: `` <C-h>4i ``, insert: `` <C-h>4i ``<br>**hybrid** — normal: `` <C-h>4i ``, select: `` <C-h>4i ``, insert: `` <F1>4i ``, `` <C-h>4i ``<br>**emacs, cua, micro** — normal: `` <F1>4i ``, `` <C-h>4i ``, select: `` <F1>4i ``, `` <C-h>4i ``, insert: `` <F1>4i ``, `` <C-h>4i ``<br>**nano** — normal: `` <F1>4i ``, select: `` <F1>4i ``, `` <C-h>4i ``, insert: `` <F1>4i `` |
...
| `org_cycle` | Org: toggle subtree fold | **spacemacs, hybrid** — normal: `` <space>mz ``, `` <space>m<tab> ``, select: `` <space>mz ``, `` <space>m<tab> `` |
| `org_todo` | Org: cycle TODO keyword |  |
| `org_priority` | Org: cycle priority cookie | **spacemacs, hybrid** — normal: `` <space>mp ``, select: `` <space>mp `` |
| `org_promote` | Org: promote heading | **spacemacs, hybrid** — normal: `` <space>mH ``, select: `` <space>mH `` |
| `org_demote` | Org: demote heading | **spacemacs, hybrid** — normal: `` <space>ml ``, select: `` <space>ml `` |
| `org_next_heading` | Org: next heading | **spacemacs, hybrid** — normal: `` <space>mj ``, select: `` <space>mj `` |
| `org_prev_heading` | Org: previous heading |  |
| `org_fold_all` | Org: fold all headings | **spacemacs, hybrid** — normal: `` <space>ma ``, select: `` <space>ma `` |
| `outline_minor_mode` | Fold the buffer by outline headings; run again to unfold (emacs outline-minor-mode) |  |
| `org_unfold_all` | Org: unfold all | **spacemacs, hybrid** — normal: `` <space>mA ``, select: `` <space>mA `` |
| `org_agenda` | Org: open agenda | **spacemacs, hybrid** — normal: `` <space>aoa ``, select: `` <space>aoa `` |
| `org_capture` | Org: capture note | **spacemacs, hybrid** — normal: `` <space>oc ``, `` <space>aoc ``, select: `` <space>oc ``, `` <space>aoc `` |
| `goto_first_change` | Goto first change | **helix, kakoune** — normal: `` [G ``, select: `` [G `` |
| `goto_last_change` | Goto last change | **spacemacs, hybrid** — normal: `` <space>jc ``, select: `` <space>jc ``<br>**helix, kakoune** — normal: `` ]G ``, select: `` ]G `` |
| `goto_line_start` | Goto line start | **spacemacs** — normal: `` 0 ``, `` g<home> ``, `` <space>j0 ``, select: `` <space>j0 ``, insert: `` <home> ``<br>**hybrid** — normal: `` 0 ``, `` g<home> ``, `` <space>j0 ``, select: `` <space>j0 ``, insert: `` <C-a> ``, `` <home> ``<br>**vim** — normal: `` 0 ``, `` g<home> ``, insert: `` <home> ``<br>**helix, kakoune** — normal: `` gh ``, `` <home> ``, select: `` gh ``, insert: `` <home> ``<br>**emacs, cua, nano** — normal: `` <C-a> ``, `` <home> ``, select: `` <C-a> ``, insert: `` <C-a> ``, `` <home> ``<br>**micro** — normal: `` <A-a> ``, `` <home> ``, select: `` <C-a> ``, insert: `` <A-a> ``, `` <home> `` |
| `goto_line_end` | Goto line end | **spacemacs** — normal: `` $ ``, `` gl ``, `` g<end> ``, `` <space>j$ ``, select: `` <space>j$ ``<br>**hybrid** — normal: `` $ ``, `` gl ``, `` g<end> ``, `` <space>j$ ``, select: `` <space>j$ ``, insert: `` <C-e> ``, `` <end> ``<br>**vim** — normal: `` $ ``, `` gl ``, `` g<end> ``<br>**helix, kakoune** — normal: `` gl ``, `` <end> ``, select: `` gl ``<br>**emacs, cua, nano** — normal: `` <C-e> ``, `` <end> ``, select: `` <C-e> ``, insert: `` <C-e> ``, `` <end> ``<br>**micro** — normal: `` <A-e> ``, `` <end> ``, select: `` <C-e> ``, insert: `` <A-e> ``, `` <end> `` |
| `goto_visual_line_start` | Goto visual line start (soft-wrap aware) | **spacemacs, hybrid, vim** — normal: `` g0 `` |
| `goto_visual_first_nonwhitespace` | Goto first non-blank of the screen line (vim g^) | **spacemacs, hybrid, vim** — normal: `` g^ `` |
...
| `goto_first_nonwhitespace` | Goto first non-blank in line | **spacemacs** — normal: `` ^ ``, `` <A-m> ``<br>**hybrid** — normal: `` ^ ``, `` <A-m> ``, insert: `` <A-m> ``<br>**vim** — normal: `` ^ ``<br>**helix, kakoune** — normal: `` gs ``, select: `` gs ``<br>**emacs, cua, micro, nano** — normal: `` <A-m> ``, insert: `` <A-m> `` |
...
| `extend_to_first_nonwhitespace` | Extend to first non-blank in line | **emacs, cua, micro, nano** — select: `` <A-m> `` |
| `extend_to_line_end` | Extend to line end | **helix, kakoune** — select: `` <end> ``<br>**cua** — select: `` <S-end> `` |
| `extend_to_line_end_newline` | Extend to line end |  |
| `signature_help` | Show signature help | **spacemacs, hybrid** — normal: `` <space>ls ``, select: `` <space>ls `` |
| `smart_tab` | Insert tab if all cursors have all whitespace to their left; otherwise, run a separate command. |  |
| `insert_tab` | Insert tab char | **helix, kakoune** — insert: `` <S-tab> `` |
| `insert_newline` | Insert newline char | **spacemacs, hybrid, vim, helix, kakoune, emacs, cua** — insert: `` <C-j> ``, `` <ret> ``<br>**micro, nano** — insert: `` <ret> `` |
| `default_indent_new_line` | Break line at point and continue the comment, indenting under it (emacs default-indent-new-line, M-j) | **spacemacs** — normal: `` <A-C-j> ``, insert: `` <A-j> ``<br>**hybrid** — normal: `` <A-C-j> ``<br>**vim** — insert: `` <A-j> `` |
...
| `delete_char_backward` | Delete previous char | **spacemacs, hybrid, emacs, cua, micro** — insert: `` <backspace> ``<br>**vim** — insert: `` <C-h> ``, `` <backspace> ``<br>**helix, kakoune** — insert: `` <C-h> ``, `` <backspace> ``, `` <S-backspace> ``<br>**nano** — normal: `` <C-h> ``, insert: `` <C-h> ``, `` <backspace> `` |
| `delete_char_forward` | Delete next char | **spacemacs, vim, micro** — insert: `` <del> ``<br>**hybrid, helix, kakoune** — insert: `` <C-d> ``, `` <del> ``<br>**emacs, cua, nano** — normal: `` <C-d> ``, insert: `` <C-d> ``, `` <del> `` |
...
| `earlier` | Move backward in history | **spacemacs, hybrid, vim** — normal: `` g<minus> ``<br>**helix** — normal: `` <A-u> ``, select: `` <A-u> ``<br>**kakoune** — normal: `` <C-k> ``, select: `` <A-u> `` |
| `later` | Move forward in history | **spacemacs, hybrid, vim** — normal: `` g+ ``<br>**helix** — normal: `` <A-U> ``, select: `` <A-U> ``<br>**kakoune** — normal: `` <C-j> ``, select: `` <A-U> `` |
| `undo_tree` | Browse the branching undo history (vim undotree) | **spacemacs, hybrid** — normal: `` <space>aU ``, select: `` <space>aU `` |
...
| `yank` | Yank selection | **spacemacs, hybrid** — normal: `` <A-w> ``<br>**helix, kakoune** — normal: `` y ``, select: `` y `` |
| `yank_to_clipboard` | Yank selections to clipboard | **helix** — normal: `` <space>y ``, select: `` <space>y ``<br>**micro** — normal: `` <C-c> ``, insert: `` <C-c> ``<br>**nano** — normal: `` <A-6> ``, insert: `` <A-6> `` |
...
| `replace_with_yanked` | Replace with yanked text | **spacemacs, hybrid, vim** — select: `` P ``, `` p ``<br>**helix, kakoune** — normal: `` R ``, select: `` R `` |
...
| `paste_after` | Paste after selection | **spacemacs, hybrid** — normal: `` p ``, `` <space>kp ``, select: `` <space>kp ``<br>**vim** — normal: `` p ``<br>**helix, kakoune** — normal: `` p ``, select: `` p `` |
| `paste_after_cursor_after` | Paste after selection, cursor after the pasted text (vim gp) | **vim** — normal: `` gp `` |
| `select_pasted_text` | Reselect the text the last put inserted (spacemacs g p) | **spacemacs, hybrid** — normal: `` gp `` |
...
| `universal_argument` | Begin a prefix argument for the next command; repeat to multiply it by 4 (emacs C-u) | **hybrid** — insert: `` <C-u> ``<br>**emacs, cua** — normal: `` <C-u> ``, insert: `` <C-u> `` |
...
| `list_packages` | Open the package menu: browse, install and delete elisp packages (emacs M-x list-packages) | **spacemacs, hybrid** — normal: `` <space>ak ``, select: `` <space>ak `` |
...
| `describe_package` | Show a package's version, home page, keywords and dependencies (emacs C-h P) | **spacemacs** — normal: `` <C-h>P ``, `` <space>hdP ``, select: `` <C-h>P ``, `` <space>hdP ``, insert: `` <C-h>P ``<br>**hybrid** — normal: `` <C-h>P ``, `` <space>hdP ``, select: `` <C-h>P ``, `` <space>hdP ``, insert: `` <F1>P ``, `` <C-h>P ``<br>**emacs, cua, micro** — normal: `` <F1>P ``, `` <C-h>P ``, select: `` <F1>P ``, `` <C-h>P ``, insert: `` <F1>P ``, `` <C-h>P ``<br>**nano** — normal: `` <F1>P ``, select: `` <F1>P ``, `` <C-h>P ``, insert: `` <F1>P `` |
| `finder_by_keyword` | List the packages that carry a keyword (emacs C-h p / finder-by-keyword) | **spacemacs** — normal: `` <C-h>p ``, select: `` <C-h>p ``, insert: `` <C-h>p ``<br>**hybrid** — normal: `` <C-h>p ``, select: `` <C-h>p ``, insert: `` <F1>p ``, `` <C-h>p ``<br>**emacs, cua, micro** — normal: `` <F1>p ``, `` <C-h>p ``, select: `` <F1>p ``, `` <C-h>p ``, insert: `` <F1>p ``, `` <C-h>p ``<br>**nano** — normal: `` <F1>p ``, select: `` <F1>p ``, `` <C-h>p ``, insert: `` <F1>p `` |
...
| `point_to_register` | Save point to a register (emacs C-x r SPC) | **spacemacs, hybrid** — normal: `` <C-x>r<space> ``, select: `` <C-x>r<space> ``, insert: `` <C-x>r<space> ``<br>**emacs** — insert: `` <C-x>r<space> ``<br>**cua** — select: `` <C-X>r<space> ``, insert: `` <C-x>r<space> `` |
| `jump_to_register` | Jump to the position in a register (emacs C-x r j) | **spacemacs, hybrid** — normal: `` <C-x>rj ``, select: `` <C-x>rj ``, insert: `` <C-x>rj ``<br>**emacs** — insert: `` <C-x>rj ``<br>**cua** — select: `` <C-X>rj ``, insert: `` <C-x>rj `` |
| `number_to_register` | Store the prefix count in a register (emacs C-x r n) | **spacemacs, hybrid** — normal: `` <C-x>rn ``, select: `` <C-x>rn ``, insert: `` <C-x>rn ``<br>**emacs** — insert: `` <C-x>rn ``<br>**cua** — select: `` <C-X>rn ``, insert: `` <C-x>rn `` |
| `increment_register` | Add the prefix count to a number register (emacs C-x r +) | **spacemacs, hybrid** — normal: `` <C-x>r+ ``, select: `` <C-x>r+ ``, insert: `` <C-x>r+ ``<br>**emacs** — insert: `` <C-x>r+ ``<br>**cua** — select: `` <C-X>r+ ``, insert: `` <C-x>r+ `` |
| `emacs_insert_register` | Insert a number or rectangle register's value at point (emacs C-x r i) | **spacemacs, hybrid** — normal: `` <C-x>ri ``, select: `` <C-x>ri ``, insert: `` <C-x>ri ``<br>**emacs** — insert: `` <C-x>ri ``<br>**cua** — select: `` <C-X>ri ``, insert: `` <C-x>ri `` |
| `copy_rectangle_to_register` | Copy the selected rectangle into a register (emacs C-x r r) | **spacemacs** — normal: `` <C-x>rr ``, select: `` <C-x>rr ``, insert: `` <C-x>rr ``<br>**hybrid** — normal: `` <C-x>rr ``, select: `` <C-x>rr `` |
| `kill_rectangle` | Kill (cut) the rectangle, saving it for yank (emacs C-x r k) | **spacemacs, hybrid** — normal: `` <C-x>rk ``, select: `` <C-x>rk ``, insert: `` <C-x>rk ``<br>**emacs** — insert: `` <C-x>rk ``<br>**cua** — select: `` <C-X>rk ``, insert: `` <C-x>rk `` |
| `delete_rectangle` | Delete the rectangle without saving (emacs C-x r d) | **spacemacs, hybrid** — normal: `` <C-x>rd ``, select: `` <C-x>rd ``, insert: `` <C-x>rd ``<br>**emacs** — insert: `` <C-x>rd ``<br>**cua** — select: `` <C-X>rd ``, insert: `` <C-x>rd `` |
| `clear_rectangle` | Blank the rectangle with spaces (emacs C-x r c) | **spacemacs, hybrid** — normal: `` <C-x>rc ``, select: `` <C-x>rc ``, insert: `` <C-x>rc ``<br>**emacs** — insert: `` <C-x>rc ``<br>**cua** — select: `` <C-X>rc ``, insert: `` <C-x>rc `` |
| `copy_rectangle_as_kill` | Copy the rectangle without deleting (emacs C-x r M-w) | **spacemacs, hybrid** — normal: `` <C-x>r<A-w> ``, select: `` <C-x>r<A-w> ``, insert: `` <C-x>r<A-w> ``<br>**emacs** — insert: `` <C-x>r<A-w> ``<br>**cua** — select: `` <C-X>r<A-w> ``, insert: `` <C-x>r<A-w> `` |
| `yank_rectangle` | Insert the saved rectangle at point (emacs C-x r y) | **spacemacs, hybrid** — normal: `` <C-x>ry ``, select: `` <C-x>ry ``, insert: `` <C-x>ry ``<br>**emacs** — insert: `` <C-x>ry ``<br>**cua** — select: `` <C-X>ry ``, insert: `` <C-x>ry `` |
| `open_rectangle` | Insert blank space to shift the rectangle right (emacs C-x r o) | **spacemacs** — normal: `` <C-x>ro ``, select: `` <C-x>ro ``, insert: `` <C-x>ro ``<br>**hybrid** — normal: `` <C-x>ro ``, select: `` <C-x>ro `` |
...
| `bookmark_set` | Set a named persistent bookmark at point (emacs C-x r m) | **spacemacs, hybrid** — normal: `` <C-x>rm ``, select: `` <C-x>rm ``, insert: `` <C-x>rm ``<br>**emacs** — insert: `` <C-x>rm ``<br>**cua** — select: `` <C-X>rm ``, insert: `` <C-x>rm `` |
| `bookmark_set_no_overwrite` | Set a bookmark, refusing to overwrite an existing name (emacs C-x r M) | **spacemacs** — normal: `` <C-x>rM ``, select: `` <C-x>rM ``, insert: `` <C-x>rM ``<br>**hybrid** — normal: `` <C-x>rM ``, select: `` <C-x>rM `` |
| `bookmark_jump` | Jump to a bookmark via a picker (emacs C-x r b) | **spacemacs** — normal: `` <C-x>rb ``, `` <space>rj ``, select: `` <C-x>rb ``, `` <space>rj ``, insert: `` <C-x>rb ``<br>**hybrid** — normal: `` <C-x>rb ``, `` <space>rj ``, select: `` <C-x>rb ``, `` <space>rj ``, insert: `` <C-x>rb ``, `` <C-x>rl ``<br>**emacs** — insert: `` <C-x>rb ``, `` <C-x>rl ``<br>**cua** — select: `` <C-X>rb ``, `` <C-X>rl ``, insert: `` <C-x>rb ``, `` <C-x>rl `` |
| `list_bookmarks` | List bookmarks in a picker; select to jump (emacs C-x r l / list-bookmarks) | **spacemacs** — normal: `` <C-x>rl ``, select: `` <C-x>rl ``, insert: `` <C-x>rl ``<br>**hybrid** — normal: `` <C-x>rl ``, select: `` <C-x>rl `` |
...
| `define_abbrev` | Define a global abbrev: <name> <expansion> (emacs C-x a g) | **spacemacs, hybrid** — normal: `` <C-x>ag ``, select: `` <C-x>ag ``, insert: `` <C-x>ag ``<br>**emacs** — normal: `` <C-x>ag ``, insert: `` <C-x>ag ``<br>**cua** — normal: `` <C-x>ag ``, select: `` <C-X>ag ``, insert: `` <C-x>ag `` |
| `add_mode_abbrev` | Define the region or word before point as a mode-local abbrev, prompting for its name (emacs add-mode-abbrev, C-x a l) | **spacemacs, hybrid** — normal: `` <C-x>al ``, select: `` <C-x>al ``, insert: `` <C-x>al ``<br>**emacs** — normal: `` <C-x>al ``, insert: `` <C-x>al ``<br>**cua** — normal: `` <C-x>al ``, select: `` <C-X>al ``, insert: `` <C-x>al `` |
| `inverse_add_global_abbrev` | Define the word before point as an abbrev, prompting for its expansion (emacs inverse-add-global-abbrev, C-x a i g) | **spacemacs, hybrid** — normal: `` <C-x>aig ``, select: `` <C-x>aig ``, insert: `` <C-x>aig ``<br>**emacs** — normal: `` <C-x>aig ``, insert: `` <C-x>aig ``<br>**cua** — normal: `` <C-x>aig ``, select: `` <C-X>aig ``, insert: `` <C-x>aig `` |
| `inverse_add_mode_abbrev` | Define the word before point as a mode-local abbrev, prompting for its expansion (emacs inverse-add-mode-abbrev, C-x a i l) | **spacemacs, hybrid** — normal: `` <C-x>ail ``, select: `` <C-x>ail ``, insert: `` <C-x>ail ``<br>**emacs** — normal: `` <C-x>ail ``, insert: `` <C-x>ail ``<br>**cua** — normal: `` <C-x>ail ``, select: `` <C-X>ail ``, insert: `` <C-x>ail `` |
...
| `expand_abbrev` | Expand the abbrev before point (emacs C-x ') | **spacemacs** — normal: `` <A-'> ``, `` <C-x>' ``, select: `` <C-x>' ``, insert: `` <C-]> ``, `` <C-x>' ``<br>**hybrid** — normal: `` <A-'> ``, `` <C-x>' ``, select: `` <C-x>' ``, insert: `` <C-x>' ``<br>**vim** — insert: `` <C-]> ``<br>**emacs** — normal: `` <C-x>' ``, insert: `` <C-x>' ``<br>**cua** — normal: `` <C-x>' ``, select: `` <C-X>' ``, insert: `` <C-x>' `` |
| `abbrev_prefix_mark` | Mark point as an abbrev prefix boundary; insert a hyphen the next expand-abbrev removes (emacs abbrev-prefix-mark, M-') | **spacemacs, hybrid** — normal: `` <space>xem ``, select: `` <space>xem `` |
| `unexpand_abbrev` | Undo the last abbrev expansion, restoring the original abbrev text (emacs unexpand-abbrev) | **spacemacs, hybrid** — normal: `` <space>xeu ``, select: `` <space>xeu `` |
...
| `paste_clipboard_before` | Paste clipboard before selections | **helix** — normal: `` <space>P ``, select: `` <space>P ``<br>**micro** — normal: `` <C-v> ``, insert: `` <C-v> ``<br>**nano** — normal: `` <C-u> ``, insert: `` <C-u> `` |
...
| `indent` | Indent selection | **spacemacs, vim** — normal: `` == ``, select: `` <gt> ``, insert: `` <C-t> ``<br>**hybrid** — normal: `` == ``, select: `` <gt> ``<br>**helix, kakoune** — normal: `` <gt> ``, select: `` <gt> `` |
| `unindent` | Unindent selection | **spacemacs, hybrid, vim** — select: `` <lt> ``<br>**helix, kakoune** — normal: `` <lt> ``, select: `` <lt> `` |
| `indent_including_blank` | Indent selection, empty lines included (kakoune A->) | **spacemacs, hybrid, vim** — select: `` g<gt> `` |
| `unindent_full_levels_only` | Unindent selection, keeping an incomplete indent (kakoune A-<) | **spacemacs, hybrid, vim** — select: `` g<lt> `` |
| `format_selections` | Format selection | **spacemacs, hybrid** — normal: `` <space>j+ ``, `` <space>j= ``, `` <space>lf ``, select: `` <space>j+ ``, `` <space>j= ``, `` <space>lf ``<br>**helix, kakoune** — normal: `` = ``, select: `` = ``<br>**nano** — normal: `` <C-j> ``, insert: `` <C-j> `` |
| `reflow_selections` | vim gq: reflow selection to text-width | **spacemacs** — normal: `` <A-q> ``<br>**hybrid, emacs, cua, micro, nano** — normal: `` <A-q> ``, insert: `` <A-q> `` |
...
| `join_selections` | Join lines inside selection | **spacemacs** — normal: `` <A-^> ``, `` <space>kJ ``, select: `` <space>kJ ``<br>**hybrid** — normal: `` <A-^> ``, `` <space>kJ ``, select: `` <space>kJ ``, insert: `` <A-^> ``<br>**helix, kakoune** — normal: `` J ``, select: `` J ``<br>**emacs, cua, micro, nano** — insert: `` <A-^> `` |
| `join_selections_space` | Join lines inside selection and select spaces | **helix, kakoune** — normal: `` <A-J> ``, select: `` <A-J> `` |
| `join_lines_vim` | Join line(s) with a space, cursor at join (vim J) | **spacemacs, hybrid, vim** — normal: `` J `` |
...
| `align_selections` | Align selections in column | **spacemacs, hybrid** — normal: `` <space>xaa ``, select: `` <space>xaa ``<br>**helix, kakoune** — normal: `` & ``, select: `` & `` |
...
| `completion` | Invoke completion popup | **spacemacs** — normal: `` <A-C-i> ``, `` <A-tab> ``, `` <C-c>,<space> ``, select: `` <C-c>,<space> ``, insert: `` <A-/> ``, `` <C-n> ``, `` <C-p> ``, `` <C-c>,<space> ``<br>**hybrid** — normal: `` <A-C-i> ``, `` <A-tab> ``, `` <C-c>,<space> ``, select: `` <C-c>,<space> ``, insert: `` <A-tab> ``<br>**vim** — insert: `` <C-n> ``, `` <C-p> ``, `` <C-x><C-n> ``, `` <C-x><C-p> ``<br>**helix** — insert: `` <C-x> ``<br>**kakoune** — insert: `` <C-x><C-x> ``<br>**emacs, cua, micro, nano** — normal: `` <A-tab> ``, insert: `` <A-tab> `` |
| `semantic_analyze_possible_completions` | List the completions possible at point in another window (semantic-analyze-possible-completions, C-c , l) | **spacemacs** — normal: `` <C-c>,l ``, select: `` <C-c>,l ``, insert: `` <C-c>,l ``<br>**hybrid** — normal: `` <C-c>,l ``, select: `` <C-c>,l `` |
| `hover` | Show docs for item under cursor | **spacemacs** — normal: `` <C-h>. ``, `` <space>lk ``, `` <space>hda ``, `` <space>hdf ``, `` <space>hdv ``, `` <space>mhh ``, select: `` K ``, `` <C-h>. ``, `` <space>lk ``, `` <space>hda ``, `` <space>hdf ``, `` <space>hdv ``, `` <space>mhh ``, insert: `` <C-h>. ``<br>**hybrid** — normal: `` <C-h>. ``, `` <space>lk ``, `` <space>hda ``, `` <space>hdf ``, `` <space>hdv ``, `` <space>mhh ``, select: `` K ``, `` <C-h>. ``, `` <space>lk ``, `` <space>hda ``, `` <space>hdf ``, `` <space>hdv ``, `` <space>mhh ``, insert: `` <F1>. ``, `` <C-h>. ``<br>**vim** — select: `` K ``<br>**helix** — normal: `` <space>k ``, select: `` <space>k ``<br>**emacs, cua, micro** — normal: `` <F1>. ``, `` <C-h>. ``, select: `` <F1>. ``, `` <C-h>. ``, insert: `` <F1>. ``, `` <C-h>. ``<br>**nano** — normal: `` <F1>. ``, select: `` <F1>. ``, `` <C-h>. ``, insert: `` <F1>. `` |
| `keyword_lookup` | vim K: run keywordprg on the word under cursor, else LSP hover | **spacemacs, hybrid, vim** — normal: `` K `` |
| `goto_first_nonwhitespace_down` | vim _: first non-blank, count-1 lines down | **spacemacs, hybrid, vim** — normal: `` _ `` |
...
| `toggle_comments` | Comment/uncomment selections | **spacemacs** — normal: `` <A-;> ``, `` <space>; ``, `` <space>cP ``, `` <space>cc ``, `` <space>cp ``, `` <C-x><C-;> ``, select: `` <space>; ``, `` <space>cP ``, `` <space>cc ``, `` <space>cp ``, `` <C-x><C-;> ``, insert: `` <C-x><C-;> ``<br>**hybrid** — normal: `` <A-;> ``, `` <space>; ``, `` <space>cP ``, `` <space>cc ``, `` <space>cp ``, `` <C-x><C-;> ``, select: `` <space>; ``, `` <space>cP ``, `` <space>cc ``, `` <space>cp ``, `` <C-x><C-;> ``, insert: `` <A-;> ``, `` <C-x><C-;> ``<br>**helix** — normal: `` <C-c> ``, `` <space>c ``, select: `` <C-c> ``, `` <space>c ``<br>**kakoune** — normal: `` <C-c> ``, select: `` <C-c> ``<br>**emacs** — normal: `` <A-;> ``, insert: `` <A-;> ``, `` <C-x><C-;> ``<br>**cua** — normal: `` <A-;> ``, select: `` <C-X><C-;> ``, insert: `` <A-;> ``, `` <C-x><C-;> ``<br>**micro** — normal: `` <A-;> ``, insert: `` <A-;> ``<br>**nano** — normal: `` <A-3> ``, `` <A-;> ``, insert: `` <A-3> ``, `` <A-;> `` |
| `toggle_line_comments` | Line comment/uncomment selections | **spacemacs, hybrid** — normal: `` gcc ``, `` <space>cL ``, `` <space>cl ``, select: `` <space>cL ``, `` <space>cl ``<br>**vim** — normal: `` gcc ``<br>**helix** — normal: `` <space><A-c> ``, select: `` <space><A-c> `` |
| `comment_to_line` | Comment/uncomment from the cursor line to a prompted line (SPC c t) | **spacemacs, hybrid** — normal: `` <space>ct ``, select: `` <space>ct `` |
| `invert_comment_to_line` | Invert comments per line from the cursor to a prompted line (SPC c T) | **spacemacs, hybrid** — normal: `` <space>cT ``, select: `` <space>cT `` |
| `toggle_block_comments` | Block comment/uncomment selections | **spacemacs, hybrid** — normal: `` <space>cb ``, select: `` <space>cb ``<br>**helix** — normal: `` <space>C ``, select: `` <space>C `` |
| `comment_kill` | Kill the comment on the current line to the kill ring (emacs comment-kill; count kills that many lines) | **spacemacs, hybrid** — normal: `` <space>cx ``, select: `` <space>cx `` |
| `rotate_selections_forward` | Rotate selections forward | **helix, kakoune** — normal: `` ) ``, select: `` ) `` |
| `rotate_selections_backward` | Rotate selections backward | **helix, kakoune** — normal: `` ( ``, select: `` ( `` |
| `rotate_selection_contents_forward` | Rotate selection contents forward | **helix, kakoune** — normal: `` <A-)> ``, select: `` <A-)> `` |
| `rotate_selection_contents_backward` | Rotate selections contents backward | **helix, kakoune** — normal: `` <A-(> ``, select: `` <A-(> `` |
| `reverse_selection_contents` | Reverse selections contents |  |
| `expand_selection` | Expand selection to parent syntax node | **spacemacs, hybrid** — normal: `` <space>v ``, `` <space>kU ``, select: `` <space>v ``, `` <space>kU ``<br>**helix** — normal: `` <A-o> ``, `` <A-up> ``, select: `` <A-o> ``, `` <A-up> ``<br>**kakoune** — normal: `` <A-up> ``, select: `` <A-o> ``, `` <A-up> `` |
| `shrink_selection` | Shrink selection to previously expanded syntax node | **helix** — normal: `` <A-i> ``, `` <A-down> ``, select: `` <A-i> ``, `` <A-down> ``<br>**kakoune** — normal: `` <A-down> ``, select: `` <A-down> `` |
| `wildfire` | Wildfire: select/expand to the closest text object | **spacemacs, hybrid, vim** — normal: `` <ret> `` |
| `wildfire_shrink` | Wildfire: shrink to the previously selected text object | **spacemacs, hybrid, vim** — normal: `` <backspace> `` |
| `select_next_sibling` | Select next sibling in the syntax tree | **spacemacs, hybrid** — normal: `` <space>kL ``, `` <space>kl ``, select: `` <space>kL ``, `` <space>kl ``<br>**helix, kakoune** — normal: `` <A-n> ``, `` <A-right> ``, select: `` <A-n> ``, `` <A-right> `` |
| `select_prev_sibling` | Select previous sibling the in syntax tree | **spacemacs, hybrid** — normal: `` <space>kH ``, `` <space>kh ``, select: `` <space>kH ``, `` <space>kh ``<br>**helix** — normal: `` <A-p> ``, `` <A-left> ``, select: `` <A-p> ``, `` <A-left> ``<br>**kakoune** — normal: `` <A-left> ``, select: `` <A-p> ``, `` <A-left> `` |
...
| `jump_forward` | Jump forward on jumplist | **spacemacs, vim** — normal: `` <C-i> ``, `` <tab> ``<br>**hybrid** — normal: `` <C-i> ``, `` <tab> ``, insert: `` <A-C-,> ``<br>**helix, kakoune** — normal: `` <C-i> ``, `` <tab> ``, select: `` <C-i> ``, `` <tab> ``<br>**emacs, cua, micro, nano** — insert: `` <A-C-,> `` |
| `jump_backward` | Jump backward on jumplist | **spacemacs, hybrid** — normal: `` <C-o> ``, `` <space>jb ``, `` <space>s` ``, select: `` <space>jb ``, `` <space>s` ``<br>**vim** — normal: `` <C-o> ``<br>**helix, kakoune** — normal: `` <C-o> ``, select: `` <C-o> `` |
| `xref_pop_marker_stack` | Go back to where the last xref lookup was invoked from (emacs xref-pop-marker-stack / xref-go-back, M-,) | **hybrid** — insert: `` <A-,> ``<br>**emacs, cua, nano** — normal: `` <A-,> ``, insert: `` <A-,> `` |
| `save_selection` | Save current selection to jumplist | **helix, kakoune** — normal: `` <C-s> ``, select: `` <C-s> `` |
| `jump_view_right` | Jump to right split | **spacemacs, hybrid** — normal: `` <C-w>l ``, `` <C-w>.l ``, `` <C-w>[l ``, `` <C-w>{l ``, `` <space>wl ``, `` <space>w.l ``, `` <space>w[l ``, `` <space>w{l ``, `` <C-w><right> ``, `` <space>w<right> ``, select: `` <space>wl ``, `` <space>w.l ``, `` <space>w[l ``, `` <space>w{l ``, `` <space>w<right> ``<br>**vim** — normal: `` <C-w>l ``, `` <C-w>.l ``, `` <C-w>[l ``, `` <C-w>{l ``, `` <C-w><right> ``<br>**helix** — normal: `` <C-w>l ``, `` <space>wl ``, `` <C-w><C-l> ``, `` <C-w><right> ``, `` <space>w<C-l> ``, `` <space>w<right> ``, select: `` <C-w>l ``, `` <space>wl ``, `` <C-w><C-l> ``, `` <C-w><right> ``, `` <space>w<C-l> ``, `` <space>w<right> ``<br>**kakoune** — normal: `` <C-w>l ``, `` <C-w><C-l> ``, `` <C-w><right> ``, select: `` <C-w>l ``, `` <C-w><C-l> ``, `` <C-w><right> `` |
| `jump_view_left` | Jump to left split | **spacemacs, hybrid** — normal: `` <C-w>h ``, `` <C-w>.h ``, `` <C-w>[h ``, `` <C-w>{h ``, `` <space>wh ``, `` <space>w.h ``, `` <space>w[h ``, `` <space>w{h ``, `` <C-w><left> ``, `` <space>w<left> ``, select: `` <space>wh ``, `` <space>w.h ``, `` <space>w[h ``, `` <space>w{h ``, `` <space>w<left> ``<br>**vim** — normal: `` <C-w>h ``, `` <C-w>.h ``, `` <C-w>[h ``, `` <C-w>{h ``, `` <C-w><left> ``<br>**helix** — normal: `` <C-w>h ``, `` <space>wh ``, `` <C-w><C-h> ``, `` <C-w><left> ``, `` <space>w<C-h> ``, `` <space>w<left> ``, select: `` <C-w>h ``, `` <space>wh ``, `` <C-w><C-h> ``, `` <C-w><left> ``, `` <space>w<C-h> ``, `` <space>w<left> ``<br>**kakoune** — normal: `` <C-w>h ``, `` <C-w><C-h> ``, `` <C-w><left> ``, select: `` <C-w>h ``, `` <C-w><C-h> ``, `` <C-w><left> `` |
| `jump_view_up` | Jump to split above | **spacemacs, hybrid** — normal: `` <C-w>k ``, `` <C-w>.k ``, `` <C-w>[k ``, `` <C-w>{k ``, `` <C-w><up> ``, `` <space>wk ``, `` <C-w><C-t> ``, `` <space>w.k ``, `` <space>w[k ``, `` <space>w{k ``, `` <space>w<up> ``, `` <space>w<C-t> ``, select: `` <space>wk ``, `` <space>w.k ``, `` <space>w[k ``, `` <space>w{k ``, `` <space>w<up> ``, `` <space>w<C-t> ``<br>**vim** — normal: `` <C-w>k ``, `` <C-w>.k ``, `` <C-w>[k ``, `` <C-w>{k ``, `` <C-w><up> ``, `` <C-w><C-t> ``<br>**helix** — normal: `` <C-w>k ``, `` <C-w><up> ``, `` <space>wk ``, `` <C-w><C-k> ``, `` <space>w<up> ``, `` <space>w<C-k> ``, select: `` <C-w>k ``, `` <C-w><up> ``, `` <space>wk ``, `` <C-w><C-k> ``, `` <space>w<up> ``, `` <space>w<C-k> ``<br>**kakoune** — normal: `` <C-w>k ``, `` <C-w><up> ``, `` <C-w><C-k> ``, select: `` <C-w>k ``, `` <C-w><up> ``, `` <C-w><C-k> `` |
| `jump_view_down` | Jump to split below | **spacemacs, hybrid** — normal: `` <C-w>b ``, `` <C-w>j ``, `` <C-w>.j ``, `` <C-w>[j ``, `` <C-w>{j ``, `` <space>wj ``, `` <C-w><C-b> ``, `` <space>w.j ``, `` <space>w[j ``, `` <space>w{j ``, `` <C-w><down> ``, `` <space>w<C-b> ``, `` <space>w<down> ``, select: `` <space>wj ``, `` <space>w.j ``, `` <space>w[j ``, `` <space>w{j ``, `` <space>w<C-b> ``, `` <space>w<down> ``<br>**vim** — normal: `` <C-w>b ``, `` <C-w>j ``, `` <C-w>.j ``, `` <C-w>[j ``, `` <C-w>{j ``, `` <C-w><C-b> ``, `` <C-w><down> ``<br>**helix** — normal: `` <C-w>j ``, `` <space>wj ``, `` <C-w><C-j> ``, `` <C-w><down> ``, `` <space>w<C-j> ``, `` <space>w<down> ``, select: `` <C-w>j ``, `` <space>wj ``, `` <C-w><C-j> ``, `` <C-w><down> ``, `` <space>w<C-j> ``, `` <space>w<down> ``<br>**kakoune** — normal: `` <C-w>j ``, `` <C-w><C-j> ``, `` <C-w><down> ``, select: `` <C-w>j ``, `` <C-w><C-j> ``, `` <C-w><down> `` |
| `swap_view_right` | Swap with right split | **spacemacs, hybrid** — normal: `` <C-w>L ``, `` <C-w>.L ``, `` <C-w>[L ``, `` <C-w>{L ``, `` <space>wL ``, `` <space>w.L ``, `` <space>w[L ``, `` <space>w{L ``, select: `` <space>wL ``, `` <space>w.L ``, `` <space>w[L ``, `` <space>w{L ``<br>**vim** — normal: `` <C-w>L ``, `` <C-w>.L ``, `` <C-w>[L ``, `` <C-w>{L ``<br>**helix** — normal: `` <C-w>L ``, `` <space>wL ``, select: `` <C-w>L ``, `` <space>wL ``<br>**kakoune** — normal: `` <C-w>L ``, select: `` <C-w>L `` |
| `swap_view_left` | Swap with left split | **spacemacs, hybrid** — normal: `` <C-w>H ``, `` <C-w>.H ``, `` <C-w>[H ``, `` <C-w>{H ``, `` <space>wH ``, `` <space>w.H ``, `` <space>w[H ``, `` <space>w{H ``, select: `` <space>wH ``, `` <space>w.H ``, `` <space>w[H ``, `` <space>w{H ``<br>**vim** — normal: `` <C-w>H ``, `` <C-w>.H ``, `` <C-w>[H ``, `` <C-w>{H ``<br>**helix** — normal: `` <C-w>H ``, `` <space>wH ``, select: `` <C-w>H ``, `` <space>wH ``<br>**kakoune** — normal: `` <C-w>H ``, select: `` <C-w>H `` |
| `swap_view_up` | Swap with split above | **spacemacs, hybrid** — normal: `` <C-w>K ``, `` <C-w>.K ``, `` <C-w>[K ``, `` <C-w>{K ``, `` <space>wK ``, `` <space>w.K ``, `` <space>w[K ``, `` <space>w{K ``, select: `` <space>wK ``, `` <space>w.K ``, `` <space>w[K ``, `` <space>w{K ``<br>**vim** — normal: `` <C-w>K ``, `` <C-w>.K ``, `` <C-w>[K ``, `` <C-w>{K ``<br>**helix** — normal: `` <C-w>K ``, `` <space>wK ``, select: `` <C-w>K ``, `` <space>wK ``<br>**kakoune** — normal: `` <C-w>K ``, select: `` <C-w>K `` |
| `swap_view_down` | Swap with split below | **spacemacs, hybrid** — normal: `` <C-w>J ``, `` <C-w>.J ``, `` <C-w>[J ``, `` <C-w>{J ``, `` <space>wJ ``, `` <space>w.J ``, `` <space>w[J ``, `` <space>w{J ``, select: `` <space>wJ ``, `` <space>w.J ``, `` <space>w[J ``, `` <space>w{J ``<br>**vim** — normal: `` <C-w>J ``, `` <C-w>.J ``, `` <C-w>[J ``, `` <C-w>{J ``<br>**helix** — normal: `` <C-w>J ``, `` <space>wJ ``, select: `` <C-w>J ``, `` <space>wJ ``<br>**kakoune** — normal: `` <C-w>J ``, select: `` <C-w>J `` |
| `tmux_navigate_left` | Move left, on out into tmux at the edge (spacemacs tmux layer) | **spacemacs, hybrid** — normal: `` <C-w><C-h> ``, `` <space>w<C-h> ``, select: `` <space>w<C-h> ``<br>**vim** — normal: `` <C-w><C-h> `` |
| `tmux_navigate_down` | Move down, on out into tmux at the edge (spacemacs tmux layer) | **spacemacs, hybrid** — normal: `` <C-w><C-j> ``, `` <space>w<C-j> ``, select: `` <space>w<C-j> ``<br>**vim** — normal: `` <C-w><C-j> `` |
| `tmux_navigate_up` | Move up, on out into tmux at the edge (spacemacs tmux layer) | **spacemacs, hybrid** — normal: `` <C-w><C-k> ``, `` <space>w<C-k> ``, select: `` <space>w<C-k> ``<br>**vim** — normal: `` <C-w><C-k> `` |
| `tmux_navigate_right` | Move right, on out into tmux at the edge (spacemacs tmux layer) | **spacemacs, hybrid** — normal: `` <C-w><C-l> ``, `` <space>w<C-l> ``, select: `` <space>w<C-l> ``<br>**vim** — normal: `` <C-w><C-l> `` |
...
| `loclist_next` | Location list: jump to next entry (:lnext) | **spacemacs, hybrid, vim** — normal: `` ]l `` |
| `loclist_prev` | Location list: jump to previous entry (:lprev) | **spacemacs, hybrid, vim** — normal: `` [l `` |
...
| `goto_next_tabpage` | Go to the next tabpage (gt / :tabnext) | **spacemacs** — normal: `` gt ``, `` <C-w>gt ``, `` <C-x>to ``, `` <space>wgt ``, select: `` <C-x>to ``, `` <space>wgt ``, insert: `` <C-x>to ``<br>**hybrid** — normal: `` gt ``, `` <C-w>gt ``, `` <C-x>to ``, `` <space>wgt ``, select: `` <C-x>to ``, `` <space>wgt ``<br>**vim** — normal: `` gt ``, `` <C-w>gt `` |
| `goto_previous_tabpage` | Go to the previous tabpage (gT / :tabprevious) | **spacemacs, hybrid** — normal: `` gT ``, `` <C-w>gT ``, `` <S-C-tab> ``, `` <space>wgT ``, select: `` <space>wgT ``<br>**vim** — normal: `` gT ``, `` <C-w>gT `` |
| `new_tab` | Open a new tabpage (:tabnew) | **spacemacs** — normal: `` <C-x>t2 ``, select: `` <C-x>t2 ``, insert: `` <C-x>t2 ``<br>**hybrid** — normal: `` <C-x>t2 ``, select: `` <C-x>t2 `` |
| `close_tab` | Close the current tabpage (:tabclose) | **spacemacs** — normal: `` <C-x>t0 ``, select: `` <C-x>t0 ``, insert: `` <C-x>t0 ``<br>**hybrid** — normal: `` <C-x>t0 ``, select: `` <C-x>t0 `` |
| `tab_only` | Close all other tabpages (:tabonly) | **spacemacs** — normal: `` <C-x>t1 ``, select: `` <C-x>t1 ``, insert: `` <C-x>t1 ``<br>**hybrid** — normal: `` <C-x>t1 ``, select: `` <C-x>t1 `` |
| `tab_move_right` | Move the current tab one position right, N with a prefix (emacs tab-move, C-x t m) | **spacemacs, hybrid** — normal: `` <C-x>tm ``, select: `` <C-x>tm ``, insert: `` <C-x>tm ``<br>**emacs** — insert: `` <C-x>tm ``<br>**cua** — select: `` <C-X>tm ``, insert: `` <C-x>tm `` |
| `window_to_new_tab` | Move the current window to a new tabpage (vim CTRL-W T) | **spacemacs, hybrid, vim** — normal: `` <C-w>T `` |
...
| `tab_recent` | Switch to the most recently visited tab (emacs tab-recent) | **hybrid** — insert: `` <C-0> ``<br>**emacs, cua, micro, nano** — normal: `` <C-0> ``, select: `` <C-0> ``, insert: `` <C-0> `` |
| `tab_bar_mode` | Toggle the tab bar (emacs tab-bar-mode) |  |
| `tab_rename` | Name the current tab (emacs tab-rename) | **spacemacs** — normal: `` <C-x>tr ``, select: `` <C-x>tr ``, insert: `` <C-x>tr ``<br>**hybrid** — normal: `` <C-x>tr ``, select: `` <C-x>tr `` |
| `tab_switch` | Switch to a tab by name or number (emacs tab-switch) | **spacemacs** — normal: `` <C-x>t<ret> ``, select: `` <C-x>t<ret> ``, insert: `` <C-x>t<ret> ``<br>**hybrid** — normal: `` <C-x>t<ret> ``, select: `` <C-x>t<ret> `` |
...
| `forward_list` | Move forward over a balanced () group (emacs forward-list, C-M-n) | **spacemacs, hybrid** — normal: `` <A-C-n> `` |
| `backward_list` | Move backward over a balanced () group (emacs backward-list, C-M-p) | **spacemacs, hybrid** — normal: `` <A-C-p> `` |
| `down_list` | Descend into the next list (emacs down-list, C-M-d) | **spacemacs, hybrid** — normal: `` <A-C-d> `` |
| `up_list` | Move forward out of the enclosing list (emacs up-list) |  |
| `backward_up_list` | Move backward out of the enclosing list (emacs backward-up-list, C-M-u) | **spacemacs, hybrid** — normal: `` <A-C-u> `` |
| `kill_sexp` | Kill the s-expression after point (emacs kill-sexp, C-M-k) | **spacemacs, hybrid** — normal: `` <A-C-k> `` |
| `mark_sexp` | Set the region over the following s-expression (emacs mark-sexp, C-M-SPC) | **spacemacs, hybrid** — normal: `` <A-C-@> ``, `` <A-C-space> `` |
| `forward_sexp` | Move forward over the next s-expression (emacs forward-sexp, C-M-f) | **spacemacs, hybrid** — normal: `` <A-C-f> `` |
| `backward_sexp` | Move backward over the previous s-expression (emacs backward-sexp, C-M-b) | **spacemacs, hybrid** — normal: `` <A-C-b> `` |
| `prog_indent_sexp` | Re-indent the s-expression after point, or the enclosing defun with a prefix (emacs prog-indent-sexp, C-M-q; here = s) | **spacemacs, hybrid** — normal: `` =s ``, `` <A-C-q> ``<br>**vim** — normal: `` =s `` |
...
| `copy_as_format` | Copy the region or line to the kill ring, wrapped for the default format (spacemacs copy-as-format) | **spacemacs, hybrid** — normal: `` <space>xff ``, select: `` <space>xff `` |
| `copy_as_format_asciidoc` | Copy the region or line as an AsciiDoc source block (copy-as-format-asciidoc) | **spacemacs, hybrid** — normal: `` <space>xfa ``, select: `` <space>xfa `` |
| `copy_as_format_bitbucket` | Copy the region or line as Bitbucket markup (copy-as-format-bitbucket) | **spacemacs, hybrid** — normal: `` <space>xfb ``, select: `` <space>xfb `` |
| `copy_as_format_disqus` | Copy the region or line as Disqus markup (copy-as-format-disqus) | **spacemacs, hybrid** — normal: `` <space>xfd ``, select: `` <space>xfd `` |
| `copy_as_format_github` | Copy the region or line as a GitHub fenced block (copy-as-format-github) | **spacemacs, hybrid** — normal: `` <space>xfg ``, select: `` <space>xfg `` |
| `copy_as_format_gitlab` | Copy the region or line as GitLab markup (copy-as-format-gitlab) | **spacemacs, hybrid** — normal: `` <space>xfl ``, select: `` <space>xfl `` |
| `copy_as_format_hipchat` | Copy the region or line as a HipChat /code message (copy-as-format-hipchat) | **spacemacs, hybrid** — normal: `` <space>xfc ``, select: `` <space>xfc `` |
| `copy_as_format_html` | Copy the region or line as HTML pre/code (copy-as-format-html) | **spacemacs, hybrid** — normal: `` <space>xfh ``, select: `` <space>xfh `` |
| `copy_as_format_jira` | Copy the region or line as a Jira {code} block (copy-as-format-jira) | **spacemacs, hybrid** — normal: `` <space>xfj ``, select: `` <space>xfj `` |
| `copy_as_format_markdown` | Copy the region or line as indented Markdown code (copy-as-format-markdown) | **spacemacs, hybrid** — normal: `` <space>xfm ``, select: `` <space>xfm `` |
| `copy_as_format_mediawiki` | Copy the region or line as MediaWiki syntaxhighlight (copy-as-format-mediawiki) | **spacemacs, hybrid** — normal: `` <space>xfw ``, select: `` <space>xfw `` |
| `copy_as_format_org_mode` | Copy the region or line as an Org src block (copy-as-format-org-mode) | **spacemacs, hybrid** — normal: `` <space>xfo ``, select: `` <space>xfo `` |
| `copy_as_format_pod` | Copy the region or line as POD (copy-as-format-pod) | **spacemacs, hybrid** — normal: `` <space>xfp ``, select: `` <space>xfp `` |
| `copy_as_format_rst` | Copy the region or line as a reStructuredText code directive (copy-as-format-rst) | **spacemacs, hybrid** — normal: `` <space>xfr ``, select: `` <space>xfr `` |
| `copy_as_format_telegram` | Copy the region or line as Telegram markup (copy-as-format-telegram) |  |
| `copy_as_format_slack` | Copy the region or line as Slack markup (copy-as-format-slack) | **spacemacs, hybrid** — normal: `` <space>xfs ``, select: `` <space>xfs `` |
| `copy_as_format_whatsapp` | Copy the region or line as WhatsApp markup (copy-as-format-whatsapp) |  |
| `mark_word` | Set the region over the next word (emacs mark-word, M-@) | **spacemacs, hybrid** — normal: `` <A-@> `` |
| `mark_paragraph` | Select the paragraph around point (emacs mark-paragraph, M-h) | **spacemacs** — normal: `` <A-h> ``<br>**hybrid, emacs, cua, micro, nano** — normal: `` <A-h> ``, insert: `` <A-h> `` |
| `mark_defun` | Select the function/defun around point (emacs mark-defun, C-M-h) | **spacemacs, hybrid** — normal: `` <A-C-h> `` |
| `kill_sentence` | Kill from point to end of sentence (emacs kill-sentence, M-k) | **spacemacs, hybrid** — normal: `` <A-k> `` |
| `backward_kill_sentence` | Kill from start of sentence to point (emacs backward-kill-sentence, C-x DEL) | **spacemacs** — normal: `` <C-x><backspace> ``, select: `` <C-x><backspace> ``, insert: `` <C-x><backspace> ``<br>**hybrid** — normal: `` <C-x><backspace> ``, select: `` <C-x><backspace> `` |
| `append_next_kill` | Make the next kill append to the last kill-ring entry (emacs append-next-kill, C-M-w) | **spacemacs, hybrid** — normal: `` <A-C-w> ``, `` <space>ra ``, select: `` <space>ra `` |
| `forward_page` | Move to the next form-feed page (emacs forward-page, C-x ]) | **spacemacs** — normal: `` <C-x>] ``, select: `` <C-x>] ``, insert: `` <C-x>] ``<br>**hybrid** — normal: `` <C-x>] ``, select: `` <C-x>] `` |
| `backward_page` | Move to the previous form-feed page (emacs backward-page, C-x [) | **spacemacs** — normal: `` <C-x>[ ``, select: `` <C-x>[ ``, insert: `` <C-x>[ ``<br>**hybrid** — normal: `` <C-x>[ ``, select: `` <C-x>[ `` |
| `mark_page` | Select the current form-feed page (emacs mark-page, C-x C-p) | **spacemacs** — normal: `` <C-x><C-p> ``, select: `` <C-x><C-p> ``, insert: `` <C-x><C-p> ``<br>**hybrid** — normal: `` <C-x><C-p> ``, select: `` <C-x><C-p> `` |
| `move_to_opposite_group` | Move the current editor to the opposite split group (JetBrains) |  |
| `rotate_view` | Goto next window | **spacemacs, hybrid** — normal: `` ]w ``, `` <C-w>p ``, `` <C-w>r ``, `` <C-w>w ``, `` <C-x>o ``, `` <C-w>.o ``, `` <C-w>.r ``, `` <C-w>.w ``, `` <C-w>[o ``, `` <C-w>[r ``, `` <C-w>[w ``, `` <C-w>{o ``, `` <C-w>{r ``, `` <C-w>{w ``, `` <space>wr ``, `` <space>ww ``, `` <C-w><C-p> ``, `` <C-w><C-r> ``, `` <C-w><C-w> ``, `` <C-w><tab> ``, `` <space>b.o ``, `` <space>w.o ``, `` <space>w.r ``, `` <space>w.w ``, `` <space>w[o ``, `` <space>w[r ``, `` <space>w[w ``, `` <space>w{o ``, `` <space>w{r ``, `` <space>w{w ``, `` <space>w<C-p> ``, `` <space>w<C-r> ``, `` <space>w<C-w> ``, `` <space>w<tab> ``, select: `` <C-x>o ``, `` <space>wr ``, `` <space>ww ``, `` <space>b.o ``, `` <space>w.o ``, `` <space>w.r ``, `` <space>w.w ``, `` <space>w[o ``, `` <space>w[r ``, `` <space>w[w ``, `` <space>w{o ``, `` <space>w{r ``, `` <space>w{w ``, `` <space>w<C-p> ``, `` <space>w<C-r> ``, `` <space>w<C-w> ``, `` <space>w<tab> ``, insert: `` <C-x>o ``<br>**vim** — normal: `` ]w ``, `` <C-w>p ``, `` <C-w>r ``, `` <C-w>w ``, `` <C-w>.o ``, `` <C-w>.r ``, `` <C-w>.w ``, `` <C-w>[o ``, `` <C-w>[r ``, `` <C-w>[w ``, `` <C-w>{o ``, `` <C-w>{r ``, `` <C-w>{w ``, `` <C-w><C-p> ``, `` <C-w><C-r> ``, `` <C-w><C-w> ``, `` <C-w><tab> ``<br>**helix** — normal: `` <C-w>w ``, `` <space>ww ``, `` <C-w><C-w> ``, `` <space>w<C-w> ``, select: `` <C-w>w ``, `` <space>ww ``, `` <C-w><C-w> ``, `` <space>w<C-w> ``<br>**kakoune** — normal: `` <C-w>w ``, `` <C-w><C-w> ``, select: `` <C-w>w ``, `` <C-w><C-w> ``<br>**emacs** — normal: `` <C-x>o ``, insert: `` <C-x>o ``<br>**cua** — normal: `` <C-x>o ``, select: `` <C-X>o ``, insert: `` <C-x>o ``<br>**micro** — normal: `` <C-w> ``, insert: `` <C-w> `` |
| `goto_preview_window` | Goto the preview window (vim CTRL-W P) | **spacemacs, hybrid** — normal: `` <C-w>P ``, `` <space>wP ``, select: `` <space>wP ``<br>**vim** — normal: `` <C-w>P `` |
| `rotate_view_reverse` | Goto previous window | **spacemacs, hybrid** — normal: `` [w ``, `` <C-w>R ``, `` <C-w>W ``, `` <C-w>.R ``, `` <C-w>[R ``, `` <C-w>{R ``, `` <space>wR ``, `` <space>wW ``, `` <space>w.R ``, `` <space>w[R ``, `` <space>w{R ``, select: `` <space>wR ``, `` <space>wW ``, `` <space>w.R ``, `` <space>w[R ``, `` <space>w{R ``<br>**vim** — normal: `` [w ``, `` <C-w>R ``, `` <C-w>W ``, `` <C-w>.R ``, `` <C-w>[R ``, `` <C-w>{R `` |
| `scroll_other_window` | Scroll the other window forward (emacs scroll-other-window, C-M-v) | **spacemacs, hybrid** — normal: `` <A-C-v> `` |
| `scroll_other_window_down` | Scroll the other window backward (emacs scroll-other-window-down, C-M-S-v) | **spacemacs, hybrid** — normal: `` <A-C-V> `` |
| `recenter_other_window` | Recenter point in the other window (emacs recenter-other-window, C-M-S-l) | **spacemacs, hybrid** — normal: `` <C-w>z ``, `` <A-C-L> ``, `` <space>wz ``, `` <C-w><C-z> ``, `` <space>w<C-z> ``, select: `` <space>wz ``, `` <space>w<C-z> ``<br>**vim** — normal: `` <C-w>z ``, `` <C-w><C-z> `` |
| `hsplit` | Horizontal bottom split | **spacemacs, hybrid** — normal: `` <C-w>S ``, `` <C-w>s ``, `` <C-x>2 ``, `` <C-w>.S ``, `` <C-w>.s ``, `` <C-w>[S ``, `` <C-w>[s ``, `` <C-w>{S ``, `` <C-w>{s ``, `` <space>wS ``, `` <space>ws ``, `` <C-w><C-s> ``, `` <space>w.S ``, `` <space>w.s ``, `` <space>w[S ``, `` <space>w[s ``, `` <space>w{S ``, `` <space>w{s ``, `` <C-w>.<minus> ``, `` <C-w>[<minus> ``, `` <C-w>{<minus> ``, `` <space>w<C-s> ``, `` <space>w.<minus> ``, `` <space>w[<minus> ``, `` <space>w{<minus> ``, select: `` <C-x>2 ``, `` <space>wS ``, `` <space>ws ``, `` <space>w.S ``, `` <space>w.s ``, `` <space>w[S ``, `` <space>w[s ``, `` <space>w{S ``, `` <space>w{s ``, `` <space>w<C-s> ``, `` <space>w.<minus> ``, `` <space>w[<minus> ``, `` <space>w{<minus> ``, insert: `` <C-x>2 ``<br>**vim** — normal: `` <C-w>S ``, `` <C-w>s ``, `` <C-w>.S ``, `` <C-w>.s ``, `` <C-w>[S ``, `` <C-w>[s ``, `` <C-w>{S ``, `` <C-w>{s ``, `` <C-w><C-s> ``, `` <C-w>.<minus> ``, `` <C-w>[<minus> ``, `` <C-w>{<minus> ``<br>**helix** — normal: `` <C-w>s ``, `` <space>ws ``, `` <C-w><C-s> ``, `` <space>w<C-s> ``, select: `` <C-w>s ``, `` <space>ws ``, `` <C-w><C-s> ``, `` <space>w<C-s> ``<br>**kakoune** — normal: `` <C-w>s ``, `` <C-w><C-s> ``, select: `` <C-w>s ``, `` <C-w><C-s> ``<br>**emacs** — normal: `` <C-x>2 ``, insert: `` <C-x>2 ``<br>**cua** — normal: `` <C-x>2 ``, select: `` <C-X>2 ``, insert: `` <C-x>2 `` |
| `hsplit_new` | Horizontal bottom split scratch buffer | **spacemacs, hybrid** — normal: `` <C-w>n ``, `` <space>wn ``, `` <C-w><C-n> ``, `` <space>bNj ``, `` <space>bNk ``, `` <space>w<C-n> ``, select: `` <space>wn ``, `` <space>bNj ``, `` <space>bNk ``, `` <space>w<C-n> ``<br>**vim** — normal: `` <C-w>n ``, `` <C-w><C-n> ``<br>**helix** — normal: `` <C-w>ns ``, `` <space>wns ``, `` <C-w>n<C-s> ``, `` <space>wn<C-s> ``, select: `` <C-w>ns ``, `` <space>wns ``, `` <C-w>n<C-s> ``, `` <space>wn<C-s> ``<br>**kakoune** — normal: `` <C-w>ns ``, `` <C-w>n<C-s> ``, select: `` <C-w>ns ``, `` <C-w>n<C-s> `` |
| `vsplit` | Vertical right split | **spacemacs, hybrid** — normal: `` <C-w>/ ``, `` <C-w>2 ``, `` <C-w>V ``, `` <C-w>v ``, `` <C-x>3 ``, `` <C-w>./ ``, `` <C-w>.V ``, `` <C-w>.v ``, `` <C-w>[/ ``, `` <C-w>[V ``, `` <C-w>[v ``, `` <C-w>{/ ``, `` <C-w>{V ``, `` <C-w>{v ``, `` <space>w/ ``, `` <space>w2 ``, `` <space>wV ``, `` <space>wv ``, `` <C-w><C-v> ``, `` <space>w./ ``, `` <space>w.V ``, `` <space>w.v ``, `` <space>w[/ ``, `` <space>w[V ``, `` <space>w[v ``, `` <space>w{/ ``, `` <space>w{V ``, `` <space>w{v ``, `` <space>w<C-v> ``, `` <space>u<space>w2 ``, select: `` <C-x>3 ``, `` <space>w/ ``, `` <space>w2 ``, `` <space>wV ``, `` <space>wv ``, `` <space>w./ ``, `` <space>w.V ``, `` <space>w.v ``, `` <space>w[/ ``, `` <space>w[V ``, `` <space>w[v ``, `` <space>w{/ ``, `` <space>w{V ``, `` <space>w{v ``, `` <space>w<C-v> ``, `` <space>u<space>w2 ``, insert: `` <C-x>3 ``<br>**vim** — normal: `` <C-w>/ ``, `` <C-w>2 ``, `` <C-w>V ``, `` <C-w>v ``, `` <C-w>./ ``, `` <C-w>.V ``, `` <C-w>.v ``, `` <C-w>[/ ``, `` <C-w>[V ``, `` <C-w>[v ``, `` <C-w>{/ ``, `` <C-w>{V ``, `` <C-w>{v ``, `` <C-w><C-v> ``<br>**helix** — normal: `` <C-w>v ``, `` <space>wv ``, `` <C-w><C-v> ``, `` <space>w<C-v> ``, select: `` <C-w>v ``, `` <space>wv ``, `` <C-w><C-v> ``, `` <space>w<C-v> ``<br>**kakoune** — normal: `` <C-w>v ``, `` <C-w><C-v> ``, select: `` <C-w>v ``, `` <C-w><C-v> ``<br>**emacs** — normal: `` <C-x>3 ``, insert: `` <C-x>3 ``<br>**cua** — normal: `` <C-x>3 ``, select: `` <C-X>3 ``, insert: `` <C-x>3 `` |
| `split_right_and_move` | Split right and move this buffer into it, leaving the old group behind (JetBrains Split and Move Right) | **spacemacs, hybrid** — normal: `` <C-w>.t ``, `` <C-w>[t ``, `` <C-w>{t ``, `` <space>w.t ``, `` <space>w[t ``, `` <space>w{t ``, select: `` <space>w.t ``, `` <space>w[t ``, `` <space>w{t ``<br>**vim** — normal: `` <C-w>.t ``, `` <C-w>[t ``, `` <C-w>{t `` |
| `split_down_and_move` | Split down and move this buffer into it, leaving the old group behind (JetBrains Split and Move Down) | **spacemacs, hybrid** — normal: `` <C-w>.T ``, `` <C-w>[T ``, `` <C-w>{T ``, `` <space>w.T ``, `` <space>w[T ``, `` <space>w{T ``, select: `` <space>w.T ``, `` <space>w[T ``, `` <space>w{T ``<br>**vim** — normal: `` <C-w>.T ``, `` <C-w>[T ``, `` <C-w>{T `` |
| `vsplit_new` | Vertical right split scratch buffer | **spacemacs, hybrid** — normal: `` <space>bNh ``, `` <space>bNl ``, select: `` <space>bNh ``, `` <space>bNl ``<br>**helix** — normal: `` <C-w>nv ``, `` <space>wnv ``, `` <C-w>n<C-v> ``, `` <space>wn<C-v> ``, select: `` <C-w>nv ``, `` <space>wnv ``, `` <C-w>n<C-v> ``, `` <space>wn<C-v> ``<br>**kakoune** — normal: `` <C-w>nv ``, `` <C-w>n<C-v> ``, select: `` <C-w>nv ``, `` <C-w>n<C-v> `` |
| `wclose` | Close window | **spacemacs, hybrid** — normal: `` <C-w>D ``, `` <C-w>c ``, `` <C-w>q ``, `` <C-x>0 ``, `` <C-w>.d ``, `` <C-w>[d ``, `` <C-w>{d ``, `` <space>cd ``, `` <space>wD ``, `` <space>wd ``, `` <space>wq ``, `` <C-w><C-d> ``, `` <C-w><C-q> ``, `` <space>w.d ``, `` <space>w[d ``, `` <space>w{d ``, `` <space>w<C-d> ``, `` <space>w<C-q> ``, `` <space>u<space>wd ``, select: `` <C-x>0 ``, `` <space>cd ``, `` <space>wD ``, `` <space>wd ``, `` <space>wq ``, `` <space>w.d ``, `` <space>w[d ``, `` <space>w{d ``, `` <space>w<C-d> ``, `` <space>w<C-q> ``, `` <space>u<space>wd ``, insert: `` <C-x>0 ``<br>**vim** — normal: `` <C-w>D ``, `` <C-w>c ``, `` <C-w>q ``, `` <C-w>.d ``, `` <C-w>[d ``, `` <C-w>{d ``, `` <C-w><C-d> ``, `` <C-w><C-q> ``<br>**helix** — normal: `` <C-w>q ``, `` <space>wq ``, `` <C-w><C-q> ``, `` <space>w<C-q> ``, select: `` <C-w>q ``, `` <space>wq ``, `` <C-w><C-q> ``, `` <space>w<C-q> ``<br>**kakoune** — normal: `` <C-w>q ``, `` <C-w><C-q> ``, select: `` <C-w>q ``, `` <C-w><C-q> ``<br>**emacs** — normal: `` <C-x>0 ``, insert: `` <C-x>0 ``<br>**cua** — normal: `` <C-x>0 ``, select: `` <C-X>0 ``, insert: `` <C-x>0 `` |
| `wonly` | Close windows except current | **spacemacs, hybrid** — normal: `` <C-w>1 ``, `` <C-w>_ ``, `` <C-w>m ``, `` <C-w>o ``, `` <C-x>1 ``, `` <C-w>.D ``, `` <C-w>._ ``, `` <C-w>.m ``, `` <C-w>[D ``, `` <C-w>[_ ``, `` <C-w>[m ``, `` <C-w>\| ``, `` <C-w>{D ``, `` <C-w>{_ ``, `` <C-w>{m ``, `` <C-w>.\| ``, `` <C-w>[\| ``, `` <C-w>{\| ``, `` <space>w1 ``, `` <space>w_ ``, `` <space>wm ``, `` <space>wo ``, `` <C-w><C-_> ``, `` <C-w><C-o> ``, `` <space>w.D ``, `` <space>w._ ``, `` <space>w.m ``, `` <space>w[D ``, `` <space>w[_ ``, `` <space>w[m ``, `` <space>w\| ``, `` <space>w{D ``, `` <space>w{_ ``, `` <space>w{m ``, `` <space>w.\| ``, `` <space>w[\| ``, `` <space>w{\| ``, `` <space>w<C-o> ``, `` <space>u<space>w1 ``, select: `` <C-x>1 ``, `` <space>w1 ``, `` <space>w_ ``, `` <space>wm ``, `` <space>wo ``, `` <space>w.D ``, `` <space>w._ ``, `` <space>w.m ``, `` <space>w[D ``, `` <space>w[_ ``, `` <space>w[m ``, `` <space>w\| ``, `` <space>w{D ``, `` <space>w{_ ``, `` <space>w{m ``, `` <space>w.\| ``, `` <space>w[\| ``, `` <space>w{\| ``, `` <space>w<C-o> ``, `` <space>u<space>w1 ``, insert: `` <C-x>1 ``<br>**vim** — normal: `` <C-w>1 ``, `` <C-w>_ ``, `` <C-w>m ``, `` <C-w>o ``, `` <C-w>.D ``, `` <C-w>._ ``, `` <C-w>.m ``, `` <C-w>[D ``, `` <C-w>[_ ``, `` <C-w>[m ``, `` <C-w>\| ``, `` <C-w>{D ``, `` <C-w>{_ ``, `` <C-w>{m ``, `` <C-w>.\| ``, `` <C-w>[\| ``, `` <C-w>{\| ``, `` <C-w><C-_> ``, `` <C-w><C-o> ``<br>**helix** — normal: `` <C-w>o ``, `` <space>wo ``, `` <C-w><C-o> ``, `` <space>w<C-o> ``, select: `` <C-w>o ``, `` <space>wo ``, `` <C-w><C-o> ``, `` <space>w<C-o> ``<br>**kakoune** — normal: `` <C-w>o ``, `` <C-w><C-o> ``, select: `` <C-w>o ``, `` <C-w><C-o> ``<br>**emacs** — normal: `` <C-x>1 ``, insert: `` <C-x>1 ``<br>**cua** — normal: `` <C-x>1 ``, select: `` <C-X>1 ``, insert: `` <C-x>1 `` |
| `select_register` | Select register | **spacemacs, hybrid, vim, helix, kakoune** — normal: `` " ``, select: `` " `` |
| `insert_register` | Insert register | **spacemacs, vim, helix, kakoune** — insert: `` <C-r> `` |
| `view_register` | Show a register's contents (emacs view-register, C-x r v) |  |
| `not_modified` | Mark the buffer unmodified without saving (emacs not-modified, M-~) | **spacemacs, hybrid** — normal: `` <A-~> `` |
...
| `copy_to_register` | Copy the region into a register (emacs copy-to-register, C-x r s) | **spacemacs** — normal: `` <C-x>rs ``, select: `` <C-x>rs ``, insert: `` <C-x>rs ``<br>**hybrid** — normal: `` <C-x>rs ``, select: `` <C-x>rs `` |
...
| `scroll_half_column_left` | Scroll view left half a screen (zH) | **spacemacs** — normal: `` zH ``, `` <C-x><gt> ``, select: `` zH ``, `` <C-x><gt> ``, insert: `` <C-x><gt> ``<br>**hybrid** — normal: `` zH ``, `` <C-x><gt> ``, select: `` zH ``, `` <C-x><gt> ``<br>**vim** — normal: `` zH ``, select: `` zH `` |
| `scroll_half_column_right` | Scroll view right half a screen (zL) | **spacemacs** — normal: `` zL ``, `` <C-x><lt> ``, select: `` zL ``, `` <C-x><lt> ``, insert: `` <C-x><lt> ``<br>**hybrid** — normal: `` zL ``, `` <C-x><lt> ``, select: `` zL ``, `` <C-x><lt> ``<br>**vim** — normal: `` zL ``, select: `` zL `` |
| `scroll_cursor_to_left_edge` | Scroll so the cursor sits at the left edge (zs) | **spacemacs, hybrid, vim** — normal: `` zs ``, select: `` zs `` |
| `scroll_cursor_to_right_edge` | Scroll so the cursor sits at the right edge (ze) | **spacemacs, hybrid, vim** — normal: `` ze ``, select: `` ze `` |
| `resize_view_wider` | Make current window wider (CTRL-W >) | **spacemacs, hybrid** — normal: `` <C-x>} ``, `` <C-w>.] ``, `` <C-w>[] ``, `` <C-w>{] ``, `` <C-w><gt> ``, `` <C-w>.<gt> ``, `` <C-w>[<gt> ``, `` <C-w>{<gt> ``, `` <space>w.] ``, `` <space>w[] ``, `` <space>w{] ``, `` <space>w<gt> ``, `` <space>w.<gt> ``, `` <space>w[<gt> ``, `` <space>w{<gt> ``, select: `` <C-x>} ``, `` <space>w.] ``, `` <space>w[] ``, `` <space>w{] ``, `` <space>w<gt> ``, `` <space>w.<gt> ``, `` <space>w[<gt> ``, `` <space>w{<gt> ``, insert: `` <C-x>} ``<br>**vim** — normal: `` <C-w>.] ``, `` <C-w>[] ``, `` <C-w>{] ``, `` <C-w><gt> ``, `` <C-w>.<gt> ``, `` <C-w>[<gt> ``, `` <C-w>{<gt> ``<br>**emacs** — normal: `` <C-x>} ``, insert: `` <C-x>} ``<br>**cua** — normal: `` <C-x>} ``, select: `` <C-X>} ``, insert: `` <C-x>} `` |
| `resize_view_narrower` | Make current window narrower (CTRL-W <) | **spacemacs, hybrid** — normal: `` <C-x>{ ``, `` <C-w>.[ ``, `` <C-w>[[ ``, `` <C-w>{[ ``, `` <C-w><lt> ``, `` <C-w>.<lt> ``, `` <C-w>[<lt> ``, `` <C-w>{<lt> ``, `` <space>w.[ ``, `` <space>w[[ ``, `` <space>w{[ ``, `` <space>w<lt> ``, `` <space>w.<lt> ``, `` <space>w[<lt> ``, `` <space>w{<lt> ``, select: `` <C-x>{ ``, `` <space>w.[ ``, `` <space>w[[ ``, `` <space>w{[ ``, `` <space>w<lt> ``, `` <space>w.<lt> ``, `` <space>w[<lt> ``, `` <space>w{<lt> ``, insert: `` <C-x>{ ``<br>**vim** — normal: `` <C-w>.[ ``, `` <C-w>[[ ``, `` <C-w>{[ ``, `` <C-w><lt> ``, `` <C-w>.<lt> ``, `` <C-w>[<lt> ``, `` <C-w>{<lt> ``<br>**emacs** — normal: `` <C-x>{ ``, insert: `` <C-x>{ ``<br>**cua** — normal: `` <C-x>{ ``, select: `` <C-X>{ ``, insert: `` <C-x>{ `` |
| `resize_view_taller` | Make current window taller (CTRL-W +) | **spacemacs, hybrid** — normal: `` <C-w>+ ``, `` <C-x>^ ``, `` <C-w>.} ``, `` <C-w>[} ``, `` <C-w>{} ``, `` <space>w+ ``, `` <space>w.} ``, `` <space>w[} ``, `` <space>w{} ``, select: `` <C-x>^ ``, `` <space>w+ ``, `` <space>w.} ``, `` <space>w[} ``, `` <space>w{} ``, insert: `` <C-x>^ ``<br>**vim** — normal: `` <C-w>+ ``, `` <C-w>.} ``, `` <C-w>[} ``, `` <C-w>{} ``<br>**emacs** — normal: `` <C-x>^ ``, insert: `` <C-x>^ ``<br>**cua** — normal: `` <C-x>^ ``, select: `` <C-X>^ ``, insert: `` <C-x>^ `` |
| `resize_view_shorter` | Make current window shorter (CTRL-W -) | **spacemacs, hybrid** — normal: `` <C-w>.{ ``, `` <C-w>[{ ``, `` <C-w>{{ ``, `` <space>w.{ ``, `` <space>w[{ ``, `` <space>w{{ ``, `` <C-w><minus> ``, `` <space>w<minus> ``, select: `` <space>w.{ ``, `` <space>w[{ ``, `` <space>w{{ ``, `` <space>w<minus> ``<br>**vim** — normal: `` <C-w>.{ ``, `` <C-w>[{ ``, `` <C-w>{{ ``, `` <C-w><minus> `` |
| `resize_view_equalize` | Make all windows equal size (CTRL-W =) | **spacemacs, hybrid** — normal: `` <C-w>= ``, `` <C-x>+ ``, `` <C-w>.= ``, `` <C-w>[= ``, `` <C-w>{= ``, `` <space>w= ``, `` <space>w.= ``, `` <space>w[= ``, `` <space>w{= ``, select: `` <C-x>+ ``, `` <space>w= ``, `` <space>w.= ``, `` <space>w[= ``, `` <space>w{= ``, insert: `` <C-x>+ ``<br>**vim** — normal: `` <C-w>= ``, `` <C-w>.= ``, `` <C-w>[= ``, `` <C-w>{= ``<br>**emacs** — normal: `` <C-x>+ ``, insert: `` <C-x>+ ``<br>**cua** — normal: `` <C-x>+ ``, select: `` <C-X>+ ``, insert: `` <C-x>+ `` |
| `golden_ratio_resize` | Resize the focused window to the golden ratio (SPC t g) | **spacemacs, hybrid** — normal: `` <C-w>.g ``, `` <C-w>[g ``, `` <C-w>{g ``, `` <space>tg ``, `` <space>w.g ``, `` <space>w[g ``, `` <space>w{g ``, select: `` <space>tg ``, `` <space>w.g ``, `` <space>w[g ``, `` <space>w{g ``<br>**vim** — normal: `` <C-w>.g ``, `` <C-w>[g ``, `` <C-w>{g `` |
...
| `insert_uuid_v4` | Insert a random UUIDv4 (SPC i U 4) | **spacemacs, hybrid** — normal: `` <space>iU4 ``, `` <space>iUU ``, select: `` <space>iU4 ``, `` <space>iUU `` |
| `insert_uuid_v1` | Insert a time-based UUIDv1 (SPC i U 1) | **spacemacs, hybrid** — normal: `` <space>iU1 ``, select: `` <space>iU1 `` |
| `insert_lorem_sentence` | Insert a lorem-ipsum sentence (SPC i l s) | **spacemacs, hybrid** — normal: `` <space>ils ``, select: `` <space>ils `` |
| `insert_lorem_paragraph` | Insert a lorem-ipsum paragraph (SPC i l p) | **spacemacs, hybrid** — normal: `` <space>ilp ``, select: `` <space>ilp `` |
| `insert_lorem_list` | Insert a lorem-ipsum list (SPC i l l) | **spacemacs, hybrid** — normal: `` <space>ill ``, select: `` <space>ill `` |
| `insert_password_simple` | Insert a simple alphanumeric password (SPC i p 1) | **spacemacs, hybrid** — normal: `` <space>ip1 ``, select: `` <space>ip1 `` |
| `insert_password_strong` | Insert a stronger password with symbols (SPC i p 2) | **spacemacs, hybrid** — normal: `` <space>ip2 ``, select: `` <space>ip2 `` |
| `insert_password_paranoid` | Insert a long password for paranoids (SPC i p 3) | **spacemacs, hybrid** — normal: `` <space>ip3 ``, select: `` <space>ip3 `` |
| `insert_password_numerical` | Insert a numeric password (SPC i p n) | **spacemacs, hybrid** — normal: `` <space>ipn ``, select: `` <space>ipn `` |
| `insert_password_phonetic` | Insert a phonetically easy password (SPC i p p) | **spacemacs, hybrid** — normal: `` <space>ipp ``, select: `` <space>ipp `` |
| `symbol_upper_camel` | Change symbol style to UpperCamelCase (SPC x i C) | **spacemacs, hybrid** — normal: `` <space>xiC ``, select: `` <space>xiC `` |
| `symbol_up_case` | Change symbol style to UP_CASE (SPC x i U) | **spacemacs, hybrid** — normal: `` <space>xiU ``, select: `` <space>xiU `` |
| `symbol_under_score` | Change symbol style to under_score (SPC x i _) | **spacemacs, hybrid** — normal: `` <space>xi_ ``, select: `` <space>xi_ `` |
...
| `symbol_dot` | Change symbol style to dot.case (vim-abolish cr.) | **spacemacs, hybrid** — normal: `` <space>xi. ``, select: `` <space>xi. `` |
| `randomize_lines_in_region` | Randomize lines in the selection (SPC x l r) | **spacemacs, hybrid** — normal: `` <space>xlr ``, select: `` <space>xlr `` |
| `randomize_words_in_region` | Randomize words in the selection (SPC x w r) | **spacemacs, hybrid** — normal: `` <space>xwr ``, select: `` <space>xwr `` |
...
| `page_up_key` | Page up, ending Select mode with 'keymodel' stopsel (vim <PageUp>) | **spacemacs, hybrid, vim** — normal: `` <pageup> `` |
| `page_down_key` | Page down, ending Select mode with 'keymodel' stopsel (vim <PageDown>) | **spacemacs, hybrid, vim** — normal: `` <pagedown> `` |
| `home_key` | Go to line start, ending Select mode with 'keymodel' stopsel (vim <Home>) | **spacemacs, hybrid, vim** — normal: `` <home> `` |
| `end_key` | Go to line end, ending Select mode with 'keymodel' stopsel (vim <End>) | **spacemacs, hybrid, vim** — normal: `` <end> `` |
| `shift_home_key` | Select to line start with 'keymodel' startsel, else go there (vim <S-Home>) | **spacemacs, hybrid, vim** — normal: `` <S-home> `` |
| `shift_end_key` | Select to line end with 'keymodel' startsel, else go there (vim <S-End>) | **spacemacs, hybrid, vim** — normal: `` <S-end> `` |
| `left_key` | Move left, ending Select mode with 'keymodel' stopsel (vim <Left>) | **spacemacs, hybrid, vim** — normal: `` <left> `` |
| `right_key` | Move right, ending Select mode with 'keymodel' stopsel (vim <Right>) | **spacemacs, hybrid, vim** — normal: `` <right> `` |
| `up_key` | Move up, ending Select mode with 'keymodel' stopsel (vim <Up>) | **spacemacs, hybrid, vim** — normal: `` <up> `` |
| `down_key` | Move down, ending Select mode with 'keymodel' stopsel (vim <Down>) | **spacemacs, hybrid, vim** — normal: `` <down> `` |
| `shift_right_key` | Select a char right with 'keymodel' startsel, else move a word right (vim <S-Right>) | **spacemacs, hybrid, vim** — normal: `` <S-right> `` |
| `shift_left_key` | Select a char left with 'keymodel' startsel, else move a word left (vim <S-Left>) | **spacemacs, hybrid, vim** — normal: `` <S-left> `` |
| `shift_down_key` | Select a line down with 'keymodel' startsel, else page down (vim <S-Down>) | **spacemacs, hybrid, vim** — normal: `` <S-down> `` |
| `shift_up_key` | Select a line up with 'keymodel' startsel, else page up (vim <S-Up>) | **spacemacs, hybrid, vim** — normal: `` <S-up> `` |
| `shift_page_up_key` | Extend a page up with 'keymodel' startsel, else page up (vim <S-PageUp>) | **spacemacs, hybrid, vim** — normal: `` <S-pageup> `` |
| `shift_page_down_key` | Extend a page down with 'keymodel' startsel, else page down (vim <S-PageDown>) | **spacemacs, hybrid, vim** — normal: `` <S-pagedown> `` |
...
| `select_end_key` | Select-mode <End>: stop Select with 'keymodel' stopsel, else extend to line end | **spacemacs, hybrid, vim** — select: `` <end> `` |
...
| `preferences` | Open the unified Preferences window | **spacemacs, hybrid** — normal: `` <space>, ``, select: `` <space>, `` |
| `set_selective_display` | Hide lines indented past the prefix-arg column; no arg turns it off (emacs set-selective-display, C-x $) | **spacemacs** — normal: `` <C-x>$ ``, select: `` <C-x>$ ``, insert: `` <C-x>$ ``<br>**hybrid** — normal: `` <C-x>$ ``, select: `` <C-x>$ `` |
...
| `help` | Open the inline Help browser | **spacemacs** — normal: `` <F1> ``, `` <C-h>? ``, `` <C-h>r ``, `` <C-h><F1> ``, `` <space>bH ``, `` <space>h? ``, `` <space>hc ``, `` <space>hh ``, `` <space>hk ``, `` <space>hr ``, `` <C-h><C-h> ``, `` <space>hdb ``, `` <space>hdk ``, `` <space>hdx ``, `` <space>h<space> ``, select: `` <C-h>? ``, `` <C-h>r ``, `` <C-h><F1> ``, `` <space>bH ``, `` <space>h? ``, `` <space>hc ``, `` <space>hh ``, `` <space>hk ``, `` <space>hr ``, `` <C-h><C-h> ``, `` <space>hdb ``, `` <space>hdk ``, `` <space>hdx ``, `` <space>h<space> ``, insert: `` <C-h>? ``, `` <C-h>r ``, `` <C-h><F1> ``, `` <C-h><C-h> ``<br>**hybrid** — normal: `` <F1> ``, `` <C-h>? ``, `` <C-h>r ``, `` <C-h><F1> ``, `` <space>bH ``, `` <space>h? ``, `` <space>hc ``, `` <space>hh ``, `` <space>hk ``, `` <space>hr ``, `` <C-h><C-h> ``, `` <space>hdb ``, `` <space>hdk ``, `` <space>hdx ``, `` <space>h<space> ``, select: `` <C-h>? ``, `` <C-h>r ``, `` <C-h><F1> ``, `` <space>bH ``, `` <space>h? ``, `` <space>hc ``, `` <space>hh ``, `` <space>hk ``, `` <space>hr ``, `` <C-h><C-h> ``, `` <space>hdb ``, `` <space>hdk ``, `` <space>hdx ``, `` <space>h<space> ``, insert: `` <F1>? ``, `` <F1>r ``, `` <C-h>? ``, `` <C-h>r ``, `` <F1><F1> ``, `` <C-h><F1> ``, `` <F1><C-h> ``, `` <C-h><C-h> ``<br>**vim** — normal: `` <F1> ``<br>**emacs, cua** — normal: `` <F1>? ``, `` <F1>r ``, `` <C-h>? ``, `` <C-h>r ``, `` <F1><F1> ``, `` <C-h><F1> ``, `` <F1><C-h> ``, `` <C-h><C-h> ``, select: `` <F1>? ``, `` <F1>r ``, `` <C-h>? ``, `` <C-h>r ``, `` <F1><F1> ``, `` <C-h><F1> ``, `` <F1><C-h> ``, `` <C-h><C-h> ``, insert: `` <F1>? ``, `` <F1>r ``, `` <C-h>? ``, `` <C-h>r ``, `` <F1><F1> ``, `` <C-h><F1> ``, `` <F1><C-h> ``, `` <C-h><C-h> ``<br>**micro** — normal: `` <C-g> ``, `` <F1>? ``, `` <F1>r ``, `` <C-h>? ``, `` <C-h>r ``, `` <F1><F1> ``, `` <C-h><F1> ``, `` <F1><C-h> ``, `` <C-h><C-h> ``, select: `` <F1>? ``, `` <F1>r ``, `` <C-h>? ``, `` <C-h>r ``, `` <F1><F1> ``, `` <C-h><F1> ``, `` <F1><C-h> ``, `` <C-h><C-h> ``, insert: `` <C-g> ``, `` <F1>? ``, `` <F1>r ``, `` <C-h>? ``, `` <C-h>r ``, `` <F1><F1> ``, `` <C-h><F1> ``, `` <F1><C-h> ``, `` <C-h><C-h> ``<br>**nano** — normal: `` <C-g> ``, `` <F1>? ``, `` <F1>r ``, `` <F1><F1> ``, `` <F1><C-h> ``, select: `` <F1>? ``, `` <F1>r ``, `` <C-h>? ``, `` <C-h>r ``, `` <F1><F1> ``, `` <C-h><F1> ``, `` <F1><C-h> ``, `` <C-h><C-h> ``, insert: `` <C-g> ``, `` <F1>? ``, `` <F1>r ``, `` <F1><F1> ``, `` <F1><C-h> `` |
| `dashboard` | Open the system-stats Dashboard (Preferences) | **spacemacs, hybrid** — normal: `` <space>bh ``, select: `` <space>bh `` |
| `search_in_files` | Open the project-wide Find in Files panel |  |
| `terminal` | Open an integrated terminal (PTY shell) | **spacemacs, hybrid** — normal: `` <space>p' ``, select: `` <space>p' `` |
...
| `gud_up` | Select the stack frame one level up (emacs gud-up) | **spacemacs** — normal: `` <C-c><lt> ``, `` <C-x><C-a><lt> ``, select: `` <C-c><lt> ``, `` <C-x><C-a><lt> ``, insert: `` <C-c><lt> ``, `` <C-x><C-a><lt> ``<br>**hybrid** — normal: `` <C-c><lt> ``, `` <C-x><C-a><lt> ``, select: `` <C-c><lt> ``, `` <C-x><C-a><lt> `` |
| `gud_down` | Select the stack frame one level down (emacs gud-down) | **spacemacs** — normal: `` <C-c><gt> ``, `` <C-x><C-a><gt> ``, select: `` <C-c><gt> ``, `` <C-x><C-a><gt> ``, insert: `` <C-c><gt> ``, `` <C-x><C-a><gt> ``<br>**hybrid** — normal: `` <C-c><gt> ``, `` <C-x><C-a><gt> ``, select: `` <C-c><gt> ``, `` <C-x><C-a><gt> `` |
| `gud_stepi` | Step one machine instruction (emacs gud-stepi) | **spacemacs** — normal: `` <C-c><C-i> ``, `` <C-x><C-a><C-i> ``, select: `` <C-c><C-i> ``, `` <C-x><C-a><C-i> ``, insert: `` <C-c><C-i> ``, `` <C-x><C-a><C-i> ``<br>**hybrid** — normal: `` <C-c><C-i> ``, `` <C-x><C-a><C-i> ``, select: `` <C-c><C-i> ``, `` <C-x><C-a><C-i> `` |
| `gud_tbreak` | Set a temporary breakpoint at the current line (emacs gud-tbreak) | **spacemacs** — normal: `` <C-x><C-a><C-t> ``, select: `` <C-x><C-a><C-t> ``, insert: `` <C-x><C-a><C-t> ``<br>**hybrid** — normal: `` <C-x><C-a><C-t> ``, select: `` <C-x><C-a><C-t> `` |
| `gud_print` | Print the expression at point in the debugger (emacs gud-print) | **spacemacs** — normal: `` <C-c><C-p> ``, `` <C-x><C-a><C-p> ``, select: `` <C-c><C-p> ``, `` <C-x><C-a><C-p> ``, insert: `` <C-c><C-p> ``, `` <C-x><C-a><C-p> ``<br>**hybrid** — normal: `` <C-c><C-p> ``, `` <C-x><C-a><C-p> ``, select: `` <C-c><C-p> ``, `` <C-x><C-a><C-p> `` |
| `gud_watch` | Watch the expression at point in the debugger (emacs gud-watch) | **spacemacs** — normal: `` <C-x><C-a><C-w> ``, select: `` <C-x><C-a><C-w> ``, insert: `` <C-x><C-a><C-w> ``<br>**hybrid** — normal: `` <C-x><C-a><C-w> ``, select: `` <C-x><C-a><C-w> `` |
| `gud_jump` | Set the debugger execution point to the current line (emacs gud-jump) | **spacemacs** — normal: `` <C-x><C-a><C-j> ``, select: `` <C-x><C-a><C-j> ``, insert: `` <C-x><C-a><C-j> ``<br>**hybrid** — normal: `` <C-x><C-a><C-j> ``, select: `` <C-x><C-a><C-j> `` |
| `gud_refresh` | Redisplay the debugger buffer (emacs gud-refresh) | **spacemacs** — normal: `` <C-c><C-l> ``, `` <C-x><C-a><C-l> ``, select: `` <C-c><C-l> ``, `` <C-x><C-a><C-l> ``, insert: `` <C-c><C-l> ``, `` <C-x><C-a><C-l> ``<br>**hybrid** — normal: `` <C-c><C-l> ``, `` <C-x><C-a><C-l> ``, select: `` <C-c><C-l> ``, `` <C-x><C-a><C-l> `` |
...
| `word_next_other_humps` | Next word start with the camel-hump setting inverted for this motion (JetBrains Move Caret to Next Word in Different CamelHumps Mode) | **spacemacs, hybrid** — normal: `` <space>xww ``, select: `` <space>xww `` |
...
| `goto_link_target` | Open what the file in this buffer links to (JetBrains Go to Link Target) | **spacemacs, hybrid** — normal: `` <space>jL ``, select: `` <space>jL `` |
| `surround_with` | Wrap the selected lines in one of the language's block constructs (JetBrains Surround With) | **spacemacs, hybrid** — normal: `` <space>xS ``, select: `` <space>xS `` |
...
| `focus_jumplist_panel` | Focus the Jumplist tool window | **spacemacs, hybrid** — normal: `` <space>Wj ``, select: `` <space>Wj `` |
| `focus_recent_panel` | Focus the Recent Files tool window | **spacemacs, hybrid** — normal: `` <space>Wu ``, select: `` <space>Wu `` |
| `focus_todo_panel` | Focus the TODO tool window | **spacemacs, hybrid** — normal: `` <space>Wd ``, select: `` <space>Wd `` |
| `focus_problems` | Focus the problems/diagnostics panel | **spacemacs, hybrid** — normal: `` <space>We ``, select: `` <space>We `` |
| `focus_run_console` | Focus the Run console (scroll output with j/k/PgUp/PgDn) | **spacemacs, hybrid** — normal: `` <space>Wr ``, select: `` <space>Wr `` |
| `focus_git_panel` | Focus the Git changes panel (j/k select, Enter opens) | **spacemacs, hybrid** — normal: `` <space>Wg ``, `` <space>gG ``, select: `` <space>Wg ``, `` <space>gG `` |
| `focus_ci_panel` | Focus the CI status panel (GitHub Actions runs; Enter opens in browser) | **spacemacs, hybrid** — normal: `` <space>Wc ``, select: `` <space>Wc `` |
| `toggle_bottom_zoom` | Maximize / restore the bottom panel | **spacemacs, hybrid** — normal: `` <space>Wm ``, select: `` <space>Wm `` |
| `toggle_drawer_mid` | Fold / unfold the middle column of the bottom drawer | **spacemacs, hybrid** — normal: `` <space>Wf ``, select: `` <space>Wf `` |
| `toggle_ide` | Toggle the IDE workbench (Zen / focus mode) | **spacemacs, hybrid** — normal: `` <space>Wz ``, `` <space>zz ``, select: `` <space>Wz ``, `` <space>zz `` |
| `settings_page` | Open the settings page (config.toml editor) | **spacemacs, hybrid** — normal: `` <space>S ``, select: `` <space>S `` |
| `goto_next_spell_error` | Move to the next misspelled word (]s) | **spacemacs, hybrid, vim** — normal: `` ]s `` |
| `goto_prev_spell_error` | Move to the previous misspelled word ([s) | **spacemacs, hybrid, vim** — normal: `` [s `` |
| `spell_add_good` | Mark word under cursor as correctly spelled (zg) | **spacemacs, hybrid, vim** — normal: `` zg `` |
| `spell_add_bad` | Mark word under cursor as misspelled (zw) | **spacemacs, hybrid, vim** — normal: `` zw `` |
| `spell_undo` | Undo a zg/zw for the word under cursor (zug) | **spacemacs, hybrid, vim** — normal: `` zug ``, `` zuw `` |
| `spell_add_good_internal` | Mark word under cursor good for this session only (zG) | **spacemacs, hybrid, vim** — normal: `` zG `` |
| `spell_add_bad_internal` | Mark word under cursor misspelled for this session only (zW) | **spacemacs, hybrid, vim** — normal: `` zW `` |
| `spell_undo_internal` | Undo a zG/zW for the word under cursor (zuG) | **spacemacs, hybrid, vim** — normal: `` zuG ``, `` zuW `` |
| `spell_suggest` | Show spelling suggestions for the word under cursor (z=) | **spacemacs, hybrid, vim** — normal: `` z= `` |
| `ispell_word` | Spell-check the word at point with aspell/hunspell (emacs ispell-word, M-$) | **spacemacs, hybrid** — normal: `` <A-$> `` |
...
| `flyspell_buffer` | Check the whole buffer with the wordlist speller and move to the first misspelling (emacs flyspell-buffer) | **nano** — normal: `` <A-x> ``, insert: `` <A-x> `` |
...
| `flyspell_mode` | Toggle on-the-fly spell checking (emacs flyspell-mode) | **spacemacs, hybrid** — normal: `` <space>tS ``, select: `` <space>tS `` |
| `flyspell_prog_mode` | Toggle on-the-fly spell checking of comments and strings (emacs flyspell-prog-mode) |  |
| `outline_next_visible_heading` | Move to the next outline heading (emacs outline-next-visible-heading) | **spacemacs** — normal: `` <C-c>@<C-n> ``, select: `` <C-c>@<C-n> ``, insert: `` <C-c>@<C-n> ``<br>**hybrid** — normal: `` <C-c>@<C-n> ``, select: `` <C-c>@<C-n> `` |
| `outline_previous_visible_heading` | Move to the previous outline heading (emacs outline-previous-visible-heading) | **spacemacs** — normal: `` <C-c>@<C-p> ``, select: `` <C-c>@<C-p> ``, insert: `` <C-c>@<C-p> ``<br>**hybrid** — normal: `` <C-c>@<C-p> ``, select: `` <C-c>@<C-p> `` |
| `outline_up_heading` | Move to the parent outline heading (emacs outline-up-heading) | **spacemacs** — normal: `` <C-c>@<C-u> ``, select: `` <C-c>@<C-u> ``, insert: `` <C-c>@<C-u> ``<br>**hybrid** — normal: `` <C-c>@<C-u> ``, select: `` <C-c>@<C-u> `` |
| `outline_forward_same_level` | Move to the next same-level heading (emacs outline-forward-same-level) | **spacemacs** — normal: `` <C-c>@<C-f> ``, select: `` <C-c>@<C-f> ``, insert: `` <C-c>@<C-f> ``<br>**hybrid** — normal: `` <C-c>@<C-f> ``, select: `` <C-c>@<C-f> `` |
| `outline_backward_same_level` | Move to the previous same-level heading (emacs outline-backward-same-level) | **spacemacs** — normal: `` <C-c>@<C-b> ``, select: `` <C-c>@<C-b> ``, insert: `` <C-c>@<C-b> ``<br>**hybrid** — normal: `` <C-c>@<C-b> ``, select: `` <C-c>@<C-b> `` |
| `outline_hide_subtree` | Fold the subtree of the heading at point (emacs outline-hide-subtree) | **spacemacs** — normal: `` <C-c>@<C-d> ``, select: `` <C-c>@<C-d> ``, insert: `` <C-c>@<C-d> ``<br>**hybrid** — normal: `` <C-c>@<C-d> ``, select: `` <C-c>@<C-d> `` |
...
| `outline_show_entry` | Reveal this heading's body (emacs outline-show-entry) | **spacemacs** — normal: `` <C-c>@<C-e> ``, select: `` <C-c>@<C-e> ``, insert: `` <C-c>@<C-e> ``<br>**hybrid** — normal: `` <C-c>@<C-e> ``, select: `` <C-c>@<C-e> `` |
| `outline_hide_body` | Fold all bodies, showing only headings (emacs outline-hide-body) | **spacemacs** — normal: `` <C-c>@<C-t> ``, select: `` <C-c>@<C-t> ``, insert: `` <C-c>@<C-t> ``<br>**hybrid** — normal: `` <C-c>@<C-t> ``, select: `` <C-c>@<C-t> `` |
| `outline_show_all` | Reveal all outline body text (emacs outline-show-all) | **spacemacs** — normal: `` <C-c>@<C-a> ``, select: `` <C-c>@<C-a> ``, insert: `` <C-c>@<C-a> ``<br>**hybrid** — normal: `` <C-c>@<C-a> ``, select: `` <C-c>@<C-a> `` |
| `outline_hide_sublevels` | Show only the top N levels of headings (emacs outline-hide-sublevels) | **spacemacs** — normal: `` <C-c>@<C-q> ``, select: `` <C-c>@<C-q> ``, insert: `` <C-c>@<C-q> ``<br>**hybrid** — normal: `` <C-c>@<C-q> ``, select: `` <C-c>@<C-q> `` |
| `outline_hide_leaves` | Fold bodies in the current subtree, keeping subheadings (emacs outline-hide-leaves) |  |
| `outline_show_children` | Reveal the immediate subheadings of the heading at point (emacs outline-show-children) | **spacemacs** — normal: `` <C-c>@<C-i> ``, select: `` <C-c>@<C-i> ``, insert: `` <C-c>@<C-i> ``<br>**hybrid** — normal: `` <C-c>@<C-i> ``, select: `` <C-c>@<C-i> `` |
| `outline_show_branches` | Reveal every subheading in the subtree at point (emacs outline-show-branches) | **spacemacs** — normal: `` <C-c>@<C-k> ``, select: `` <C-c>@<C-k> ``, insert: `` <C-c>@<C-k> ``<br>**hybrid** — normal: `` <C-c>@<C-k> ``, select: `` <C-c>@<C-k> `` |
...
| `fold_toggle` | Toggle fold under cursor (za) | **spacemacs** — normal: `` za ``, `` <C-c>@<C-c> ``, select: `` <C-c>@<C-c> ``, insert: `` <C-c>@<C-c> ``<br>**hybrid** — normal: `` za ``, `` <C-c>@<C-c> ``, select: `` <C-c>@<C-c> ``<br>**vim** — normal: `` za `` |
| `fold_toggle_recursive` | Toggle the fold under the cursor and every fold nested in it (zA) | **spacemacs, hybrid, vim** — normal: `` zA `` |
| `fold_open` | Open fold under cursor (zo) | **spacemacs** — normal: `` zo ``, `` <C-c>@<C-r> ``, `` <C-c>@<C-s> ``, select: `` <C-c>@<C-r> ``, `` <C-c>@<C-s> ``, insert: `` <C-c>@<C-r> ``, `` <C-c>@<C-s> ``<br>**hybrid** — normal: `` zo ``, `` <C-c>@<C-r> ``, `` <C-c>@<C-s> ``, select: `` <C-c>@<C-r> ``, `` <C-c>@<C-s> ``<br>**vim** — normal: `` zo `` |
| `fold_view_cursor` | View cursor line: open just enough folds to unhide it (zv) | **spacemacs, hybrid, vim** — normal: `` zv `` |
| `fold_close` | Close fold under cursor (zc) | **spacemacs** — normal: `` zc ``, `` <C-c>@<C-h> ``, select: `` <C-c>@<C-h> ``, insert: `` <C-c>@<C-h> ``<br>**hybrid** — normal: `` zc ``, `` <C-c>@<C-h> ``, select: `` <C-c>@<C-h> ``<br>**vim** — normal: `` zc `` |
| `fold_open_recursive` | Open fold under cursor and all nested folds (IntelliJ Expand Recursively) | **spacemacs, hybrid, vim** — normal: `` zO `` |
| `fold_close_recursive` | Close fold under cursor and all nested folds (IntelliJ Collapse Recursively) | **spacemacs, hybrid, vim** — normal: `` zC `` |
| `fold_open_all` | Open all folds (zR) | **spacemacs** — normal: `` zR ``, `` <C-c>@<A-C-s> ``, select: `` <C-c>@<A-C-s> ``, insert: `` <C-c>@<A-C-s> ``<br>**hybrid** — normal: `` zR ``, `` <C-c>@<A-C-s> ``, select: `` <C-c>@<A-C-s> ``<br>**vim** — normal: `` zR `` |
| `fold_close_all` | Close all folds (zM) | **spacemacs** — normal: `` zM ``, `` <C-c>@<A-C-h> ``, select: `` <C-c>@<A-C-h> ``, insert: `` <C-c>@<A-C-h> ``<br>**hybrid** — normal: `` zM ``, `` <C-c>@<A-C-h> ``, select: `` <C-c>@<A-C-h> ``<br>**vim** — normal: `` zM `` |
| `fold_reapply_level` | Undo hand-opened and hand-closed folds: re-apply foldlevel (zX) | **spacemacs, hybrid, vim** — normal: `` zX `` |
| `fold_enable_toggle` | Toggle 'foldenable': open or close every fold at once (vim zi) | **spacemacs, hybrid, vim** — normal: `` zi `` |
| `fold_enable_off` | Reset 'foldenable': all folds open (vim zn) | **spacemacs, hybrid, vim** — normal: `` zn `` |
...
| `render_doc_comments` | Show every doc comment in the buffer as rendered prose (JetBrains Render All Doc Comments) | **spacemacs, hybrid** — normal: `` <space>xV ``, select: `` <space>xV `` |
...
| `narrow_to_region` | Narrow the buffer to the selected region (SPC n r) | **spacemacs** — normal: `` <C-x>nn ``, `` <space>nr ``, select: `` <C-x>nn ``, `` <space>nr ``, insert: `` <C-x>nn ``<br>**hybrid** — normal: `` <C-x>nn ``, `` <space>nr ``, select: `` <C-x>nn ``, `` <space>nr `` |
| `widen` | Widen: remove narrowing and reveal the whole buffer (SPC n w) | **spacemacs** — normal: `` <C-x>nw ``, `` <space>nw ``, select: `` <C-x>nw ``, `` <space>nw ``, insert: `` <C-x>nw ``<br>**hybrid** — normal: `` <C-x>nw ``, `` <space>nw ``, select: `` <C-x>nw ``, `` <space>nw `` |
| `narrow_to_function_indirect` | Narrow to the function in an indirect (split) view (SPC n F) | **spacemacs, hybrid** — normal: `` <space>nF ``, select: `` <space>nF `` |
| `narrow_region_indirect` | Narrow to the selected region in an indirect (split) view (SPC n R) | **spacemacs, hybrid** — normal: `` <space>nR ``, select: `` <space>nR `` |
| `layout_add_buffers` | Add another layout's buffers into the current windows (SPC l A) | **spacemacs, hybrid** — normal: `` <space>lA ``, select: `` <space>lA `` |
| `winner_undo` | Undo the last window-layout change (winner-undo, SPC w u) | **spacemacs, hybrid** — normal: `` <C-w>u ``, `` <C-w>.u ``, `` <C-w>[u ``, `` <C-w>{u ``, `` <space>wu ``, `` <space>w.u ``, `` <space>w[u ``, `` <space>w{u ``, select: `` <space>wu ``, `` <space>w.u ``, `` <space>w[u ``, `` <space>w{u ``<br>**vim** — normal: `` <C-w>u ``, `` <C-w>.u ``, `` <C-w>[u ``, `` <C-w>{u `` |
| `winner_redo` | Redo a window-layout change (winner-redo, SPC w . U) | **spacemacs, hybrid** — normal: `` <C-w>.U ``, `` <C-w>[U ``, `` <C-w>{U ``, `` <space>w.U ``, `` <space>w[U ``, `` <space>w{U ``, select: `` <space>w.U ``, `` <space>w[U ``, `` <space>w{U ``<br>**vim** — normal: `` <C-w>.U ``, `` <C-w>[U ``, `` <C-w>{U `` |
| `exit_transient_state` | Leave the current transient state (q) | **spacemacs, hybrid** — normal: `` <C-w>.q ``, `` <C-w>[q ``, `` <C-w>{q ``, `` <space>b.q ``, `` <space>enq ``, `` <space>epq ``, `` <space>lwq ``, `` <space>n+q ``, `` <space>n=q ``, `` <space>n_q ``, `` <space>w.q ``, `` <space>w[q ``, `` <space>w{q ``, `` <space>x.q ``, `` <space>zfq ``, `` <space>zxq ``, `` <space>l<ret> ``, `` <space>n<minus>q ``, select: `` <space>b.q ``, `` <space>enq ``, `` <space>epq ``, `` <space>lwq ``, `` <space>n+q ``, `` <space>n=q ``, `` <space>n_q ``, `` <space>w.q ``, `` <space>w[q ``, `` <space>w{q ``, `` <space>x.q ``, `` <space>zfq ``, `` <space>zxq ``, `` <space>l<ret> ``, `` <space>n<minus>q ``<br>**vim** — normal: `` <C-w>.q ``, `` <C-w>[q ``, `` <C-w>{q `` |
| `text_scale_increase` | Increase the text scale one step (SPC z x +) | **spacemacs** — normal: `` <C-x><C-+> ``, `` <C-x><C-=> ``, `` <space>zx+ ``, `` <space>zx= ``, `` <space>zxk ``, `` <C-x><A-C-+> ``, `` <C-x><A-C-=> ``, select: `` <C-x><C-+> ``, `` <C-x><C-=> ``, `` <space>zx+ ``, `` <space>zx= ``, `` <space>zxk ``, `` <C-x><A-C-+> ``, `` <C-x><A-C-=> ``, insert: `` <C-x><C-+> ``, `` <C-x><C-=> ``, `` <C-x><A-C-+> ``, `` <C-x><A-C-=> ``<br>**hybrid** — normal: `` <C-x><C-+> ``, `` <C-x><C-=> ``, `` <space>zx+ ``, `` <space>zx= ``, `` <space>zxk ``, `` <C-x><A-C-+> ``, `` <C-x><A-C-=> ``, select: `` <C-x><C-+> ``, `` <C-x><C-=> ``, `` <space>zx+ ``, `` <space>zx= ``, `` <space>zxk ``, `` <C-x><A-C-+> ``, `` <C-x><A-C-=> `` |
| `text_scale_decrease` | Decrease the text scale one step (SPC z x -) | **spacemacs** — normal: `` <space>zx_ ``, `` <space>zxj ``, `` <C-x><C-minus> ``, `` <C-x><A-C-minus> ``, `` <space>zx<minus> ``, select: `` <space>zx_ ``, `` <space>zxj ``, `` <C-x><C-minus> ``, `` <C-x><A-C-minus> ``, `` <space>zx<minus> ``, insert: `` <C-x><C-minus> ``, `` <C-x><A-C-minus> ``<br>**hybrid** — normal: `` <space>zx_ ``, `` <space>zxj ``, `` <C-x><C-minus> ``, `` <C-x><A-C-minus> ``, `` <space>zx<minus> ``, select: `` <space>zx_ ``, `` <space>zxj ``, `` <C-x><C-minus> ``, `` <C-x><A-C-minus> ``, `` <space>zx<minus> `` |
| `text_scale_reset` | Reset the text scale to the default size (SPC z x 0) | **spacemacs** — normal: `` <C-x><C-0> ``, `` <space>zx0 ``, `` <C-x><A-C-0> ``, select: `` <C-x><C-0> ``, `` <space>zx0 ``, `` <C-x><A-C-0> ``, insert: `` <C-x><C-0> ``, `` <C-x><A-C-0> ``<br>**hybrid** — normal: `` <C-x><C-0> ``, `` <space>zx0 ``, `` <C-x><A-C-0> ``, select: `` <C-x><C-0> ``, `` <space>zx0 ``, `` <C-x><A-C-0> `` |
| `frame_zoom_in` | Zoom the frame in one step (SPC z f +) | **spacemacs, hybrid** — normal: `` <space>zf+ ``, `` <space>zf= ``, `` <space>zfk ``, select: `` <space>zf+ ``, `` <space>zf= ``, `` <space>zfk `` |
| `frame_zoom_out` | Zoom the frame out one step (SPC z f -) | **spacemacs, hybrid** — normal: `` <space>zf_ ``, `` <space>zfj ``, `` <space>zf<minus> ``, select: `` <space>zf_ ``, `` <space>zfj ``, `` <space>zf<minus> `` |
| `frame_zoom_reset` | Reset the frame zoom to the default size (SPC z f 0) | **spacemacs, hybrid** — normal: `` <space>zf0 ``, select: `` <space>zf0 `` |
| `copy_version` | Display and copy the zmax version to the clipboard (SPC f e v) | **spacemacs, hybrid** — normal: `` <space>fev ``, select: `` <space>fev `` |
| `narrow_to_page_indirect` | Narrow to the page in an indirect (split) view (SPC n P) | **spacemacs, hybrid** — normal: `` <space>nP ``, select: `` <space>nP `` |
| `kmacro_ring_next` | Cycle to the next macro in the ring (SPC K r n) | **spacemacs** — normal: `` <space>Krn ``, `` <C-x><C-k><C-n> ``, select: `` <space>Krn ``, `` <C-x><C-k><C-n> ``, insert: `` <C-x><C-k><C-n> ``<br>**hybrid** — normal: `` <space>Krn ``, `` <C-x><C-k><C-n> ``, select: `` <space>Krn ``, `` <C-x><C-k><C-n> `` |
| `kmacro_ring_prev` | Cycle to the previous macro in the ring (SPC K r p) | **spacemacs** — normal: `` <space>KrN ``, `` <space>Krp ``, `` <C-x><C-k><C-p> ``, select: `` <space>KrN ``, `` <space>Krp ``, `` <C-x><C-k><C-p> ``, insert: `` <C-x><C-k><C-p> ``<br>**hybrid** — normal: `` <space>KrN ``, `` <space>Krp ``, `` <C-x><C-k><C-p> ``, select: `` <space>KrN ``, `` <space>Krp ``, `` <C-x><C-k><C-p> `` |
| `kmacro_ring_delete` | Delete the head macro in the ring (SPC K r d) | **spacemacs** — normal: `` <space>Krd ``, `` <C-x><C-k>d ``, select: `` <space>Krd ``, `` <C-x><C-k>d ``, insert: `` <C-x><C-k>d ``<br>**hybrid** — normal: `` <space>Krd ``, `` <C-x><C-k>d ``, select: `` <space>Krd ``, `` <C-x><C-k>d `` |
| `kmacro_ring_swap` | Swap the first two macros in the ring (SPC K r s) | **spacemacs** — normal: `` <space>Krs ``, `` <C-x><C-k><C-t> ``, select: `` <space>Krs ``, `` <C-x><C-k><C-t> ``, insert: `` <C-x><C-k><C-t> ``<br>**hybrid** — normal: `` <space>Krs ``, `` <C-x><C-k><C-t> ``, select: `` <space>Krs ``, `` <C-x><C-k><C-t> `` |
| `kmacro_ring_view` | View the head macro in the ring (SPC K r L) | **spacemacs, hybrid** — normal: `` <space>Kv ``, `` <space>KrL ``, select: `` <space>Kv ``, `` <space>KrL `` |
| `kmacro_call_ring_2nd` | Run the second macro in the ring without rotating it (emacs kmacro-call-ring-2nd, SPC K r l) | **spacemacs, hybrid** — normal: `` <space>Krl ``, select: `` <space>Krl `` |
| `kmacro_to_register` | Write the last macro to a register (SPC K e r) | **spacemacs** — normal: `` <space>Ken ``, `` <space>Ker ``, `` <C-x><C-k>x ``, select: `` <space>Ken ``, `` <space>Ker ``, `` <C-x><C-k>x ``, insert: `` <C-x><C-k>x ``<br>**hybrid** — normal: `` <space>Ken ``, `` <space>Ker ``, `` <C-x><C-k>x ``, select: `` <space>Ken ``, `` <space>Ker ``, `` <C-x><C-k>x `` |
| `kmacro_add_counter` | Add [count] to the keyboard-macro counter (SPC K c a) | **spacemacs** — normal: `` <space>Kca ``, `` <C-x><C-k><C-a> ``, select: `` <space>Kca ``, `` <C-x><C-k><C-a> ``, insert: `` <C-x><C-k><C-a> ``<br>**hybrid** — normal: `` <space>Kca ``, `` <C-x><C-k><C-a> ``, select: `` <space>Kca ``, `` <C-x><C-k><C-a> `` |
| `kmacro_insert_counter` | Insert the macro counter value, then increment (SPC K c c) | **spacemacs** — normal: `` <space>Kcc ``, `` <C-x><C-k><C-i> ``, select: `` <space>Kcc ``, `` <C-x><C-k><C-i> ``, insert: `` <C-x><C-k><C-i> ``<br>**hybrid** — normal: `` <space>Kcc ``, `` <C-x><C-k><C-i> ``, select: `` <space>Kcc ``, `` <C-x><C-k><C-i> `` |
| `kmacro_set_counter` | Set the keyboard-macro counter to [count] (emacs kmacro-set-counter) | **spacemacs** — normal: `` <space>KcC ``, `` <C-x><C-k><C-c> ``, select: `` <space>KcC ``, `` <C-x><C-k><C-c> ``, insert: `` <C-x><C-k><C-c> ``<br>**hybrid** — normal: `` <space>KcC ``, `` <C-x><C-k><C-c> ``, select: `` <space>KcC ``, `` <C-x><C-k><C-c> `` |
| `kmacro_set_format` | Set the macro-counter insert format, e.g. %03d (emacs kmacro-set-format) | **spacemacs** — normal: `` <space>Kcf ``, `` <C-x><C-k><C-f> ``, select: `` <space>Kcf ``, `` <C-x><C-k><C-f> ``, insert: `` <C-x><C-k><C-f> ``<br>**hybrid** — normal: `` <space>Kcf ``, `` <C-x><C-k><C-f> ``, select: `` <space>Kcf ``, `` <C-x><C-k><C-f> `` |
| `kmacro_name_last_macro` | Name the last kbd macro and register it as an invokable command (emacs kmacro-name-last-macro) | **spacemacs** — normal: `` <C-x><C-k>n ``, select: `` <C-x><C-k>n ``, insert: `` <C-x><C-k>n ``<br>**hybrid** — normal: `` <C-x><C-k>n ``, select: `` <C-x><C-k>n `` |
| `insert_kbd_macro` | Insert a textual definition of the last kbd macro (emacs insert-kbd-macro) |  |
| `apply_macro_to_region_lines` | Run the last kbd macro at the start of each line in the region (emacs apply-macro-to-region-lines) | **spacemacs** — normal: `` <C-x><C-k>r ``, select: `` <C-x><C-k>r ``, insert: `` <C-x><C-k>r ``<br>**hybrid** — normal: `` <C-x><C-k>r ``, select: `` <C-x><C-k>r `` |
| `kmacro_end_or_call_macro` | End recording, or call the last kbd macro (emacs kmacro-end-or-call-macro, F4) | **spacemacs** — normal: `` <F4> ``, `` <C-x>e ``, `` <space>KK ``, select: `` <C-x>e ``, `` <space>KK ``, insert: `` <C-x>e ``<br>**hybrid** — normal: `` <F4> ``, `` <C-x>e ``, `` <space>KK ``, select: `` <C-x>e ``, `` <space>KK ``<br>**vim** — normal: `` <F4> `` |
| `kmacro_end_or_call_macro_repeat` | Repeat-variant of end-or-call macro (emacs kmacro-end-or-call-macro-repeat) | **spacemacs** — normal: `` <C-x><C-k><C-k> ``, select: `` <C-x><C-k><C-k> ``, insert: `` <C-x><C-k><C-k> ``<br>**hybrid** — normal: `` <C-x><C-k><C-k> ``, select: `` <C-x><C-k><C-k> `` |
| `kmacro_edit_macro` | Edit the last kbd macro's keys as text (emacs edit-kbd-macro / kmacro-edit-macro) | **spacemacs** — normal: `` <space>Kee ``, `` <C-x><C-k><C-e> ``, `` <C-x><C-k><ret> ``, select: `` <space>Kee ``, `` <C-x><C-k><C-e> ``, `` <C-x><C-k><ret> ``, insert: `` <C-x><C-k><C-e> ``, `` <C-x><C-k><ret> ``<br>**hybrid** — normal: `` <space>Kee ``, `` <C-x><C-k><C-e> ``, `` <C-x><C-k><ret> ``, select: `` <space>Kee ``, `` <C-x><C-k><C-e> ``, `` <C-x><C-k><ret> `` |
| `edit_kbd_macro` | Ask which keyboard macro to edit, then edit its keys (emacs edit-kbd-macro, C-x C-k e) | **spacemacs** — normal: `` <C-x><C-k>e ``, select: `` <C-x><C-k>e ``, insert: `` <C-x><C-k>e ``<br>**hybrid** — normal: `` <C-x><C-k>e ``, select: `` <C-x><C-k>e `` |
...
| `kmacro_step_edit_macro` | Step through the last kbd macro key by key, editing as you go (emacs kmacro-step-edit-macro) | **spacemacs** — normal: `` <space>Kes ``, `` <C-x><C-k><space> ``, select: `` <space>Kes ``, `` <C-x><C-k><space> ``, insert: `` <C-x><C-k><space> ``<br>**hybrid** — normal: `` <space>Kes ``, `` <C-x><C-k><space> ``, select: `` <space>Kes ``, `` <C-x><C-k><space> `` |
| `kmacro_edit_lossage` | Edit the recently pressed keys as a macro (emacs kmacro-edit-lossage) | **spacemacs** — normal: `` <space>Kel ``, `` <C-x><C-k>l ``, select: `` <space>Kel ``, `` <C-x><C-k>l ``, insert: `` <C-x><C-k>l ``<br>**hybrid** — normal: `` <space>Kel ``, `` <C-x><C-k>l ``, select: `` <space>Kel ``, `` <C-x><C-k>l `` |
| `kmacro_bind_to_key` | Report the config binding for the last kbd macro (emacs kmacro-bind-to-key) | **spacemacs** — normal: `` <space>Keb ``, `` <C-x><C-k>b ``, select: `` <space>Keb ``, `` <C-x><C-k>b ``, insert: `` <C-x><C-k>b ``<br>**hybrid** — normal: `` <space>Keb ``, `` <C-x><C-k>b ``, select: `` <space>Keb ``, `` <C-x><C-k>b `` |
| `kmacro_redisplay` | Force a redisplay while a kbd macro runs (emacs kmacro-redisplay, C-x C-k d) |  |
| `toggle_readonly` | Toggle the buffer's read-only (writable) state (SPC b w) | **spacemacs** — normal: `` <space>bw ``, `` <C-x><C-q> ``, select: `` <space>bw ``, `` <C-x><C-q> ``, insert: `` <C-x><C-q> ``<br>**hybrid** — normal: `` <space>bw ``, `` <C-x><C-q> ``, select: `` <space>bw ``, `` <C-x><C-q> `` |
| `toggle_window_dedication` | Toggle window dedication (spacemacs SPC w t) | **spacemacs** — normal: `` <C-w>t ``, `` <C-x>wd ``, `` <space>wt ``, select: `` <C-x>wd ``, `` <space>wt ``, insert: `` <C-x>wd ``<br>**hybrid** — normal: `` <C-w>t ``, `` <C-x>wd ``, `` <space>wt ``, select: `` <C-x>wd ``, `` <space>wt ``<br>**vim** — normal: `` <C-w>t `` |
| `toggle_subword` | Toggle sub-word w/b/e motions (spacemacs SPC t c) | **spacemacs, hybrid** — normal: `` <space>tc ``, select: `` <space>tc `` |
| `toggle_superword` | Toggle super-word w/b/e motions: symbols join words (emacs superword-mode, SPC t C) | **spacemacs, hybrid** — normal: `` <space>tC ``, select: `` <space>tC `` |
| `toggle_auto_fill` | Toggle auto-fill: wrap at text-width while typing (spacemacs SPC t F) | **spacemacs, hybrid** — normal: `` <space>tF ``, select: `` <space>tF `` |
| `toggle_follow_mode` | Toggle follow mode: windows on the same doc scroll together (spacemacs SPC w f) | **spacemacs, hybrid** — normal: `` <C-w>f ``, `` <space>wf ``, select: `` <space>wf ``<br>**vim** — normal: `` <C-w>f `` |
| `subword_w` | Next word start, sub-word aware (w) | **spacemacs, vim** — normal: `` w ``, `` <C-right> ``, insert: `` <C-right> ``, `` <S-right> ``<br>**hybrid** — normal: `` w ``, `` <C-right> `` |
| `subword_b` | Previous word start, sub-word aware (b) | **spacemacs, hybrid, vim** — normal: `` b `` |
| `subword_e` | Next word end, sub-word aware (e) | **spacemacs, hybrid, vim** — normal: `` e `` |
...
| `paredit_slurp_forward` | Paredit: slurp the next s-expression forward (SPC k s) | **spacemacs, hybrid** — normal: `` <space>ks ``, `` <space>k`s ``, select: `` <space>ks ``, `` <space>k`s `` |
| `paredit_barf_forward` | Paredit: barf the last s-expression forward (SPC k b) | **spacemacs, hybrid** — normal: `` <space>kb ``, select: `` <space>kb `` |
| `paredit_slurp_backward` | Paredit: slurp the previous s-expression backward (SPC k S) | **spacemacs, hybrid** — normal: `` <space>kS ``, select: `` <space>kS `` |
| `paredit_barf_backward` | Paredit: barf the first s-expression backward (SPC k B) | **spacemacs, hybrid** — normal: `` <space>kB ``, select: `` <space>kB `` |
| `paredit_splice` | Paredit: splice/unwrap the enclosing s-expression (SPC k W) | **spacemacs, hybrid** — normal: `` <space>kW ``, select: `` <space>kW `` |
| `paredit_raise` | Paredit: raise the current s-expression (SPC k r) | **spacemacs, hybrid** — normal: `` <space>kr ``, select: `` <space>kr `` |
| `paredit_transpose` | Paredit: transpose the s-expressions around point (SPC k t) | **spacemacs, hybrid** — normal: `` <space>kt ``, `` <space>k`p ``, `` <space>k`t ``, select: `` <space>kt ``, `` <space>k`p ``, `` <space>k`t `` |
| `paredit_split` | Paredit: split the enclosing list at point (SPC j s) | **spacemacs, hybrid** — normal: `` <space>jS ``, `` <space>js ``, select: `` <space>jS ``, `` <space>js `` |
| `paredit_absorb` | Paredit: absorb the previous sexp into the current form (SPC k a) | **spacemacs, hybrid** — normal: `` <space>ka ``, select: `` <space>ka `` |
| `paredit_convolute` | Paredit: convolute — swap enclosing/inner prefixes (SPC k c) | **spacemacs, hybrid** — normal: `` <space>kc ``, select: `` <space>kc `` |
| `buffer_swap_window_1` | Swap current buffer with window 1 (SPC b . M-1) | **spacemacs, hybrid** — normal: `` <space>b.<A-1> ``, select: `` <space>b.<A-1> `` |
| `buffer_swap_window_2` | Swap current buffer with window 2 (SPC b . M-2) | **spacemacs, hybrid** — normal: `` <space>b.<A-2> ``, select: `` <space>b.<A-2> `` |
| `buffer_swap_window_3` | Swap current buffer with window 3 (SPC b . M-3) | **spacemacs, hybrid** — normal: `` <space>b.<A-3> ``, select: `` <space>b.<A-3> `` |
| `buffer_swap_window_4` | Swap current buffer with window 4 (SPC b . M-4) | **spacemacs, hybrid** — normal: `` <space>b.<A-4> ``, select: `` <space>b.<A-4> `` |
| `buffer_swap_window_5` | Swap current buffer with window 5 (SPC b . M-5) | **spacemacs, hybrid** — normal: `` <space>b.<A-5> ``, select: `` <space>b.<A-5> `` |
| `buffer_swap_window_6` | Swap current buffer with window 6 (SPC b . M-6) | **spacemacs, hybrid** — normal: `` <space>b.<A-6> ``, select: `` <space>b.<A-6> `` |
| `buffer_swap_window_7` | Swap current buffer with window 7 (SPC b . M-7) | **spacemacs, hybrid** — normal: `` <space>b.<A-7> ``, select: `` <space>b.<A-7> `` |
| `buffer_swap_window_8` | Swap current buffer with window 8 (SPC b . M-8) | **spacemacs, hybrid** — normal: `` <space>b.<A-8> ``, select: `` <space>b.<A-8> `` |
| `buffer_swap_window_9` | Swap current buffer with window 9 (SPC b . M-9) | **spacemacs, hybrid** — normal: `` <space>b.<A-9> ``, select: `` <space>b.<A-9> `` |
| `paredit_splice_kill_forward` | Paredit: splice, killing forward (SPC k e) | **spacemacs, hybrid** — normal: `` <space>ke ``, select: `` <space>ke `` |
| `paredit_splice_kill_backward` | Paredit: splice, killing backward (SPC k E) | **spacemacs, hybrid** — normal: `` <space>kE ``, select: `` <space>kE `` |
| `paredit_insert_sexp_after` | Paredit: insert a new () sexp after the current one (SPC k )) | **spacemacs, hybrid** — normal: `` <space>k) ``, select: `` <space>k) `` |
| `paredit_insert_sexp_before` | Paredit: insert a new () sexp before the current one (SPC k () | **spacemacs, hybrid** — normal: `` <space>k( ``, select: `` <space>k( `` |
| `fold_next` | Move to next fold (zj) | **spacemacs, hybrid, vim** — normal: `` ]z ``, `` zj `` |
| `fold_prev` | Move to previous fold (zk) | **spacemacs, hybrid, vim** — normal: `` [z ``, `` zk `` |
| `goto_line_last_nonblank` | Goto last non-blank on line (g_) | **spacemacs, hybrid, vim** — normal: `` g_ `` |
...
| `goto_prev_mark` | Goto previous lowercase mark ([\`) | **spacemacs, hybrid, vim** — normal: `` [` `` |
| `goto_next_mark` | Goto next lowercase mark (]\`) | **spacemacs, hybrid, vim** — normal: `` ]` `` |
| `goto_prev_mark_line` | Goto previous lowercase mark, line start ([']) | **spacemacs, hybrid, vim** — normal: `` [' `` |
| `goto_next_mark_line` | Goto next lowercase mark, line start (]') | **spacemacs, hybrid, vim** — normal: `` ]' `` |
| `yank_file_path` | Yank current file path to clipboard | **spacemacs, hybrid** — normal: `` <space>fyC ``, `` <space>fyY ``, `` <space>fyy ``, select: `` <space>fyC ``, `` <space>fyY ``, `` <space>fyy `` |
...
| `open_url_under_cursor` | Open the URL under the cursor in the browser | **spacemacs** — normal: `` <C-c><ret> ``, select: `` <C-c><ret> ``, insert: `` <C-c><ret> ``<br>**hybrid** — normal: `` <C-c><ret> ``, select: `` <C-c><ret> `` |
| `open_all_buffer_links` | Open every URL in the current buffer in the browser (link-hint-open-all-links, SPC x A) | **spacemacs, hybrid** — normal: `` <space>xA ``, select: `` <space>xA `` |
| `copy_all_buffer_links` | Copy every URL in the current buffer to the clipboard (link-hint-copy-all-links, SPC x Y) | **spacemacs, hybrid** — normal: `` <space>xY ``, select: `` <space>xY `` |
| `link_hint_open_link` | Pick a URL from the current buffer and open it in the browser (link-hint-open-link, SPC x O) | **spacemacs, hybrid** — normal: `` <space>xO ``, select: `` <space>xO `` |
| `helm_google_suggest` | Google suggestions, opening the results in the browser (helm-google-suggest, SPC s w g) | **spacemacs, hybrid** — normal: `` <space>swg ``, select: `` <space>swg `` |
| `link_hint_copy_link` | Pick a URL from the current buffer and copy it to the clipboard (link-hint-copy-link, SPC x y) | **spacemacs, hybrid** — normal: `` <space>xy ``, select: `` <space>xy `` |
| `profiler_start` | Start (and reset) the command profiler (SPC h P s) | **spacemacs, hybrid** — normal: `` <space>hPs ``, select: `` <space>hPs `` |
| `profiler_stop` | Stop the command profiler, keeping its samples (SPC h P k) | **spacemacs, hybrid** — normal: `` <space>hPk ``, select: `` <space>hPk `` |
| `profiler_report` | Show the command profiler report, slowest first (SPC h P r) | **spacemacs, hybrid** — normal: `` <space>hPr ``, select: `` <space>hPr `` |
...
| `count_selection` | Count chars/words/lines in selection | **spacemacs, hybrid** — normal: `` <A-=> ``, `` <space>xc ``, select: `` <space>xc `` |
| `match_brackets` | Goto matching bracket | **spacemacs, hybrid** — normal: `` <space>k% ``, select: `` <space>k% ``<br>**helix** — normal: `` mm ``, select: `` mm ``<br>**kakoune** — normal: `` M ``, `` m ``, select: `` mm ``<br>**nano** — normal: `` <A-]> ``, insert: `` <A-]> `` |
| `match_brackets_extend` | Extend to matching bracket, inclusive (vim d%/c%/y%) |  |
| `match_brackets_or_goto_percent` | Goto matching bracket, or {count} percent through the file | **spacemacs, hybrid, vim** — normal: `` % ``, select: `` % `` |
| `surround_add` | Surround add | **helix** — normal: `` ms ``, select: `` ms ``<br>**kakoune** — select: `` ms `` |
| `surround_replace` | Surround replace | **helix** — normal: `` mr ``, select: `` mr ``<br>**kakoune** — select: `` mr `` |
| `surround_delete` | Surround delete | **helix** — normal: `` md ``, select: `` md ``<br>**kakoune** — select: `` md `` |
| `select_textobject_around` | Select around object | **spacemacs, hybrid, vim** — select: `` a ``<br>**helix** — normal: `` ma ``, select: `` ma ``<br>**kakoune** — normal: `` <A-a> ``, select: `` ma ``, `` <A-a> `` |
| `select_textobject_inner` | Select inside object | **spacemacs, hybrid, vim** — select: `` i ``<br>**helix** — normal: `` mi ``, select: `` mi ``<br>**kakoune** — normal: `` <A-i> ``, select: `` mi ``, `` <A-i> `` |
| `select_to_textobject_around_start` | Select to the whole object's start (kakoune [) | **spacemacs, hybrid, vim** — normal: `` [o `` |
| `select_to_textobject_around_end` | Select to the whole object's end (kakoune ]) | **spacemacs, hybrid, vim** — normal: `` ]o `` |
| `extend_to_textobject_around_start` | Extend to the whole object's start (kakoune {) | **spacemacs, hybrid, vim** — normal: `` [O `` |
| `extend_to_textobject_around_end` | Extend to the whole object's end (kakoune }) | **spacemacs, hybrid, vim** — normal: `` ]O `` |
| `select_to_textobject_inner_start` | Select to the inner object's start (kakoune A-[) | **spacemacs, hybrid, vim** — normal: `` [<A-o> `` |
| `select_to_textobject_inner_end` | Select to the inner object's end (kakoune A-]) | **spacemacs, hybrid, vim** — normal: `` ]<A-o> `` |
| `extend_to_textobject_inner_start` | Extend to the inner object's start (kakoune A-{) | **spacemacs, hybrid, vim** — normal: `` [<A-O> `` |
| `extend_to_textobject_inner_end` | Extend to the inner object's end (kakoune A-}) | **spacemacs, hybrid, vim** — normal: `` ]<A-O> `` |
| `change_textobject_inner` | Change inside object (ci) | **spacemacs, hybrid, vim** — normal: `` ci `` |
| `change_textobject_around` | Change around object (ca) | **spacemacs, hybrid, vim** — normal: `` ca `` |
| `delete_textobject_inner` | Delete inside object (di) | **spacemacs, hybrid, vim** — normal: `` di `` |
| `delete_textobject_around` | Delete around object (da) | **spacemacs, hybrid, vim** — normal: `` da `` |
| `yank_textobject` | Yank the selection and put the cursor at its start (vim visual y) |  |
| `yank_textobject_inner` | Yank inside object (yi) | **spacemacs, hybrid, vim** — normal: `` yi `` |
| `yank_textobject_around` | Yank around object (ya) | **spacemacs, hybrid, vim** — normal: `` ya `` |
...
| `delete_to_mark` | Delete to a mark (vim d\`) | **spacemacs, hybrid, vim** — normal: `` d` `` |
| `delete_to_mark_line` | Delete whole lines to a mark (vim d') | **spacemacs, hybrid, vim** — normal: `` d' `` |
| `change_to_mark` | Change to a mark (vim c\`) | **spacemacs, hybrid, vim** — normal: `` c` `` |
| `change_to_mark_line` | Change whole lines to a mark (vim c') | **spacemacs, hybrid, vim** — normal: `` c' `` |
| `yank_to_mark` | Yank to a mark (vim y\`) | **spacemacs, hybrid, vim** — normal: `` y` `` |
| `yank_to_mark_line` | Yank whole lines to a mark (vim y') | **spacemacs, hybrid, vim** — normal: `` y' `` |
| `reflow_textobject_inner` | Reflow inside object (vim gqi) | **spacemacs, hybrid, vim** — normal: `` gqi `` |
| `reflow_textobject_around` | Reflow around object (vim gqa) | **spacemacs, hybrid, vim** — normal: `` gqa `` |
| `reflow_keep_textobject_inner` | Reflow inside object, keep cursor (vim gwi) | **spacemacs, hybrid, vim** — normal: `` gwi `` |
| `reflow_keep_textobject_around` | Reflow around object, keep cursor (vim gwa) | **spacemacs, hybrid, vim** — normal: `` gwa `` |
| `indent_textobject_inner` | Indent inside object (vim >i) | **spacemacs, hybrid, vim** — normal: `` <gt>i `` |
| `indent_textobject_around` | Indent around object (vim >a) | **spacemacs, hybrid, vim** — normal: `` <gt>a `` |
| `unindent_textobject_inner` | Unindent inside object (vim <i) | **spacemacs, hybrid, vim** — normal: `` <lt>i `` |
| `unindent_textobject_around` | Unindent around object (vim <a) | **spacemacs, hybrid, vim** — normal: `` <lt>a `` |
| `uppercase_textobject_inner` | Uppercase inside object (vim gUi) | **spacemacs, hybrid, vim** — normal: `` gUi `` |
| `uppercase_textobject_around` | Uppercase around object (vim gUa) | **spacemacs, hybrid, vim** — normal: `` gUa `` |
| `lowercase_textobject_inner` | Lowercase inside object (vim gui) | **spacemacs, hybrid, vim** — normal: `` gui `` |
| `lowercase_textobject_around` | Lowercase around object (vim gua) | **spacemacs, hybrid, vim** — normal: `` gua `` |
| `togglecase_textobject_inner` | Toggle case inside object (vim g~i) | **spacemacs, hybrid, vim** — normal: `` g~i `` |
| `togglecase_textobject_around` | Toggle case around object (vim g~a) | **spacemacs, hybrid, vim** — normal: `` g~a `` |
| `delete_find_char_forward` | Delete to next char (df) | **spacemacs, hybrid, vim** — normal: `` df `` |
| `delete_till_char_forward` | Delete till next char (dt) | **spacemacs, hybrid, vim** — normal: `` dt `` |
| `zap_to_char` | Kill through the next char, inclusive (emacs zap-to-char, M-z) | **spacemacs** — normal: `` <A-z> ``<br>**hybrid, emacs, cua, micro, nano** — normal: `` <A-z> ``, insert: `` <A-z> `` |
...
| `xref_find_references` | Find references to a symbol across the workspace (emacs xref-find-references) | **spacemacs, hybrid** — normal: `` <A-?> ``, `` <space>pE ``, select: `` <space>pE `` |
...
| `picture_open_line` | Picture-mode: split the line at point (emacs picture-open-line) | **hybrid, emacs, cua** — insert: `` <C-o> `` |
...
| `twocol_two_columns` | Two-column: create a side-by-side partner buffer (emacs 2C-two-columns) | **spacemacs** — normal: `` <F2>2 ``, `` <C-x>62 ``, select: `` <C-x>62 ``, insert: `` <C-x>62 ``<br>**hybrid** — normal: `` <F2>2 ``, `` <C-x>62 ``, select: `` <C-x>62 `` |
| `twocol_associate_buffer` | Two-column: associate the other window's buffer (emacs 2C-associate-buffer) | **spacemacs** — normal: `` <F2>b ``, `` <C-x>6b ``, select: `` <C-x>6b ``, insert: `` <C-x>6b ``<br>**hybrid** — normal: `` <F2>b ``, `` <C-x>6b ``, select: `` <C-x>6b `` |
| `twocol_split` | Two-column: split the buffer at point into two columns (emacs 2C-split) | **spacemacs** — normal: `` <F2>s ``, `` <C-x>6s ``, select: `` <C-x>6s ``, insert: `` <C-x>6s ``<br>**hybrid** — normal: `` <F2>s ``, `` <C-x>6s ``, select: `` <C-x>6s `` |
| `twocol_merge` | Two-column: merge the partner column back in (emacs 2C-merge) | **spacemacs** — normal: `` <F2>1 ``, `` <C-x>61 ``, select: `` <C-x>61 ``, insert: `` <C-x>61 ``<br>**hybrid** — normal: `` <F2>1 ``, `` <C-x>61 ``, select: `` <C-x>61 `` |
| `twocol_dissociate` | Two-column: break the association (emacs 2C-dissociate) | **spacemacs** — normal: `` <F2>d ``, `` <C-x>6d ``, select: `` <C-x>6d ``, insert: `` <C-x>6d ``<br>**hybrid** — normal: `` <F2>d ``, `` <C-x>6d ``, select: `` <C-x>6d `` |
| `twocol_newline` | Two-column: newline in both columns (emacs 2C-newline) | **spacemacs** — normal: `` <F2><ret> ``, `` <C-x>6<ret> ``, select: `` <C-x>6<ret> ``, insert: `` <C-x>6<ret> ``<br>**hybrid** — normal: `` <F2><ret> ``, `` <C-x>6<ret> ``, select: `` <C-x>6<ret> `` |
...
| `indent_rigidly` | Shift the region by N columns (emacs indent-rigidly) | **spacemacs** — normal: `` <C-x><tab> ``, select: `` <C-x><tab> ``, insert: `` <C-x><tab> ``<br>**hybrid** — normal: `` <C-x><tab> ``, select: `` <C-x><tab> `` |
| `quoted_insert` | Insert the next key literally, control chars included (emacs quoted-insert) | **hybrid, emacs, cua** — insert: `` <C-q> ``<br>**kakoune** — insert: `` <C-v> `` |
| `foldout_zoom_subtree` | Narrow to the outline subtree at point (emacs foldout-zoom-subtree) | **spacemacs** — normal: `` <C-c><C-z> ``, select: `` <C-c><C-z> ``, insert: `` <C-c><C-z> ``<br>**hybrid** — normal: `` <C-c><C-z> ``, select: `` <C-c><C-z> `` |
| `foldout_exit_fold` | Leave the zoomed subtree and widen (emacs foldout-exit-fold) | **spacemacs** — normal: `` <C-c><C-x> ``, select: `` <C-c><C-x> ``, insert: `` <C-c><C-x> ``<br>**hybrid** — normal: `` <C-c><C-x> ``, select: `` <C-c><C-x> `` |
| `ff_find_related_file` | Visit the related header/source file (emacs ff-find-related-file) |  |
| `revert_buffer_quick` | Revert the buffer from its file without confirmation (emacs revert-buffer-quick) | **spacemacs** — normal: `` <C-x>xg ``, select: `` <C-x>xg ``, insert: `` <C-x>xg ``<br>**hybrid** — normal: `` <C-x>xg ``, select: `` <C-x>xg `` |
| `delete_file` | Delete a file from disk (emacs delete-file) |  |
| `quit_window` | Quit this window, burying the buffer (emacs quit-window) |  |
| `switch_to_buffer_other_window` | Show a buffer in another window (emacs switch-to-buffer-other-window) | **spacemacs, hybrid** — normal: `` <C-x>4b ``, select: `` <C-x>4b ``, insert: `` <C-x>4b ``<br>**emacs** — insert: `` <C-x>4b ``<br>**cua** — select: `` <C-X>4b ``, insert: `` <C-x>4b `` |
| `find_file_other_window` | Open a file in another window (emacs find-file-other-window) | **spacemacs, hybrid** — normal: `` <C-x>4f ``, `` <C-x>4<C-f> ``, select: `` <C-x>4f ``, `` <C-x>4<C-f> ``, insert: `` <C-x>4f ``, `` <C-x>4<C-f> ``<br>**emacs** — insert: `` <C-x>4f ``, `` <C-x>4<C-f> ``<br>**cua** — select: `` <C-X>4f ``, `` <C-X>4<C-f> ``, insert: `` <C-x>4f ``, `` <C-x>4<C-f> `` |
| `shrink_window_if_larger_than_buffer` | Shrink the window to fit its buffer (emacs shrink-window-if-larger-than-buffer) | **spacemacs** — normal: `` <C-x><minus> ``, select: `` <C-x><minus> ``, insert: `` <C-x><minus> ``<br>**hybrid** — normal: `` <C-x><minus> ``, select: `` <C-x><minus> `` |
...
| `keyboard_escape_quit` | Drop extra cursors and deactivate the region (emacs keyboard-escape-quit) | **emacs, cua, micro, nano** — insert: `` <esc><esc><esc> `` |
...
| `async_shell_command` | Run a shell command without blocking, output to a buffer (emacs async-shell-command) | **hybrid, emacs, cua, micro, nano** — insert: `` <A-&> `` |
...
| `tab_to_tab_stop` | Pad with spaces or tabs to the next tab stop (emacs tab-to-tab-stop, M-i) | **hybrid, emacs, cua, micro, nano** — insert: `` <A-i> `` |
| `indent_code_rigidly` | Shift region lines by [count] columns, skipping lines that start in a string (emacs indent-code-rigidly, = r) | **spacemacs, hybrid, vim** — normal: `` =r `` |
| `indent_sexp_rigidly` | Reindent this line and shift the grouping starting on it by the same amount (emacs C-u TAB) |  |
| `c_hungry_delete_forward` | Delete all whitespace after point, else one char (emacs c-hungry-delete-forward, SPC x d f) | **spacemacs, hybrid** — normal: `` <space>xdf ``, select: `` <space>xdf `` |
| `c_hungry_delete_backwards` | Delete all whitespace before point, else one char (emacs c-hungry-delete-backwards, SPC x d b) | **spacemacs, hybrid** — normal: `` <space>xdb ``, select: `` <space>xdb `` |
| `c_beginning_of_defun` | Move to the start of the function at point (emacs c-beginning-of-defun) | **spacemacs, hybrid** — normal: `` <A-C-a> `` |
| `c_end_of_defun` | Move to the end of the function at point (emacs c-end-of-defun) | **spacemacs, hybrid** — normal: `` <A-C-e> `` |
...
| `comment_set_column` | Set the comment column from point, aligning this line's comment with a prefix (emacs comment-set-column, C-x ;) | **spacemacs** — normal: `` <C-x>; ``, select: `` <C-x>; ``, insert: `` <C-x>; ``<br>**hybrid** — normal: `` <C-x>; ``, select: `` <C-x>; `` |
...
| `delete_find_char_backward` | Delete to prev char (dF) | **spacemacs, hybrid, vim** — normal: `` dF `` |
| `delete_till_char_backward` | Delete till prev char (dT) | **spacemacs, hybrid, vim** — normal: `` dT `` |
| `change_find_char_forward` | Change to next char (cf) | **spacemacs, hybrid, vim** — normal: `` cf `` |
| `change_till_char_forward` | Change till next char (ct) | **spacemacs, hybrid, vim** — normal: `` ct `` |
| `change_find_char_backward` | Change to prev char (cF) | **spacemacs, hybrid, vim** — normal: `` cF `` |
| `change_till_char_backward` | Change till prev char (cT) | **spacemacs, hybrid, vim** — normal: `` cT `` |
| `yank_find_char_forward` | Yank to next char (yf) | **spacemacs, hybrid, vim** — normal: `` yf `` |
| `yank_till_char_forward` | Yank till next char (yt) | **spacemacs, hybrid, vim** — normal: `` yt `` |
| `yank_find_char_backward` | Yank to prev char (yF) | **spacemacs, hybrid, vim** — normal: `` yF `` |
| `yank_till_char_backward` | Yank till prev char (yT) | **spacemacs, hybrid, vim** — normal: `` yT `` |
| `set_mark` | Set mark (m{a-z} buffer, m{A-Z} global) | **spacemacs, hybrid, vim** — normal: `` m `` |
| `goto_mark` | Goto mark exact (\`{a-z/A-Z/0-9}, \`\` for last jump) | **spacemacs, hybrid, vim** — normal: `` ` `` |
| `goto_mark_line` | Goto mark line ('{a-z/A-Z/0-9}, '' for last jump) | **spacemacs, hybrid, vim** — normal: `` ' `` |
| `goto_mark_nojump` | Goto mark exact without changing jumplist (g\`) | **spacemacs, hybrid, vim** — normal: `` g` `` |
| `goto_mark_line_nojump` | Goto mark line without changing jumplist (g') | **spacemacs, hybrid, vim** — normal: `` g' `` |
| `repeat_substitute` | Repeat last :substitute (&) | **spacemacs, hybrid, vim** — normal: `` & `` |
| `repeat_substitute_global` | Repeat last :substitute on whole file (g&) | **spacemacs, hybrid, vim** — normal: `` g& `` |
| `vim_record_macro` | Record macro into register (q{reg}) | **spacemacs, hybrid, vim** — normal: `` q `` |
| `vim_replay_macro` | Replay macro from register (@{reg}) | **spacemacs, hybrid, vim** — normal: `` @ `` |
| `save_visual_selection` | Save the visual selection (for gv) |  |
| `reselect_visual` | Reselect the last visual area (gv) | **spacemacs, hybrid, vim** — normal: `` gv ``, select: `` gv `` |
| `mark_insert_exit` | Record the insert-exit position (for gi) |  |
| `insert_at_last_insert` | Insert at the last insert position (gi) | **spacemacs, hybrid, vim** — normal: `` gi `` |
| `goto_next_function` | Goto next function | **spacemacs, vim** — normal: `` ][ ``, `` ]m ``<br>**hybrid** — normal: `` ][ ``, `` ]m ``, insert: `` <A-C-e> ``<br>**helix, kakoune** — normal: `` ]f ``, select: `` ]f ``<br>**emacs, cua, micro, nano** — normal: `` <A-C-e> ``, insert: `` <A-C-e> `` |
| `goto_prev_function` | Goto previous function | **spacemacs, vim** — normal: `` [] ``, `` [m ``<br>**hybrid** — normal: `` [] ``, `` [m ``, insert: `` <A-C-a> ``<br>**helix, kakoune** — normal: `` [f ``, select: `` [f ``<br>**emacs, cua, micro, nano** — normal: `` <A-C-a> ``, insert: `` <A-C-a> `` |
...
| `goto_prev_parameter` | Goto previous parameter | **helix, kakoune** — normal: `` [a ``, select: `` [a `` |
| `goto_next_comment` | Goto next comment | **spacemacs, hybrid, vim** — normal: `` ]* ``, `` ]/ ``<br>**helix, kakoune** — normal: `` ]c ``, select: `` ]c `` |
| `goto_prev_comment` | Goto previous comment | **spacemacs, hybrid, vim** — normal: `` [* ``, `` [/ ``<br>**helix, kakoune** — normal: `` [c ``, select: `` [c `` |
| `goto_next_test` | Goto next test | **helix, kakoune** — normal: `` ]T ``, select: `` ]T `` |
| `goto_prev_test` | Goto previous test | **helix, kakoune** — normal: `` [T ``, select: `` [T `` |
| `goto_next_xml_element` | Goto next (X)HTML element | **helix, kakoune** — normal: `` ]x ``, select: `` ]x `` |
...
| `goto_next_paragraph` | Goto next paragraph | **spacemacs** — normal: `` } ``, `` <A-}> ``, select: `` } ``<br>**hybrid** — normal: `` } ``, `` <A-}> ``, select: `` } ``, insert: `` <A-}> ``<br>**vim** — normal: `` } ``, select: `` } ``<br>**helix, kakoune** — normal: `` ]p ``, select: `` ]p ``<br>**emacs, cua, micro, nano** — normal: `` <A-}> ``, insert: `` <A-}> `` |
| `goto_prev_paragraph` | Goto previous paragraph | **spacemacs** — normal: `` { ``, `` <A-{> ``, select: `` { ``<br>**hybrid** — normal: `` { ``, `` <A-{> ``, select: `` { ``, insert: `` <A-{> ``<br>**vim** — normal: `` { ``, select: `` { ``<br>**helix, kakoune** — normal: `` [p ``, select: `` [p ``<br>**emacs, cua, micro, nano** — normal: `` <A-{> ``, insert: `` <A-{> `` |
| `goto_next_section` | Goto next section (vim ]]) | **spacemacs, hybrid, vim** — normal: `` ]] `` |
| `goto_prev_section` | Goto previous section (vim [[) | **spacemacs, hybrid, vim** — normal: `` [[ `` |
| `move_sentence_forward` | Move to next sentence | **spacemacs, hybrid** — normal: `` ) ``, `` <A-e> ``, select: `` ) ``<br>**vim** — normal: `` ) ``, select: `` ) `` |
| `move_sentence_backward` | Move to previous sentence | **spacemacs, hybrid** — normal: `` ( ``, `` <A-a> ``, select: `` ( ``<br>**vim** — normal: `` ( ``, select: `` ( `` |
| `dap_launch` | Launch debug target | **spacemacs** — normal: `` <S-F5> ``, `` <space>dd ``, `` <C-c><C-d> ``, select: `` <space>dd ``, `` <C-c><C-d> ``, insert: `` <C-c><C-d> ``<br>**hybrid** — normal: `` <S-F5> ``, `` <space>dd ``, `` <C-c><C-d> ``, select: `` <space>dd ``, `` <C-c><C-d> ``<br>**vim** — normal: `` <S-F5> ``<br>**helix** — normal: `` <space>Gl ``, select: `` <space>Gl `` |
| `dap_restart` | Restart debugging session | **spacemacs, hybrid** — normal: `` <space>dr ``, select: `` <space>dr ``<br>**helix** — normal: `` <space>Gr ``, select: `` <space>Gr `` |
| `dap_toggle_breakpoint` | Toggle breakpoint | **spacemacs, hybrid** — normal: `` <F9> ``, `` <space>db ``, select: `` <space>db ``<br>**vim** — normal: `` <F9> ``<br>**helix** — normal: `` <space>Gb ``, select: `` <space>Gb `` |
| `dap_remove_breakpoint` | Remove breakpoint on current line (Emacs gud-remove) | **spacemacs** — normal: `` <C-x><C-a><C-d> ``, select: `` <C-x><C-a><C-d> ``, insert: `` <C-x><C-a><C-d> ``<br>**hybrid** — normal: `` <C-x><C-a><C-d> ``, select: `` <C-x><C-a><C-d> ``, insert: `` <C-c><C-d> ``<br>**emacs** — normal: `` <C-c><C-d> ``, select: `` <C-c><C-d> ``, insert: `` <C-c><C-d> ``<br>**cua** — normal: `` <C-c><C-d> ``, insert: `` <C-c><C-d> ``<br>**micro, nano** — select: `` <C-c><C-d> `` |
| `dap_set_breakpoint` | Set a breakpoint on the current line, leaving an existing one alone (Emacs gud-break) | **spacemacs** — normal: `` <C-x><C-a><C-b> ``, select: `` <C-x><C-a><C-b> ``, insert: `` <C-x><C-a><C-b> ``<br>**hybrid** — normal: `` <C-x><C-a><C-b> ``, select: `` <C-x><C-a><C-b> `` |
| `dap_continue` | Continue program execution | **spacemacs** — normal: `` <space>dc ``, `` <C-x><C-a><C-r> ``, select: `` <space>dc ``, `` <C-x><C-a><C-r> ``, insert: `` <C-x><C-a><C-r> ``<br>**hybrid** — normal: `` <space>dc ``, `` <C-x><C-a><C-r> ``, select: `` <space>dc ``, `` <C-x><C-a><C-r> ``<br>**helix** — normal: `` <space>Gc ``, select: `` <space>Gc `` |
| `dap_run_to_cursor` | Run the debugger up to the cursor line (JetBrains Run To Cursor) | **spacemacs** — normal: `` <space>dC ``, `` <C-c><C-u> ``, `` <C-x><C-a><C-u> ``, select: `` <space>dC ``, `` <C-c><C-u> ``, `` <C-x><C-a><C-u> ``, insert: `` <C-c><C-u> ``, `` <C-x><C-a><C-u> ``<br>**hybrid** — normal: `` <space>dC ``, `` <C-c><C-u> ``, `` <C-x><C-a><C-u> ``, select: `` <space>dC ``, `` <C-c><C-u> ``, `` <C-x><C-a><C-u> `` |
| `dap_pause` | Pause program execution | **spacemacs, hybrid** — normal: `` <space>dp ``, select: `` <space>dp ``<br>**helix** — normal: `` <space>Gh ``, select: `` <space>Gh `` |
| `dap_step_in` | Step in | **spacemacs** — normal: `` <F11> ``, `` <space>di ``, `` <C-c><C-s> ``, `` <C-x><C-a><C-s> ``, select: `` <space>di ``, `` <C-c><C-s> ``, `` <C-x><C-a><C-s> ``, insert: `` <C-c><C-s> ``, `` <C-x><C-a><C-s> ``<br>**hybrid** — normal: `` <F11> ``, `` <space>di ``, `` <C-c><C-s> ``, `` <C-x><C-a><C-s> ``, select: `` <space>di ``, `` <C-c><C-s> ``, `` <C-x><C-a><C-s> ``<br>**vim** — normal: `` <F11> ``<br>**helix** — normal: `` <space>Gi ``, select: `` <space>Gi `` |
| `dap_smart_step_in` | Step into a chosen call on this line (JetBrains Smart Step Into, Shift F7) | **spacemacs, hybrid** — normal: `` <S-F7> ``, `` <space>dI ``, select: `` <space>dI ``<br>**vim** — normal: `` <S-F7> `` |
| `dap_step_out` | Step out | **spacemacs** — normal: `` <S-F11> ``, `` <space>do ``, `` <C-c><C-f> ``, `` <C-x><C-a><C-f> ``, select: `` <space>do ``, `` <C-c><C-f> ``, `` <C-x><C-a><C-f> ``, insert: `` <C-c><C-f> ``, `` <C-x><C-a><C-f> ``<br>**hybrid** — normal: `` <S-F11> ``, `` <space>do ``, `` <C-c><C-f> ``, `` <C-x><C-a><C-f> ``, select: `` <space>do ``, `` <C-c><C-f> ``, `` <C-x><C-a><C-f> ``<br>**vim** — normal: `` <S-F11> ``<br>**helix** — normal: `` <space>Go ``, select: `` <space>Go `` |
| `dap_next` | Step to next | **spacemacs** — normal: `` <F10> ``, `` <space>dn ``, `` <C-c><C-n> ``, `` <C-x><C-a><C-n> ``, select: `` <space>dn ``, `` <C-c><C-n> ``, `` <C-x><C-a><C-n> ``, insert: `` <C-c><C-n> ``, `` <C-x><C-a><C-n> ``<br>**hybrid** — normal: `` <F10> ``, `` <space>dn ``, `` <C-c><C-n> ``, `` <C-x><C-a><C-n> ``, select: `` <space>dn ``, `` <C-c><C-n> ``, `` <C-x><C-a><C-n> ``<br>**vim** — normal: `` <F10> ``<br>**helix** — normal: `` <space>Gn ``, select: `` <space>Gn `` |
| `dap_variables` | List variables | **spacemacs, hybrid** — normal: `` <space>dv ``, select: `` <space>dv ``<br>**helix** — normal: `` <space>Gv ``, select: `` <space>Gv `` |
...
| `dap_toggle_breakpoint_enabled` | Enable or disable the breakpoint on this line, keeping it (JetBrains Enable/Disable Breakpoint) |  |
| `dap_mute_breakpoints` | Stop, or resume, sending any breakpoint to the debugger (JetBrains Mute Breakpoints) |  |
| `dap_disable_all_but_this` | Disable every breakpoint except the one on this line (JetBrains Disable All Except This) |  |
| `dap_remove_all_but_this` | Remove every breakpoint except the one on this line (JetBrains Remove All Except This) |  |
| `dap_remove_breakpoints_in_file` | Remove every breakpoint in this file (JetBrains Remove All Breakpoints in the File) |  |
| `dap_restore_breakpoint` | Put back the breakpoint removed last (JetBrains Restore Breakpoint) |  |
| `dap_add_conditional_breakpoint` | Set a breakpoint here and edit its condition (JetBrains Add Conditional Breakpoint) |  |
| `dap_add_log_breakpoint` | Set a breakpoint here and edit the message it logs (JetBrains Add Logging Breakpoint) |  |
| `dap_copy_stack` | Copy the stopped thread's stack frames to the clipboard (JetBrains Copy Stack) |  |
| `dap_add_watch` | Add a watch expression (JetBrains New Watch) |  |
| `dap_show_watches` | Show every watch with its value in the selected frame (JetBrains Watches) |  |
| `dap_remove_watch` | Remove a picked watch (JetBrains Remove Watch) |  |
| `dap_remove_all_watches` | Remove every watch (JetBrains Remove All Watches) |  |
| `dap_edit_watch` | Edit a picked watch (JetBrains Edit Watch) |  |
| `dap_copy_watch` | Duplicate a picked watch (JetBrains Duplicate Watch) |  |
| `dap_move_watch_up` | Move a picked watch up (JetBrains Move Watch Up) |  |
| `dap_move_watch_down` | Move a picked watch down (JetBrains Move Watch Down) |  |
| `dap_copy_variable_value` | Yank a picked variable's value (JetBrains Copy Value) |  |
| `dap_copy_variable_name` | Yank a picked variable's name (JetBrains Copy Name) |  |
| `dap_set_variable` | Change a picked variable's value in the debuggee (JetBrains Set Value) |  |
...
| `gdb_display_locals_buffer` | Show local variables of the current frame (emacs gdb-display-locals-buffer) | **spacemacs, hybrid** — normal: `` <space>dgl ``, select: `` <space>dgl `` |
| `gdb_display_registers_buffer` | Show CPU registers of the current frame (emacs gdb-display-registers-buffer) | **spacemacs, hybrid** — normal: `` <space>dgr ``, select: `` <space>dgr `` |
| `gdb_display_stack_for_thread` | Show the call stack of the current thread (emacs gdb-display-stack-for-thread) | **spacemacs, hybrid** — normal: `` <space>dgs ``, select: `` <space>dgs `` |
...
| `gdb_display_disassembly_buffer` | Disassemble around the current frame PC (emacs gdb-display-disassembly-buffer) | **spacemacs, hybrid** — normal: `` <space>dgd ``, select: `` <space>dgd `` |
| `gdb_display_disassembly_for_thread` | Disassemble around the current thread PC (emacs gdb-display-disassembly-for-thread) |  |
| `gdb_display_io_buffer` | Show the inferior IO / Run console (emacs gdb-display-io-buffer) | **spacemacs, hybrid** — normal: `` <space>dgi ``, select: `` <space>dgi `` |
| `gdb_display_memory_buffer` | Read and hexdump target memory (emacs gdb-display-memory-buffer) | **spacemacs, hybrid** — normal: `` <space>dgm ``, select: `` <space>dgm `` |
| `gdb_delete_breakpoint` | Delete the breakpoint on the current line (emacs gdb-delete-breakpoint) | **spacemacs, hybrid** — normal: `` <space>dgk ``, select: `` <space>dgk `` |
| `gdb_edit_value` | Set a variable/expression value in the debugger (emacs gdb-edit-value) | **spacemacs, hybrid** — normal: `` <space>dge ``, select: `` <space>dge `` |
| `gdb_many_windows` | Open the multi-pane debugger layout (emacs gdb-many-windows) | **spacemacs, hybrid** — normal: `` <space>dgw ``, select: `` <space>dgw `` |
...
| `pandoc_menu` | Convert the buffer through pandoc, picking the output format (SPC P /) | **spacemacs, hybrid** — normal: `` <space>P/ ``, select: `` <space>P/ `` |
| `shell_pipe` | Pipe selections through shell command | **helix, kakoune** — normal: `` \| ``, select: `` \| `` |
| `shell_pipe_to` | Pipe selections into shell command ignoring output | **helix, kakoune** — normal: `` <A-\|> ``, select: `` <A-\|> `` |
| `shell_insert_output` | Insert shell command output before selections | **helix, kakoune** — normal: `` ! ``, select: `` ! `` |
| `shell_command` | Run a shell command and show its output; a count inserts it at point instead (emacs shell-command, M-!) | **spacemacs, hybrid** — normal: `` <A-!> `` |
| `shell_command_on_region` | Pipe the selection through a shell command and show the output; a count replaces the selection instead (emacs shell-command-on-region, M-|) | **spacemacs, hybrid** — normal: `` <A-\|> `` |
| `shell_append_output` | Append shell command output after selections | **helix, kakoune** — normal: `` <A-!> ``, select: `` <A-!> `` |
| `shell_keep_pipe` | Filter selections with shell predicate | **helix, kakoune** — normal: `` $ ``, select: `` $ `` |
| `suspend` | Suspend and return to shell | **spacemacs** — normal: `` <C-z> ``, `` <C-x><C-z> ``, select: `` <C-x><C-z> ``, insert: `` <C-x><C-z> ``<br>**hybrid** — normal: `` <C-z> ``, `` <C-x><C-z> ``, select: `` <C-x><C-z> ``<br>**vim** — normal: `` <C-z> ``<br>**helix, kakoune** — normal: `` <C-z> ``, select: `` <C-z> `` |
| `rename_symbol` | Rename symbol | **spacemacs, hybrid** — normal: `` <space>lr ``, select: `` <space>lr ``<br>**helix** — normal: `` <space>r ``, select: `` <space>r `` |
| `increment` | Increment item under cursor | **spacemacs, hybrid** — normal: `` <C-a> ``, `` g<C-a> ``, `` <space>n++ ``, `` <space>n+= ``, `` <space>n=+ ``, `` <space>n== ``, `` <space>n_+ ``, `` <space>n_= ``, `` <space>n<minus>+ ``, `` <space>n<minus>= ``, select: `` <C-a> ``, `` <space>n++ ``, `` <space>n+= ``, `` <space>n=+ ``, `` <space>n== ``, `` <space>n_+ ``, `` <space>n_= ``, `` <space>n<minus>+ ``, `` <space>n<minus>= ``<br>**vim** — normal: `` <C-a> ``, `` g<C-a> ``, select: `` <C-a> ``<br>**helix, kakoune** — normal: `` <C-a> ``, select: `` <C-a> `` |
| `decrement` | Decrement item under cursor | **spacemacs, hybrid** — normal: `` g<C-x> ``, `` <space>n+_ ``, `` <space>n=_ ``, `` <space>n__ ``, `` <space>n+<minus> ``, `` <space>n<minus>_ ``, `` <space>n=<minus> ``, `` <space>n_<minus> ``, `` <space>n<minus><minus> ``, select: `` <space>n+_ ``, `` <space>n=_ ``, `` <space>n__ ``, `` <space>n+<minus> ``, `` <space>n<minus>_ ``, `` <space>n=<minus> ``, `` <space>n_<minus> ``, `` <space>n<minus><minus> ``<br>**vim** — normal: `` <C-x> ``, `` g<C-x> ``, select: `` <C-x> ``<br>**helix, kakoune** — normal: `` <C-x> ``, select: `` <C-x> `` |
| `increment_sequential` | Increment each line in the selection by a growing amount (vim g CTRL-A) | **spacemacs, hybrid, vim** — select: `` g<C-a> `` |
| `decrement_sequential` | Decrement each line in the selection by a growing amount (vim g CTRL-X) | **spacemacs, hybrid, vim** — select: `` g<C-x> `` |
| `record_macro` | Record macro | **helix, kakoune** — normal: `` Q ``, select: `` Q ``<br>**micro** — normal: `` <C-u> ``, insert: `` <C-u> `` |
| `replay_macro` | Replay macro | **spacemacs, hybrid, vim** — normal: `` Q ``<br>**helix, kakoune** — normal: `` q ``, select: `` q ``<br>**micro** — normal: `` <C-j> ``, insert: `` <C-j> `` |
| `command_palette` | Open command palette | **spacemacs** — normal: `` <A-x> ``, `` <C-x>* ``, `` <space>? ``, `` <space><space> ``, select: `` <C-x>* ``, `` <space>? ``, `` <space><space> ``, insert: `` <C-x>* ``<br>**hybrid** — normal: `` <A-x> ``, `` <C-x>* ``, `` <space>? ``, `` <space><space> ``, select: `` <C-x>* ``, `` <space>? ``, `` <space><space> ``, insert: `` <A-x> ``<br>**helix** — normal: `` <space>? ``, select: `` <space>? ``<br>**emacs, cua** — normal: `` <A-x> ``, insert: `` <A-x> `` |
| `execute_extended_command_for_buffer` | Run a command declared by this buffer's major mode (emacs execute-extended-command-for-buffer, M-X) | **spacemacs** — normal: `` <A-X> ``<br>**hybrid** — normal: `` <A-X> ``, insert: `` <A-X> ``<br>**emacs, cua, micro, nano** — insert: `` <A-X> `` |
| `search_everywhere` | Search Everywhere: choose Files/Symbols/Text/Actions/Buffers (JetBrains) | **spacemacs, hybrid** — normal: `` <space>sE ``, select: `` <space>sE `` |
| `recent_files_switcher` | Recent Files switcher: tool windows + recent files (SPC b r) | **spacemacs, hybrid** — normal: `` <space>br ``, select: `` <space>br `` |
...
| `goto_char` | Label every visible occurrence of a char and jump (vim-easymotion s) | **spacemacs, hybrid** — normal: `` <A-g>c ``, `` <space>ja ``, `` <space>je ``, select: `` <space>ja ``, `` <space>je `` |
...
| `show_keyword_line_from_start` | Show the first line containing the keyword ([i) | **spacemacs, hybrid, vim** — normal: `` [i `` |
| `show_keyword_line_from_cursor` | Show the next line containing the keyword (]i) | **spacemacs, hybrid, vim** — normal: `` ]i `` |
| `list_keyword_lines_from_start` | List every line containing the keyword ([I) | **spacemacs, hybrid, vim** — normal: `` [I `` |
| `list_keyword_lines_from_cursor` | List the lines below containing the keyword (]I) | **spacemacs, hybrid, vim** — normal: `` ]I `` |
| `list_defines_from_start` | List every #define of the keyword ([D) | **spacemacs, hybrid, vim** — normal: `` [D `` |
| `list_defines_from_cursor` | List the #defines of the keyword below the cursor (]D) | **spacemacs, hybrid, vim** — normal: `` ]D `` |
| `goto_keyword_line_from_start` | Jump to the first line containing the keyword ([CTRL-I) | **spacemacs, hybrid, vim** — normal: `` [<C-i> `` |
| `goto_keyword_line_from_cursor` | Jump to the next line containing the keyword (]CTRL-I) | **spacemacs, hybrid, vim** — normal: `` ]<C-i> `` |
| `goto_define_from_start` | Jump to the first #define of the keyword ([CTRL-D) | **spacemacs, hybrid, vim** — normal: `` [<C-d> `` |
| `goto_define_from_cursor` | Jump to the next #define of the keyword (]CTRL-D) | **spacemacs, hybrid, vim** — normal: `` ]<C-d> `` |
...
| `yank_no_trailing_whitespace` | Yank without the trailing whitespace of each line (zy) | **spacemacs, hybrid, vim** — normal: `` zy `` |
| `paste_after_no_trailing_whitespace` | Paste after without trailing whitespace (zp) | **spacemacs, hybrid, vim** — normal: `` zp `` |
| `paste_before_no_trailing_whitespace` | Paste before without trailing whitespace (zP) | **spacemacs, hybrid, vim** — normal: `` zP `` |
| `command_mode_count` | Open the Ex line, with the count's line range ({count}:) | **spacemacs, hybrid, vim** — normal: `` : `` |
...
| `complete_included` | Complete a keyword from this file and the files it includes (i_CTRL-X CTRL-I) | **vim** — insert: `` <C-x><C-i> `` |
...
| `operator_func` | Call 'operatorfunc' on the selection (g@) | **spacemacs, hybrid, vim** — normal: `` g@@ `` |
...
| `kmacro_end_macro` | End the keyboard macro being defined (emacs kmacro-end-macro, C-x )) | **spacemacs, hybrid** — normal: `` <C-x>) ``, select: `` <C-x>) ``, insert: `` <C-x>) ``<br>**emacs** — insert: `` <C-x>) ``<br>**cua** — select: `` <C-X>) ``, insert: `` <C-x>) `` |
| `kmacro_start_macro` | Start defining a keyboard macro; C-u appends to the last one (emacs kmacro-start-macro, C-x () | **spacemacs, hybrid** — normal: `` <C-x>( ``, select: `` <C-x>( ``, insert: `` <C-x>( ``<br>**emacs** — insert: `` <C-x>( ``<br>**cua** — select: `` <C-X>( ``, insert: `` <C-x>( `` |
| `kmacro_start_macro_or_insert_counter` | Start a kbd macro, or insert the counter while defining one (emacs kmacro-start-macro-or-insert-counter, F3) | **spacemacs, hybrid** — normal: `` <F3> ``, `` <space>Kk ``, select: `` <space>Kk `` |
...
| `describe_function` | Describe a command — its doc and key bindings (emacs describe-function, C-h f) | **spacemacs** — normal: `` <C-h>f ``, select: `` <C-h>f ``, insert: `` <C-h>f ``<br>**hybrid** — normal: `` <C-h>f ``, select: `` <C-h>f ``, insert: `` <F1>f ``, `` <C-h>f ``<br>**emacs, cua, micro** — normal: `` <F1>f ``, `` <C-h>f ``, select: `` <F1>f ``, `` <C-h>f ``, insert: `` <F1>f ``, `` <C-h>f ``<br>**nano** — normal: `` <F1>f ``, select: `` <F1>f ``, `` <C-h>f ``, insert: `` <F1>f `` |
| `describe_key_briefly` | Echo, in one line, the command a key runs (emacs describe-key-briefly, C-h c) | **spacemacs** — normal: `` <C-h>c ``, select: `` <C-h>c ``, insert: `` <C-h>c ``<br>**hybrid** — normal: `` <C-h>c ``, select: `` <C-h>c ``, insert: `` <F1>c ``, `` <C-h>c ``<br>**emacs, cua, micro** — normal: `` <F1>c ``, `` <C-h>c ``, select: `` <F1>c ``, `` <C-h>c ``, insert: `` <F1>c ``, `` <C-h>c ``<br>**nano** — normal: `` <F1>c ``, select: `` <F1>c ``, `` <C-h>c ``, insert: `` <F1>c `` |
| `describe_variable` | Describe an editor/vim variable — value and default (emacs describe-variable, C-h v) | **spacemacs** — normal: `` <C-h>v ``, select: `` <C-h>v ``, insert: `` <C-h>v ``<br>**hybrid** — normal: `` <C-h>v ``, select: `` <C-h>v ``, insert: `` <F1>v ``, `` <C-h>v ``<br>**emacs, cua, micro** — normal: `` <F1>v ``, `` <C-h>v ``, select: `` <F1>v ``, `` <C-h>v ``, insert: `` <F1>v ``, `` <C-h>v ``<br>**nano** — normal: `` <F1>v ``, select: `` <F1>v ``, `` <C-h>v ``, insert: `` <F1>v `` |
| `describe_symbol` | Describe a name, command or variable (emacs describe-symbol, C-h o) | **spacemacs** — normal: `` <C-h>o ``, select: `` <C-h>o ``, insert: `` <C-h>o ``<br>**hybrid** — normal: `` <C-h>o ``, select: `` <C-h>o ``, insert: `` <F1>o ``, `` <C-h>o ``<br>**emacs, cua, micro** — normal: `` <F1>o ``, `` <C-h>o ``, select: `` <F1>o ``, `` <C-h>o ``, insert: `` <F1>o ``, `` <C-h>o ``<br>**nano** — normal: `` <F1>o ``, select: `` <F1>o ``, `` <C-h>o ``, insert: `` <F1>o `` |
...
| `help_quick_toggle` | Show or close the quick-help sheet (emacs help-quick-toggle) | **spacemacs** — normal: `` <C-h><C-q> ``, select: `` <C-h><C-q> ``, insert: `` <C-h><C-q> ``<br>**hybrid** — normal: `` <C-h><C-q> ``, select: `` <C-h><C-q> ``, insert: `` <F1><C-q> ``, `` <C-h><C-q> ``<br>**emacs, cua, micro** — normal: `` <F1><C-q> ``, `` <C-h><C-q> ``, select: `` <F1><C-q> ``, `` <C-h><C-q> ``, insert: `` <F1><C-q> ``, `` <C-h><C-q> ``<br>**nano** — normal: `` <F1><C-q> ``, select: `` <F1><C-q> ``, `` <C-h><C-q> ``, insert: `` <F1><C-q> `` |
...
| `help_find_source` | Visit the source of what the Help buffer describes (emacs help-find-source, C-h 4 s) | **spacemacs** — normal: `` <C-h>4s ``, select: `` <C-h>4s ``, insert: `` <C-h>4s ``<br>**hybrid** — normal: `` <C-h>4s ``, select: `` <C-h>4s ``, insert: `` <F1>4s ``, `` <C-h>4s ``<br>**emacs, cua, micro** — normal: `` <F1>4s ``, `` <C-h>4s ``, select: `` <F1>4s ``, `` <C-h>4s ``, insert: `` <F1>4s ``, `` <C-h>4s ``<br>**nano** — normal: `` <F1>4s ``, select: `` <F1>4s ``, `` <C-h>4s ``, insert: `` <F1>4s `` |
...
| `info_goto_emacs_command_node` | Show the manual node documenting a command (emacs Info-goto-emacs-command-node, C-h F) | **spacemacs** — normal: `` <C-h>F ``, select: `` <C-h>F ``, insert: `` <C-h>F ``<br>**hybrid** — normal: `` <C-h>F ``, select: `` <C-h>F ``, insert: `` <F1>F ``, `` <C-h>F ``<br>**emacs, cua, micro** — normal: `` <F1>F ``, `` <C-h>F ``, select: `` <F1>F ``, `` <C-h>F ``, insert: `` <F1>F ``, `` <C-h>F ``<br>**nano** — normal: `` <F1>F ``, select: `` <F1>F ``, `` <C-h>F ``, insert: `` <F1>F `` |
| `isearch_help_map` | List the incremental-search keys and commands (emacs isearch-help-map, C-h C-h in isearch) |  |
| `help_go_back` | Go back to the previously visited Help entry (emacs help-go-back) | **spacemacs, hybrid, vim** — normal: `` gb `` |
...
| `find_file_other_tab` | Open a file in a new tab (emacs find-file-other-tab) | **spacemacs, hybrid** — normal: `` <C-x>tf ``, `` <C-x>t<C-f> ``, select: `` <C-x>tf ``, `` <C-x>t<C-f> ``, insert: `` <C-x>tf ``, `` <C-x>t<C-f> ``<br>**emacs** — insert: `` <C-x>tf ``, `` <C-x>t<C-f> ``<br>**cua** — select: `` <C-X>tf ``, `` <C-X>t<C-f> ``, insert: `` <C-x>tf ``, `` <C-x>t<C-f> `` |
...
| `vc_register` | Put the current file under version control: git add (emacs vc-register) | **spacemacs** — normal: `` <C-x>vi ``, select: `` <C-x>vi ``, insert: `` <C-x>vi ``<br>**hybrid** — normal: `` <C-x>vi ``, select: `` <C-x>vi `` |
...
| `vc_update_change_log` | Insert ChangeLog entries from the recent commits (emacs vc-update-change-log) | **spacemacs** — normal: `` <C-x>va ``, select: `` <C-x>va ``, insert: `` <C-x>va ``<br>**hybrid** — normal: `` <C-x>va ``, select: `` <C-x>va `` |
| `vc_ediff` | Diff the current file against a revision (emacs vc-ediff) |  |
| `set_buffer_file_coding_system` | Set the encoding this buffer is saved in (emacs set-buffer-file-coding-system) | **spacemacs** — normal: `` <C-x><ret>f ``, select: `` <C-x><ret>f ``, insert: `` <C-x><ret>f ``<br>**hybrid** — normal: `` <C-x><ret>f ``, select: `` <C-x><ret>f `` |
| `set_terminal_coding_system` | Set the coding system the hosted terminal's output is decoded with (emacs C-x RET t) | **spacemacs** — normal: `` <C-x><ret>t ``, select: `` <C-x><ret>t ``, insert: `` <C-x><ret>t ``<br>**hybrid** — normal: `` <C-x><ret>t ``, select: `` <C-x><ret>t `` |
| `set_keyboard_coding_system` | Set the coding system keys are encoded into for the hosted terminal (emacs C-x RET k) | **spacemacs** — normal: `` <C-x><ret>k ``, select: `` <C-x><ret>k ``, insert: `` <C-x><ret>k ``<br>**hybrid** — normal: `` <C-x><ret>k ``, select: `` <C-x><ret>k `` |
| `set_selection_coding_system` | Set the coding system used for the system clipboard (emacs C-x RET x) | **spacemacs** — normal: `` <C-x><ret>x ``, select: `` <C-x><ret>x ``, insert: `` <C-x><ret>x ``<br>**hybrid** — normal: `` <C-x><ret>x ``, select: `` <C-x><ret>x `` |
| `set_next_selection_coding_system` | Set the coding system for the next clipboard transfer only (emacs C-x RET X) | **spacemacs** — normal: `` <C-x><ret>X ``, select: `` <C-x><ret>X ``, insert: `` <C-x><ret>X ``<br>**hybrid** — normal: `` <C-x><ret>X ``, select: `` <C-x><ret>X `` |
| `set_buffer_process_coding_system` | Set the coding systems a subprocess's pipes are decoded/encoded with (emacs C-x RET p) | **spacemacs** — normal: `` <C-x><ret>p ``, select: `` <C-x><ret>p ``, insert: `` <C-x><ret>p ``<br>**hybrid** — normal: `` <C-x><ret>p ``, select: `` <C-x><ret>p `` |
| `set_file_name_coding_system` | Set the coding system file names are encoded into (emacs C-x RET F) | **spacemacs** — normal: `` <C-x><ret>F ``, select: `` <C-x><ret>F ``, insert: `` <C-x><ret>F ``<br>**hybrid** — normal: `` <C-x><ret>F ``, select: `` <C-x><ret>F `` |
| `prefer_coding_system` | Make a coding system the default for files that are opened (emacs C-x RET c / prefer-coding-system) |  |
| `universal_coding_system_argument` | Run the next file read or write with a coding system you name (emacs C-x RET c) | **spacemacs** — normal: `` <C-x><ret>c ``, select: `` <C-x><ret>c ``, insert: `` <C-x><ret>c ``<br>**hybrid** — normal: `` <C-x><ret>c ``, select: `` <C-x><ret>c `` |
...
| `set_input_method` | Choose the input method this buffer composes characters with (emacs set-input-method, C-x RET C-\) | **spacemacs, hybrid** — normal: `` <C-x><ret><C-\> ``, select: `` <C-x><ret><C-\> ``, insert: `` <C-x><ret><C-\> ``<br>**emacs** — insert: `` <C-x><ret><C-\> ``<br>**cua** — select: `` <C-X><ret><C-\> ``, insert: `` <C-x><ret><C-\> `` |
| `quail_set_keyboard_layout` | Tell the input-method system your physical keyboard layout (emacs quail-set-keyboard-layout) |  |
| `toggle_input_method` | Switch the buffer's input method off, or back on (emacs toggle-input-method, C-\) | **hybrid** — insert: `` <C-\> ``<br>**emacs, cua, micro, nano** — normal: `` <C-\> ``, insert: `` <C-\> `` |
...
| `left_char` | Move to the character to the left on display, reading the paragraph's direction (emacs left-char) | **hybrid** — insert: `` <left> ``<br>**emacs, cua, micro, nano** — normal: `` <left> ``, insert: `` <left> `` |
| `right_char` | Move to the character to the right on display, reading the paragraph's direction (emacs right-char) | **hybrid** — insert: `` <right> ``<br>**emacs, cua, micro, nano** — normal: `` <right> ``, insert: `` <right> `` |
| `modify_category_entry` | Add the character after point to a character category, or remove it (emacs modify-category-entry) |  |
| `activate_transient_input_method` | Turn an input method on for one character only (emacs activate-transient-input-method, C-x \) | **spacemacs, hybrid** — normal: `` <C-x>\ ``, select: `` <C-x>\ ``, insert: `` <C-x>\ ``<br>**emacs** — insert: `` <C-x>\ ``<br>**cua** — select: `` <C-X>\ ``, insert: `` <C-x>\ `` |
...
| `describe_input_method` | Show an input method's documentation and key table (emacs describe-input-method, C-h C-\) | **spacemacs** — normal: `` <C-h>I ``, `` <C-h><C-\> ``, select: `` <C-h>I ``, `` <C-h><C-\> ``, insert: `` <C-h>I ``, `` <C-h><C-\> ``<br>**hybrid** — normal: `` <C-h>I ``, `` <C-h><C-\> ``, select: `` <C-h>I ``, `` <C-h><C-\> ``, insert: `` <F1>I ``, `` <C-h>I ``, `` <F1><C-\> ``, `` <C-h><C-\> ``<br>**emacs, cua, micro** — normal: `` <F1>I ``, `` <C-h>I ``, `` <F1><C-\> ``, `` <C-h><C-\> ``, select: `` <F1>I ``, `` <C-h>I ``, `` <F1><C-\> ``, `` <C-h><C-\> ``, insert: `` <F1>I ``, `` <C-h>I ``, `` <F1><C-\> ``, `` <C-h><C-\> ``<br>**nano** — normal: `` <F1>I ``, `` <F1><C-\> ``, select: `` <F1>I ``, `` <C-h>I ``, `` <F1><C-\> ``, `` <C-h><C-\> ``, insert: `` <F1>I ``, `` <F1><C-\> `` |
...
| `exit_recursive_edit` | Leave the innermost recursive editing level (emacs exit-recursive-edit, C-M-c) | **spacemacs, hybrid, vim** — normal: `` <A-C-c> `` |
| `abort_recursive_edit` | Abort the command that opened the innermost recursive edit (emacs abort-recursive-edit, C-]) | **hybrid, emacs, cua, micro, nano** — insert: `` <C-]> `` |
| `kbd_macro_query` | Ask how to continue when a running keyboard macro reaches this point (emacs kbd-macro-query, C-x q) | **spacemacs** — normal: `` <C-x>q ``, select: `` <C-x>q ``, insert: `` <C-x>q ``<br>**hybrid** — normal: `` <C-x>q ``, select: `` <C-x>q `` |
...
| `emerge_buffers` | Merge two buffers into a merge buffer (emacs emerge-buffers) | **spacemacs, hybrid** — normal: `` <space>Dmbb ``, select: `` <space>Dmbb `` |
| `emerge_buffers_with_ancestor` | Three-way merge two buffers against their ancestor (emacs emerge-buffers-with-ancestor) | **spacemacs, hybrid** — normal: `` <space>Dmb3 ``, select: `` <space>Dmb3 `` |
| `emerge_files_with_ancestor` | Three-way merge two files against their ancestor (emacs emerge-files-with-ancestor) | **spacemacs, hybrid** — normal: `` <space>Dmf3 ``, select: `` <space>Dmf3 `` |
...
| `add_change_log_entry_other_window` | Start a ChangeLog entry for this file and function in a split (emacs add-change-log-entry-other-window) | **spacemacs** — normal: `` <C-x>4a ``, select: `` <C-x>4a ``, insert: `` <C-x>4a ``<br>**hybrid** — normal: `` <C-x>4a ``, select: `` <C-x>4a `` |
...
| `revert_buffer_with_coding_system` | Re-read the file with a coding system you name (emacs revert-buffer-with-coding-system) | **spacemacs** — normal: `` <C-x><ret>r ``, select: `` <C-x><ret>r ``, insert: `` <C-x><ret>r ``<br>**hybrid** — normal: `` <C-x><ret>r ``, select: `` <C-x><ret>r `` |
| `clean_buffer_list` | Kill the buffers left untouched for three days (emacs clean-buffer-list) |  |
| `switch_to_buffer_other_tab` | Show a buffer in a new tab (emacs switch-to-buffer-other-tab) | **spacemacs, hybrid** — normal: `` <C-x>tb ``, select: `` <C-x>tb ``, insert: `` <C-x>tb ``<br>**emacs** — insert: `` <C-x>tb ``<br>**cua** — select: `` <C-X>tb ``, insert: `` <C-x>tb `` |
| `dired_other_tab` | Open Dired in a new tab (emacs dired-other-tab) | **spacemacs, hybrid** — normal: `` <C-x>td ``, select: `` <C-x>td ``, insert: `` <C-x>td ``<br>**emacs** — insert: `` <C-x>td ``<br>**cua** — select: `` <C-X>td ``, insert: `` <C-x>td `` |
| `rot13_other_window` | Show this buffer ROT13'd in a split (emacs rot13-other-window) |  |
| `outline_hide_other` | Hide everything but the current entry, its parents and the top-level headings (emacs outline-hide-other) | **spacemacs** — normal: `` <C-c>@<C-o> ``, select: `` <C-c>@<C-o> ``, insert: `` <C-c>@<C-o> ``<br>**hybrid** — normal: `` <C-c>@<C-o> ``, select: `` <C-c>@<C-o> `` |
| `reposition_window` | Scroll so the whole function at point is on screen (emacs reposition-window) | **hybrid, emacs, cua, micro, nano** — insert: `` <A-C-l> `` |
...
| `aggressive_indent_mode` | Toggle re-indenting the enclosing form after every edit (aggressive-indent-mode, SPC t I) | **spacemacs, hybrid** — normal: `` <space>tI ``, select: `` <space>tI `` |
...
| `hs_hide_level` | Fold every block at a nesting depth you name (emacs hs-hide-level) | **spacemacs** — normal: `` <C-c>@<C-l> ``, select: `` <C-c>@<C-l> ``, insert: `` <C-c>@<C-l> ``<br>**hybrid** — normal: `` <C-c>@<C-l> ``, select: `` <C-c>@<C-l> `` |
...
| `rectangle_mark_mode` | Toggle rectangular region selection (emacs rectangle-mark-mode) | **spacemacs, hybrid** — normal: `` <C-x><space> ``, select: `` <C-x><space> ``, insert: `` <C-x><space> ``<br>**emacs** — insert: `` <C-x><space> ``<br>**cua** — normal: `` <C-ret> ``, select: `` <C-ret> ``, `` <C-X><space> ``, insert: `` <C-ret> ``, `` <C-x><space> `` |
...
| `exchange_point_and_mark` | Swap point and mark; the opposite rectangle corner in rectangle-mark-mode (emacs C-x C-x) | **spacemacs, hybrid** — normal: `` <C-x><C-x> ``, select: `` <C-x><C-x> ``, insert: `` <C-x><C-x> ``<br>**emacs** — normal: `` <C-x><C-x> ``, insert: `` <C-x><C-x> ``<br>**cua** — normal: `` <C-x><C-x> ``, select: `` <C-X><C-x> ``, insert: `` <C-x><C-x> `` |
| `vc_edit_next_command` | Edit the next VC command before it runs (emacs vc-edit-next-command, C-x v !) | **spacemacs** — normal: `` <C-x>v! ``, select: `` <C-x>v! ``, insert: `` <C-x>v! ``<br>**hybrid** — normal: `` <C-x>v! ``, select: `` <C-x>v! `` |
...
| `ediff_patch_buffer` | Patch a buffer with a patch buffer/file and review it (emacs ediff-patch-buffer, SPC D b p) | **spacemacs, hybrid** — normal: `` <space>Dbp ``, select: `` <space>Dbp `` |
...
| `term_line_mode` | Terminal: edit input locally, Enter sends the line (emacs term-line-mode) | **spacemacs** — normal: `` <C-c><C-j> ``, select: `` <C-c><C-j> ``, insert: `` <C-c><C-j> ``<br>**hybrid** — normal: `` <C-c><C-j> ``, select: `` <C-c><C-j> `` |
...
| `window_configuration_to_register` | Save the window configuration in a register (emacs window-configuration-to-register) | **spacemacs** — normal: `` <C-x>rw ``, select: `` <C-x>rw ``, insert: `` <C-x>rw ``<br>**hybrid** — normal: `` <C-x>rw ``, select: `` <C-x>rw `` |
...
| `frameset_to_register` | Save the frame's window configuration in a register (emacs frameset-to-register) | **spacemacs** — normal: `` <C-x>rf ``, select: `` <C-x>rf ``, insert: `` <C-x>rf ``<br>**hybrid** — normal: `` <C-x>rf ``, select: `` <C-x>rf `` |
...
| `display_time` | Toggle the clock in the mode line (emacs display-time) | **spacemacs, hybrid** — normal: `` <space>tmt ``, select: `` <space>tmt `` |
| `display_battery_mode` | Toggle the battery charge in the mode line (emacs display-battery-mode) | **spacemacs, hybrid** — normal: `` <space>tmb ``, select: `` <space>tmb `` |
...
| `add_dir_local_variable` | Set a variable for this whole tree in .dir-locals.el (emacs add-dir-local-variable) | **spacemacs, hybrid** — normal: `` <space>fvd ``, select: `` <space>fvd `` |
...
| `report_spacemacs_issue` | Open the Spacemacs issue tracker pre-filled; C-u adds your last keys (Spacemacs SPC h I) | **spacemacs, hybrid** — normal: `` <space>hI ``, select: `` <space>hI `` |
| `report_spacemacs_issue_with_keys` | Open the issue tracker pre-filled, with your last pressed keys (Spacemacs SPC u SPC h I) | **spacemacs, hybrid** — normal: `` <space>u<space>hI ``, select: `` <space>u<space>hI `` |
| `toggle_smooth_scrolling` | Toggle smooth scrolling (vim 'smoothscroll', Spacemacs SPC t n v) | **spacemacs, hybrid** — normal: `` <space>tnv ``, select: `` <space>tnv `` |
| `toggle_tilde_fringe` | Show or hide the ~ marking the rows past the end of the buffer (Spacemacs SPC T ~) | **spacemacs, hybrid** — normal: `` <space>T~ ``, select: `` <space>T~ `` |
| `nyan_mode` | Draw nyan-mode's scroll-position cat in the mode line (Spacemacs SPC t m n) | **spacemacs, hybrid** — normal: `` <space>tmn ``, select: `` <space>tmn `` |
| `toggle_modeline_minor_modes` | Show or hide the mode line's minor-mode lighters (Spacemacs SPC t m m) | **spacemacs, hybrid** — normal: `` <space>tmm ``, select: `` <space>tmm `` |
| `toggle_modeline_responsive` | Drop the mode line's optional constructs when they no longer fit (Spacemacs SPC t m r) | **spacemacs, hybrid** — normal: `` <space>tmr ``, select: `` <space>tmr `` |
| `toggle_modeline_new_version` | Show a mode-line lighter when a newer release is known (Spacemacs SPC t m V) | **spacemacs, hybrid** — normal: `` <space>tmV ``, select: `` <space>tmV `` |
| `toggle_modeline_org_clock` | Show the running org task clock in the mode line (Spacemacs SPC t m c) | **spacemacs, hybrid** — normal: `` <space>tmc ``, select: `` <space>tmc `` |
| `ggtags_mode` | Look tags up in the etags table before the language server (ggtags-mode, Spacemacs SPC t G) | **spacemacs, hybrid** — normal: `` <space>tG ``, select: `` <space>tG `` |
| `yasnippet_mode` | Enable or disable snippet expansion (yasnippet-mode, Spacemacs SPC t y) | **spacemacs, hybrid** — normal: `` <space>ty ``, select: `` <space>ty `` |
| `locate_library` | Report where a loadable library lives (emacs locate-library, Spacemacs SPC f e l) | **spacemacs, hybrid** — normal: `` <space>fel ``, select: `` <space>fel `` |
| `open_early_config` | Open the early config zmax reads before the editor starts (Spacemacs SPC f e I) | **spacemacs, hybrid** — normal: `` <space>feI ``, select: `` <space>feI `` |
| `restart_editor_timed` | Restart zmax with start-up phase timing on (Spacemacs SPC q t) | **spacemacs, hybrid** — normal: `` <space>qt ``, select: `` <space>qt `` |
| `restart_editor_adv_timers` | Restart zmax with per-phase and per-plugin timing on (Spacemacs SPC q T) | **spacemacs, hybrid** — normal: `` <space>qT ``, select: `` <space>qT `` |
| `ediff_merge_directories` | Merge the files two directories have in common (emacs ediff-merge-directories, SPC D m d d) | **spacemacs, hybrid** — normal: `` <space>Dmdd ``, select: `` <space>Dmdd `` |
| `ediff_show_registry` | List the ediff sessions started in this run (emacs ediff-show-registry, SPC D s) | **spacemacs, hybrid** — normal: `` <space>Ds ``, select: `` <space>Ds `` |
| `smeargle_commits` | Tint lines by the age rank of the commit that last touched them (smeargle-commits, SPC g H h) | **spacemacs, hybrid** — normal: `` <space>gHh ``, select: `` <space>gHh `` |
| `smeargle` | Tint lines by how long ago they were last updated (smeargle, SPC g H t) | **spacemacs, hybrid** — normal: `` <space>gHt ``, select: `` <space>gHt `` |
| `smeargle_clear` | Clear the smeargle commit highlighting (smeargle-clear, SPC g H c) | **spacemacs, hybrid** — normal: `` <space>gHc ``, select: `` <space>gHc `` |
| `git_link_select_remote` | Choose the remote the git-link commands build URLs from (Spacemacs SPC u before SPC g l) | **spacemacs, hybrid** — normal: `` <space>u<space>gl ``, select: `` <space>u<space>gl `` |
| `log_edit_kill_buffer` | Discard the commit message and abort the commit (emacs log-edit-kill-buffer, SPC m a / SPC m k) |  |
| `describe_face` | Show what a face of the active theme renders as (emacs describe-face, SPC h d F) | **spacemacs, hybrid** — normal: `` <space>hdF ``, select: `` <space>hdF `` |
...
| `close_sticky_popup` | Close the popup window on top (Spacemacs SPC w p p) | **spacemacs, hybrid** — normal: `` <space>wpp ``, select: `` <space>wpp `` |
...
| `make_frame_command` | Create a new frame showing this buffer (emacs make-frame-command) | **spacemacs, hybrid** — normal: `` <C-x>52 ``, `` <space>Fn ``, select: `` <C-x>52 ``, `` <space>Fn ``, insert: `` <C-x>52 ``<br>**emacs** — normal: `` <C-x>52 ``, select: `` <C-x>52 ``, insert: `` <C-x>52 ``<br>**cua** — normal: `` <C-x>52 ``, select: `` <C-X>52 ``, insert: `` <C-x>52 ``<br>**micro, nano** — select: `` <C-x>52 `` |
...
| `toggle_frame_fullscreen` | Toggle the terminal window's fullscreen state (emacs toggle-frame-fullscreen, F11) | **spacemacs** — normal: `` <space>TF ``, select: `` <space>TF ``<br>**hybrid** — normal: `` <space>TF ``, select: `` <space>TF ``, insert: `` <F11> ``<br>**emacs, cua, micro, nano** — normal: `` <F11> ``, select: `` <F11> ``, insert: `` <F11> `` |
| `toggle_frame_maximized` | Maximize or restore the terminal window (emacs toggle-frame-maximized, M-F10) | **spacemacs** — normal: `` <space>TM ``, select: `` <space>TM ``<br>**hybrid** — normal: `` <space>TM ``, select: `` <space>TM ``, insert: `` <A-F10> ``<br>**emacs, cua, micro, nano** — normal: `` <A-F10> ``, select: `` <A-F10> ``, insert: `` <A-F10> `` |
| `iconify_or_deiconify_frame` | Iconify or deiconify the frame; no visible effect on a tty (emacs iconify-or-deiconify-frame, C-z under X) | **hybrid** — insert: `` <C-z> ``<br>**emacs, nano** — normal: `` <C-z> ``, select: `` <C-z> ``, insert: `` <C-z> ``<br>**micro** — select: `` <C-z> `` |
...
| `switch_to_minibuffer` | Select the active minibuffer window (spacemacs SPC w b, switch-to-minibuffer-window) | **spacemacs, hybrid** — normal: `` <space>wb ``, select: `` <space>wb `` |
...
| `clone_frame` | Create a new frame with a copy of this frame's layout (emacs clone-frame) | **spacemacs, hybrid, emacs** — normal: `` <C-x>5c ``, select: `` <C-x>5c ``, insert: `` <C-x>5c ``<br>**cua** — normal: `` <C-x>5c ``, select: `` <C-X>5c ``, insert: `` <C-x>5c ``<br>**micro, nano** — select: `` <C-x>5c `` |
| `delete_frame` | Delete the displayed frame (emacs delete-frame) | **spacemacs, hybrid** — normal: `` <C-x>50 ``, `` <space>Fd ``, select: `` <C-x>50 ``, `` <space>Fd ``, insert: `` <C-x>50 ``<br>**emacs** — normal: `` <C-x>50 ``, select: `` <C-x>50 ``, insert: `` <C-x>50 ``<br>**cua** — normal: `` <C-x>50 ``, select: `` <C-X>50 ``, insert: `` <C-x>50 ``<br>**micro, nano** — select: `` <C-x>50 `` |
| `delete_other_frames` | Delete every frame but this one (emacs delete-other-frames) | **spacemacs, hybrid** — normal: `` <C-x>51 ``, `` <space>FD ``, select: `` <C-x>51 ``, `` <space>FD ``, insert: `` <C-x>51 ``<br>**emacs** — normal: `` <C-x>51 ``, select: `` <C-x>51 ``, insert: `` <C-x>51 ``<br>**cua** — normal: `` <C-x>51 ``, select: `` <C-X>51 ``, insert: `` <C-x>51 ``<br>**micro, nano** — select: `` <C-x>51 `` |
| `other_frame` | Display the next frame (emacs other-frame) | **spacemacs, hybrid** — normal: `` ]t ``, `` <C-x>5o ``, `` <space>Fo ``, select: `` <C-x>5o ``, `` <space>Fo ``, insert: `` <C-x>5o ``<br>**vim** — normal: `` ]t ``<br>**emacs** — normal: `` <C-x>5o ``, select: `` <C-x>5o ``, insert: `` <C-x>5o ``<br>**cua** — normal: `` <C-x>5o ``, select: `` <C-X>5o ``, insert: `` <C-x>5o ``<br>**micro, nano** — select: `` <C-x>5o `` |
| `previous_frame` | Display the previous frame (spacemacs [t) | **spacemacs, hybrid, vim** — normal: `` [t `` |
| `undelete_frame` | Bring back the most recently deleted frame (emacs undelete-frame) | **spacemacs, hybrid, emacs** — normal: `` <C-x>5u ``, select: `` <C-x>5u ``, insert: `` <C-x>5u ``<br>**cua** — normal: `` <C-x>5u ``, select: `` <C-X>5u ``, insert: `` <C-x>5u ``<br>**micro, nano** — select: `` <C-x>5u `` |
...
| `find_file_other_frame` | Open a file in a new frame (emacs find-file-other-frame) | **spacemacs, hybrid** — normal: `` <C-x>5f ``, `` <space>Ff ``, `` <C-x>5<C-f> ``, select: `` <C-x>5f ``, `` <space>Ff ``, `` <C-x>5<C-f> ``, insert: `` <C-x>5f ``, `` <C-x>5<C-f> ``<br>**emacs** — normal: `` <C-x>5f ``, `` <C-x>5<C-f> ``, select: `` <C-x>5f ``, `` <C-x>5<C-f> ``, insert: `` <C-x>5f ``, `` <C-x>5<C-f> ``<br>**cua** — normal: `` <C-x>5f ``, `` <C-x>5<C-f> ``, select: `` <C-X>5f ``, `` <C-X>5<C-f> ``, insert: `` <C-x>5f ``, `` <C-x>5<C-f> ``<br>**micro, nano** — select: `` <C-x>5f ``, `` <C-x>5<C-f> `` |
| `find_file_read_only_other_frame` | Open a file read-only in a new frame (emacs find-file-read-only-other-frame) | **spacemacs, hybrid, emacs** — normal: `` <C-x>5r ``, select: `` <C-x>5r ``, insert: `` <C-x>5r ``<br>**cua** — normal: `` <C-x>5r ``, select: `` <C-X>5r ``, insert: `` <C-x>5r ``<br>**micro, nano** — select: `` <C-x>5r `` |
| `switch_to_buffer_other_frame` | Display a buffer in a new frame (emacs switch-to-buffer-other-frame) | **spacemacs, hybrid** — normal: `` <C-x>5b ``, `` <space>Fb ``, select: `` <C-x>5b ``, `` <space>Fb ``, insert: `` <C-x>5b ``<br>**emacs** — normal: `` <C-x>5b ``, select: `` <C-x>5b ``, insert: `` <C-x>5b ``<br>**cua** — normal: `` <C-x>5b ``, select: `` <C-X>5b ``, insert: `` <C-x>5b ``<br>**micro, nano** — select: `` <C-x>5b `` |
| `display_buffer_other_frame` | Put a buffer in another frame without selecting it (emacs display-buffer-other-frame, SPC F B) | **spacemacs, hybrid, emacs** — normal: `` <C-x>5<C-o> ``, select: `` <C-x>5<C-o> ``, insert: `` <C-x>5<C-o> ``<br>**cua** — normal: `` <C-x>5<C-o> ``, select: `` <C-X>5<C-o> ``, insert: `` <C-x>5<C-o> ``<br>**micro, nano** — select: `` <C-x>5<C-o> `` |
| `dired_other_frame` | Open Dired in a new frame (emacs dired-other-frame) | **spacemacs, hybrid** — normal: `` <C-x>5d ``, `` <space>FO ``, select: `` <C-x>5d ``, `` <space>FO ``, insert: `` <C-x>5d ``<br>**emacs** — normal: `` <C-x>5d ``, select: `` <C-x>5d ``, insert: `` <C-x>5d ``<br>**cua** — normal: `` <C-x>5d ``, select: `` <C-X>5d ``, insert: `` <C-x>5d ``<br>**micro, nano** — select: `` <C-x>5d `` |
| `other_frame_prefix` | Display the next command's buffer in a new frame (emacs other-frame-prefix) | **spacemacs, hybrid, emacs** — normal: `` <C-x>55 ``, select: `` <C-x>55 ``, insert: `` <C-x>55 ``<br>**cua** — normal: `` <C-x>55 ``, select: `` <C-X>55 ``, insert: `` <C-x>55 ``<br>**micro, nano** — select: `` <C-x>55 `` |
| `other_window_prefix` | Display the next command's buffer in another window (emacs other-window-prefix) | **spacemacs** — normal: `` <C-x>44 ``, select: `` <C-x>44 ``, insert: `` <C-x>44 ``<br>**hybrid** — normal: `` <C-x>44 ``, select: `` <C-x>44 `` |
| `other_tab_prefix` | Display the next command's buffer in a new tab (emacs other-tab-prefix) | **spacemacs** — normal: `` <C-x>tt ``, select: `` <C-x>tt ``, insert: `` <C-x>tt ``<br>**hybrid** — normal: `` <C-x>tt ``, select: `` <C-x>tt `` |
| `display_buffer` | Show a buffer in another window without selecting it (emacs display-buffer) | **spacemacs** — normal: `` <C-x>4<C-o> ``, select: `` <C-x>4<C-o> ``, insert: `` <C-x>4<C-o> ``<br>**hybrid** — normal: `` <C-x>4<C-o> ``, select: `` <C-x>4<C-o> `` |
| `server_start` | Start the zmax server so clients can hand it files (emacs server-start) |  |
| `server_edit` | Finish with this buffer and let the waiting client return (emacs server-edit) | **spacemacs** — normal: `` <C-x># ``, select: `` <C-x># ``, insert: `` <C-x># ``<br>**hybrid** — normal: `` <C-x># ``, select: `` <C-x># `` |
...
| `paste_after_reindent` | Paste after, indent shifted to the current line (vim ]p) | **spacemacs, hybrid, vim** — normal: `` ]p `` |
| `paste_before_reindent` | Paste before, indent shifted to the current line (vim [p) | **spacemacs, hybrid, vim** — normal: `` [p `` |
...
| `mouse_buffer_menu` | The buffer menu, from the mouse (emacs mouse-buffer-menu) | **spacemacs, hybrid, vim** — normal: `` <C-F10> `` |
...
| `context_menu_open` | Pop up the context menu at the click, or at point (emacs context-menu-open) | **spacemacs, vim** — normal: `` <S-F10> ``<br>**hybrid** — normal: `` <S-F10> ``, insert: `` <S-F10> ``<br>**emacs, cua, micro, nano** — insert: `` <S-F10> `` |
...
| `find_file_read_only` | Visit a file in a read-only buffer (emacs find-file-read-only, C-x C-r) | **spacemacs, hybrid** — normal: `` <C-x><C-r> ``, select: `` <C-x><C-r> ``, insert: `` <C-x><C-r> ``<br>**emacs** — insert: `` <C-x><C-r> ``<br>**cua** — select: `` <C-X><C-r> ``, insert: `` <C-x><C-r> `` |
...
| `compose_mail_other_frame` | Open a mail draft in a new frame (emacs compose-mail-other-frame) | **spacemacs, hybrid, emacs** — normal: `` <C-x>5m ``, select: `` <C-x>5m ``, insert: `` <C-x>5m ``<br>**cua** — normal: `` <C-x>5m ``, select: `` <C-X>5m ``, insert: `` <C-x>5m ``<br>**micro, nano** — select: `` <C-x>5m `` |
