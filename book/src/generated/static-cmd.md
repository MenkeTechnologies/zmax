...
| --- | --- | --- |
| `no_op` | Do nothing |  |
| `move_char_left` | Move left | **spacemacs** — normal: `` h ``, insert: `` <C-b> ``, `` <left> ``<br>**vim** — normal: `` h ``, `` <C-h> ``, insert: `` <left> ``<br>**helix, kakoune** — normal: `` h ``, `` <left> ``, insert: `` <left> ``<br>**emacs, cua, nano** — normal: `` <C-b> ``, insert: `` <C-b> `` |
| `move_char_right` | Move right | **spacemacs** — normal: `` l ``, insert: `` <C-f> ``, `` <right> ``<br>**vim** — normal: `` l ``, `` <space> ``, insert: `` <right> ``<br>**helix, kakoune** — normal: `` l ``, `` <right> ``, insert: `` <right> ``<br>**emacs, cua, nano** — normal: `` <C-f> ``, insert: `` <C-f> `` |
| `move_line_up` | Move up | **spacemacs, vim** — normal: `` k ``, `` <C-p> ``, insert: `` <up> ``<br>**helix, kakoune** — normal: `` gk `` |
| `move_line_down` | Move down | **spacemacs, vim** — normal: `` j ``, `` <C-j> ``, `` <C-n> ``, insert: `` <down> ``<br>**helix, kakoune** — normal: `` gj `` |
...
| `move_visual_line_up` | Move up | **spacemacs, vim** — normal: `` gk ``, `` g<up> ``, insert: `` <C-g>k ``, `` <C-g><up> ``, `` <C-g><C-k> ``<br>**helix, kakoune** — normal: `` k ``, `` <up> ``, insert: `` <up> ``<br>**emacs, cua, nano** — normal: `` <up> ``, `` <C-p> ``, insert: `` <up> ``, `` <C-p> ``<br>**micro** — normal: `` <up> ``, insert: `` <up> `` |
| `move_visual_line_down` | Move down | **spacemacs, vim** — normal: `` gj ``, `` g<down> ``, insert: `` <C-g>j ``, `` <C-g><C-j> ``, `` <C-g><down> ``<br>**helix, kakoune** — normal: `` j ``, `` <down> ``, insert: `` <down> ``<br>**emacs, cua, nano** — normal: `` <C-n> ``, `` <down> ``, insert: `` <C-n> ``, `` <down> ``<br>**micro** — normal: `` <down> ``, insert: `` <down> `` |
...
| `move_prev_word_start` | Move to start of previous word | **spacemacs** — normal: `` <A-b> ``, `` <A-left> ``, `` <C-left> ``, insert: `` <A-b> ``, `` <C-left> ``, `` <S-left> ``<br>**vim** — normal: `` <C-left> ``, insert: `` <C-left> ``, `` <S-left> ``<br>**helix, kakoune** — normal: `` b ``<br>**emacs, cua, micro, nano** — normal: `` <A-b> ``, insert: `` <A-b> `` |
| `move_next_word_end` | Move to end of next word | **helix, kakoune** — normal: `` e ``<br>**emacs, cua, nano** — normal: `` <A-f> ``, insert: `` <A-f> `` |
...
| `extend_prev_word_start` | Extend to start of previous word | **helix, kakoune** — select: `` b ``<br>**emacs, cua, micro, nano** — select: `` <A-b> `` |
| `extend_next_word_end` | Extend to end of next word | **helix, kakoune** — select: `` e ``<br>**emacs, cua, micro, nano** — select: `` <A-f> `` |
...
| `repeat_last_motion` | Repeat last motion | **spacemacs** — normal: `` <C-x>z ``, select: `` <C-x>z ``, insert: `` <C-x>z ``<br>**helix, kakoune** — normal: `` <A-.> ``, select: `` <A-.> `` |
...
| `replace` | Replace with new char | **spacemacs, vim** — select: `` r ``<br>**helix, kakoune** — normal: `` r ``, select: `` r `` |
| `switch_case` | Switch (toggle) case | **spacemacs, vim** — select: `` ~ ``<br>**helix, kakoune** — normal: `` ~ ``, select: `` ~ `` |
...
| `downcase_word` | Lower-case the word after point (emacs downcase-word, M-l) | **spacemacs** — normal: `` <A-l> ``<br>**emacs, cua, micro, nano** — normal: `` <A-l> ``, insert: `` <A-l> `` |
| `capitalize_word` | Capitalize the word after point (emacs capitalize-word, M-c) | **spacemacs** — normal: `` <A-c> ``<br>**emacs, cua, nano** — normal: `` <A-c> ``, insert: `` <A-c> `` |
...
| `page_up` | Move page up | **spacemacs** — normal: `` <A-v> ``, `` <C-b> ``, `` <S-minus> ``, insert: `` <A-v> ``, `` <S-up> ``, `` <pageup> ``<br>**vim** — normal: `` <C-b> ``, `` <S-minus> ``, insert: `` <S-up> ``, `` <pageup> ``<br>**helix** — normal: `` <C-b> ``, `` Z<C-b> ``, `` z<C-b> ``, `` <pageup> ``, `` Z<pageup> ``, `` z<pageup> ``, select: `` <C-b> ``, `` Z<C-b> ``, `` z<C-b> ``, `` <pageup> ``, `` Z<pageup> ``, `` z<pageup> ``, insert: `` <pageup> ``<br>**kakoune** — normal: `` <C-b> ``, `` V<C-b> ``, `` v<C-b> ``, `` <pageup> ``, `` V<pageup> ``, `` v<pageup> ``, select: `` <C-b> ``, `` <pageup> ``, insert: `` <pageup> ``<br>**emacs, cua, micro** — normal: `` <A-v> ``, `` <pageup> ``, insert: `` <A-v> ``, `` <pageup> ``<br>**nano** — normal: `` <A-v> ``, `` <C-y> ``, `` <pageup> ``, insert: `` <A-v> ``, `` <C-y> ``, `` <pageup> `` |
...
| `page_cursor_half_up` | Move page and cursor half up | **spacemacs, vim** — normal: `` <C-u> ``<br>**helix** — normal: `` <C-u> ``, `` Z<C-u> ``, `` z<C-u> ``, `` Z<backspace> ``, `` z<backspace> ``, select: `` <C-u> ``, `` Z<C-u> ``, `` z<C-u> ``, `` Z<backspace> ``, `` z<backspace> ``<br>**kakoune** — normal: `` <C-u> ``, `` V<C-u> ``, `` v<C-u> ``, `` V<backspace> ``, `` v<backspace> ``, select: `` <C-u> `` |
...
| `search` | Search for regex pattern | **spacemacs** — normal: `` / ``, `` <C-s> ``, `` <A-C-s> ``, select: `` / ``<br>**vim, kakoune** — normal: `` / ``, select: `` / ``<br>**helix** — normal: `` / ``, `` Z/ ``, `` z/ ``, select: `` / ``, `` Z/ ``, `` z/ ``<br>**emacs, cua** — normal: `` <C-s> ``, `` <A-C-s> ``, insert: `` <C-s> ``, `` <A-C-s> ``<br>**micro** — normal: `` <F3> ``, `` <F7> ``, `` <C-f> ``, `` <A-C-s> ``, insert: `` <F3> ``, `` <F7> ``, `` <C-f> ``, `` <A-C-s> ``<br>**nano** — normal: `` <C-s> ``, `` <C-w> ``, `` <A-C-s> ``, insert: `` <C-s> ``, `` <C-w> ``, `` <A-C-s> `` |
| `rsearch` | Reverse search for regex pattern | **spacemacs** — normal: `` ? ``, `` <A-C-r> ``, select: `` ? ``<br>**vim, kakoune** — normal: `` ? ``, select: `` ? ``<br>**helix** — normal: `` ? ``, `` Z? ``, `` z? ``, select: `` ? ``, `` Z? ``, `` z? ``<br>**emacs, cua, micro** — normal: `` <C-r> ``, `` <A-C-r> ``, insert: `` <C-r> ``, `` <A-C-r> ``<br>**nano** — normal: `` <C-q> ``, `` <A-C-r> ``, insert: `` <C-q> ``, `` <A-C-r> `` |
...
| `search_next` | Select next search match | **spacemacs** — normal: `` <space>sH ``, select: `` <space>sH ``<br>**helix** — normal: `` n ``, `` Zn ``, `` zn ``, select: `` Zn ``, `` zn ``<br>**kakoune** — normal: `` n ``<br>**micro** — normal: `` <C-n> ``, insert: `` <C-n> ``<br>**nano** — normal: `` <A-w> ``, insert: `` <A-w> `` |
...
| `count_words_region` | Count occurrences per word in the selection (SPC x w c) | **spacemacs** — normal: `` <space>xwc ``, select: `` <space>xwc ``<br>**nano** — normal: `` <A-d> ``, insert: `` <A-d> `` |
...
| `toggle_modeline_major_mode` | Toggle the major mode (file type) in the mode line (SPC t m M) | **spacemacs** — normal: `` <space>tmM ``, select: `` <space>tmM `` |
...
| `ediff_merge_revisions_with_ancestor` | Merge two revisions of this file against their common ancestor (emacs ediff-merge-revisions-with-ancestor, SPC D m r 3) | **spacemacs** — normal: `` <space>Dmr3 ``, select: `` <space>Dmr3 `` |
| `ediff_merge_revisions` | Merge two revisions of this file, no ancestor (emacs ediff-merge-revisions, SPC D m r r) | **spacemacs** — normal: `` <space>Dmrr ``, select: `` <space>Dmrr `` |
...
| `collapse_selection` | Collapse selection into single cursor | **helix, kakoune** — normal: `` ; ``, select: `` ; ``<br>**emacs, cua** — normal: `` <C-g> ``, `` <C-pause> ``, insert: `` <C-g> ``, `` <C-pause> ``<br>**micro, nano** — normal: `` <C-pause> ``, insert: `` <C-pause> `` |
...
| `insert_mode` | Insert before selection | **spacemacs** — normal: `` i ``, `` <ins> ``, `` <space>ki ``, select: `` <space>ki ``<br>**vim** — normal: `` i ``, `` <ins> ``<br>**helix, kakoune** — normal: `` i ``, select: `` i ``<br>**emacs, cua, micro, nano** — normal: `` a ``, `` i `` |
...
| `query_replace` | Replace matches one by one, asking (emacs query-replace M-%) | **emacs, cua, micro, nano** — insert: `` <A-%> `` |
| `query_replace_regexp` | Replace regexp matches one by one, asking (emacs query-replace-regexp C-M-%) | **emacs, cua, micro, nano** — insert: `` <A-C-%> `` |
...
| `gnus` | Open the Gnus newsreader on $NNTPSERVER or the ~/News spool (emacs gnus) | **spacemacs** — normal: `` <space>aN ``, select: `` <space>aN `` |
...
| `insert_at_line_start` | Insert at start of line | **spacemacs, vim** — normal: `` I ``, `` gI ``<br>**helix, kakoune** — normal: `` I ``, select: `` I `` |
| `insert_at_line_end` | Insert at end of line | **spacemacs, vim** — normal: `` A ``<br>**helix, kakoune** — normal: `` A ``, select: `` A `` |
| `open_below` | Open new line below selection | **spacemacs, vim** — normal: `` o ``<br>**helix, kakoune** — normal: `` o ``, select: `` o `` |
| `open_above` | Open new line above selection | **spacemacs, vim** — normal: `` O ``<br>**helix, kakoune** — normal: `` O ``, select: `` O `` |
...
| `select_mode` | Enter selection extend mode | **spacemacs** — normal: `` v ``, `` gh ``, `` <C-space> ``, `` <space>kv ``, `` <space>k<C-v> ``, select: `` <space>kv ``, `` <space>k<C-v> ``<br>**vim** — normal: `` v ``, `` gh ``<br>**helix** — normal: `` v ``<br>**emacs, cua, micro** — normal: `` <C-space> ``<br>**nano** — normal: `` <A-a> ``, `` <C-space> ``, insert: `` <A-a> `` |
| `exit_select_mode` | Exit selection mode | **helix, kakoune** — select: `` <esc> `` |
| `goto_definition` | Goto definition | **spacemacs** — normal: `` g] ``, `` gd ``, `` <A-.> ``, `` <C-w>] ``, `` g<C-]> ``, `` <C-c>,j ``, `` <C-w>g] ``, `` <C-x>5. ``, `` <space>gd ``, `` <space>jf ``, `` <space>jv ``, `` <space>w] ``, `` <C-w><C-]> ``, `` <space>mgg ``, `` <space>wg] ``, `` <C-w>g<C-]> ``, `` <space>w<C-]> ``, `` <space>wg<C-]> ``, select: `` <C-]> ``, `` <C-c>,j ``, `` <C-x>5. ``, `` <space>gd ``, `` <space>jf ``, `` <space>jv ``, `` <space>w] ``, `` <space>mgg ``, `` <space>wg] ``, `` <space>w<C-]> ``, `` <space>wg<C-]> ``, insert: `` <C-c>,j ``, `` <C-x>5. ``<br>**vim** — normal: `` g] ``, `` gd ``, `` <C-w>] ``, `` g<C-]> ``, `` <C-w>g] ``, `` <C-w><C-]> ``, `` <C-w>g<C-]> ``, select: `` <C-]> ``<br>**helix, kakoune** — normal: `` gd ``, select: `` gd ``<br>**emacs, cua, nano** — normal: `` <A-.> ``, insert: `` <A-.> `` |
...
| `goto_declaration` | Goto declaration | **spacemacs** — normal: `` gD ``, `` <C-w>i ``, `` <space>gD ``, `` <space>wi ``, `` <C-w><C-i> ``, `` <space>w<C-i> ``, select: `` <space>gD ``, `` <space>wi ``, `` <space>w<C-i> ``<br>**vim** — normal: `` gD ``, `` <C-w>i ``, `` <C-w><C-i> ``<br>**helix, kakoune** — normal: `` gD ``, select: `` gD `` |
...
| `goto_file_start` | Goto line number `<n>` else file start | **spacemacs** — normal: `` gg ``, `` <A-lt> ``, `` <C-home> ``, insert: `` <A-lt> ``, `` <C-home> ``<br>**vim** — normal: `` gg ``, `` <C-home> ``, insert: `` <C-home> ``<br>**helix, kakoune** — normal: `` gg ``<br>**emacs, cua, micro** — normal: `` <A-lt> ``, select: `` <A-lt> ``, insert: `` <A-lt> ``<br>**nano** — normal: `` <A-\> ``, `` <A-lt> ``, select: `` <A-lt> ``, insert: `` <A-\> ``, `` <A-lt> `` |
...
| `goto_file` | Goto files/URLs in selections | **spacemacs** — normal: `` [f ``, `` ]f ``, `` gf ``, `` gx ``, `` <C-w>gF ``, `` <C-w>gf ``, `` <space>fF ``, `` <space>jU ``, `` <space>ju ``, `` <space>pF ``, `` <space>wgF ``, `` <space>wgf ``, select: `` <space>fF ``, `` <space>jU ``, `` <space>ju ``, `` <space>pF ``, `` <space>wgF ``, `` <space>wgf ``<br>**vim** — normal: `` [f ``, `` ]f ``, `` gf ``, `` gx ``, `` <C-w>gF ``, `` <C-w>gf ``<br>**helix, kakoune** — normal: `` gf ``, select: `` gf `` |
| `goto_file_hsplit` | Goto files in selections (hsplit) | **spacemacs** — normal: `` <C-w>F ``, `` <space>wF ``, `` <C-w><C-f> ``, `` <space>w<C-f> ``, select: `` <space>wF ``, `` <space>w<C-f> ``<br>**vim** — normal: `` <C-w>F ``, `` <C-w><C-f> ``<br>**helix** — normal: `` <C-w>f ``, `` <space>wf ``, select: `` <C-w>f ``, `` <space>wf ``<br>**kakoune** — normal: `` <C-w>f ``, select: `` <C-w>f `` |
...
| `goto_reference` | Goto references | **spacemacs, vim** — normal: `` gr ``<br>**helix, kakoune** — normal: `` gr ``, select: `` gr ``<br>**emacs, cua, micro, nano** — normal: `` <A-?> ``, insert: `` <A-?> `` |
...
| `goto_window_top` | Goto window top | **spacemacs, vim** — normal: `` H ``<br>**helix, kakoune** — normal: `` gt ``, select: `` gt `` |
...
| `what_cursor_position` | Report the character at point, its code, position, percentage and column (emacs what-cursor-position, C-x =) | **spacemacs** — normal: `` <C-x>= ``, select: `` <C-x>= ``, insert: `` <C-x>= ``<br>**nano** — normal: `` <C-c> ``, insert: `` <C-c> `` |
...
| `goto_line` | Goto line | **spacemacs** — normal: `` <A-g>g ``, `` <A-g><A-g> ``<br>**helix, kakoune** — normal: `` G ``, select: `` G ``<br>**emacs, cua, micro** — normal: `` <A-g>g ``, `` <A-g><A-g> ``, insert: `` <A-g>g ``, `` <A-g><A-g> ``<br>**nano** — normal: `` <A-g> ``, `` <C-_> ``, insert: `` <A-g> ``, `` <C-_> `` |
| `goto_last_line` | Goto last line | **spacemacs** — normal: `` G ``, `` <A-gt> ``, `` <C-end> ``<br>**vim** — normal: `` G ``, `` <C-end> ``<br>**helix, kakoune** — normal: `` ge ``<br>**emacs, cua, micro** — normal: `` <A-gt> ``, select: `` <A-gt> ``, insert: `` <A-gt> ``<br>**nano** — normal: `` <A-/> ``, `` <A-gt> ``, select: `` <A-gt> ``, insert: `` <A-/> ``, `` <A-gt> `` |
...
| `menu_bar_open` | Open the menu bar (emacs menu-bar-open, F10) | **emacs, cua, nano** — normal: `` <F10> ``, insert: `` <F10> `` |
| `menu_bar_mode` | Toggle the menu-bar row (emacs menu-bar-mode) | **spacemacs** — normal: `` <space>Tm ``, select: `` <space>Tm `` |
| `tool_bar_mode` | Toggle the tool-bar row of command buttons (emacs tool-bar-mode) | **spacemacs** — normal: `` <space>Tt ``, select: `` <space>Tt `` |
...
| `tmm_menubar` | Pick a menu-bar command from a text list (emacs tmm-menubar) | **emacs, cua, micro, nano** — normal: `` <A-`> ``, insert: `` <A-`> `` |
...
| `goto_line_start` | Goto line start | **spacemacs** — normal: `` 0 ``, `` g<home> ``, `` <space>j0 ``, select: `` <space>j0 ``, insert: `` <home> ``<br>**vim** — normal: `` 0 ``, `` g<home> ``, insert: `` <home> ``<br>**helix, kakoune** — normal: `` gh ``, `` <home> ``, select: `` gh ``, insert: `` <home> ``<br>**emacs, cua, nano** — normal: `` <C-a> ``, `` <home> ``, select: `` <C-a> ``, insert: `` <C-a> ``, `` <home> ``<br>**micro** — normal: `` <A-a> ``, `` <home> ``, select: `` <C-a> ``, insert: `` <A-a> ``, `` <home> `` |
| `goto_line_end` | Goto line end | **spacemacs** — normal: `` $ ``, `` gl ``, `` g<end> ``, `` <space>j$ ``, select: `` <space>j$ ``<br>**vim** — normal: `` $ ``, `` gl ``, `` g<end> ``<br>**helix, kakoune** — normal: `` gl ``, `` <end> ``, select: `` gl ``<br>**emacs, cua, nano** — normal: `` <C-e> ``, `` <end> ``, select: `` <C-e> ``, insert: `` <C-e> ``, `` <end> ``<br>**micro** — normal: `` <A-e> ``, `` <end> ``, select: `` <C-e> ``, insert: `` <A-e> ``, `` <end> `` |
...
| `goto_first_nonwhitespace` | Goto first non-blank in line | **spacemacs** — normal: `` ^ ``, `` <A-m> ``<br>**vim** — normal: `` ^ ``<br>**helix, kakoune** — normal: `` gs ``, select: `` gs ``<br>**emacs, cua, micro, nano** — normal: `` <A-m> ``, insert: `` <A-m> `` |
...
| `insert_tab` | Insert tab char | **helix, kakoune** — insert: `` <S-tab> ``<br>**emacs, cua, micro, nano** — insert: `` <A-i> `` |
| `insert_newline` | Insert newline char | **spacemacs, vim, helix, kakoune, emacs, cua** — insert: `` <C-j> ``, `` <ret> ``<br>**micro, nano** — insert: `` <ret> `` |
...
| `delete_char_backward` | Delete previous char | **spacemacs** — insert: `` <backspace> ``<br>**vim, emacs, cua, micro** — insert: `` <C-h> ``, `` <backspace> ``<br>**helix, kakoune** — insert: `` <C-h> ``, `` <backspace> ``, `` <S-backspace> ``<br>**nano** — normal: `` <C-h> ``, insert: `` <C-h> ``, `` <backspace> `` |
| `delete_char_forward` | Delete next char | **spacemacs, vim, micro** — insert: `` <del> ``<br>**helix, kakoune** — insert: `` <C-d> ``, `` <del> ``<br>**emacs, cua, nano** — normal: `` <C-d> ``, insert: `` <C-d> ``, `` <del> `` |
...
| `delete_word_backward` | Delete previous word | **spacemacs, vim, helix, kakoune** — insert: `` <C-w> ``, `` <A-backspace> ``<br>**emacs, cua** — insert: `` <C-w> ``, `` <A-backspace> ``, `` <A-C-backspace> ``<br>**micro, nano** — insert: `` <A-backspace> ``, `` <A-C-backspace> `` |
...
| `replace_with_yanked` | Replace with yanked text | **spacemacs, vim** — select: `` P ``, `` p ``<br>**helix, kakoune** — normal: `` R ``, select: `` R `` |
...
| `paste_after` | Paste after selection | **spacemacs** — normal: `` p ``, `` <space>kp ``, select: `` <space>kp ``<br>**vim** — normal: `` p ``<br>**helix, kakoune** — normal: `` p ``, select: `` p `` |
...
| `yank_pop` | Replace the just-yanked text with the next kill-ring entry (emacs M-y) | **spacemacs** — normal: `` <A-y> ``<br>**emacs, cua, micro, nano** — normal: `` <A-y> ``, insert: `` <A-y> `` |
| `set_mark_command` | Set mark and activate region, pushing to the mark ring (emacs C-SPC) | **spacemacs** — normal: `` <C-@> ``<br>**emacs, cua, micro, nano** — insert: `` <C-space> `` |
...
| `format_selections` | Format selection | **spacemacs** — normal: `` <space>j+ ``, `` <space>j= ``, `` <space>lf ``, select: `` <space>j+ ``, `` <space>j= ``, `` <space>lf ``<br>**helix, kakoune** — normal: `` = ``, select: `` = ``<br>**nano** — normal: `` <C-j> ``, insert: `` <C-j> `` |
| `reflow_selections` | vim gq: reflow selection to text-width | **spacemacs** — normal: `` <A-q> ``<br>**emacs, cua, micro, nano** — normal: `` <A-q> ``, insert: `` <A-q> `` |
...
| `join_selections` | Join lines inside selection | **spacemacs** — normal: `` <A-^> ``, `` <space>kJ ``, select: `` <space>kJ ``<br>**helix, kakoune** — normal: `` J ``, select: `` J ``<br>**emacs, cua, micro, nano** — insert: `` <A-^> `` |
...
| `toggle_comments` | Comment/uncomment selections | **spacemacs** — normal: `` <A-;> ``, `` <space>; ``, `` <space>cP ``, `` <space>cc ``, `` <space>cp ``, `` <C-x><C-;> ``, select: `` <space>; ``, `` <space>cP ``, `` <space>cc ``, `` <space>cp ``, `` <C-x><C-;> ``, insert: `` <C-x><C-;> ``<br>**helix** — normal: `` <C-c> ``, `` <space>c ``, select: `` <C-c> ``, `` <space>c ``<br>**kakoune** — normal: `` <C-c> ``, select: `` <C-c> ``<br>**emacs** — normal: `` <A-;> ``, insert: `` <A-;> ``, `` <C-x><C-;> ``<br>**cua** — normal: `` <A-;> ``, select: `` <C-X><C-;> ``, insert: `` <A-;> ``, `` <C-x><C-;> ``<br>**micro** — normal: `` <A-;> ``, insert: `` <A-;> ``<br>**nano** — normal: `` <A-3> ``, `` <A-;> ``, insert: `` <A-3> ``, `` <A-;> `` |
...
| `expand_selection` | Expand selection to parent syntax node | **spacemacs** — normal: `` <space>v ``, `` <space>kU ``, select: `` <space>v ``, `` <space>kU ``<br>**helix** — normal: `` <A-o> ``, `` <A-up> ``, select: `` <A-o> ``, `` <A-up> ``<br>**kakoune** — normal: `` <A-up> ``, select: `` <A-o> ``, `` <A-up> `` |
...
| `jump_backward` | Jump backward on jumplist | **spacemacs** — normal: `` <C-o> ``, `` <space>jb ``, `` <space>s` ``, select: `` <space>jb ``, `` <space>s` ``<br>**vim** — normal: `` <C-o> ``<br>**helix, kakoune** — normal: `` <C-o> ``, select: `` <C-o> ``<br>**emacs, cua, nano** — normal: `` <A-,> ``, insert: `` <A-,> `` |
...
| `jump_view_left` | Jump to left split | **spacemacs** — normal: `` <C-w>h ``, `` <C-w>.h ``, `` <C-w>[h ``, `` <C-w>{h ``, `` <space>wh ``, `` <C-w><C-h> ``, `` <space>w.h ``, `` <space>w[h ``, `` <space>w{h ``, `` <C-w><left> ``, `` <space>w<C-h> ``, `` <space>w<left> ``, select: `` <space>wh ``, `` <space>w.h ``, `` <space>w[h ``, `` <space>w{h ``, `` <space>w<C-h> ``, `` <space>w<left> ``<br>**vim** — normal: `` <C-w>h ``, `` <C-w>.h ``, `` <C-w>[h ``, `` <C-w>{h ``, `` <C-w><C-h> ``, `` <C-w><left> ``<br>**helix** — normal: `` <C-w>h ``, `` <space>wh ``, `` <C-w><C-h> ``, `` <C-w><left> ``, `` <space>w<C-h> ``, `` <space>w<left> ``, select: `` <C-w>h ``, `` <space>wh ``, `` <C-w><C-h> ``, `` <C-w><left> ``, `` <space>w<C-h> ``, `` <space>w<left> ``<br>**kakoune** — normal: `` <C-w>h ``, `` <C-w><C-h> ``, `` <C-w><left> ``, select: `` <C-w>h ``, `` <C-w><C-h> ``, `` <C-w><left> `` |
| `jump_view_up` | Jump to split above | **spacemacs** — normal: `` <C-w>k ``, `` <C-w>.k ``, `` <C-w>[k ``, `` <C-w>{k ``, `` <C-w><up> ``, `` <space>wk ``, `` <C-w><C-k> ``, `` <C-w><C-t> ``, `` <space>w.k ``, `` <space>w[k ``, `` <space>w{k ``, `` <space>w<up> ``, `` <space>w<C-k> ``, `` <space>w<C-t> ``, select: `` <space>wk ``, `` <space>w.k ``, `` <space>w[k ``, `` <space>w{k ``, `` <space>w<up> ``, `` <space>w<C-k> ``, `` <space>w<C-t> ``<br>**vim** — normal: `` <C-w>k ``, `` <C-w>.k ``, `` <C-w>[k ``, `` <C-w>{k ``, `` <C-w><up> ``, `` <C-w><C-k> ``, `` <C-w><C-t> ``<br>**helix** — normal: `` <C-w>k ``, `` <C-w><up> ``, `` <space>wk ``, `` <C-w><C-k> ``, `` <space>w<up> ``, `` <space>w<C-k> ``, select: `` <C-w>k ``, `` <C-w><up> ``, `` <space>wk ``, `` <C-w><C-k> ``, `` <space>w<up> ``, `` <space>w<C-k> ``<br>**kakoune** — normal: `` <C-w>k ``, `` <C-w><up> ``, `` <C-w><C-k> ``, select: `` <C-w>k ``, `` <C-w><up> ``, `` <C-w><C-k> `` |
...
| `swap_view_right` | Swap with right split | **spacemacs** — normal: `` <C-w>L ``, `` <C-w>.L ``, `` <C-w>[L ``, `` <C-w>{L ``, `` <space>wL ``, `` <space>w.L ``, `` <space>w[L ``, `` <space>w{L ``, select: `` <space>wL ``, `` <space>w.L ``, `` <space>w[L ``, `` <space>w{L ``<br>**vim** — normal: `` <C-w>L ``, `` <C-w>.L ``, `` <C-w>[L ``, `` <C-w>{L ``<br>**helix** — normal: `` <C-w>L ``, `` <space>wL ``, select: `` <C-w>L ``, `` <space>wL ``<br>**kakoune** — normal: `` <C-w>L ``, select: `` <C-w>L `` |
| `swap_view_left` | Swap with left split | **spacemacs** — normal: `` <C-w>H ``, `` <C-w>.H ``, `` <C-w>[H ``, `` <C-w>{H ``, `` <space>wH ``, `` <space>w.H ``, `` <space>w[H ``, `` <space>w{H ``, select: `` <space>wH ``, `` <space>w.H ``, `` <space>w[H ``, `` <space>w{H ``<br>**vim** — normal: `` <C-w>H ``, `` <C-w>.H ``, `` <C-w>[H ``, `` <C-w>{H ``<br>**helix** — normal: `` <C-w>H ``, `` <space>wH ``, select: `` <C-w>H ``, `` <space>wH ``<br>**kakoune** — normal: `` <C-w>H ``, select: `` <C-w>H `` |
| `swap_view_up` | Swap with split above | **spacemacs** — normal: `` <C-w>K ``, `` <C-w>.K ``, `` <C-w>[K ``, `` <C-w>{K ``, `` <space>wK ``, `` <space>w.K ``, `` <space>w[K ``, `` <space>w{K ``, select: `` <space>wK ``, `` <space>w.K ``, `` <space>w[K ``, `` <space>w{K ``<br>**vim** — normal: `` <C-w>K ``, `` <C-w>.K ``, `` <C-w>[K ``, `` <C-w>{K ``<br>**helix** — normal: `` <C-w>K ``, `` <space>wK ``, select: `` <C-w>K ``, `` <space>wK ``<br>**kakoune** — normal: `` <C-w>K ``, select: `` <C-w>K `` |
| `swap_view_down` | Swap with split below | **spacemacs** — normal: `` <C-w>J ``, `` <C-w>.J ``, `` <C-w>[J ``, `` <C-w>{J ``, `` <space>wJ ``, `` <space>w.J ``, `` <space>w[J ``, `` <space>w{J ``, select: `` <space>wJ ``, `` <space>w.J ``, `` <space>w[J ``, `` <space>w{J ``<br>**vim** — normal: `` <C-w>J ``, `` <C-w>.J ``, `` <C-w>[J ``, `` <C-w>{J ``<br>**helix** — normal: `` <C-w>J ``, `` <space>wJ ``, select: `` <C-w>J ``, `` <space>wJ ``<br>**kakoune** — normal: `` <C-w>J ``, select: `` <C-w>J `` |
...
| `transpose_view` | Transpose splits | **spacemacs** — normal: `` <C-w>M ``, `` <C-w>x ``, `` <space>wM ``, `` <space>wx ``, `` <C-w><C-x> ``, `` <space>w<C-x> ``, select: `` <space>wM ``, `` <space>wx ``, `` <space>w<C-x> ``<br>**vim** — normal: `` <C-w>M ``, `` <C-w>x ``, `` <C-w><C-x> ``<br>**helix** — normal: `` <C-w>t ``, `` <space>wt ``, `` <C-w><C-t> ``, `` <space>w<C-t> ``, select: `` <C-w>t ``, `` <space>wt ``, `` <C-w><C-t> ``, `` <space>w<C-t> ``<br>**kakoune** — normal: `` <C-w>t ``, `` <C-w><C-t> ``, select: `` <C-w>t ``, `` <C-w><C-t> `` |
...
| `tab_recent` | Switch to the most recently visited tab (emacs tab-recent) | **emacs, cua, micro, nano** — normal: `` <C-0> ``, select: `` <C-0> ``, insert: `` <C-0> `` |
...
| `copy_as_format` | Copy the region or line to the kill ring, wrapped for the default format (spacemacs copy-as-format) | **spacemacs** — normal: `` <space>xff ``, select: `` <space>xff `` |
| `copy_as_format_asciidoc` | Copy the region or line as an AsciiDoc source block (copy-as-format-asciidoc) | **spacemacs** — normal: `` <space>xfa ``, select: `` <space>xfa `` |
| `copy_as_format_bitbucket` | Copy the region or line as Bitbucket markup (copy-as-format-bitbucket) | **spacemacs** — normal: `` <space>xfb ``, select: `` <space>xfb `` |
| `copy_as_format_disqus` | Copy the region or line as Disqus markup (copy-as-format-disqus) | **spacemacs** — normal: `` <space>xfd ``, select: `` <space>xfd `` |
| `copy_as_format_github` | Copy the region or line as a GitHub fenced block (copy-as-format-github) | **spacemacs** — normal: `` <space>xfg ``, select: `` <space>xfg `` |
| `copy_as_format_gitlab` | Copy the region or line as GitLab markup (copy-as-format-gitlab) | **spacemacs** — normal: `` <space>xfl ``, select: `` <space>xfl `` |
| `copy_as_format_hipchat` | Copy the region or line as a HipChat /code message (copy-as-format-hipchat) | **spacemacs** — normal: `` <space>xfc ``, select: `` <space>xfc `` |
| `copy_as_format_html` | Copy the region or line as HTML pre/code (copy-as-format-html) | **spacemacs** — normal: `` <space>xfh ``, select: `` <space>xfh `` |
| `copy_as_format_jira` | Copy the region or line as a Jira {code} block (copy-as-format-jira) | **spacemacs** — normal: `` <space>xfj ``, select: `` <space>xfj `` |
| `copy_as_format_markdown` | Copy the region or line as indented Markdown code (copy-as-format-markdown) | **spacemacs** — normal: `` <space>xfm ``, select: `` <space>xfm `` |
| `copy_as_format_mediawiki` | Copy the region or line as MediaWiki syntaxhighlight (copy-as-format-mediawiki) | **spacemacs** — normal: `` <space>xfw ``, select: `` <space>xfw `` |
| `copy_as_format_org_mode` | Copy the region or line as an Org src block (copy-as-format-org-mode) | **spacemacs** — normal: `` <space>xfo ``, select: `` <space>xfo `` |
| `copy_as_format_pod` | Copy the region or line as POD (copy-as-format-pod) | **spacemacs** — normal: `` <space>xfp ``, select: `` <space>xfp `` |
| `copy_as_format_rst` | Copy the region or line as a reStructuredText code directive (copy-as-format-rst) | **spacemacs** — normal: `` <space>xfr ``, select: `` <space>xfr `` |
...
| `mark_paragraph` | Select the paragraph around point (emacs mark-paragraph, M-h) | **spacemacs** — normal: `` <A-h> ``<br>**emacs, cua, micro, nano** — normal: `` <A-h> ``, insert: `` <A-h> `` |
...
| `hsplit` | Horizontal bottom split | **spacemacs** — normal: `` <C-w>S ``, `` <C-w>s ``, `` <C-x>2 ``, `` <C-w>.S ``, `` <C-w>.s ``, `` <C-w>[S ``, `` <C-w>[s ``, `` <C-w>{S ``, `` <C-w>{s ``, `` <space>wS ``, `` <space>ws ``, `` <C-w><C-s> ``, `` <space>w.S ``, `` <space>w.s ``, `` <space>w[S ``, `` <space>w[s ``, `` <space>w{S ``, `` <space>w{s ``, `` <C-w>.<minus> ``, `` <C-w>[<minus> ``, `` <C-w>{<minus> ``, `` <space>w<C-s> ``, `` <space>w.<minus> ``, `` <space>w[<minus> ``, `` <space>w{<minus> ``, select: `` <C-x>2 ``, `` <space>wS ``, `` <space>ws ``, `` <space>w.S ``, `` <space>w.s ``, `` <space>w[S ``, `` <space>w[s ``, `` <space>w{S ``, `` <space>w{s ``, `` <space>w<C-s> ``, `` <space>w.<minus> ``, `` <space>w[<minus> ``, `` <space>w{<minus> ``, insert: `` <C-x>2 ``<br>**vim** — normal: `` <C-w>S ``, `` <C-w>s ``, `` <C-w>.S ``, `` <C-w>.s ``, `` <C-w>[S ``, `` <C-w>[s ``, `` <C-w>{S ``, `` <C-w>{s ``, `` <C-w><C-s> ``, `` <C-w>.<minus> ``, `` <C-w>[<minus> ``, `` <C-w>{<minus> ``<br>**helix** — normal: `` <C-w>s ``, `` <space>ws ``, `` <C-w><C-s> ``, `` <space>w<C-s> ``, select: `` <C-w>s ``, `` <space>ws ``, `` <C-w><C-s> ``, `` <space>w<C-s> ``<br>**kakoune** — normal: `` <C-w>s ``, `` <C-w><C-s> ``, select: `` <C-w>s ``, `` <C-w><C-s> ``<br>**emacs** — normal: `` <C-x>2 ``, insert: `` <C-x>2 ``<br>**cua** — normal: `` <C-x>2 ``, select: `` <C-X>2 ``, insert: `` <C-x>2 `` |
| `hsplit_new` | Horizontal bottom split scratch buffer | **spacemacs** — normal: `` <C-w>n ``, `` <space>wn ``, `` <C-w><C-n> ``, `` <space>bNj ``, `` <space>bNk ``, `` <space>w<C-n> ``, select: `` <space>wn ``, `` <space>bNj ``, `` <space>bNk ``, `` <space>w<C-n> ``<br>**vim** — normal: `` <C-w>n ``, `` <C-w><C-n> ``<br>**helix** — normal: `` <C-w>ns ``, `` <space>wns ``, `` <C-w>n<C-s> ``, `` <space>wn<C-s> ``, select: `` <C-w>ns ``, `` <space>wns ``, `` <C-w>n<C-s> ``, `` <space>wn<C-s> ``<br>**kakoune** — normal: `` <C-w>ns ``, `` <C-w>n<C-s> ``, select: `` <C-w>ns ``, `` <C-w>n<C-s> `` |
| `vsplit` | Vertical right split | **spacemacs** — normal: `` <C-w>/ ``, `` <C-w>2 ``, `` <C-w>V ``, `` <C-w>v ``, `` <C-x>3 ``, `` <C-w>./ ``, `` <C-w>.V ``, `` <C-w>.v ``, `` <C-w>[/ ``, `` <C-w>[V ``, `` <C-w>[v ``, `` <C-w>{/ ``, `` <C-w>{V ``, `` <C-w>{v ``, `` <space>w/ ``, `` <space>w2 ``, `` <space>wV ``, `` <space>wv ``, `` <C-w><C-v> ``, `` <space>w./ ``, `` <space>w.V ``, `` <space>w.v ``, `` <space>w[/ ``, `` <space>w[V ``, `` <space>w[v ``, `` <space>w{/ ``, `` <space>w{V ``, `` <space>w{v ``, `` <space>w<C-v> ``, `` <space>u<space>w2 ``, select: `` <C-x>3 ``, `` <space>w/ ``, `` <space>w2 ``, `` <space>wV ``, `` <space>wv ``, `` <space>w./ ``, `` <space>w.V ``, `` <space>w.v ``, `` <space>w[/ ``, `` <space>w[V ``, `` <space>w[v ``, `` <space>w{/ ``, `` <space>w{V ``, `` <space>w{v ``, `` <space>w<C-v> ``, `` <space>u<space>w2 ``, insert: `` <C-x>3 ``<br>**vim** — normal: `` <C-w>/ ``, `` <C-w>2 ``, `` <C-w>V ``, `` <C-w>v ``, `` <C-w>./ ``, `` <C-w>.V ``, `` <C-w>.v ``, `` <C-w>[/ ``, `` <C-w>[V ``, `` <C-w>[v ``, `` <C-w>{/ ``, `` <C-w>{V ``, `` <C-w>{v ``, `` <C-w><C-v> ``<br>**helix** — normal: `` <C-w>v ``, `` <space>wv ``, `` <C-w><C-v> ``, `` <space>w<C-v> ``, select: `` <C-w>v ``, `` <space>wv ``, `` <C-w><C-v> ``, `` <space>w<C-v> ``<br>**kakoune** — normal: `` <C-w>v ``, `` <C-w><C-v> ``, select: `` <C-w>v ``, `` <C-w><C-v> ``<br>**emacs** — normal: `` <C-x>3 ``, insert: `` <C-x>3 ``<br>**cua** — normal: `` <C-x>3 ``, select: `` <C-X>3 ``, insert: `` <C-x>3 `` |
| `vsplit_new` | Vertical right split scratch buffer | **spacemacs** — normal: `` <space>bNh ``, `` <space>bNl ``, select: `` <space>bNh ``, `` <space>bNl ``<br>**helix** — normal: `` <C-w>nv ``, `` <space>wnv ``, `` <C-w>n<C-v> ``, `` <space>wn<C-v> ``, select: `` <C-w>nv ``, `` <space>wnv ``, `` <C-w>n<C-v> ``, `` <space>wn<C-v> ``<br>**kakoune** — normal: `` <C-w>nv ``, `` <C-w>n<C-v> ``, select: `` <C-w>nv ``, `` <C-w>n<C-v> `` |
...
| `select_register` | Select register | **spacemacs, vim, helix, kakoune** — normal: `` " ``, select: `` " `` |
...
| `align_view_center` | Align view center | **spacemacs** — normal: `` zz ``, `` <C-l> ``, `` <C-w>.z ``, `` <C-w>[z ``, `` <C-w>{z ``, `` <space>b.z ``, `` <space>w.z ``, `` <space>w[z ``, `` <space>wc. ``, `` <space>w{z ``, select: `` zz ``, `` <space>b.z ``, `` <space>w.z ``, `` <space>w[z ``, `` <space>wc. ``, `` <space>w{z ``<br>**vim** — normal: `` zz ``, `` <C-w>.z ``, `` <C-w>[z ``, `` <C-w>{z ``, select: `` zz ``<br>**helix** — normal: `` Zc ``, `` Zz ``, `` zc ``, `` zz ``, select: `` Zc ``, `` Zz ``, `` zc ``, `` zz ``<br>**kakoune** — normal: `` Vc ``, `` Vv ``, `` vc ``, `` vv ``<br>**emacs, cua, micro, nano** — insert: `` <C-l> `` |
...
| `kmacro_call_ring_2nd` | Run the second macro in the ring without rotating it (emacs kmacro-call-ring-2nd, SPC K r l) | **spacemacs** — normal: `` <space>Krl ``, select: `` <space>Krl `` |
...
| `helm_google_suggest` | Google suggestions, opening the results in the browser (helm-google-suggest, SPC s w g) | **spacemacs** — normal: `` <space>swg ``, select: `` <space>swg `` |
...
| `match_brackets` | Goto matching bracket | **spacemacs** — normal: `` <space>k% ``, select: `` <space>k% ``<br>**helix** — normal: `` mm ``, select: `` mm ``<br>**kakoune** — normal: `` M ``, `` m ``, select: `` mm ``<br>**nano** — normal: `` <A-]> ``, insert: `` <A-]> `` |
...
| `select_textobject_around` | Select around object | **spacemacs, vim** — select: `` a ``<br>**helix** — normal: `` ma ``, select: `` ma ``<br>**kakoune** — normal: `` <A-a> ``, select: `` ma ``, `` <A-a> `` |
| `select_textobject_inner` | Select inside object | **spacemacs, vim** — select: `` i ``<br>**helix** — normal: `` mi ``, select: `` mi ``<br>**kakoune** — normal: `` <A-i> ``, select: `` mi ``, `` <A-i> `` |
...
| `zap_to_char` | Kill through the next char, inclusive (emacs zap-to-char, M-z) | **spacemacs** — normal: `` <A-z> ``<br>**emacs, cua, micro, nano** — normal: `` <A-z> ``, insert: `` <A-z> `` |
...
| `nova` | Play Nova, the fighter campaign: squadrons, Star Destroyers, trench runs, walkers and a cockpit view |  |
...
| `keyboard_escape_quit` | Drop extra cursors and deactivate the region (emacs keyboard-escape-quit) | **emacs, cua, micro, nano** — insert: `` <C-]> ``, `` <esc><esc><esc> `` |
...
| `async_shell_command` | Run a shell command without blocking, output to a buffer (emacs async-shell-command) | **emacs, cua, micro, nano** — insert: `` <A-&> `` |
...
| `comment_set_column` | Set the comment column from point, aligning this line's comment with a prefix (emacs comment-set-column, C-x ;) | **spacemacs** — normal: `` <C-x>; ``, select: `` <C-x>; ``, insert: `` <C-x>; `` |
...
| `goto_next_function` | Goto next function | **spacemacs, vim** — normal: `` ][ ``, `` ]m ``<br>**helix, kakoune** — normal: `` ]f ``, select: `` ]f ``<br>**emacs, cua, micro, nano** — normal: `` <A-C-e> ``, insert: `` <A-C-e> `` |
| `goto_prev_function` | Goto previous function | **spacemacs, vim** — normal: `` [] ``, `` [m ``<br>**helix, kakoune** — normal: `` [f ``, select: `` [f ``<br>**emacs, cua, micro, nano** — normal: `` <A-C-a> ``, insert: `` <A-C-a> `` |
...
| `goto_next_comment` | Goto next comment | **spacemacs, vim** — normal: `` ]* ``, `` ]/ ``<br>**helix, kakoune** — normal: `` ]c ``, select: `` ]c `` |
| `goto_prev_comment` | Goto previous comment | **spacemacs, vim** — normal: `` [* ``, `` [/ ``<br>**helix, kakoune** — normal: `` [c ``, select: `` [c `` |
...
| `goto_next_paragraph` | Goto next paragraph | **spacemacs** — normal: `` } ``, `` <A-}> ``, select: `` } ``<br>**vim** — normal: `` } ``, select: `` } ``<br>**helix, kakoune** — normal: `` ]p ``, select: `` ]p ``<br>**emacs, cua, micro, nano** — normal: `` <A-}> ``, insert: `` <A-}> `` |
| `goto_prev_paragraph` | Goto previous paragraph | **spacemacs** — normal: `` { ``, `` <A-{> ``, select: `` { ``<br>**vim** — normal: `` { ``, select: `` { ``<br>**helix, kakoune** — normal: `` [p ``, select: `` [p ``<br>**emacs, cua, micro, nano** — normal: `` <A-{> ``, insert: `` <A-{> `` |
...
| `dap_remove_breakpoint` | Remove breakpoint on current line (Emacs gud-remove) | **spacemacs** — normal: `` <C-x><C-a><C-d> ``, select: `` <C-x><C-a><C-d> ``, insert: `` <C-x><C-a><C-d> ``<br>**emacs** — normal: `` <C-c><C-d> ``, select: `` <C-c><C-d> ``, insert: `` <C-c><C-d> ``<br>**cua** — normal: `` <C-c><C-d> ``, insert: `` <C-c><C-d> ``<br>**micro, nano** — select: `` <C-c><C-d> `` |
...
| `shell_pipe` | Pipe selections through shell command | **spacemacs** — normal: `` <A-\|> ``<br>**helix, kakoune** — normal: `` \| ``, select: `` \| `` |
| `shell_pipe_to` | Pipe selections into shell command ignoring output | **helix, kakoune** — normal: `` <A-\|> ``, select: `` <A-\|> `` |
| `shell_insert_output` | Insert shell command output before selections | **spacemacs** — normal: `` <A-!> ``<br>**helix, kakoune** — normal: `` ! ``, select: `` ! `` |
...
| `suspend` | Suspend and return to shell | **spacemacs** — normal: `` <C-z> ``, `` <C-x><C-z> ``, select: `` <C-x><C-z> ``, insert: `` <C-x><C-z> ``<br>**vim** — normal: `` <C-z> ``<br>**helix, kakoune** — normal: `` <C-z> ``, select: `` <C-z> `` |
| `rename_symbol` | Rename symbol | **spacemacs** — normal: `` <space>lr ``, select: `` <space>lr ``<br>**helix** — normal: `` <space>r ``, select: `` <space>r `` |
| `increment` | Increment item under cursor | **spacemacs** — normal: `` <C-a> ``, `` g<C-a> ``, `` <space>n++ ``, `` <space>n+= ``, `` <space>n=+ ``, `` <space>n== ``, `` <space>n_+ ``, `` <space>n_= ``, `` <space>n<minus>+ ``, `` <space>n<minus>= ``, select: `` <C-a> ``, `` <space>n++ ``, `` <space>n+= ``, `` <space>n=+ ``, `` <space>n== ``, `` <space>n_+ ``, `` <space>n_= ``, `` <space>n<minus>+ ``, `` <space>n<minus>= ``<br>**vim** — normal: `` <C-a> ``, `` g<C-a> ``, select: `` <C-a> ``<br>**helix, kakoune** — normal: `` <C-a> ``, select: `` <C-a> `` |
...
| `command_palette` | Open command palette | **spacemacs** — normal: `` <A-X> ``, `` <A-x> ``, `` <C-x>* ``, `` <space>? ``, `` <space><space> ``, select: `` <C-x>* ``, `` <space>? ``, `` <space><space> ``, insert: `` <C-x>* ``<br>**helix** — normal: `` <space>? ``, select: `` <space>? ``<br>**emacs, cua** — normal: `` <A-x> ``, insert: `` <A-X> ``, `` <A-x> ``<br>**micro, nano** — insert: `` <A-X> `` |
...
| `goto_word` | Jump to a two-character label | **spacemacs** — normal: `` <space>jl ``, `` <space>jw ``, select: `` <space>jl ``, `` <space>jw ``<br>**helix, kakoune** — normal: `` gw `` |
...
| `emmet_expand` | Expand emmet/zen HTML abbreviation (or Tab) | **helix, kakoune, emacs, cua, micro, nano** — insert: `` <tab> `` |
...
| `find_file_other_tab` | Open a file in a new tab (emacs find-file-other-tab) | **spacemacs** — normal: `` <C-x>tf ``, `` <C-x>t<C-f> ``, select: `` <C-x>tf ``, `` <C-x>t<C-f> ``, insert: `` <C-x>tf ``, `` <C-x>t<C-f> ``<br>**emacs** — insert: `` <C-x>tf ``, `` <C-x>t<C-f> ``<br>**cua** — select: `` <C-X>tf ``, `` <C-X>t<C-f> ``, insert: `` <C-x>tf ``, `` <C-x>t<C-f> `` |
...
| `toggle_input_method` | Switch the buffer's input method off, or back on (emacs toggle-input-method, C-\) | **emacs, cua, micro, nano** — normal: `` <C-\> ``, insert: `` <C-\> `` |
...
| `left_char` | Move to the character to the left on display, reading the paragraph's direction (emacs left-char) | **emacs, cua, micro, nano** — normal: `` <left> ``, insert: `` <left> `` |
| `right_char` | Move to the character to the right on display, reading the paragraph's direction (emacs right-char) | **emacs, cua, micro, nano** — normal: `` <right> ``, insert: `` <right> `` |
...
| `describe_input_method` | Show an input method's documentation and key table (emacs describe-input-method, C-h C-\) | **spacemacs** — normal: `` <C-h>I ``, `` <C-h><C-\> ``, select: `` <C-h>I ``, `` <C-h><C-\> ``, insert: `` <C-h>I ``, `` <C-h><C-\> `` |
...
| `exit_recursive_edit` | Leave the innermost recursive editing level (emacs exit-recursive-edit, C-M-c) | **spacemacs, vim** — normal: `` <A-C-c> `` |
| `kbd_macro_query` | Ask how to continue when a running keyboard macro reaches this point (emacs kbd-macro-query, C-x q) | **spacemacs** — normal: `` <C-x>q ``, select: `` <C-x>q ``, insert: `` <C-x>q `` |
...
| `switch_to_buffer_other_tab` | Show a buffer in a new tab (emacs switch-to-buffer-other-tab) | **spacemacs** — normal: `` <C-x>tb ``, select: `` <C-x>tb ``, insert: `` <C-x>tb ``<br>**emacs** — insert: `` <C-x>tb ``<br>**cua** — select: `` <C-X>tb ``, insert: `` <C-x>tb `` |
...
| `report_spacemacs_issue` | Open the Spacemacs issue tracker pre-filled; C-u adds your last keys (Spacemacs SPC h I) | **spacemacs** — normal: `` <space>hI ``, select: `` <space>hI `` |
| `report_spacemacs_issue_with_keys` | Open the issue tracker pre-filled, with your last pressed keys (Spacemacs SPC u SPC h I) | **spacemacs** — normal: `` <space>u<space>hI ``, select: `` <space>u<space>hI `` |
| `toggle_smooth_scrolling` | Toggle smooth scrolling (vim 'smoothscroll', Spacemacs SPC t n v) | **spacemacs** — normal: `` <space>tnv ``, select: `` <space>tnv `` |
| `toggle_tilde_fringe` | Show or hide the ~ marking the rows past the end of the buffer (Spacemacs SPC T ~) | **spacemacs** — normal: `` <space>T~ ``, select: `` <space>T~ `` |
| `nyan_mode` | Draw nyan-mode's scroll-position cat in the mode line (Spacemacs SPC t m n) | **spacemacs** — normal: `` <space>tmn ``, select: `` <space>tmn `` |
| `toggle_modeline_minor_modes` | Show or hide the mode line's minor-mode lighters (Spacemacs SPC t m m) | **spacemacs** — normal: `` <space>tmm ``, select: `` <space>tmm `` |
| `toggle_modeline_responsive` | Drop the mode line's optional constructs when they no longer fit (Spacemacs SPC t m r) | **spacemacs** — normal: `` <space>tmr ``, select: `` <space>tmr `` |
| `toggle_modeline_new_version` | Show a mode-line lighter when a newer release is known (Spacemacs SPC t m V) | **spacemacs** — normal: `` <space>tmV ``, select: `` <space>tmV `` |
| `toggle_modeline_org_clock` | Show the running org task clock in the mode line (Spacemacs SPC t m c) | **spacemacs** — normal: `` <space>tmc ``, select: `` <space>tmc `` |
| `ggtags_mode` | Look tags up in the etags table before the language server (ggtags-mode, Spacemacs SPC t G) | **spacemacs** — normal: `` <space>tG ``, select: `` <space>tG `` |
| `yasnippet_mode` | Enable or disable snippet expansion (yasnippet-mode, Spacemacs SPC t y) | **spacemacs** — normal: `` <space>ty ``, select: `` <space>ty `` |
| `locate_library` | Report where a loadable library lives (emacs locate-library, Spacemacs SPC f e l) | **spacemacs** — normal: `` <space>fel ``, select: `` <space>fel `` |
| `open_early_config` | Open the early config zmax reads before the editor starts (Spacemacs SPC f e I) | **spacemacs** — normal: `` <space>feI ``, select: `` <space>feI `` |
| `restart_editor_timed` | Restart zmax with start-up phase timing on (Spacemacs SPC q t) | **spacemacs** — normal: `` <space>qt ``, select: `` <space>qt `` |
| `restart_editor_adv_timers` | Restart zmax with per-phase and per-plugin timing on (Spacemacs SPC q T) | **spacemacs** — normal: `` <space>qT ``, select: `` <space>qT `` |
| `ediff_merge_directories` | Merge the files two directories have in common (emacs ediff-merge-directories, SPC D m d d) | **spacemacs** — normal: `` <space>Dmdd ``, select: `` <space>Dmdd `` |
| `ediff_show_registry` | List the ediff sessions started in this run (emacs ediff-show-registry, SPC D s) | **spacemacs** — normal: `` <space>Ds ``, select: `` <space>Ds `` |
| `smeargle_commits` | Tint lines by the age rank of the commit that last touched them (smeargle-commits, SPC g H h) | **spacemacs** — normal: `` <space>gHh ``, select: `` <space>gHh `` |
| `smeargle` | Tint lines by how long ago they were last updated (smeargle, SPC g H t) | **spacemacs** — normal: `` <space>gHt ``, select: `` <space>gHt `` |
| `smeargle_clear` | Clear the smeargle commit highlighting (smeargle-clear, SPC g H c) | **spacemacs** — normal: `` <space>gHc ``, select: `` <space>gHc `` |
| `git_link_select_remote` | Choose the remote the git-link commands build URLs from (Spacemacs SPC u before SPC g l) | **spacemacs** — normal: `` <space>u<space>gl ``, select: `` <space>u<space>gl `` |
| `log_edit_kill_buffer` | Discard the commit message and abort the commit (emacs log-edit-kill-buffer, SPC m a / SPC m k) |  |
| `describe_face` | Show what a face of the active theme renders as (emacs describe-face, SPC h d F) | **spacemacs** — normal: `` <space>hdF ``, select: `` <space>hdF `` |
...
| `make_frame_command` | Create a new frame showing this buffer (emacs make-frame-command) | **spacemacs** — normal: `` <C-x>52 ``, `` <space>Fn ``, select: `` <C-x>52 ``, `` <space>Fn ``, insert: `` <C-x>52 ``<br>**emacs** — normal: `` <C-x>52 ``, select: `` <C-x>52 ``, insert: `` <C-x>52 ``<br>**cua** — normal: `` <C-x>52 ``, select: `` <C-X>52 ``, insert: `` <C-x>52 ``<br>**micro, nano** — select: `` <C-x>52 `` |
...
| `toggle_frame_fullscreen` | Toggle the terminal window's fullscreen state (emacs toggle-frame-fullscreen, F11) | **spacemacs** — normal: `` <space>TF ``, select: `` <space>TF ``<br>**emacs, cua, micro, nano** — normal: `` <F11> ``, select: `` <F11> ``, insert: `` <F11> `` |
| `toggle_frame_maximized` | Maximize or restore the terminal window (emacs toggle-frame-maximized, M-F10) | **spacemacs** — normal: `` <space>TM ``, select: `` <space>TM ``<br>**emacs, cua, micro, nano** — normal: `` <A-F10> ``, select: `` <A-F10> ``, insert: `` <A-F10> `` |
| `iconify_or_deiconify_frame` | Iconify or deiconify the frame; no visible effect on a tty (emacs iconify-or-deiconify-frame, C-z under X) | **emacs, nano** — normal: `` <C-z> ``, select: `` <C-z> ``, insert: `` <C-z> ``<br>**micro** — select: `` <C-z> `` |
...
| `delete_frame` | Delete the displayed frame (emacs delete-frame) | **spacemacs** — normal: `` <C-x>50 ``, `` <space>Fd ``, select: `` <C-x>50 ``, `` <space>Fd ``, insert: `` <C-x>50 ``<br>**emacs** — normal: `` <C-x>50 ``, select: `` <C-x>50 ``, insert: `` <C-x>50 ``<br>**cua** — normal: `` <C-x>50 ``, select: `` <C-X>50 ``, insert: `` <C-x>50 ``<br>**micro, nano** — select: `` <C-x>50 `` |
| `delete_other_frames` | Delete every frame but this one (emacs delete-other-frames) | **spacemacs** — normal: `` <C-x>51 ``, `` <space>FD ``, select: `` <C-x>51 ``, `` <space>FD ``, insert: `` <C-x>51 ``<br>**emacs** — normal: `` <C-x>51 ``, select: `` <C-x>51 ``, insert: `` <C-x>51 ``<br>**cua** — normal: `` <C-x>51 ``, select: `` <C-X>51 ``, insert: `` <C-x>51 ``<br>**micro, nano** — select: `` <C-x>51 `` |
| `other_frame` | Display the next frame (emacs other-frame) | **spacemacs** — normal: `` ]t ``, `` <C-x>5o ``, `` <space>Fo ``, select: `` <C-x>5o ``, `` <space>Fo ``, insert: `` <C-x>5o ``<br>**vim** — normal: `` ]t ``<br>**emacs** — normal: `` <C-x>5o ``, select: `` <C-x>5o ``, insert: `` <C-x>5o ``<br>**cua** — normal: `` <C-x>5o ``, select: `` <C-X>5o ``, insert: `` <C-x>5o ``<br>**micro, nano** — select: `` <C-x>5o `` |
| `undelete_frame` | Bring back the most recently deleted frame (emacs undelete-frame) | **spacemacs, emacs** — normal: `` <C-x>5u ``, select: `` <C-x>5u ``, insert: `` <C-x>5u ``<br>**cua** — normal: `` <C-x>5u ``, select: `` <C-X>5u ``, insert: `` <C-x>5u ``<br>**micro, nano** — select: `` <C-x>5u `` |
...
| `find_file_other_frame` | Open a file in a new frame (emacs find-file-other-frame) | **spacemacs, emacs** — normal: `` <C-x>5f ``, select: `` <C-x>5f ``, insert: `` <C-x>5f ``<br>**cua** — normal: `` <C-x>5f ``, select: `` <C-X>5f ``, insert: `` <C-x>5f ``<br>**micro, nano** — select: `` <C-x>5f `` |
| `find_file_read_only_other_frame` | Open a file read-only in a new frame (emacs find-file-read-only-other-frame) | **spacemacs, emacs** — normal: `` <C-x>5r ``, select: `` <C-x>5r ``, insert: `` <C-x>5r ``<br>**cua** — normal: `` <C-x>5r ``, select: `` <C-X>5r ``, insert: `` <C-x>5r ``<br>**micro, nano** — select: `` <C-x>5r `` |
| `switch_to_buffer_other_frame` | Display a buffer in a new frame (emacs switch-to-buffer-other-frame) | **spacemacs, emacs** — normal: `` <C-x>5b ``, select: `` <C-x>5b ``, insert: `` <C-x>5b ``<br>**cua** — normal: `` <C-x>5b ``, select: `` <C-X>5b ``, insert: `` <C-x>5b ``<br>**micro, nano** — select: `` <C-x>5b `` |
| `display_buffer_other_frame` | Put a buffer in another frame without selecting it (emacs display-buffer-other-frame, SPC F B) |  |
| `dired_other_frame` | Open Dired in a new frame (emacs dired-other-frame) | **spacemacs** — normal: `` <C-x>5d ``, `` <space>FO ``, select: `` <C-x>5d ``, `` <space>FO ``, insert: `` <C-x>5d ``<br>**emacs** — normal: `` <C-x>5d ``, select: `` <C-x>5d ``, insert: `` <C-x>5d ``<br>**cua** — normal: `` <C-x>5d ``, select: `` <C-X>5d ``, insert: `` <C-x>5d ``<br>**micro, nano** — select: `` <C-x>5d `` |
...
| `mouse_buffer_menu` | The buffer menu, from the mouse (emacs mouse-buffer-menu) | **spacemacs, vim** — normal: `` <C-F10> `` |
...
| `context_menu_open` | Pop up the context menu at the click, or at point (emacs context-menu-open) | **spacemacs, vim** — normal: `` <S-F10> ``<br>**emacs, cua, micro, nano** — insert: `` <S-F10> `` |
