...
| --- | --- | --- |
| `no_op` | Do nothing |  |
| `move_char_left` | Move left | **spacemacs** — normal: `` h ``, `` <left> ``, insert: `` <C-b> ``, `` <left> ``<br>**vim** — normal: `` h ``, `` <C-h> ``, `` <left> ``, insert: `` <left> ``<br>**helix** — normal: `` h ``, `` <left> ``, insert: `` <left> ``<br>**emacs** — normal: `` <C-b> ``, `` <left> ``, insert: `` <C-b> ``, `` <left> `` |
| `move_char_right` | Move right | **spacemacs** — normal: `` l ``, `` <right> ``, insert: `` <C-f> ``, `` <right> ``<br>**vim** — normal: `` l ``, `` <right> ``, `` <space> ``, insert: `` <right> ``<br>**helix** — normal: `` l ``, `` <right> ``, insert: `` <right> ``<br>**emacs** — normal: `` <C-f> ``, `` <right> ``, insert: `` <C-f> ``, `` <right> `` |
| `move_line_up` | Move up | **spacemacs, vim** — normal: `` gk ``, `` g<up> ``<br>**helix** — normal: `` gk `` |
| `move_line_down` | Move down | **spacemacs, vim** — normal: `` gj ``, `` g<down> ``<br>**helix** — normal: `` gj `` |
...
| `move_visual_line_up` | Move up | **spacemacs, vim** — normal: `` k ``, `` <up> ``, `` <C-p> ``, insert: `` <up> ``, `` <C-g>k ``, `` <C-g><up> ``, `` <C-g><C-k> ``<br>**helix** — normal: `` k ``, `` <up> ``, insert: `` <up> ``<br>**emacs** — normal: `` <up> ``, `` <C-p> ``, insert: `` <up> ``, `` <C-p> `` |
| `move_visual_line_down` | Move down | **spacemacs, vim** — normal: `` j ``, `` <C-j> ``, `` <C-n> ``, `` <down> ``, insert: `` <C-g>j ``, `` <down> ``, `` <C-g><C-j> ``, `` <C-g><down> ``<br>**helix** — normal: `` j ``, `` <down> ``, insert: `` <down> ``<br>**emacs** — normal: `` <C-n> ``, `` <down> ``, insert: `` <C-n> ``, `` <down> `` |
| `extend_char_left` | Extend left | **helix** — select: `` h ``, `` <left> ``<br>**emacs** — select: `` <C-b> ``, `` <left> `` |
| `extend_char_right` | Extend right | **vim** — select: `` <space> ``<br>**helix** — select: `` l ``, `` <right> ``<br>**emacs** — select: `` <C-f> ``, `` <right> `` |
| `extend_line_up` | Extend up | **helix** — select: `` gk `` |
| `extend_line_down` | Extend down | **helix** — select: `` gj `` |
| `extend_visual_line_up` | Extend up | **helix** — select: `` k ``, `` <up> ``<br>**emacs** — select: `` <up> ``, `` <C-p> `` |
| `extend_visual_line_down` | Extend down | **helix** — select: `` j ``, `` <down> ``<br>**emacs** — select: `` <C-n> ``, `` <down> `` |
...
| `block_dollar` | Visual-block: extend each row to its own line end (CTRL-V $) | **spacemacs, vim** — select: `` $ ``, `` <end> `` |
...
| `move_next_word_start` | Move to start of next word | **spacemacs** — normal: `` <A-f> ``, `` <A-right> ``, `` <C-right> ``, `` <S-right> ``, insert: `` <A-f> ``, `` <C-right> ``, `` <S-right> ``<br>**vim** — normal: `` <C-right> ``, `` <S-right> ``, insert: `` <C-right> ``, `` <S-right> ``<br>**helix** — normal: `` w `` |
| `move_prev_word_start` | Move to start of previous word | **spacemacs** — normal: `` <A-b> ``, `` <A-left> ``, `` <C-left> ``, `` <S-left> ``, insert: `` <A-b> ``, `` <C-left> ``, `` <S-left> ``<br>**vim** — normal: `` <C-left> ``, `` <S-left> ``, insert: `` <C-left> ``, `` <S-left> ``<br>**helix** — normal: `` b ``<br>**emacs** — normal: `` <A-b> ``, insert: `` <A-b> `` |
| `move_next_word_end` | Move to end of next word | **helix** — normal: `` e ``<br>**emacs** — normal: `` <A-f> ``, insert: `` <A-f> `` |
...
| `extend_prev_word_start` | Extend to start of previous word | **helix** — select: `` b ``<br>**emacs** — select: `` <A-b> `` |
| `extend_next_word_end` | Extend to end of next word | **helix** — select: `` e ``<br>**emacs** — select: `` <A-f> `` |
...
| `switch_to_uppercase` | Switch to uppercase | **spacemacs** — normal: `` <space>xU ``, `` <C-x><C-u> ``, select: `` <space>xU ``, `` <C-x><C-u> ``, insert: `` <C-x><C-u> ``<br>**helix** — normal: `` <A-`> ``, select: `` <A-`> ``<br>**emacs** — insert: `` <C-x><C-u> `` |
| `switch_to_lowercase` | Switch to lowercase | **spacemacs** — normal: `` <space>xu ``, `` <C-x><C-l> ``, select: `` <space>xu ``, `` <C-x><C-l> ``, insert: `` <C-x><C-l> ``<br>**helix** — normal: `` ` ``, select: `` ` ``<br>**emacs** — insert: `` <C-x><C-l> `` |
| `upcase_word` | Upper-case the word after point (emacs upcase-word, M-u) | **spacemacs** — normal: `` <A-u> ``<br>**emacs** — normal: `` <A-u> ``, insert: `` <A-u> `` |
| `downcase_word` | Lower-case the word after point (emacs downcase-word, M-l) | **spacemacs** — normal: `` <A-l> ``<br>**emacs** — normal: `` <A-l> ``, insert: `` <A-l> `` |
| `capitalize_word` | Capitalize the word after point (emacs capitalize-word, M-c) | **spacemacs** — normal: `` <A-c> ``<br>**emacs** — normal: `` <A-c> ``, insert: `` <A-c> `` |
...
| `page_up` | Move page up | **spacemacs** — normal: `` <A-v> ``, `` <C-b> ``, `` <S-up> ``, `` <pageup> ``, `` <S-minus> ``, insert: `` <A-v> ``, `` <S-up> ``, `` <pageup> ``<br>**vim** — normal: `` <C-b> ``, `` <S-up> ``, `` <pageup> ``, `` <S-minus> ``, insert: `` <S-up> ``, `` <pageup> ``<br>**helix** — normal: `` <C-b> ``, `` Z<C-b> ``, `` z<C-b> ``, `` <pageup> ``, `` Z<pageup> ``, `` z<pageup> ``, select: `` <C-b> ``, `` Z<C-b> ``, `` z<C-b> ``, `` <pageup> ``, `` Z<pageup> ``, `` z<pageup> ``, insert: `` <pageup> ``<br>**emacs** — normal: `` <A-v> ``, `` <pageup> ``, insert: `` <A-v> ``, `` <pageup> `` |
| `page_down` | Move page down | **spacemacs, vim** — normal: `` <C-f> ``, `` <S-+> ``, `` <S-ret> ``, `` <S-down> ``, `` <pagedown> ``, insert: `` <S-down> ``, `` <pagedown> ``<br>**helix** — normal: `` <C-f> ``, `` Z<C-f> ``, `` z<C-f> ``, `` <pagedown> ``, `` Z<pagedown> ``, `` z<pagedown> ``, select: `` <C-f> ``, `` Z<C-f> ``, `` z<C-f> ``, `` <pagedown> ``, `` Z<pagedown> ``, `` z<pagedown> ``, insert: `` <pagedown> ``<br>**emacs** — normal: `` <C-v> ``, `` <pagedown> ``, insert: `` <C-v> ``, `` <pagedown> `` |
...
| `select_all` | Select whole document | **spacemacs** — normal: `` <C-x>h ``, select: `` <C-x>h ``, insert: `` <C-x>h ``<br>**helix** — normal: `` % ``, select: `` % ``<br>**emacs** — normal: `` <C-x>h ``, insert: `` <C-x>h `` |
...
| `search` | Search for regex pattern | **spacemacs** — normal: `` / ``, `` <C-s> ``, `` <A-C-s> ``, select: `` / ``<br>**vim** — normal: `` / ``, select: `` / ``<br>**helix** — normal: `` / ``, `` Z/ ``, `` z/ ``, select: `` / ``, `` Z/ ``, `` z/ ``<br>**emacs** — normal: `` <C-s> ``, `` <A-C-s> ``, insert: `` <C-s> ``, `` <A-C-s> `` |
| `rsearch` | Reverse search for regex pattern | **spacemacs** — normal: `` ? ``, `` <A-C-r> ``, select: `` ? ``<br>**vim** — normal: `` ? ``, select: `` ? ``<br>**helix** — normal: `` ? ``, `` Z? ``, `` z? ``, select: `` ? ``, `` Z? ``, `` z? ``<br>**emacs** — normal: `` <C-r> ``, `` <A-C-r> ``, insert: `` <C-r> ``, `` <A-C-r> `` |
...
| `transpose_line` | Swap the current line with the previous one (emacs transpose-lines, C-x C-t) | **spacemacs** — normal: `` <C-x><C-t> ``, select: `` <C-x><C-t> ``, insert: `` <C-x><C-t> ``<br>**emacs** — insert: `` <C-x><C-t> `` |
...
| `delete_window_and_buffer` | Close window and kill its buffer (SPC w . x) | **spacemacs** — normal: `` <C-w>.x ``, `` <C-w>[x ``, `` <C-w>{x ``, `` <C-x>40 ``, `` <space>w.x ``, `` <space>w[x ``, `` <space>w{x ``, `` <space>u<space>bD ``, `` <space>u<space>wD ``, select: `` <C-x>40 ``, `` <space>w.x ``, `` <space>w[x ``, `` <space>w{x ``, `` <space>u<space>bD ``, `` <space>u<space>wD ``, insert: `` <C-x>40 ``<br>**vim** — normal: `` <C-w>.x ``, `` <C-w>[x ``, `` <C-w>{x `` |
...
| `eval_elisp_line` | Evaluate the current line as elisp (SPC m e e) | **spacemacs** — normal: `` <C-x><C-e> ``, `` <space>me$ ``, `` <space>mee ``, `` <space>mel ``, select: `` <C-x><C-e> ``, `` <space>me$ ``, `` <space>mee ``, `` <space>mel ``, insert: `` <C-x><C-e> `` |
...
| `ediff_regions` | Ediff two regions linewise: mark A, then diff B (SPC D r l) | **spacemacs** — normal: `` <space>Drl ``, `` <space>Drw ``, select: `` <space>Drl ``, `` <space>Drw `` |
...
| `collapse_selection` | Collapse selection into single cursor | **helix** — normal: `` ; ``, select: `` ; ``<br>**emacs** — normal: `` <C-g> ``, insert: `` <C-g> `` |
| `flip_selections` | Flip selection cursor and anchor | **spacemacs** — normal: `` <C-x><C-x> ``, select: `` <C-x><C-x> ``, insert: `` <C-x><C-x> ``<br>**helix** — normal: `` <A-;> ``, select: `` <A-;> ``<br>**emacs** — normal: `` <C-x><C-x> ``, insert: `` <C-x><C-x> `` |
| `ensure_selections_forward` | Ensure all selections face forward | **helix** — normal: `` <A-:> ``, select: `` <A-:> `` |
| `insert_mode` | Insert before selection | **spacemacs** — normal: `` i ``, `` <ins> ``, `` <space>ki ``, select: `` <space>ki ``<br>**vim** — normal: `` i ``, `` <ins> ``<br>**helix** — normal: `` i ``, select: `` i ``<br>**emacs** — normal: `` a ``, `` i `` |
| `append_mode` | Append after selection | **spacemacs, vim** — normal: `` a ``<br>**helix** — normal: `` a ``, select: `` a `` |
| `replace_mode` | Enter Replace mode (overtype) | **spacemacs, vim** — normal: `` R ``, `` gR `` |
| `command_mode` | Enter command mode | **spacemacs** — normal: `` gQ ``, `` <space>: ``, `` <space>k: ``, select: `` : ``, `` <space>: ``, `` <space>k: ``<br>**vim** — normal: `` gQ ``, select: `` : ``<br>**helix** — normal: `` : ``, select: `` : `` |
| `file_picker` | Open file picker | **spacemacs** — normal: `` <C-x>4f ``, `` <space>ff ``, `` <space>pf ``, `` <space>ph ``, `` <space>pp ``, `` <C-x><C-f> ``, `` <C-x><C-r> ``, select: `` <C-x>4f ``, `` <space>ff ``, `` <space>pf ``, `` <space>ph ``, `` <space>pp ``, `` <C-x><C-f> ``, `` <C-x><C-r> ``, insert: `` <C-x>4f ``, `` <C-x><C-f> ``, `` <C-x><C-r> ``<br>**helix** — normal: `` <space>f ``, select: `` <space>f ``<br>**emacs** — normal: `` <C-x><C-f> ``, insert: `` <C-x><C-f> `` |
...
| `file_explorer` | Open file explorer in workspace root | **spacemacs** — normal: `` <C-x>td ``, `` <space>ad ``, `` <space>af ``, `` <space>ft ``, `` <space>pd ``, `` <space>pt ``, `` <space>atrd ``, `` <space>atrr ``, select: `` <C-x>td ``, `` <space>ad ``, `` <space>af ``, `` <space>ft ``, `` <space>pd ``, `` <space>pt ``, `` <space>atrd ``, `` <space>atrr ``, insert: `` <C-x>td ``<br>**helix** — normal: `` <space>e ``, select: `` <space>e `` |
...
| `list_buffers` | List open buffers in the Buffer Menu (emacs list-buffers) | **spacemacs** — normal: `` <C-x><C-b> ``, select: `` <C-x><C-b> ``, insert: `` <C-x><C-b> ``<br>**emacs** — normal: `` <C-x><C-b> ``, insert: `` <C-x><C-b> `` |
...
| `isearch_forward_word` | Incremental whole-word search forward (emacs isearch-forward-word) | **spacemacs** — normal: `` <A-s>w `` |
...
| `query_replace` | Replace matches one by one, asking (emacs query-replace M-%) | **emacs** — insert: `` <A-%> `` |
| `query_replace_regexp` | Replace regexp matches one by one, asking (emacs query-replace-regexp C-M-%) | **emacs** — insert: `` <A-C-%> `` |
...
| `dired` | Open the Dired directory editor (emacs C-x d) | **spacemacs** — normal: `` <C-x>d ``, `` <space>pD ``, select: `` <C-x>d ``, `` <space>pD ``, insert: `` <C-x>d ``<br>**emacs** — insert: `` <C-x>d `` |
| `dired_jump` | Open Dired on the current buffer's directory (emacs C-x C-j) | **spacemacs** — normal: `` <C-x><C-j> ``, select: `` <C-x><C-j> ``, insert: `` <C-x><C-j> ``<br>**emacs** — insert: `` <C-x><C-j> `` |
...
| `buffer_picker` | Open buffer picker | **spacemacs** — normal: `` <C-x>b ``, `` <C-x>wd ``, `` <space>bb ``, `` <space>lb ``, `` <space>lt ``, `` <space>pb ``, `` <space>b.b ``, select: `` <C-x>b ``, `` <C-x>wd ``, `` <space>bb ``, `` <space>lb ``, `` <space>lt ``, `` <space>pb ``, `` <space>b.b ``, insert: `` <C-x>b ``, `` <C-x>wd ``<br>**helix** — normal: `` <space>b ``, select: `` <space>b ``<br>**emacs** — normal: `` <C-x>b ``, insert: `` <C-x>b `` |
...
| `select_mode` | Enter selection extend mode | **spacemacs** — normal: `` v ``, `` gh ``, `` <C-space> ``, `` <space>kv ``, `` <space>k<C-v> ``, select: `` <space>kv ``, `` <space>k<C-v> ``<br>**vim** — normal: `` v ``, `` gh ``<br>**helix** — normal: `` v ``<br>**emacs** — normal: `` <C-space> `` |
| `exit_select_mode` | Exit selection mode | **helix** — select: `` <esc> `` |
| `goto_definition` | Goto definition | **spacemacs** — normal: `` g] ``, `` gd ``, `` <A-.> ``, `` <C-]> ``, `` <C-w>] ``, `` g<C-]> ``, `` <C-c>,j ``, `` <C-w>g] ``, `` <C-x>5. ``, `` <space>gd ``, `` <space>jf ``, `` <space>jv ``, `` <space>w] ``, `` <C-w><C-]> ``, `` <space>mgg ``, `` <space>wg] ``, `` <C-w>g<C-]> ``, `` <space>w<C-]> ``, `` <space>wg<C-]> ``, select: `` <C-]> ``, `` <C-c>,j ``, `` <C-x>5. ``, `` <space>gd ``, `` <space>jf ``, `` <space>jv ``, `` <space>w] ``, `` <space>mgg ``, `` <space>wg] ``, `` <space>w<C-]> ``, `` <space>wg<C-]> ``, insert: `` <C-c>,j ``, `` <C-x>5. ``<br>**vim** — normal: `` g] ``, `` gd ``, `` <C-]> ``, `` <C-w>] ``, `` g<C-]> ``, `` <C-w>g] ``, `` <C-w><C-]> ``, `` <C-w>g<C-]> ``, select: `` <C-]> ``<br>**helix** — normal: `` gd ``, select: `` gd ``<br>**emacs** — normal: `` <A-.> ``, insert: `` <A-.> `` |
...
| `goto_file_start` | Goto line number `<n>` else file start | **spacemacs** — normal: `` gg ``, `` <A-lt> ``, `` <C-home> ``, insert: `` <A-lt> ``, `` <C-home> ``<br>**vim** — normal: `` gg ``, `` <C-home> ``, insert: `` <C-home> ``<br>**helix** — normal: `` gg ``<br>**emacs** — normal: `` <A-lt> ``, select: `` <A-lt> ``, insert: `` <A-lt> `` |
...
| `goto_reference` | Goto references | **spacemacs, vim** — normal: `` gr ``<br>**helix** — normal: `` gr ``, select: `` gr ``<br>**emacs** — normal: `` <A-?> ``, insert: `` <A-?> `` |
...
| `move_to_window_line_top_bottom` | Move point to window centre/top/bottom, cycling (emacs move-to-window-line-top-bottom, M-r) | **spacemacs** — normal: `` <A-r> ``<br>**emacs** — normal: `` <A-r> ``, insert: `` <A-r> `` |
...
| `goto_line` | Goto line | **spacemacs** — normal: `` <A-g>g ``, `` <A-g><A-g> ``<br>**helix** — normal: `` G ``, select: `` G ``<br>**emacs** — normal: `` <A-g>g ``, `` <A-g><A-g> ``, insert: `` <A-g>g ``, `` <A-g><A-g> `` |
| `goto_last_line` | Goto last line | **spacemacs** — normal: `` G ``, `` <A-gt> ``, `` <C-end> ``<br>**vim** — normal: `` G ``, `` <C-end> ``<br>**helix** — normal: `` ge ``<br>**emacs** — normal: `` <A-gt> ``, select: `` <A-gt> ``, insert: `` <A-gt> `` |
...
| `goto_next_diag` | Goto next diagnostic | **spacemacs** — normal: `` ]d ``, `` <space>enj ``, `` <space>enn ``, `` <space>epj ``, `` <space>epn ``, select: `` <space>enj ``, `` <space>enn ``, `` <space>epj ``, `` <space>epn ``<br>**vim** — normal: `` ]d ``<br>**helix** — normal: `` ]d ``, select: `` ]d ``<br>**emacs** — normal: `` <A-g>n ``, insert: `` <A-g>n ``, `` <A-g><A-n> `` |
| `goto_prev_diag` | Goto previous diagnostic | **spacemacs** — normal: `` [d ``, `` <space>enk ``, `` <space>enp ``, `` <space>epk ``, `` <space>epp ``, select: `` <space>enk ``, `` <space>enp ``, `` <space>epk ``, `` <space>epp ``<br>**vim** — normal: `` [d ``<br>**helix** — normal: `` [d ``, select: `` [d ``<br>**emacs** — normal: `` <A-g>p ``, insert: `` <A-g>p ``, `` <A-g><A-p> `` |
...
| `menu_bar_open` | Open the menu bar (emacs menu-bar-open, F10) | **emacs** — normal: `` <F10> ``, insert: `` <F10> `` |
| `tmm_menubar` | Pick a menu-bar command from a text list (emacs tmm-menubar) | **emacs** — normal: `` <A-`> ``, insert: `` <A-`> `` |
...
| `xref_find_definitions_other_window` | Goto definition in another window (emacs xref-find-definitions-other-window) | **spacemacs** — normal: `` <C-w>d ``, `` <C-x>4. ``, `` <space>mgG ``, select: `` <C-x>4. ``, `` <space>mgG ``, insert: `` <C-x>4. ``<br>**vim** — normal: `` <C-w>d `` |
...
| `goto_line_start` | Goto line start | **spacemacs** — normal: `` 0 ``, `` g0 ``, `` <home> ``, `` g<home> ``, `` <space>j0 ``, select: `` <space>j0 ``, insert: `` <home> ``<br>**vim** — normal: `` 0 ``, `` g0 ``, `` <home> ``, `` g<home> ``, insert: `` <home> ``<br>**helix** — normal: `` gh ``, `` <home> ``, select: `` gh ``, insert: `` <home> ``<br>**emacs** — normal: `` <C-a> ``, `` <home> ``, select: `` <C-a> ``, insert: `` <C-a> ``, `` <home> `` |
| `goto_line_end` | Goto line end | **spacemacs** — normal: `` $ ``, `` g$ ``, `` gl ``, `` <end> ``, `` g<end> ``, `` <space>j$ ``, select: `` <space>j$ ``<br>**vim** — normal: `` $ ``, `` g$ ``, `` gl ``, `` <end> ``, `` g<end> ``<br>**helix** — normal: `` gl ``, `` <end> ``, select: `` gl ``<br>**emacs** — normal: `` <C-e> ``, `` <end> ``, select: `` <C-e> ``, insert: `` <C-e> ``, `` <end> `` |
...
| `goto_next_buffer` | Goto next buffer | **spacemacs** — normal: `` ]b ``, `` <space>bn ``, `` <space>b.n ``, `` <C-x><right> ``, select: `` <space>bn ``, `` <space>b.n ``, `` <C-x><right> ``, insert: `` <C-x><right> ``<br>**vim** — normal: `` ]b ``<br>**helix** — normal: `` gn ``, select: `` gn ``<br>**emacs** — normal: `` <C-x><right> ``, insert: `` <C-x><right> `` |
| `goto_previous_buffer` | Goto previous buffer | **spacemacs** — normal: `` [b ``, `` <space>bp ``, `` <space>b.N ``, `` <space>b.p ``, `` <C-x><left> ``, select: `` <space>bp ``, `` <space>b.N ``, `` <space>b.p ``, `` <C-x><left> ``, insert: `` <C-x><left> ``<br>**vim** — normal: `` [b ``<br>**helix** — normal: `` gp ``, select: `` gp ``<br>**emacs** — normal: `` <C-x><left> ``, insert: `` <C-x><left> `` |
| `goto_line_end_newline` | Goto newline at line end | **spacemacs, vim, helix** — insert: `` <end> `` |
| `goto_first_nonwhitespace` | Goto first non-blank in line | **spacemacs** — normal: `` ^ ``, `` g^ ``, `` <A-m> ``<br>**vim** — normal: `` ^ ``, `` g^ ``<br>**helix** — normal: `` gs ``, select: `` gs ``<br>**emacs** — normal: `` <A-m> ``, insert: `` <A-m> `` |
| `trim_selections` | Trim whitespace from selections | **helix** — normal: `` _ ``, select: `` _ `` |
| `extend_to_line_start` | Extend to line start | **helix** — select: `` <home> `` |
| `extend_to_first_nonwhitespace` | Extend to first non-blank in line | **emacs** — select: `` <A-m> `` |
| `extend_to_line_end` | Extend to line end | **helix** — select: `` <end> `` |
| `extend_to_line_end_newline` | Extend to line end |  |
| `signature_help` | Show signature help | **spacemacs** — normal: `` <space>ls ``, select: `` <space>ls `` |
| `smart_tab` | Insert tab if all cursors have all whitespace to their left; otherwise, run a separate command. |  |
| `insert_tab` | Insert tab char | **helix** — insert: `` <S-tab> ``<br>**emacs** — insert: `` <A-i> `` |
| `insert_newline` | Insert newline char | **spacemacs, vim, helix, emacs** — insert: `` <C-j> ``, `` <ret> `` |
...
| `delete_char_backward` | Delete previous char | **spacemacs** — insert: `` <backspace> ``<br>**vim, emacs** — insert: `` <C-h> ``, `` <backspace> ``<br>**helix** — insert: `` <C-h> ``, `` <backspace> ``, `` <S-backspace> `` |
| `delete_char_forward` | Delete next char | **spacemacs, vim** — insert: `` <del> ``<br>**helix** — insert: `` <C-d> ``, `` <del> ``<br>**emacs** — normal: `` <C-d> ``, insert: `` <C-d> ``, `` <del> `` |
...
| `delete_word_backward` | Delete previous word | **spacemacs, vim, helix** — insert: `` <C-w> ``, `` <A-backspace> ``<br>**emacs** — insert: `` <C-w> ``, `` <A-backspace> ``, `` <A-C-backspace> `` |
| `delete_word_forward` | Delete next word | **spacemacs** — normal: `` <A-d> ``, insert: `` <A-d> ``<br>**vim, emacs** — insert: `` <A-d> ``<br>**helix** — insert: `` <A-d> ``, `` <A-del> `` |
| `kill_to_line_start` | Delete till start of line | **spacemacs, vim, helix** — insert: `` <C-u> `` |
| `kill_to_line_end` | Delete till end of line | **helix** — insert: `` <C-k> ``<br>**emacs** — normal: `` <C-k> ``, insert: `` <C-k> `` |
| `undo` | Undo change | **spacemacs** — normal: `` U ``, `` u ``, `` <C-/> ``, `` <C-_> ``, `` <C-x>u ``, `` <space>ku ``, select: `` <C-x>u ``, `` <space>ku ``, insert: `` <C-/> ``, `` <C-_> ``, `` <C-x>u ``<br>**vim** — normal: `` U ``, `` u ``<br>**helix** — normal: `` u ``, select: `` u ``<br>**emacs** — normal: `` <C-/> ``, `` <C-_> ``, `` <C-x>u ``, insert: `` <C-/> ``, `` <C-_> ``, `` <C-x>u `` |
...
| `paste_after` | Paste after selection | **spacemacs** — normal: `` p ``, `` ]p ``, `` gp ``, `` <space>kp ``, select: `` <space>kp ``<br>**vim** — normal: `` p ``, `` ]p ``, `` gp ``<br>**helix** — normal: `` p ``, select: `` p `` |
| `paste_before` | Paste before selection | **spacemacs** — normal: `` P ``, `` [P ``, `` [p ``, `` ]P ``, `` gP ``, `` <space>kP ``, select: `` <space>kP ``<br>**vim** — normal: `` P ``, `` [P ``, `` [p ``, `` ]P ``, `` gP ``<br>**helix** — normal: `` P ``, select: `` P `` |
| `yank_from_kill_ring` | Yank the latest kill-ring entry (emacs C-y) | **emacs** — normal: `` <C-y> ``, insert: `` <C-y> `` |
| `yank_pop` | Replace the just-yanked text with the next kill-ring entry (emacs M-y) | **spacemacs** — normal: `` <A-y> ``<br>**emacs** — normal: `` <A-y> ``, insert: `` <A-y> `` |
| `set_mark_command` | Set mark and activate region, pushing to the mark ring (emacs C-SPC) | **spacemacs** — normal: `` <C-@> ``<br>**emacs** — insert: `` <C-space> `` |
| `pop_to_mark` | Jump to the top of the mark ring, rotating it (emacs C-x C-SPC) | **spacemacs** — normal: `` <C-x><C-space> ``, select: `` <C-x><C-space> ``, insert: `` <C-x><C-space> ``<br>**emacs** — insert: `` <C-x><C-space> `` |
| `universal_argument` | Begin a prefix argument for the next command; repeat to multiply it by 4 (emacs C-u) | **emacs** — normal: `` <C-u> ``, insert: `` <C-u> `` |
...
| `point_to_register` | Save point to a register (emacs C-x r SPC) | **spacemacs** — normal: `` <C-x>r<space> ``, select: `` <C-x>r<space> ``, insert: `` <C-x>r<space> ``<br>**emacs** — insert: `` <C-x>r<space> `` |
| `jump_to_register` | Jump to the position in a register (emacs C-x r j) | **spacemacs** — normal: `` <C-x>rj ``, select: `` <C-x>rj ``, insert: `` <C-x>rj ``<br>**emacs** — insert: `` <C-x>rj `` |
| `number_to_register` | Store the prefix count in a register (emacs C-x r n) | **spacemacs** — normal: `` <C-x>rn ``, select: `` <C-x>rn ``, insert: `` <C-x>rn ``<br>**emacs** — insert: `` <C-x>rn `` |
| `increment_register` | Add the prefix count to a number register (emacs C-x r +) | **spacemacs** — normal: `` <C-x>r+ ``, select: `` <C-x>r+ ``, insert: `` <C-x>r+ ``<br>**emacs** — insert: `` <C-x>r+ `` |
| `emacs_insert_register` | Insert a number or rectangle register's value at point (emacs C-x r i) | **spacemacs** — normal: `` <C-x>ri ``, select: `` <C-x>ri ``, insert: `` <C-x>ri ``<br>**emacs** — insert: `` <C-x>ri `` |
...
| `kill_rectangle` | Kill (cut) the rectangle, saving it for yank (emacs C-x r k) | **spacemacs** — normal: `` <C-x>rk ``, select: `` <C-x>rk ``, insert: `` <C-x>rk ``<br>**emacs** — insert: `` <C-x>rk `` |
| `delete_rectangle` | Delete the rectangle without saving (emacs C-x r d) | **spacemacs** — normal: `` <C-x>rd ``, select: `` <C-x>rd ``, insert: `` <C-x>rd ``<br>**emacs** — insert: `` <C-x>rd `` |
| `clear_rectangle` | Blank the rectangle with spaces (emacs C-x r c) | **spacemacs** — normal: `` <C-x>rc ``, select: `` <C-x>rc ``, insert: `` <C-x>rc ``<br>**emacs** — insert: `` <C-x>rc `` |
| `copy_rectangle_as_kill` | Copy the rectangle without deleting (emacs C-x r M-w) | **spacemacs** — normal: `` <C-x>r<A-w> ``, select: `` <C-x>r<A-w> ``, insert: `` <C-x>r<A-w> ``<br>**emacs** — insert: `` <C-x>r<A-w> `` |
| `yank_rectangle` | Insert the saved rectangle at point (emacs C-x r y) | **spacemacs** — normal: `` <C-x>ry ``, select: `` <C-x>ry ``, insert: `` <C-x>ry ``<br>**emacs** — insert: `` <C-x>ry `` |
...
| `bookmark_set` | Set a named persistent bookmark at point (emacs C-x r m) | **spacemacs** — normal: `` <C-x>rm ``, select: `` <C-x>rm ``, insert: `` <C-x>rm ``<br>**emacs** — insert: `` <C-x>rm `` |
...
| `bookmark_jump` | Jump to a bookmark via a picker (emacs C-x r b) | **spacemacs** — normal: `` <C-x>rb ``, `` <space>rj ``, select: `` <C-x>rb ``, `` <space>rj ``, insert: `` <C-x>rb ``<br>**emacs** — insert: `` <C-x>rb ``, `` <C-x>rl `` |
...
| `define_abbrev` | Define a global abbrev: <name> <expansion> (emacs C-x a g) | **spacemacs** — normal: `` <C-x>ag ``, `` <C-x>al ``, select: `` <C-x>ag ``, `` <C-x>al ``, insert: `` <C-x>ag ``, `` <C-x>al ``<br>**emacs** — insert: `` <C-x>ag `` |
| `add_mode_abbrev` | Define a major-mode-local abbrev: <name> <expansion> (emacs add-mode-abbrev, C-x a l) |  |
| `inverse_add_global_abbrev` | Define the word before point as an abbrev, prompting for its expansion (emacs inverse-add-global-abbrev, C-x a i g) | **spacemacs** — normal: `` <C-x>aig ``, `` <C-x>ail ``, select: `` <C-x>aig ``, `` <C-x>ail ``, insert: `` <C-x>aig ``, `` <C-x>ail ``<br>**emacs** — insert: `` <C-x>aig `` |
...
| `expand_abbrev` | Expand the abbrev before point (emacs C-x ') | **spacemacs** — normal: `` <A-'> ``, `` <C-x>' ``, select: `` <C-x>' ``, insert: `` <C-]> ``, `` <C-x>' ``<br>**vim** — insert: `` <C-]> ``<br>**emacs** — insert: `` <C-x>' `` |
...
| `indent` | Indent selection | **spacemacs** — normal: `` == ``, `` <A-C-\> ``, `` <space>xac ``, `` <space>x<tab> ``, select: `` <space>xac ``, `` <space>x<tab> ``, insert: `` <C-t> ``<br>**vim** — normal: `` == ``, insert: `` <C-t> ``<br>**helix** — normal: `` <gt> ``, select: `` <gt> ``<br>**emacs** — insert: `` <A-C-\> `` |
...
| `reflow_selections` | vim gq: reflow selection to text-width | **spacemacs** — normal: `` <A-q> ``<br>**emacs** — normal: `` <A-q> ``, insert: `` <A-q> `` |
| `reflow_selections_keep_cursor` | vim gw: reflow to text-width, keep cursor |  |
| `join_selections` | Join lines inside selection | **spacemacs** — normal: `` <A-^> ``, `` <space>kJ ``, select: `` <space>kJ ``<br>**helix** — normal: `` J ``, select: `` J ``<br>**emacs** — insert: `` <A-^> `` |
...
| `completion` | Invoke completion popup | **spacemacs** — normal: `` <A-C-i> ``, `` <A-tab> ``, `` <C-c>,l ``, `` <C-c>,<space> ``, select: `` <C-c>,l ``, `` <C-c>,<space> ``, insert: `` <A-/> ``, `` <C-n> ``, `` <C-p> ``, `` <C-c>,l ``, `` <C-c>,<space> ``<br>**vim** — insert: `` <C-n> ``, `` <C-p> ``, `` <C-x><C-]> ``, `` <C-x><C-i> ``, `` <C-x><C-n> ``, `` <C-x><C-p> ``, `` <C-x><C-v> ``<br>**helix** — insert: `` <C-x> `` |
| `hover` | Show docs for item under cursor | **spacemacs** — normal: `` <C-h>. ``, `` <C-w>} ``, `` <C-w>g} ``, `` <space>lk ``, `` <space>w} ``, `` <space>hda ``, `` <space>hdf ``, `` <space>hdv ``, `` <space>mhh ``, `` <space>wg} ``, select: `` K ``, `` <C-h>. ``, `` <space>lk ``, `` <space>w} ``, `` <space>hda ``, `` <space>hdf ``, `` <space>hdv ``, `` <space>mhh ``, `` <space>wg} ``, insert: `` <C-h>. ``<br>**vim** — normal: `` <C-w>} ``, `` <C-w>g} ``, select: `` K ``<br>**helix** — normal: `` <space>k ``, select: `` <space>k `` |
...
| `toggle_comments` | Comment/uncomment selections | **spacemacs** — normal: `` <A-;> ``, `` <space>; ``, `` <space>cP ``, `` <space>cc ``, `` <space>cp ``, `` <C-x><C-;> ``, select: `` <space>; ``, `` <space>cP ``, `` <space>cc ``, `` <space>cp ``, `` <C-x><C-;> ``, insert: `` <C-x><C-;> ``<br>**helix** — normal: `` <C-c> ``, `` <space>c ``, select: `` <C-c> ``, `` <space>c ``<br>**emacs** — normal: `` <A-;> ``, insert: `` <A-;> ``, `` <C-x><C-;> `` |
...
| `jump_forward` | Jump forward on jumplist | **spacemacs, vim** — normal: `` <C-i> ``, `` <tab> ``<br>**helix** — normal: `` <C-i> ``, `` <tab> ``, select: `` <C-i> ``, `` <tab> ``<br>**emacs** — insert: `` <A-C-,> `` |
| `jump_backward` | Jump backward on jumplist | **spacemacs** — normal: `` <C-o> ``, `` <C-t> ``, `` <space>jb ``, `` <space>s` ``, select: `` <space>jb ``, `` <space>s` ``<br>**vim** — normal: `` <C-o> ``, `` <C-t> ``<br>**helix** — normal: `` <C-o> ``, select: `` <C-o> ``<br>**emacs** — normal: `` <A-,> ``, insert: `` <A-,> `` |
...
| `mark_paragraph` | Select the paragraph around point (emacs mark-paragraph, M-h) | **spacemacs** — normal: `` <A-h> ``<br>**emacs** — normal: `` <A-h> ``, insert: `` <A-h> `` |
...
| `rotate_view` | Goto next window | **spacemacs** — normal: `` ]w ``, `` <C-w>P ``, `` <C-w>p ``, `` <C-w>r ``, `` <C-w>w ``, `` <C-x>o ``, `` <C-w>.o ``, `` <C-w>.r ``, `` <C-w>.w ``, `` <C-w>[o ``, `` <C-w>[r ``, `` <C-w>[w ``, `` <C-w>{o ``, `` <C-w>{r ``, `` <C-w>{w ``, `` <space>wP ``, `` <space>wp ``, `` <space>wr ``, `` <space>ww ``, `` <C-w><C-p> ``, `` <C-w><C-r> ``, `` <C-w><C-w> ``, `` <C-w><tab> ``, `` <space>b.o ``, `` <space>w.o ``, `` <space>w.r ``, `` <space>w.w ``, `` <space>w[o ``, `` <space>w[r ``, `` <space>w[w ``, `` <space>w{o ``, `` <space>w{r ``, `` <space>w{w ``, `` <space>w<C-p> ``, `` <space>w<C-r> ``, `` <space>w<C-w> ``, `` <space>w<tab> ``, select: `` <C-x>o ``, `` <space>wP ``, `` <space>wp ``, `` <space>wr ``, `` <space>ww ``, `` <space>b.o ``, `` <space>w.o ``, `` <space>w.r ``, `` <space>w.w ``, `` <space>w[o ``, `` <space>w[r ``, `` <space>w[w ``, `` <space>w{o ``, `` <space>w{r ``, `` <space>w{w ``, `` <space>w<C-p> ``, `` <space>w<C-r> ``, `` <space>w<C-w> ``, `` <space>w<tab> ``, insert: `` <C-x>o ``<br>**vim** — normal: `` ]w ``, `` <C-w>P ``, `` <C-w>p ``, `` <C-w>r ``, `` <C-w>w ``, `` <C-w>.o ``, `` <C-w>.r ``, `` <C-w>.w ``, `` <C-w>[o ``, `` <C-w>[r ``, `` <C-w>[w ``, `` <C-w>{o ``, `` <C-w>{r ``, `` <C-w>{w ``, `` <C-w><C-p> ``, `` <C-w><C-r> ``, `` <C-w><C-w> ``, `` <C-w><tab> ``<br>**helix** — normal: `` <C-w>w ``, `` <space>ww ``, `` <C-w><C-w> ``, `` <space>w<C-w> ``, select: `` <C-w>w ``, `` <space>ww ``, `` <C-w><C-w> ``, `` <space>w<C-w> ``<br>**emacs** — normal: `` <C-x>o ``, insert: `` <C-x>o `` |
...
| `hsplit` | Horizontal bottom split | **spacemacs** — normal: `` <C-w>S ``, `` <C-w>s ``, `` <C-x>2 ``, `` <C-w>.S ``, `` <C-w>.s ``, `` <C-w>[S ``, `` <C-w>[s ``, `` <C-w>{S ``, `` <C-w>{s ``, `` <space>wS ``, `` <space>ws ``, `` <C-w><C-s> ``, `` <space>w.S ``, `` <space>w.s ``, `` <space>w[S ``, `` <space>w[s ``, `` <space>w{S ``, `` <space>w{s ``, `` <C-w>.<minus> ``, `` <C-w>[<minus> ``, `` <C-w>{<minus> ``, `` <space>w<C-s> ``, `` <space>w.<minus> ``, `` <space>w[<minus> ``, `` <space>w{<minus> ``, select: `` <C-x>2 ``, `` <space>wS ``, `` <space>ws ``, `` <space>w.S ``, `` <space>w.s ``, `` <space>w[S ``, `` <space>w[s ``, `` <space>w{S ``, `` <space>w{s ``, `` <space>w<C-s> ``, `` <space>w.<minus> ``, `` <space>w[<minus> ``, `` <space>w{<minus> ``, insert: `` <C-x>2 ``<br>**vim** — normal: `` <C-w>S ``, `` <C-w>s ``, `` <C-w>.S ``, `` <C-w>.s ``, `` <C-w>[S ``, `` <C-w>[s ``, `` <C-w>{S ``, `` <C-w>{s ``, `` <C-w><C-s> ``, `` <C-w>.<minus> ``, `` <C-w>[<minus> ``, `` <C-w>{<minus> ``<br>**helix** — normal: `` <C-w>s ``, `` <space>ws ``, `` <C-w><C-s> ``, `` <space>w<C-s> ``, select: `` <C-w>s ``, `` <space>ws ``, `` <C-w><C-s> ``, `` <space>w<C-s> ``<br>**emacs** — normal: `` <C-x>2 ``, insert: `` <C-x>2 `` |
...
| `vsplit` | Vertical right split | **spacemacs** — normal: `` <C-w>/ ``, `` <C-w>2 ``, `` <C-w>V ``, `` <C-w>v ``, `` <C-x>3 ``, `` <C-w>./ ``, `` <C-w>.V ``, `` <C-w>.v ``, `` <C-w>[/ ``, `` <C-w>[V ``, `` <C-w>[v ``, `` <C-w>{/ ``, `` <C-w>{V ``, `` <C-w>{v ``, `` <space>w/ ``, `` <space>w2 ``, `` <space>wV ``, `` <space>wv ``, `` <C-w><C-v> ``, `` <space>w./ ``, `` <space>w.V ``, `` <space>w.v ``, `` <space>w[/ ``, `` <space>w[V ``, `` <space>w[v ``, `` <space>w{/ ``, `` <space>w{V ``, `` <space>w{v ``, `` <space>w<C-v> ``, `` <space>u<space>w2 ``, select: `` <C-x>3 ``, `` <space>w/ ``, `` <space>w2 ``, `` <space>wV ``, `` <space>wv ``, `` <space>w./ ``, `` <space>w.V ``, `` <space>w.v ``, `` <space>w[/ ``, `` <space>w[V ``, `` <space>w[v ``, `` <space>w{/ ``, `` <space>w{V ``, `` <space>w{v ``, `` <space>w<C-v> ``, `` <space>u<space>w2 ``, insert: `` <C-x>3 ``<br>**vim** — normal: `` <C-w>/ ``, `` <C-w>2 ``, `` <C-w>V ``, `` <C-w>v ``, `` <C-w>./ ``, `` <C-w>.V ``, `` <C-w>.v ``, `` <C-w>[/ ``, `` <C-w>[V ``, `` <C-w>[v ``, `` <C-w>{/ ``, `` <C-w>{V ``, `` <C-w>{v ``, `` <C-w><C-v> ``<br>**helix** — normal: `` <C-w>v ``, `` <space>wv ``, `` <C-w><C-v> ``, `` <space>w<C-v> ``, select: `` <C-w>v ``, `` <space>wv ``, `` <C-w><C-v> ``, `` <space>w<C-v> ``<br>**emacs** — normal: `` <C-x>3 ``, insert: `` <C-x>3 `` |
...
| `align_view_top` | Align view top | **spacemacs, vim** — normal: `` zt ``<br>**helix** — normal: `` Zt ``, `` zt ``, select: `` Zt ``, `` zt `` |
| `align_view_center` | Align view center | **spacemacs** — normal: `` zz ``, `` <C-l> ``, `` <C-w>.z ``, `` <C-w>[z ``, `` <C-w>{z ``, `` <space>b.z ``, `` <space>w.z ``, `` <space>w[z ``, `` <space>wc. ``, `` <space>w{z ``, select: `` <space>b.z ``, `` <space>w.z ``, `` <space>w[z ``, `` <space>wc. ``, `` <space>w{z ``<br>**vim** — normal: `` zz ``, `` <C-w>.z ``, `` <C-w>[z ``, `` <C-w>{z ``<br>**helix** — normal: `` Zc ``, `` Zz ``, `` zc ``, `` zz ``, select: `` Zc ``, `` Zz ``, `` zc ``, `` zz ``<br>**emacs** — insert: `` <C-l> `` |
| `align_view_bottom` | Align view bottom | **spacemacs, vim** — normal: `` zb ``<br>**helix** — normal: `` Zb ``, `` zb ``, select: `` Zb ``, `` zb `` |
...
| `scroll_column_left` | Scroll view left one column (zh) | **spacemacs, vim** — normal: `` zh ``, `` z<left> `` |
| `scroll_column_right` | Scroll view right one column (zl) | **spacemacs, vim** — normal: `` zl ``, `` z<right> `` |
| `scroll_half_column_left` | Scroll view left half a screen (zH) | **spacemacs** — normal: `` zH ``, `` ze ``, `` <C-x><gt> ``, select: `` <C-x><gt> ``, insert: `` <C-x><gt> ``<br>**vim** — normal: `` zH ``, `` ze `` |
| `scroll_half_column_right` | Scroll view right half a screen (zL) | **spacemacs** — normal: `` zL ``, `` zs ``, `` <C-x><lt> ``, select: `` <C-x><lt> ``, insert: `` <C-x><lt> ``<br>**vim** — normal: `` zL ``, `` zs `` |
| `resize_view_wider` | Make current window wider (CTRL-W >) | **spacemacs** — normal: `` <C-x>} ``, `` <C-w>.] ``, `` <C-w>[] ``, `` <C-w>{] ``, `` <C-w><gt> ``, `` <C-w>.<gt> ``, `` <C-w>[<gt> ``, `` <C-w>{<gt> ``, `` <space>w.] ``, `` <space>w[] ``, `` <space>w{] ``, `` <space>w<gt> ``, `` <space>w.<gt> ``, `` <space>w[<gt> ``, `` <space>w{<gt> ``, select: `` <C-x>} ``, `` <space>w.] ``, `` <space>w[] ``, `` <space>w{] ``, `` <space>w<gt> ``, `` <space>w.<gt> ``, `` <space>w[<gt> ``, `` <space>w{<gt> ``, insert: `` <C-x>} ``<br>**vim** — normal: `` <C-w>.] ``, `` <C-w>[] ``, `` <C-w>{] ``, `` <C-w><gt> ``, `` <C-w>.<gt> ``, `` <C-w>[<gt> ``, `` <C-w>{<gt> ``<br>**emacs** — normal: `` <C-x>} ``, insert: `` <C-x>} `` |
| `resize_view_narrower` | Make current window narrower (CTRL-W <) | **spacemacs** — normal: `` <C-x>{ ``, `` <C-w>.[ ``, `` <C-w>[[ ``, `` <C-w>{[ ``, `` <C-w><lt> ``, `` <C-w>.<lt> ``, `` <C-w>[<lt> ``, `` <C-w>{<lt> ``, `` <space>w.[ ``, `` <space>w[[ ``, `` <space>w{[ ``, `` <space>w<lt> ``, `` <space>w.<lt> ``, `` <space>w[<lt> ``, `` <space>w{<lt> ``, select: `` <C-x>{ ``, `` <space>w.[ ``, `` <space>w[[ ``, `` <space>w{[ ``, `` <space>w<lt> ``, `` <space>w.<lt> ``, `` <space>w[<lt> ``, `` <space>w{<lt> ``, insert: `` <C-x>{ ``<br>**vim** — normal: `` <C-w>.[ ``, `` <C-w>[[ ``, `` <C-w>{[ ``, `` <C-w><lt> ``, `` <C-w>.<lt> ``, `` <C-w>[<lt> ``, `` <C-w>{<lt> ``<br>**emacs** — normal: `` <C-x>{ ``, insert: `` <C-x>{ `` |
| `resize_view_taller` | Make current window taller (CTRL-W +) | **spacemacs** — normal: `` <C-w>+ ``, `` <C-x>^ ``, `` <C-w>.} ``, `` <C-w>[} ``, `` <C-w>{} ``, `` <space>w+ ``, `` <space>w.} ``, `` <space>w[} ``, `` <space>w{} ``, select: `` <C-x>^ ``, `` <space>w+ ``, `` <space>w.} ``, `` <space>w[} ``, `` <space>w{} ``, insert: `` <C-x>^ ``<br>**vim** — normal: `` <C-w>+ ``, `` <C-w>.} ``, `` <C-w>[} ``, `` <C-w>{} ``<br>**emacs** — normal: `` <C-x>^ ``, insert: `` <C-x>^ `` |
...
| `resize_view_equalize` | Make all windows equal size (CTRL-W =) | **spacemacs** — normal: `` <C-w>= ``, `` <C-x>+ ``, `` <C-w>.= ``, `` <C-w>[= ``, `` <C-w>{= ``, `` <space>w= ``, `` <space>w.= ``, `` <space>w[= ``, `` <space>w{= ``, select: `` <C-x>+ ``, `` <space>w= ``, `` <space>w.= ``, `` <space>w[= ``, `` <space>w{= ``, insert: `` <C-x>+ ``<br>**vim** — normal: `` <C-w>= ``, `` <C-w>.= ``, `` <C-w>[= ``, `` <C-w>{= ``<br>**emacs** — normal: `` <C-x>+ ``, insert: `` <C-x>+ `` |
...
| `spell_add_good` | Mark word under cursor as correctly spelled (zg) | **spacemacs, vim** — normal: `` zG ``, `` zg `` |
| `spell_add_bad` | Mark word under cursor as misspelled (zw) | **spacemacs, vim** — normal: `` zW ``, `` zw `` |
| `spell_undo` | Undo a zg/zw for the word under cursor (zug) | **spacemacs, vim** — normal: `` zuG ``, `` zuW ``, `` zug ``, `` zuw `` |
...
| `fold_open` | Open fold under cursor (zo) | **spacemacs** — normal: `` zO ``, `` zo ``, `` zv ``, `` zx ``, `` <C-c>@<C-r> ``, `` <C-c>@<C-s> ``, select: `` <C-c>@<C-r> ``, `` <C-c>@<C-s> ``, insert: `` <C-c>@<C-r> ``, `` <C-c>@<C-s> ``<br>**vim** — normal: `` zO ``, `` zo ``, `` zv ``, `` zx `` |
...
| `fold_open_all` | Open all folds (zR) | **spacemacs** — normal: `` zR ``, `` zX ``, `` zn ``, `` <C-c>@<A-C-s> ``, select: `` <C-c>@<A-C-s> ``, insert: `` <C-c>@<A-C-s> ``<br>**vim** — normal: `` zR ``, `` zX ``, `` zn `` |
| `fold_close_all` | Close all folds (zM) | **spacemacs** — normal: `` zM ``, `` zN ``, `` <C-c>@<A-C-h> ``, select: `` <C-c>@<A-C-h> ``, insert: `` <C-c>@<A-C-h> ``<br>**vim** — normal: `` zM ``, `` zN `` |
...
| `exit_transient_state` | Leave the current transient state (q) | **spacemacs** — normal: `` <C-w>.q ``, `` <C-w>[q ``, `` <C-w>{q ``, `` <space>b.q ``, `` <space>enq ``, `` <space>epq ``, `` <space>lwq ``, `` <space>n+q ``, `` <space>n=q ``, `` <space>n_q ``, `` <space>w.q ``, `` <space>w[q ``, `` <space>w{q ``, `` <space>x.q ``, `` <space>zfq ``, `` <space>zxq ``, `` <space>n<minus>q ``, select: `` <space>b.q ``, `` <space>enq ``, `` <space>epq ``, `` <space>lwq ``, `` <space>n+q ``, `` <space>n=q ``, `` <space>n_q ``, `` <space>w.q ``, `` <space>w[q ``, `` <space>w{q ``, `` <space>x.q ``, `` <space>zfq ``, `` <space>zxq ``, `` <space>n<minus>q ``<br>**vim** — normal: `` <C-w>.q ``, `` <C-w>[q ``, `` <C-w>{q `` |
...
| `kmacro_step_edit_macro` | Edit the whole last kbd macro (emacs kmacro-step-edit-macro; no per-key stepping) | **spacemacs** — normal: `` <space>Kes ``, `` <C-x><C-k><space> ``, select: `` <space>Kes ``, `` <C-x><C-k><space> ``, insert: `` <C-x><C-k><space> `` |
...
| `toggle_window_dedication` | Toggle window dedication (spacemacs SPC w t) | **spacemacs** — normal: `` <C-w>t ``, `` <space>wt ``, select: `` <space>wt ``<br>**vim** — normal: `` <C-w>t `` |
...
| `subword_w` | Next word start, sub-word aware (w) | **spacemacs, vim** — normal: `` w `` |
...
| `zap_to_char` | Kill through the next char, inclusive (emacs zap-to-char, M-z) | **spacemacs** — normal: `` <A-z> ``<br>**emacs** — normal: `` <A-z> ``, insert: `` <A-z> `` |
...
| `picture_open_line` | Picture-mode: split the line at point (emacs picture-open-line) | **emacs** — insert: `` <C-o> `` |
...
| `quoted_insert` | Insert the next key literally, control chars included (emacs quoted-insert) | **emacs** — insert: `` <C-q> `` |
...
| `switch_to_buffer_other_window` | Show a buffer in another window (emacs switch-to-buffer-other-window) | **spacemacs** — normal: `` <C-x>4b ``, select: `` <C-x>4b ``, insert: `` <C-x>4b `` |
...
| `keyboard_escape_quit` | Drop extra cursors and deactivate the region (emacs keyboard-escape-quit) | **emacs** — insert: `` <C-]> ``, `` <esc><esc><esc> `` |
...
| `async_shell_command` | Run a shell command without blocking, output to a buffer (emacs async-shell-command) | **emacs** — insert: `` <A-&> `` |
...
| `goto_next_function` | Goto next function | **spacemacs, vim** — normal: `` ][ ``, `` ]m ``<br>**helix** — normal: `` ]f ``, select: `` ]f ``<br>**emacs** — normal: `` <A-C-e> ``, insert: `` <A-C-e> `` |
| `goto_prev_function` | Goto previous function | **spacemacs, vim** — normal: `` [] ``, `` [m ``<br>**helix** — normal: `` [f ``, select: `` [f ``<br>**emacs** — normal: `` <A-C-a> ``, insert: `` <A-C-a> `` |
...
| `goto_next_paragraph` | Goto next paragraph | **spacemacs** — normal: `` } ``, `` <A-}> ``, select: `` } ``<br>**vim** — normal: `` } ``, select: `` } ``<br>**helix** — normal: `` ]p ``, select: `` ]p ``<br>**emacs** — normal: `` <A-}> ``, insert: `` <A-}> `` |
| `goto_prev_paragraph` | Goto previous paragraph | **spacemacs** — normal: `` { ``, `` <A-{> ``, select: `` { ``<br>**vim** — normal: `` { ``, select: `` { ``<br>**helix** — normal: `` [p ``, select: `` [p ``<br>**emacs** — normal: `` <A-{> ``, insert: `` <A-{> `` |
...
| `increment` | Increment item under cursor | **spacemacs** — normal: `` <C-a> ``, `` g<C-a> ``, `` <space>n++ ``, `` <space>n+= ``, `` <space>n=+ ``, `` <space>n== ``, `` <space>n_+ ``, `` <space>n_= ``, `` <space>n<minus>+ ``, `` <space>n<minus>= ``, select: `` <C-a> ``, `` g<C-a> ``, `` <space>n++ ``, `` <space>n+= ``, `` <space>n=+ ``, `` <space>n== ``, `` <space>n_+ ``, `` <space>n_= ``, `` <space>n<minus>+ ``, `` <space>n<minus>= ``<br>**vim** — normal: `` <C-a> ``, `` g<C-a> ``, select: `` <C-a> ``, `` g<C-a> ``<br>**helix** — normal: `` <C-a> ``, select: `` <C-a> `` |
| `decrement` | Decrement item under cursor | **spacemacs** — normal: `` g<C-x> ``, `` <space>n+_ ``, `` <space>n=_ ``, `` <space>n__ ``, `` <space>n+<minus> ``, `` <space>n<minus>_ ``, `` <space>n=<minus> ``, `` <space>n_<minus> ``, `` <space>n<minus><minus> ``, select: `` g<C-x> ``, `` <space>n+_ ``, `` <space>n=_ ``, `` <space>n__ ``, `` <space>n+<minus> ``, `` <space>n<minus>_ ``, `` <space>n=<minus> ``, `` <space>n_<minus> ``, `` <space>n<minus><minus> ``<br>**vim** — normal: `` <C-x> ``, `` g<C-x> ``, select: `` <C-x> ``, `` g<C-x> ``<br>**helix** — normal: `` <C-x> ``, select: `` <C-x> `` |
...
| `command_palette` | Open command palette | **spacemacs** — normal: `` <A-X> ``, `` <A-x> ``, `` <C-x>* ``, `` <C-x>; ``, `` <C-x>q ``, `` <space>? ``, `` <space><space> ``, select: `` <C-x>* ``, `` <C-x>; ``, `` <C-x>q ``, `` <space>? ``, `` <space><space> ``, insert: `` <C-x>* ``, `` <C-x>; ``, `` <C-x>q ``<br>**helix** — normal: `` <space>? ``, select: `` <space>? ``<br>**emacs** — normal: `` <A-x> ``, insert: `` <A-X> ``, `` <A-x> `` |
...
| `find_char_forward_label` | easymotion f: label forward occurrences of a char and jump | **spacemacs, vim** — normal: `` f `` |
| `find_char_backward_label` | easymotion F: label backward occurrences of a char and jump | **spacemacs, vim** — normal: `` F `` |
| `till_char_forward_label` | easymotion t: label forward, jump till before a char | **spacemacs, vim** — normal: `` t `` |
| `till_char_backward_label` | easymotion T: label backward, jump till after a char | **spacemacs, vim** — normal: `` T `` |
| `goto_next_tabstop` | Goto next snippet placeholder |  |
| `goto_prev_tabstop` | Goto next snippet placeholder |  |
| `emmet_expand` | Expand emmet/zen HTML abbreviation (or Tab) | **helix, emacs** — insert: `` <tab> `` |
...
| `dabbrev_expand` | Expand the word before point from the buffer's other words (emacs dabbrev-expand, JetBrains Cyclic Expand Word) | **emacs** — normal: `` <A-/> ``, insert: `` <A-/> `` |
...
| `reposition_window` | Scroll so the whole function at point is on screen (emacs reposition-window) | **emacs** — insert: `` <A-C-l> `` |
...
| `rectangle_mark_mode` | Toggle rectangular region selection (emacs rectangle-mark-mode) | **spacemacs** — normal: `` <C-x><space> ``, select: `` <C-x><space> ``, insert: `` <C-x><space> ``<br>**emacs** — insert: `` <C-x><space> `` |
