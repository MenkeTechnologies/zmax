use zmax_loader::grammar::{build_grammars, fetch_grammars};

const STRICT: bool = true;

fn main() {
    if std::env::var("ZMAX_DISABLE_AUTO_GRAMMAR_BUILD").is_err() {
    ...
    #[cfg(windows)]
    windows_rc::link_icon_in_windows_exe("../contrib/zmax-256p.ico");
}
