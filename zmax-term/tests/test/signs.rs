        ...
        vec![
            (
                ...
                Some(&|app: &Application| {
                    ...
                    assert!(zmax_view::signs::is_defined("warn"));
                }),
            ),
            (
            ...
            (
                ...
                Some(&{
                    ...
                    move |app: &Application| {
                        ...
                        assert!(!zmax_view::signs::has_signs(&path), "signs not cleared");
                    }
                }),
            ),
        ],
