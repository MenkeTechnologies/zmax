...
use zmax_event::{cancelable_future, TaskController, TaskHandle};
use zmax_lsp::lsp;
use zmax_lsp::lsp::{CompletionContext, CompletionTriggerKind};
use zmax_lsp::util::pos_to_lsp_pos;
use zmax_stdx::rope::RopeSliceExt;
use zmax_view::document::{Mode, SavePoint};
use zmax_view::handlers::completion::{CompletionEvent, ResponseContext};
use zmax_view::{Document, DocumentId, Editor, ViewId};
...
impl zmax_event::AsyncHook for CompletionHandler {
