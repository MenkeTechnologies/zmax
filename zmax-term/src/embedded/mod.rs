//! Embedded / single-board development integration — the zmax port of the
//! Arduino IDE and PlatformIO IDE workflows.
//!
//! Rather than reimplement toolchains, zmax drives the same command-line
...
pub fn tool_available(binary: &str) -> bool {
    zmax_stdx::env::binary_exists(binary)
}
...
/// future subcommand is reachable from inside zmax.
...
/// subcommand (including `home`) is reachable from inside zmax.
