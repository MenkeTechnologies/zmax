//! Table — the zmax port of GNU Emacs `table.el`, the text-based table editor.
//!
...
//! [`zmax_core::table`]; this module is only key handling and rendering.
//!
...
use zmax_core::table::{backward_cell, forward_cell, Table};
