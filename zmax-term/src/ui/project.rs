//! Project — the zmax port of GNU Emacs `project.el`.
//!
...
//! [`zmax_core::project`]; this module does the directory I/O, rendering and
//! key handling.
//!
...
use zmax_core::project::{rank, PROJECT_MARKERS};
