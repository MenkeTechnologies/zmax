use zmax_core::indent::IndentStyle;
use zmax_core::{coords_at_pos, encoding, unicode::width::UnicodeWidthStr, Position};
use zmax_lsp::lsp::DiagnosticSeverity;
use zmax_view::document::DEFAULT_LANGUAGE_NAME;
use zmax_view::{
...
use zmax_view::editor::StatusLineElement as StatusLineElementID;
...
{
    match element_id {
        zmax_view::editor::StatusLineElement::Mode => render_mode,
        zmax_view::editor::StatusLineElement::Spinner => render_lsp_spinner,
        zmax_view::editor::StatusLineElement::FileBaseName => render_file_base_name,
        zmax_view::editor::StatusLineElement::FileName => render_file_name,
        zmax_view::editor::StatusLineElement::FileAbsolutePath => render_file_absolute_path,
        zmax_view::editor::StatusLineElement::FileModificationIndicator => {
        ...
        zmax_view::editor::StatusLineElement::Position => render_position,
        zmax_view::editor::StatusLineElement::PositionPercentage => render_position_percentage,
        zmax_view::editor::StatusLineElement::TotalLineNumbers => render_total_line_numbers,
        zmax_view::editor::StatusLineElement::Separator => render_separator,
        zmax_view::editor::StatusLineElement::Spacer => render_spacer,
        zmax_view::editor::StatusLineElement::VersionControl => render_version_control,
        zmax_view::editor::StatusLineElement::Register => render_register,
        zmax_view::editor::StatusLineElement::CurrentWorkingDirectory => render_cwd,
        zmax_view::editor::StatusLineElement::CodeActionHint => render_code_action_hint,
        zmax_view::editor::StatusLineElement::TrailingWhitespace => render_trailing_whitespace,
        zmax_view::editor::StatusLineElement::MixedIndent => render_mixed_indent,
        zmax_view::editor::StatusLineElement::FileFormatIcon => render_file_format_icon,
    }
}
