...
use zmax_view::{editor::Action, graphics::Rect, keyboard::KeyCode};
    ...
    fn render_dashboard(
        ...
        let logo = Canvas::default()
            ...
            .paint(move |ctx| {
                ...
                ctx.print(10.0, 50.0, Line::from(Span::styled("zmax", accent)));
            });
...
fn draw_path(
    ...
    y: u16,
    path: &str,
    dir: zmax_view::graphics::Style,
    file: zmax_view::graphics::Style,
) {
    match path.rfind('/') {
        Some(slash) => {
