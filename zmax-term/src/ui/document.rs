...
use zmax_core::text_annotations::TextAnnotations;
use zmax_core::{visual_offset_from_block, Position, RopeSlice};
use zmax_stdx::rope::RopeSliceExt;
use zmax_view::editor::{WhitespaceConfig, WhitespaceRenderValue};
use zmax_view::graphics::Rect;
use zmax_view::theme::Style;
use zmax_view::view::ViewPosition;
use zmax_view::{Document, Theme};
...
pub fn render_document(
    ...
    view_id: Option<zmax_view::ViewId>,
) {
