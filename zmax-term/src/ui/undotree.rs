//! Undo-tree browser — the zmax port of vim's `undotree` plugin
//! (`:UndotreeToggle`).
//!
//! zmax (like Helix) already stores undo history as a *branching tree*: every
//! [`Revision`](zmax_core::history) has a parent and may have several
...
use zmax_view::{graphics::Rect, DocumentId, ViewId};
