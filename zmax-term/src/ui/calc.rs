//! Calc — the zmax port of GNU Emacs `calc-mode`, the RPN stack calculator.
//!
//! A full-screen [`Component`] over the pure, unit-tested [`zmax_core::calc`]
...
use zmax_core::calc::{format_value, Angle, BinOp, Calc as Engine, UnOp};
