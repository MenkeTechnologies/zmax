    ...
    let mut normal = keymap!({ "Normal mode"
        ...
        "space" => { "Leader (spacemacs SPC)"
            ...
            "s" => { "Search"
                ...
                "M" => global_search_in_scope,     // SPC s M : project search inside a saved scope (JetBrains scopes)
            ...
            "c" => { "Comments"
                ...
                "H" => recent_tests,               // SPC c H : pick one of the finished test runs and run it again (JetBrains Recent Tests)
