...
pub use zmax_view::handlers::{word_index, Handlers};
...
pub fn setup(config: Arc<ArcSwap<Config>>) -> Handlers {
    ...
    let handlers = Handlers {
        completions: zmax_view::handlers::completion::CompletionHandler::new(event_tx),
        signature_hints,
        auto_save,
        document_colors,
        document_links,
    ...
    zmax_view::handlers::register_hooks(&handlers);
    ...
    crate::commands::register_post_command_hooks();
