...
; --- Properties & members ---------------------------------------------------
(property_declaration name: (identifier) @variable.other.member)
(typed_property_declaration name: (identifier) @variable.other.member)
...
; --- Function & method calls (override @variable.other.member on the callee) --------------
...
; --- Hotkeys & hotstrings ----------------------------------------------------
(hotkey_trigger) @constant
(hotstring_trigger) @constant
