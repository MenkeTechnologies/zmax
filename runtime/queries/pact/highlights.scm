...
(s_expression
  head: (s_expression_head) @keyword.control.exception
...
(s_expression
  head: (s_expression_head) @keyword.control.conditional
...
(s_expression
  head: (s_expression_head) @keyword.control.return
  (#any-of?  @keyword.control.return
    "yield" "resume"
  )
)
...
(schema_field_identifier) @variable.other.member
(doc_string) @string.documentation
(module_identifier) @namespace
(module_governance) @function
(use module: (reference) @namespace)
...
(s_expression_head (ident) @namespace . (ident) @function.method)

(reference) @variable
(reference (ident) @namespace . (ident) @variable.other.member)
