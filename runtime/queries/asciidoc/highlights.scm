...
(revnumber) @constant.numeric.integer
...
(document_attr
  (attr_name) @variable.other.member)
...
((section_block
  (element_attr
    (element_attr_marker) @comment
    (positional_attr (block_style) @_style @comment)
    (element_attr_marker) @comment)
  (delimited_block
    (delimited_block_start_marker) @comment
    (delimited_block_end_marker) @comment))
