...
use zmax_core::unicode::width::{UnicodeWidthChar, UnicodeWidthStr};
use zmax_view::graphics::{Color, Modifier, Rect, Style, UnderlineStyle};
...
///
/// ```
/// use zmax_tui::buffer::{Buffer, Cell, Symbol};
/// use zmax_view::graphics::{Rect, Color, UnderlineStyle, Style, Modifier};
///
