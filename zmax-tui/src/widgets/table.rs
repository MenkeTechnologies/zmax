...
/// ```rust
/// # use zmax_tui::widgets::Cell;
/// # use zmax_tui::text::{Span, Spans, Text};
/// # use zmax_view::graphics::{Style, Modifier};
...
/// ```rust
/// # use zmax_tui::widgets::{Block, Borders, Table, Row, Cell};
/// # use zmax_tui::layout::Constraint;
/// # use zmax_view::graphics::{Style, Color, Modifier};
/// # use zmax_tui::text::{Text, Spans, Span};
/// Table::new(vec![
