...
impl Client {
    ...
    pub fn start(
        ...
        let cmd = zmax_stdx::env::which(cmd)?;
    ...
    pub fn supports_feature(&self, feature: LanguageServerFeature) -> bool {
        ...
        match feature {
            ...
            LanguageServerFeature::TypeHierarchy => matches!(
                capabilities.type_hierarchy_provider,
                Some(
                    TypeHierarchyServerCapability::Simple(true)
                        | TypeHierarchyServerCapability::Options(_)
                )
            ),
        }
    }
        ...
        let params = lsp::InitializeParams {
            ...
            capabilities: lsp::ClientCapabilities {
                ...
                text_document: Some(lsp::TextDocumentClientCapabilities {
                    ...
                    type_hierarchy: Some(lsp::DynamicRegistrationClientCapabilities {
                        dynamic_registration: Some(false),
                    }),
    ...
    /// (i.e. zmax's *outbound* write completed — independent of how slow the server
    ...
    pub fn text_document_document_color(
        ...
        let params = lsp::DocumentColorParams {
            ...
            partial_result_params: zmax_lsp_types::PartialResultParams {
