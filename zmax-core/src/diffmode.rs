//! Diff-mode substrate — the pure, filesystem-free parser behind the zmax port
...
/// length numbers (zmax recomputes both halves; stock Emacs leaves the second
...
/// alone. Stock Emacs edits the *patched source files* on disk; zmax only
