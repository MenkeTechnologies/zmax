...
//! commands driving zmax toward a strict superset of GNU Emacs, VS Code,
//! Neovim/Vim, Sublime Text, JetBrains, Zed and Helix (plus a couple of originals
//! that go beyond all of them).
//!
//! Like `zmax-term`'s `text_ops`, everything here is a plain function (or small
...
/// ⭐ zmax original — beyond GNU Emacs, VS Code, Vim, Sublime, JetBrains, Zed and
