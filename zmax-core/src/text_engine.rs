...
//! (plus a couple of zmax originals) pushing the editor toward a strict superset
...
// ---------------------------------------------------------------------------
// ⭐ zmax original — beyond GNU Emacs, VS Code, Vim, Sublime, JetBrains, Zed
...
/// ⭐ zmax original: cycle an identifier's naming convention
...
// ---------------------------------------------------------------------------
// ⭐ zmax original — beyond all listed editors: sum a numeric column across a
...
/// ⭐ zmax original: sum the `field`-th `sep`-delimited column over `lines`,
