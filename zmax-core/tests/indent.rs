...
#[test]
fn test_treesitter_indent_rust_zmax() {
    ...
    for file in files.split_whitespace() {
        ...
        let ignored_lines: Vec<Range<usize>> = match file {
            "zmax-term/src/application.rs" => vec![
            ...
            "zmax-term/src/commands/dap.rs" => vec![
                // Complex `format!` macro
                46..52,
            ],
            "zmax-term/src/commands/lsp.rs" => vec![
                // Macro
                624..627,
                ...
                878..879,
                // Same as in `zmax-term/src/commands.rs`
                1335..1343,
            ],
            "zmax-term/src/config.rs" => vec![
                // Multiline string
                146..152,
            ],
            "zmax-term/src/keymap.rs" => vec![
                // Complex macro (see above)
                456..470,
                // Multiline string without indent
                563..567,
            ],
            "zmax-term/src/main.rs" => vec![
                // Multiline string
                44..70,
            ],
            "zmax-term/src/ui/completion.rs" => vec![
                // Macro
                218..232,
            ],
            "zmax-term/src/ui/editor.rs" => vec![
            ...
            "zmax-term/src/ui/lsp.rs" => vec![
                // Macro
                56..61,
            ],
            "zmax-term/src/ui/statusline.rs" => vec![
                // Same as in `zmax-term/src/commands.rs`
                436..442,
                450..456,
            ],
...
fn test_treesitter_indent(
    ...
    std::env::set_var("ZMAX_RUNTIME", runtime.to_str().unwrap());
